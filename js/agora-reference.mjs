...
import { d as _, e as n, o as r, s as b, w as c, r as h, c as d, x as l, _ as y, O as g, a as o, f as p, u as i, z as t, B as u, t as f, I as O, h as j, p as q } from "./NcEmptyContent-q-geAf0w-OoTkDdhx.chunk.mjs";
import { r as v } from "./NcRichText-G8kzsdwx--9l1qhwo.chunk.mjs";
import { E as w, N as k } from "./CalendarEnd-ClsNIsqf.chunk.mjs";
import { _ as B } from "./AgoraAppIcon.vue_vue_type_script_setup_true_lang-Dm2Ci4ie.chunk.mjs";

const N = { key: 0 }, C = _({ __name: "BadgeSmallDiv", props: { tag: { default: "span" } }, setup(a) {
  return (s, e) => (r(), n(b(s.tag), { class: "badge-small" }, { default: c(() => [h(s.$slots, "icon", {}, void 0, true), s.$slots.default ? (r(), d("span", N, [h(s.$slots, "default", {}, void 0, true)])) : l("", true)]), _: 3 }));
} }), m = y(C, [["__scopeId", "data-v-a75cba4f"]]), D = { key: 0, class: "agora_widget" }, I = { class: "widget_header" }, $ = ["href"], R = { class: "description" }, V = { class: "clamped" }, z = { key: 0, class: "widget_footer" }, S = _({ __name: "Reference", props: { richObject: {} }, setup(a) {
  const s = a.richObject?.inquiry?.expiry ? g.fromMillis(a.richObject.inquiry.expiry * 1e3).diffNow("hours").hours < 36 ? "warning" : "success" : "";
  return (e, E) => e.richObject ? (r(), d("div", D, [o("div", I, [p(i(B), { size: 20, class: "title-icon" }), o("a", { class: "title", href: e.richObject.inquiry.url, target: "_blank" }, t(e.richObject.inquiry.title), 9, $), e.richObject.inquiry.participated ? (r(), n(m, { key: 0, class: "success" }, { default: c(() => [u(t(i(f)("agora", "participated")), 1)]), _: 1 })) : e.richObject.inquiry.expired ? (r(), n(m, { key: 1, class: "error" }, { default: c(() => [u(t(i(f)("agora", "closed")), 1)]), _: 1 })) : e.richObject.inquiry.expiry > 0 ? (r(), n(m, { key: 2, class: O(i(s)) }, { icon: c(() => [p(w, { size: 16 })]), default: c(() => [u(" " + t(i(g).fromMillis(e.richObject.inquiry.expiry * 1e3).toRelative()), 1)]), _: 1 }, 8, ["class"])) : l("", true)]), o("div", R, [o("span", V, t(e.richObject.inquiry.description), 1)]), e.richObject.inquiry.ownerId ? (r(), d("div", z, [o("span", null, t(i(f)("agora", "By:")), 1), p(i(k), { user: e.richObject.inquiry.ownerId, "display-name": e.richObject.inquiry.ownerDisplayName }, null, 8, ["user", "display-name"])])) : l("", true)])) : l("", true);
