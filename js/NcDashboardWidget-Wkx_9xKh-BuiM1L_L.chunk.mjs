...
const XY = "agora", eC = "1.0.0-rc5";
import { aU as Y_, X as Kc, aV as Ww, aW as C_, a3 as b_, d as Zc, P as tr, e as Ya, o as qe, w as sr, C as Qc, z as Ca, r as Js, x as Cs, u as qd, ab as $w, a4 as S_, K as Gw, U as Vw, aX as Od, aY as Rd, aZ as Id, a_ as Xc, a$ as ba, b0 as F_, b1 as Ud, b2 as Jw, B as Rn, k as zd, t as re, O as Kw, aO as Bd, D as Zw, aQ as Qw, aP as eg, b3 as Xw, E as eM, b4 as tM, b as sM, q as nM, b5 as aM, ar as tg, aJ as rM, i as Wd, c as dt, b6 as iM, b7 as oM, N as x_, V as nr, a as Sa, f as $d, L as sg, M as ng, ae as lM, J as dM, s as mM, b8 as uM, v as N_, aa as cM } from "./NcEmptyContent-q-geAf0w-B0ZeCpG6.chunk.mjs";
const se = Y_().setApp("agora").detectUser().build();
function gM(a) {
  const i = a.reduce((u, g) => (u[g.id] = g, u), {}), r = a.filter((u) => u.parent === 0).sort((u, g) => g.timestamp - u.timestamp).map((u) => {
  ...
  function l(u) {
    ...
    for (; f.length > 0; ) {
      ...
      if (p !== void 0) {
        ...
        if (L) {
          g.push({ ...L });
          const w = a.filter((D) => D.parent === p).map((D) => D.id);
          f.push(...w);
        }
      }
    }
...
function Se(a, i = "") {
  ...
  const l = { replace: (u, g) => {
    ...
    return f = f.replace(Ot.caret, "$1"), r = r.replace(u, f), l;
  }, getRegex: () => new RegExp(r, i) };
  return l;
}
var Ot = { codeRemoveIndent: /^(?: {1,4}| {0,3}\t)/gm, outputLinkReplace: /\\([\[\]])/g, indentCodeCompensation: /^(\s+)(?:```)/, beginningSpace: /^\s+/, endingHash: /#$/, startingSpaceChar: /^ /, endingSpaceChar: / $/, nonSpaceChar: /[^ ]/, newLineCharGlobal: /\n/g, tabCharGlobal: /\t/g, multipleSpaceGlobal: /\s+/g, blankLine: /^[ \t]*$/, doubleBlankLine: /\n[ \t]*\n[ \t]*$/, blockquoteStart: /^ {0,3}>/, blockquoteSetextReplace: /\n {0,3}((?:=+|-+) *)(?=\n|$)/g, blockquoteSetextReplace2: /^ {0,3}>[ \t]?/gm, listReplaceTabs: /^\t+/, listReplaceNesting: /^ {1,4}(?=( {4})*[^ ])/g, listIsTask: /^\[[ xX]\] /, listReplaceTask: /^\[[ xX]\] +/, anyLine: /\n.*\n/, hrefBrackets: /^<(.*)>$/, tableDelimiter: /[:|]/, tableAlignChars: /^\||\| *$/g, tableRowBlankLine: /\n[ \t]*$/, tableAlignRight: /^ *-+: *$/, tableAlignCenter: /^ *:-+: *$/, tableAlignLeft: /^ *:-+ *$/, startATag: /^<a /i, endATag: /^<\/a>/i, startPreScriptTag: /^<(pre|code|kbd|script)(\s|>)/i, endPreScriptTag: /^<\/(pre|code|kbd|script)(\s|>)/i, startAngleBracket: /^</, endAngleBracket: />$/, pedanticHrefTitle: /^([^'"]*[^\s])\s+(['"])(.*)\2/, unicodeAlphaNumeric: /[\p{L}\p{N}]/u, escapeTest: /[&<>"']/, escapeReplace: /[&<>"']/g, escapeTestNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/, escapeReplaceNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g, unescapeTest: /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig, caret: /(^|[^\[])\^/g, percentDecode: /%25/g, findPipe: /\|/g, splitPipe: / \|/, slashPipe: /\\\|/g, carriageReturn: /\r\n|\r/g, spaceLine: /^ +$/gm, notSpaceStart: /^\S*/, endingNewline: /\n$/, listItemRegex: (a) => new RegExp(`^( {0,3}${a})((?:[	 ][^\\n]*)?(?:\\n|$))`), nextBulletRegex: (a) => new RegExp(`^ {0,${Math.min(3, a - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`), hrRegex: (a) => new RegExp(`^ {0,${Math.min(3, a - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`), fencesBeginRegex: (a) => new RegExp(`^ {0,${Math.min(3, a - 1)}}(?:\`\`\`|~~~)`), headingBeginRegex: (a) => new RegExp(`^ {0,${Math.min(3, a - 1)}}#`), htmlBeginRegex: (a) => new RegExp(`^ {0,${Math.min(3, a - 1)}}<(?:[a-z].*>|!--)`, "i") }, hM = /^(?:[ \t]*(?:\n|$))+/, fM = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/, _M = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/, Lo = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/, pM = /^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/, rg = /(?:[*+-]|\d{1,9}[.)])/, E_ = /^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/, H_ = Se(E_).replace(/bull/g, rg).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex(), yM = Se(E_).replace(/bull/g, rg).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(), ig = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/, vM = /^[^\n]+/, og = /(?!\s*\])(?:\\.|[^\[\]\\])+/, wM = Se(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label", og).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(), MM = Se(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, rg).getRegex(), Gd = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", lg = /<!--(?:-?>|[\s\S]*?(?:-->|$))/, LM = Se("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", lg).replace("tag", Gd).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), P_ = Se(ig).replace("hr", Lo).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Gd).getRegex(), kM = Se(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph", P_).getRegex(), dg = { blockquote: kM, code: fM, def: wM, fences: _M, heading: pM, hr: Lo, html: LM, lheading: H_, list: MM, newline: hM, paragraph: P_, table: Mo, text: vM }, j_ = Se("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", Lo).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Gd).getRegex(), TM = { ...dg, lheading: yM, table: j_, paragraph: Se(ig).replace("hr", Lo).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", j_).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Gd).getRegex() }, DM = { ...dg, html: Se(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment", lg).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(), def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/, heading: /^(#{1,6})(.*)(?:\n+|$)/, fences: Mo, lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/, paragraph: Se(ig).replace("hr", Lo).replace("heading", ` *#{1,6} *[^
]`).replace("lheading", H_).replace("|table", "").replace("blockquote", " {0,3}>").replace("|fences", "").replace("|list", "").replace("|html", "").replace("|tag", "").getRegex() }, YM = /^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/, CM = /^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/, q_ = /^( {2,}|\\)\n(?!\s*$)/, bM = /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/, Vd = /[\p{P}\p{S}]/u, mg = /[\s\p{P}\p{S}]/u, O_ = /[^\s\p{P}\p{S}]/u, SM = Se(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, mg).getRegex(), R_ = /(?!~)[\p{P}\p{S}]/u, FM = /(?!~)[\s\p{P}\p{S}]/u, xM = /(?:[^\s\p{P}\p{S}]|~)/u, NM = /\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g, I_ = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/, AM = Se(I_, "u").replace(/punct/g, Vd).getRegex(), EM = Se(I_, "u").replace(/punct/g, R_).getRegex(), U_ = "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)", HM = Se(U_, "gu").replace(/notPunctSpace/g, O_).replace(/punctSpace/g, mg).replace(/punct/g, Vd).getRegex(), PM = Se(U_, "gu").replace(/notPunctSpace/g, xM).replace(/punctSpace/g, FM).replace(/punct/g, R_).getRegex(), jM = Se("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, O_).replace(/punctSpace/g, mg).replace(/punct/g, Vd).getRegex(), qM = Se(/\\(punct)/, "gu").replace(/punct/g, Vd).getRegex(), OM = Se(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(), RM = Se(lg).replace("(?:-->|$)", "-->").getRegex(), IM = Se("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", RM).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(), Jd = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, UM = Se(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label", Jd).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(), z_ = Se(/^!?\[(label)\]\[(ref)\]/).replace("label", Jd).replace("ref", og).getRegex(), B_ = Se(/^!?\[(ref)\](?:\[\])?/).replace("ref", og).getRegex(), zM = Se("reflink|nolink(?!\\()", "g").replace("reflink", z_).replace("nolink", B_).getRegex(), ug = { _backpedal: Mo, anyPunctuation: qM, autolink: OM, blockSkip: NM, br: q_, code: CM, del: Mo, emStrongLDelim: AM, emStrongRDelimAst: HM, emStrongRDelimUnd: jM, escape: YM, link: UM, nolink: B_, punctuation: SM, reflink: z_, reflinkSearch: zM, tag: IM, text: bM, url: Mo }, BM = { ...ug, link: Se(/^!?\[(label)\]\((.*?)\)/).replace("label", Jd).getRegex(), reflink: Se(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", Jd).getRegex() }, cg = { ...ug, emStrongRDelimAst: PM, emStrongLDelim: EM, url: Se(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/, "i").replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(), _backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/, del: /^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/, text: /^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/ }, WM = { ...cg, br: Se(q_).replace("{2,}", "*").getRegex(), text: Se(cg.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex() }, Kd = { normal: dg, gfm: TM, pedantic: DM }, ko = { normal: ug, gfm: cg, breaks: WM, pedantic: BM }, $M = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }, W_ = (a) => $M[a];
function pn(a, i) {
  if (i) {
    if (Ot.escapeTest.test(a)) return a.replace(Ot.escapeReplace, W_);
  } else if (Ot.escapeTestNoEncode.test(a)) return a.replace(Ot.escapeReplaceNoEncode, W_);
  return a;
}
function $_(a) {
  try {
    a = encodeURI(a).replace(Ot.percentDecode, "%");
  } catch {
    return null;
  }
  return a;
...
function G_(a, i) {
  const r = a.replace(Ot.findPipe, (g, f, p) => {
    let L = false, w = f;
    for (; --w >= 0 && p[w] === "\\"; ) L = !L;
    return L ? "|" : " |";
  }), l = r.split(Ot.splitPipe);
  let u = 0;
  if (l[0].trim() || l.shift(), l.length > 0 && !l.at(-1)?.trim() && l.pop(), i) if (l.length > i) l.splice(i);
  else for (; l.length < i; ) l.push("");
  for (; u < l.length; u++) l[u] = l[u].trim().replace(Ot.slashPipe, "|");
  return l;
}
function To(a, i, r) {
  const l = a.length;
  if (l === 0) return "";
  let u = 0;
  for (; u < l && a.charAt(l - u - 1) === i; ) u++;
  return a.slice(0, l - u);
}
function GM(a, i) {
  if (a.indexOf(i[1]) === -1) return -1;
  let r = 0;
  for (let l = 0; l < a.length; l++) if (a[l] === "\\") l++;
  else if (a[l] === i[0]) r++;
  else if (a[l] === i[1] && (r--, r < 0)) return l;
  return r > 0 ? -2 : -1;
}
function V_(a, i, r, l, u) {
  const g = i.href, f = i.title || null, p = a[1].replace(u.other.outputLinkReplace, "$1");
  l.state.inLink = true;
  const L = { type: a[0].charAt(0) === "!" ? "image" : "link", raw: r, href: g, title: f, text: p, tokens: l.inlineTokens(p) };
  return l.state.inLink = false, L;
}
function VM(a, i, r) {
  const l = a.match(r.other.indentCodeCompensation);
  if (l === null) return i;
  const u = l[1];
  return i.split(`
`).map((g) => {
...
`) };
  ...
  fences(a) {
    ...
    if (i) {
      const r = i[0], l = VM(r, i[3] || "", this.rules);
...
` + r.join(`
`), I = this.blockquote(q);
          g[g.length - 1] = I, l = l.substring(0, l.length - N.raw.length) + I.raw, u = u.substring(0, u.length - N.text.length) + I.text;
          break;
        } else if (H?.type === "list") {
          const N = H, q = N.raw + `
` + r.join(`
`), I = this.list(q);
          g[g.length - 1] = I, l = l.substring(0, l.length - H.raw.length) + I.raw, u = u.substring(0, u.length - N.raw.length) + I.raw, r = q.substring(g.at(-1).raw.length).split(`
`);
          continue;
        }
      }
  ...
  list(a) {
    ...
    if (i) {
      ...
      for (; a; ) {
        let L = false, w = "", D = "";
        if (!(i = g.exec(a)) || this.rules.block.hr.test(a)) break;
        w = i[0], a = a.substring(w.length);
        let b = i[2].split(`
`, 1)[0].replace(this.rules.other.listReplaceTabs, (Q) => " ".repeat(3 * Q.length)), H = a.split(`
`, 1)[0], N = !b.trim(), q = 0;
...
`, a = a.substring(H.length + 1), L = true), !L) {
          const Q = this.rules.other.nextBulletRegex(q), X = this.rules.other.hrRegex(q), te = this.rules.other.fencesBeginRegex(q), Z = this.rules.other.headingBeginRegex(q), ge = this.rules.other.htmlBeginRegex(q);
          for (; a; ) {
            const B = a.split(`
`, 1)[0];
            let V;
            if (H = B, this.options.pedantic ? (H = H.replace(this.rules.other.listReplaceNesting, "  "), V = H) : V = H.replace(this.rules.other.tabCharGlobal, "    "), te.test(H) || Z.test(H) || ge.test(H) || Q.test(H) || X.test(H)) break;
            if (V.search(this.rules.other.nonSpaceChar) >= q || !H.trim()) D += `
` + V.slice(q);
            else {
              if (N || b.replace(this.rules.other.tabCharGlobal, "    ").search(this.rules.other.nonSpaceChar) >= 4 || te.test(b) || Z.test(b) || X.test(b)) break;
              D += `
` + H;
            }
            !N && !H.trim() && (N = true), w += B + `
`, a = a.substring(B.length + 1), b = V.slice(q);
          }
        }
        u.loose || (f ? u.loose = true : this.rules.other.doubleBlankLine.test(w) && (f = true));
        let I = null, x;
        this.options.gfm && (I = this.rules.other.listIsTask.exec(D), I && (x = I[0] !== "[ ] ", D = D.replace(this.rules.other.listReplaceTask, ""))), u.items.push({ type: "list_item", raw: w, task: !!I, checked: x, loose: false, text: D, tokens: [] }), u.raw += w;
      }
  ...
  table(a) {
    ...
    const r = G_(i[1]), l = i[2].replace(this.rules.other.tableAlignChars, "").split("|"), u = i[3]?.trim() ? i[3].replace(this.rules.other.tableRowBlankLine, "").split(`
`) : [], g = { type: "table", raw: i[0], header: [], align: [], rows: [] };
    if (r.length === l.length) {
      ...
      for (const f of u) g.rows.push(G_(f, g.header.length).map((p, L) => ({ text: p, tokens: this.lexer.inline(p), header: false, align: g.align[L] })));
      return g;
    }
  }
  lheading(a) {
...
` ? i[1].slice(0, -1) : i[1];
  ...
  link(a) {
    ...
    if (i) {
      ...
      return l = l.trim(), this.rules.other.startAngleBracket.test(l) && (this.options.pedantic && !this.rules.other.endAngleBracket.test(r) ? l = l.slice(1) : l = l.slice(1, -1)), V_(i, { href: l && l.replace(this.rules.inline.anyPunctuation, "$1"), title: u && u.replace(this.rules.inline.anyPunctuation, "$1") }, i[0], this.lexer, this.rules);
    }
  }
  reflink(a, i) {
    let r;
    if ((r = this.rules.inline.reflink.exec(a)) || (r = this.rules.inline.nolink.exec(a))) {
      ...
      return V_(r, u, r[0], this.lexer, this.rules);
    }
  }
  emStrong(a, i, r = "") {
    let l = this.rules.inline.emStrongLDelim.exec(a);
    ...
    if (!(l[1] || l[2] || "") || !r || this.rules.inline.punctuation.exec(r)) {
      ...
      for (D.lastIndex = 0, i = i.slice(-1 * a.length + g); (l = D.exec(i)) != null; ) {
        ...
        if (L -= p, L > 0) continue;
        p = Math.min(p, p + L + w);
        const b = [...l[0]][0].length, H = a.slice(0, g + l.index + b + p);
        if (Math.min(g, p) % 2) {
          const q = H.slice(1, -1);
  ...
  constructor(i) {
    ...
    const r = { other: Ot, block: Kd.normal, inline: ko.normal };
  ...
  static lex(i, r) {
    return new Kf(r).lex(i);
  }
  static lexInline(i, r) {
    return new Kf(r).inlineTokens(i);
  }
  lex(i) {
    i = i.replace(Ot.carriageReturn, `
`), this.blockTokens(i, this.tokens);
  ...
  blockTokens(i, r = [], l = false) {
    for (this.options.pedantic && (i = i.replace(Ot.tabCharGlobal, "    ").replace(Ot.spaceLine, "")); i; ) {
      let u;
...
` + u.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = f.text) : r.push(u);
  ...
  code({ text: a, lang: i, escaped: r }) {
    const l = (i || "").match(Ot.notSpaceStart)?.[0], u = a.replace(Ot.endingNewline, "") + `
`;
    return l ? '<pre><code class="language-' + pn(l) + '">' + (r ? u : pn(u, true)) + `</code></pre>
` : "<pre><code>" + (r ? u : pn(u, true)) + `</code></pre>
`;
  }
  blockquote({ tokens: a }) {
    return `<blockquote>
...
`;
  ...
  heading({ tokens: a, depth: i }) {
    return `<h${i}>${this.parser.parseInline(a)}</h${i}>
`;
  }
  hr(a) {
    return `<hr>
...
`;
  ...
  listitem(a) {
    let i = "";
    if (a.task) {
      const r = this.checkbox({ checked: !!a.checked });
      a.loose ? a.tokens[0]?.type === "paragraph" ? (a.tokens[0].text = r + " " + a.tokens[0].text, a.tokens[0].tokens && a.tokens[0].tokens.length > 0 && a.tokens[0].tokens[0].type === "text" && (a.tokens[0].tokens[0].text = r + " " + pn(a.tokens[0].tokens[0].text), a.tokens[0].tokens[0].escaped = true)) : a.tokens.unshift({ type: "text", raw: r + " ", text: r + " ", escaped: true }) : i += r + " ";
    }
    return i += this.parser.parse(a.tokens, !!a.loose), `<li>${i}</li>
`;
  }
  checkbox({ checked: a }) {
...
`;
  ...
  table(a) {
    let i = "", r = "";
    for (let u = 0; u < a.header.length; u++) r += this.tablecell(a.header[u]);
...
`;
  ...
  tablecell(a) {
    const i = this.parser.parseInline(a.tokens), r = a.header ? "th" : "td";
    return (a.align ? `<${r} align="${a.align}">` : `<${r}>`) + i + `</${r}>
`;
  }
  strong({ tokens: a }) {
  ...
  link({ href: a, title: i, tokens: r }) {
    const l = this.parser.parseInline(r), u = $_(a);
    if (u === null) return l;
    a = u;
    let g = '<a href="' + a + '"';
    return i && (g += ' title="' + pn(i) + '"'), g += ">" + l + "</a>", g;
  }
  image({ href: a, title: i, text: r, tokens: l }) {
    l && (r = this.parser.parseInline(l, this.parser.textRenderer));
    const u = $_(a);
    if (u === null) return pn(r);
    a = u;
    let g = `<img src="${a}" alt="${r}"`;
    return i && (g += ` title="${pn(i)}"`), g += ">", g;
  }
  text(a) {
    return "tokens" in a && a.tokens ? this.parser.parseInline(a.tokens) : "escaped" in a && a.escaped ? a.text : pn(a.text);
  }
}, gg = class {
  strong({ text: a }) {
    return a;
  ...
  static parse(i, r) {
    return new Zf(r).parse(i);
  }
  static parseInline(i, r) {
    return new Zf(r).parseInline(i);
  }
  parse(i, r = true) {
    let l = "";
...
` + this.renderer.text(p);
  ...
  provideLexer() {
    return this.block ? In.lex : In.lexInline;
  }
  provideParser() {
  ...
  walkTokens(a, i) {
    let r = [];
    for (const l of a) switch (r = r.concat(i.call(this, l)), l.type) {
      case "table": {
        const u = l;
  ...
  lexer(a, i) {
    return In.lex(a, i ?? this.defaults);
  }
  parser(a, i) {
    return Un.parse(a, i ?? this.defaults);
  }
  parseMarkdown(a) {
    return (r, l) => {
      ...
      g.hooks && (g.hooks.options = g, g.hooks.block = a);
      const p = g.hooks ? g.hooks.provideLexer() : a ? In.lex : In.lexInline, L = g.hooks ? g.hooks.provideParser() : a ? Un.parse : Un.parseInline;
...
Please report this to https://github.com/markedjs/marked.`, a) {
        const l = "<p>An error occurred:</p><pre>" + pn(r.message + "", true) + "</pre>";
...
Ye.options = Ye.setOptions = function(a) {
  return rr.setOptions(a), Ye.defaults = rr.defaults, A_(Ye.defaults), Ye;
}, Ye.getDefaults = ag, Ye.defaults = ar, Ye.use = function(...a) {
  return rr.use(...a), Ye.defaults = rr.defaults, A_(Ye.defaults), Ye;
}, Ye.walkTokens = function(a, i) {
  return rr.walkTokens(a, i);
}, Ye.parseInline = rr.parseInline, Ye.Parser = Un, Ye.parser = Un.parse, Ye.Renderer = Qd, Ye.TextRenderer = gg, Ye.Lexer = In, Ye.lexer = In.lex, Ye.Tokenizer = Zd, Ye.Hooks = Xd, Ye.parse = Ye, Ye.options, Ye.setOptions, Ye.use, Ye.walkTokens, Ye.parseInline, Un.parse, In.lex;
const KM = /[\0-\x1F!-,\.\/:-@\[-\^`\{-\xA9\xAB-\xB4\xB6-\xB9\xBB-\xBF\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u02FF\u0375\u0378\u0379\u037E\u0380-\u0385\u0387\u038B\u038D\u03A2\u03F6\u0482\u0530\u0557\u0558\u055A-\u055F\u0589-\u0590\u05BE\u05C0\u05C3\u05C6\u05C8-\u05CF\u05EB-\u05EE\u05F3-\u060F\u061B-\u061F\u066A-\u066D\u06D4\u06DD\u06DE\u06E9\u06FD\u06FE\u0700-\u070F\u074B\u074C\u07B2-\u07BF\u07F6-\u07F9\u07FB\u07FC\u07FE\u07FF\u082E-\u083F\u085C-\u085F\u086B-\u089F\u08B5\u08C8-\u08D2\u08E2\u0964\u0965\u0970\u0984\u098D\u098E\u0991\u0992\u09A9\u09B1\u09B3-\u09B5\u09BA\u09BB\u09C5\u09C6\u09C9\u09CA\u09CF-\u09D6\u09D8-\u09DB\u09DE\u09E4\u09E5\u09F2-\u09FB\u09FD\u09FF\u0A00\u0A04\u0A0B-\u0A0E\u0A11\u0A12\u0A29\u0A31\u0A34\u0A37\u0A3A\u0A3B\u0A3D\u0A43-\u0A46\u0A49\u0A4A\u0A4E-\u0A50\u0A52-\u0A58\u0A5D\u0A5F-\u0A65\u0A76-\u0A80\u0A84\u0A8E\u0A92\u0AA9\u0AB1\u0AB4\u0ABA\u0ABB\u0AC6\u0ACA\u0ACE\u0ACF\u0AD1-\u0ADF\u0AE4\u0AE5\u0AF0-\u0AF8\u0B00\u0B04\u0B0D\u0B0E\u0B11\u0B12\u0B29\u0B31\u0B34\u0B3A\u0B3B\u0B45\u0B46\u0B49\u0B4A\u0B4E-\u0B54\u0B58-\u0B5B\u0B5E\u0B64\u0B65\u0B70\u0B72-\u0B81\u0B84\u0B8B-\u0B8D\u0B91\u0B96-\u0B98\u0B9B\u0B9D\u0BA0-\u0BA2\u0BA5-\u0BA7\u0BAB-\u0BAD\u0BBA-\u0BBD\u0BC3-\u0BC5\u0BC9\u0BCE\u0BCF\u0BD1-\u0BD6\u0BD8-\u0BE5\u0BF0-\u0BFF\u0C0D\u0C11\u0C29\u0C3A-\u0C3C\u0C45\u0C49\u0C4E-\u0C54\u0C57\u0C5B-\u0C5F\u0C64\u0C65\u0C70-\u0C7F\u0C84\u0C8D\u0C91\u0CA9\u0CB4\u0CBA\u0CBB\u0CC5\u0CC9\u0CCE-\u0CD4\u0CD7-\u0CDD\u0CDF\u0CE4\u0CE5\u0CF0\u0CF3-\u0CFF\u0D0D\u0D11\u0D45\u0D49\u0D4F-\u0D53\u0D58-\u0D5E\u0D64\u0D65\u0D70-\u0D79\u0D80\u0D84\u0D97-\u0D99\u0DB2\u0DBC\u0DBE\u0DBF\u0DC7-\u0DC9\u0DCB-\u0DCE\u0DD5\u0DD7\u0DE0-\u0DE5\u0DF0\u0DF1\u0DF4-\u0E00\u0E3B-\u0E3F\u0E4F\u0E5A-\u0E80\u0E83\u0E85\u0E8B\u0EA4\u0EA6\u0EBE\u0EBF\u0EC5\u0EC7\u0ECE\u0ECF\u0EDA\u0EDB\u0EE0-\u0EFF\u0F01-\u0F17\u0F1A-\u0F1F\u0F2A-\u0F34\u0F36\u0F38\u0F3A-\u0F3D\u0F48\u0F6D-\u0F70\u0F85\u0F98\u0FBD-\u0FC5\u0FC7-\u0FFF\u104A-\u104F\u109E\u109F\u10C6\u10C8-\u10CC\u10CE\u10CF\u10FB\u1249\u124E\u124F\u1257\u1259\u125E\u125F\u1289\u128E\u128F\u12B1\u12B6\u12B7\u12BF\u12C1\u12C6\u12C7\u12D7\u1311\u1316\u1317\u135B\u135C\u1360-\u137F\u1390-\u139F\u13F6\u13F7\u13FE-\u1400\u166D\u166E\u1680\u169B-\u169F\u16EB-\u16ED\u16F9-\u16FF\u170D\u1715-\u171F\u1735-\u173F\u1754-\u175F\u176D\u1771\u1774-\u177F\u17D4-\u17D6\u17D8-\u17DB\u17DE\u17DF\u17EA-\u180A\u180E\u180F\u181A-\u181F\u1879-\u187F\u18AB-\u18AF\u18F6-\u18FF\u191F\u192C-\u192F\u193C-\u1945\u196E\u196F\u1975-\u197F\u19AC-\u19AF\u19CA-\u19CF\u19DA-\u19FF\u1A1C-\u1A1F\u1A5F\u1A7D\u1A7E\u1A8A-\u1A8F\u1A9A-\u1AA6\u1AA8-\u1AAF\u1AC1-\u1AFF\u1B4C-\u1B4F\u1B5A-\u1B6A\u1B74-\u1B7F\u1BF4-\u1BFF\u1C38-\u1C3F\u1C4A-\u1C4C\u1C7E\u1C7F\u1C89-\u1C8F\u1CBB\u1CBC\u1CC0-\u1CCF\u1CD3\u1CFB-\u1CFF\u1DFA\u1F16\u1F17\u1F1E\u1F1F\u1F46\u1F47\u1F4E\u1F4F\u1F58\u1F5A\u1F5C\u1F5E\u1F7E\u1F7F\u1FB5\u1FBD\u1FBF-\u1FC1\u1FC5\u1FCD-\u1FCF\u1FD4\u1FD5\u1FDC-\u1FDF\u1FED-\u1FF1\u1FF5\u1FFD-\u203E\u2041-\u2053\u2055-\u2070\u2072-\u207E\u2080-\u208F\u209D-\u20CF\u20F1-\u2101\u2103-\u2106\u2108\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A\u213B\u2140-\u2144\u214A-\u214D\u214F-\u215F\u2189-\u24B5\u24EA-\u2BFF\u2C2F\u2C5F\u2CE5-\u2CEA\u2CF4-\u2CFF\u2D26\u2D28-\u2D2C\u2D2E\u2D2F\u2D68-\u2D6E\u2D70-\u2D7E\u2D97-\u2D9F\u2DA7\u2DAF\u2DB7\u2DBF\u2DC7\u2DCF\u2DD7\u2DDF\u2E00-\u2E2E\u2E30-\u3004\u3008-\u3020\u3030\u3036\u3037\u303D-\u3040\u3097\u3098\u309B\u309C\u30A0\u30FB\u3100-\u3104\u3130\u318F-\u319F\u31C0-\u31EF\u3200-\u33FF\u4DC0-\u4DFF\u9FFD-\u9FFF\uA48D-\uA4CF\uA4FE\uA4FF\uA60D-\uA60F\uA62C-\uA63F\uA673\uA67E\uA6F2-\uA716\uA720\uA721\uA789\uA78A\uA7C0\uA7C1\uA7CB-\uA7F4\uA828-\uA82B\uA82D-\uA83F\uA874-\uA87F\uA8C6-\uA8CF\uA8DA-\uA8DF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA954-\uA95F\uA97D-\uA97F\uA9C1-\uA9CE\uA9DA-\uA9DF\uA9FF\uAA37-\uAA3F\uAA4E\uAA4F\uAA5A-\uAA5F\uAA77-\uAA79\uAAC3-\uAADA\uAADE\uAADF\uAAF0\uAAF1\uAAF7-\uAB00\uAB07\uAB08\uAB0F\uAB10\uAB17-\uAB1F\uAB27\uAB2F\uAB5B\uAB6A-\uAB6F\uABEB\uABEE\uABEF\uABFA-\uABFF\uD7A4-\uD7AF\uD7C7-\uD7CA\uD7FC-\uD7FF\uE000-\uF8FF\uFA6E\uFA6F\uFADA-\uFAFF\uFB07-\uFB12\uFB18-\uFB1C\uFB29\uFB37\uFB3D\uFB3F\uFB42\uFB45\uFBB2-\uFBD2\uFD3E-\uFD4F\uFD90\uFD91\uFDC8-\uFDEF\uFDFC-\uFDFF\uFE10-\uFE1F\uFE30-\uFE32\uFE35-\uFE4C\uFE50-\uFE6F\uFE75\uFEFD-\uFF0F\uFF1A-\uFF20\uFF3B-\uFF3E\uFF40\uFF5B-\uFF65\uFFBF-\uFFC1\uFFC8\uFFC9\uFFD0\uFFD1\uFFD8\uFFD9\uFFDD-\uFFFF]|\uD800[\uDC0C\uDC27\uDC3B\uDC3E\uDC4E\uDC4F\uDC5E-\uDC7F\uDCFB-\uDD3F\uDD75-\uDDFC\uDDFE-\uDE7F\uDE9D-\uDE9F\uDED1-\uDEDF\uDEE1-\uDEFF\uDF20-\uDF2C\uDF4B-\uDF4F\uDF7B-\uDF7F\uDF9E\uDF9F\uDFC4-\uDFC7\uDFD0\uDFD6-\uDFFF]|\uD801[\uDC9E\uDC9F\uDCAA-\uDCAF\uDCD4-\uDCD7\uDCFC-\uDCFF\uDD28-\uDD2F\uDD64-\uDDFF\uDF37-\uDF3F\uDF56-\uDF5F\uDF68-\uDFFF]|\uD802[\uDC06\uDC07\uDC09\uDC36\uDC39-\uDC3B\uDC3D\uDC3E\uDC56-\uDC5F\uDC77-\uDC7F\uDC9F-\uDCDF\uDCF3\uDCF6-\uDCFF\uDD16-\uDD1F\uDD3A-\uDD7F\uDDB8-\uDDBD\uDDC0-\uDDFF\uDE04\uDE07-\uDE0B\uDE14\uDE18\uDE36\uDE37\uDE3B-\uDE3E\uDE40-\uDE5F\uDE7D-\uDE7F\uDE9D-\uDEBF\uDEC8\uDEE7-\uDEFF\uDF36-\uDF3F\uDF56-\uDF5F\uDF73-\uDF7F\uDF92-\uDFFF]|\uD803[\uDC49-\uDC7F\uDCB3-\uDCBF\uDCF3-\uDCFF\uDD28-\uDD2F\uDD3A-\uDE7F\uDEAA\uDEAD-\uDEAF\uDEB2-\uDEFF\uDF1D-\uDF26\uDF28-\uDF2F\uDF51-\uDFAF\uDFC5-\uDFDF\uDFF7-\uDFFF]|\uD804[\uDC47-\uDC65\uDC70-\uDC7E\uDCBB-\uDCCF\uDCE9-\uDCEF\uDCFA-\uDCFF\uDD35\uDD40-\uDD43\uDD48-\uDD4F\uDD74\uDD75\uDD77-\uDD7F\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDFF\uDE12\uDE38-\uDE3D\uDE3F-\uDE7F\uDE87\uDE89\uDE8E\uDE9E\uDEA9-\uDEAF\uDEEB-\uDEEF\uDEFA-\uDEFF\uDF04\uDF0D\uDF0E\uDF11\uDF12\uDF29\uDF31\uDF34\uDF3A\uDF45\uDF46\uDF49\uDF4A\uDF4E\uDF4F\uDF51-\uDF56\uDF58-\uDF5C\uDF64\uDF65\uDF6D-\uDF6F\uDF75-\uDFFF]|\uD805[\uDC4B-\uDC4F\uDC5A-\uDC5D\uDC62-\uDC7F\uDCC6\uDCC8-\uDCCF\uDCDA-\uDD7F\uDDB6\uDDB7\uDDC1-\uDDD7\uDDDE-\uDDFF\uDE41-\uDE43\uDE45-\uDE4F\uDE5A-\uDE7F\uDEB9-\uDEBF\uDECA-\uDEFF\uDF1B\uDF1C\uDF2C-\uDF2F\uDF3A-\uDFFF]|\uD806[\uDC3B-\uDC9F\uDCEA-\uDCFE\uDD07\uDD08\uDD0A\uDD0B\uDD14\uDD17\uDD36\uDD39\uDD3A\uDD44-\uDD4F\uDD5A-\uDD9F\uDDA8\uDDA9\uDDD8\uDDD9\uDDE2\uDDE5-\uDDFF\uDE3F-\uDE46\uDE48-\uDE4F\uDE9A-\uDE9C\uDE9E-\uDEBF\uDEF9-\uDFFF]|\uD807[\uDC09\uDC37\uDC41-\uDC4F\uDC5A-\uDC71\uDC90\uDC91\uDCA8\uDCB7-\uDCFF\uDD07\uDD0A\uDD37-\uDD39\uDD3B\uDD3E\uDD48-\uDD4F\uDD5A-\uDD5F\uDD66\uDD69\uDD8F\uDD92\uDD99-\uDD9F\uDDAA-\uDEDF\uDEF7-\uDFAF\uDFB1-\uDFFF]|\uD808[\uDF9A-\uDFFF]|\uD809[\uDC6F-\uDC7F\uDD44-\uDFFF]|[\uD80A\uD80B\uD80E-\uD810\uD812-\uD819\uD824-\uD82B\uD82D\uD82E\uD830-\uD833\uD837\uD839\uD83D\uD83F\uD87B-\uD87D\uD87F\uD885-\uDB3F\uDB41-\uDBFF][\uDC00-\uDFFF]|\uD80D[\uDC2F-\uDFFF]|\uD811[\uDE47-\uDFFF]|\uD81A[\uDE39-\uDE3F\uDE5F\uDE6A-\uDECF\uDEEE\uDEEF\uDEF5-\uDEFF\uDF37-\uDF3F\uDF44-\uDF4F\uDF5A-\uDF62\uDF78-\uDF7C\uDF90-\uDFFF]|\uD81B[\uDC00-\uDE3F\uDE80-\uDEFF\uDF4B-\uDF4E\uDF88-\uDF8E\uDFA0-\uDFDF\uDFE2\uDFE5-\uDFEF\uDFF2-\uDFFF]|\uD821[\uDFF8-\uDFFF]|\uD823[\uDCD6-\uDCFF\uDD09-\uDFFF]|\uD82C[\uDD1F-\uDD4F\uDD53-\uDD63\uDD68-\uDD6F\uDEFC-\uDFFF]|\uD82F[\uDC6B-\uDC6F\uDC7D-\uDC7F\uDC89-\uDC8F\uDC9A-\uDC9C\uDC9F-\uDFFF]|\uD834[\uDC00-\uDD64\uDD6A-\uDD6C\uDD73-\uDD7A\uDD83\uDD84\uDD8C-\uDDA9\uDDAE-\uDE41\uDE45-\uDFFF]|\uD835[\uDC55\uDC9D\uDCA0\uDCA1\uDCA3\uDCA4\uDCA7\uDCA8\uDCAD\uDCBA\uDCBC\uDCC4\uDD06\uDD0B\uDD0C\uDD15\uDD1D\uDD3A\uDD3F\uDD45\uDD47-\uDD49\uDD51\uDEA6\uDEA7\uDEC1\uDEDB\uDEFB\uDF15\uDF35\uDF4F\uDF6F\uDF89\uDFA9\uDFC3\uDFCC\uDFCD]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85-\uDE9A\uDEA0\uDEB0-\uDFFF]|\uD838[\uDC07\uDC19\uDC1A\uDC22\uDC25\uDC2B-\uDCFF\uDD2D-\uDD2F\uDD3E\uDD3F\uDD4A-\uDD4D\uDD4F-\uDEBF\uDEFA-\uDFFF]|\uD83A[\uDCC5-\uDCCF\uDCD7-\uDCFF\uDD4C-\uDD4F\uDD5A-\uDFFF]|\uD83B[\uDC00-\uDDFF\uDE04\uDE20\uDE23\uDE25\uDE26\uDE28\uDE33\uDE38\uDE3A\uDE3C-\uDE41\uDE43-\uDE46\uDE48\uDE4A\uDE4C\uDE50\uDE53\uDE55\uDE56\uDE58\uDE5A\uDE5C\uDE5E\uDE60\uDE63\uDE65\uDE66\uDE6B\uDE73\uDE78\uDE7D\uDE7F\uDE8A\uDE9C-\uDEA0\uDEA4\uDEAA\uDEBC-\uDFFF]|\uD83C[\uDC00-\uDD2F\uDD4A-\uDD4F\uDD6A-\uDD6F\uDD8A-\uDFFF]|\uD83E[\uDC00-\uDFEF\uDFFA-\uDFFF]|\uD869[\uDEDE-\uDEFF]|\uD86D[\uDF35-\uDF3F]|\uD86E[\uDC1E\uDC1F]|\uD873[\uDEA2-\uDEAF]|\uD87A[\uDFE1-\uDFFF]|\uD87E[\uDE1E-\uDFFF]|\uD884[\uDF4B-\uDFFF]|\uDB40[\uDC00-\uDCFF\uDDF0-\uDFFF]/g, ZM = Object.hasOwnProperty;
class J_ {
  constructor() {
  ...
  slug(i, r) {
    ...
    let u = QM(i, r === true);
    const g = u;
    for (; ZM.call(l.occurrences, u); ) l.occurrences[g]++, u = g + "-" + l.occurrences[g];
...
function QM(a, i) {
  return typeof a != "string" ? "" : (i || (a = a.toLowerCase()), a.replace(KM, "").replace(/ /g, "-"));
}
let K_ = new J_(), Z_ = [];
const XM = /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;
function eL(a) {
  return a.replace(XM, (i, r) => (r = r.toLowerCase(), r === "colon" ? ":" : r.charAt(0) === "#" ? r.charAt(1) === "x" ? String.fromCharCode(parseInt(r.substring(2), 16)) : String.fromCharCode(+r.substring(1)) : ""));
}
function Q_({ prefix: a = "", globalSlugs: i = false } = {}) {
  return { headerIds: false, hooks: { preprocess(r) {
    return i || tL(), r;
  } }, useNewRenderer: true, renderer: { heading({ tokens: r, depth: l }) {
    const u = this.parser.parseInline(r), g = eL(u).trim().replace(/<[!\/a-z].*?>/gi, ""), f = l, p = `${a}${K_.slug(g.toLowerCase())}`, L = { level: f, text: u, id: p, raw: g };
    return Z_.push(L), `<h${f} id="${p}">${u}</h${f}>
`;
  } } };
}
function tL() {
...
var em = { exports: {} }, sL = em.exports, ep;
function nL() {
  return ep || (ep = 1, (function(a, i) {
    (function(r, l) {
      a.exports = l();
    })(sL, (function() {
      var r;
      ...
      function L(e) {
        ...
        var s;
        for (s in e) if (p(e, s)) return false;
        return true;
      }
      function w(e) {
        return e === void 0;
      ...
      function H(e, s) {
        var d = [], m, h = e.length;
        for (m = 0; m < h; ++m) d.push(s(e[m], m));
        return d;
      }
      function N(e, s) {
        for (var d in s) p(s, d) && (e[d] = s[d]);
        return p(s, "toString") && (e.toString = s.toString), p(s, "valueOf") && (e.valueOf = s.valueOf), e;
      }
      function q(e, s, d, m) {
        return ia(e, s, d, m, true).utc();
      }
      function I() {
      ...
      Array.prototype.some ? Q = Array.prototype.some : Q = function(e) {
        var s = Object(this), d = s.length >>> 0, m;
        for (m = 0; m < d; m++) if (m in s && e.call(this, s[m], m, s)) return true;
        return false;
      };
      function X(e) {
        var s = null, d = false, m = e._d && !isNaN(e._d.getTime());
        if (m && (s = x(e), d = Q.call(s.parsedDateParts, function(h) {
          return h != null;
        }), m = s.overflow < 0 && !s.empty && !s.invalidEra && !s.invalidMonth && !s.invalidWeekday && !s.weekdayMismatch && !s.nullInput && !s.invalidFormat && !s.userInvalidated && (!s.meridiem || s.meridiem && d), e._strict && (m = m && s.charsLeftOver === 0 && s.unusedTokens.length === 0 && s.bigHour === void 0)), Object.isFrozen == null || !Object.isFrozen(e)) e._isValid = m;
        else return m;
        return e._isValid;
      }
      function te(e) {
        var s = q(NaN);
        return e != null ? N(x(s), e) : x(s).userInvalidated = true, s;
      }
      var Z = l.momentProperties = [], ge = false;
      function B(e, s) {
        var d, m, h, k = Z.length;
        if (w(s._isAMomentObject) || (e._isAMomentObject = s._isAMomentObject), w(s._i) || (e._i = s._i), w(s._f) || (e._f = s._f), w(s._l) || (e._l = s._l), w(s._strict) || (e._strict = s._strict), w(s._tzm) || (e._tzm = s._tzm), w(s._isUTC) || (e._isUTC = s._isUTC), w(s._offset) || (e._offset = s._offset), w(s._pf) || (e._pf = x(s)), w(s._locale) || (e._locale = s._locale), k > 0) for (d = 0; d < k; d++) m = Z[d], h = s[m], w(h) || (e[m] = h);
        return e;
      }
      function V(e) {
...
` + new Error().stack), d = false;
      ...
      var pe = {};
      function It(e, s) {
        l.deprecationHandler != null && l.deprecationHandler(e, s), pe[e] || (je(s), pe[e] = true);
      }
      ...
      function zn(e) {
        var s, d;
        for (d in e) p(e, d) && (s = e[d], Re(s) ? this[d] = s : this["_" + d] = s);
        this._config = e, this._dayOfMonthOrdinalParseLenient = new RegExp((this._dayOfMonthOrdinalParse.source || this._ordinalParse.source) + "|" + /\d{1,2}/.source);
      }
      function Ks(e, s) {
        var d = N({}, e), m;
        for (m in s) p(s, m) && (f(e[m]) && f(s[m]) ? (d[m] = {}, N(d[m], e[m]), N(d[m], s[m])) : s[m] != null ? d[m] = s[m] : delete d[m]);
        for (m in e) p(e, m) && !p(s, m) && f(e[m]) && (d[m] = N({}, d[m]));
        return d;
      }
      function Fa(e) {
        e != null && this.set(e);
      ...
      function vm(e, s, d) {
        ...
        return Re(m) ? m.call(s, d) : m;
      }
      function Ct(e, s, d) {
        var m = "" + Math.abs(e), h = s - m.length, k = e >= 0;
      ...
      function J(e, s, d, m) {
        ...
        typeof m == "string" && (h = function() {
          return this[m]();
        }), e && (Bn[e] = h), s && (Bn[s[0]] = function() {
          return Ct(h.apply(this, arguments), s[1], s[2]);
        }), d && (Bn[d] = function() {
      ...
      function wm(e) {
        var s = e.match(Ut), d, m;
        for (d = 0, m = s.length; d < m; d++) Bn[s[d]] ? s[d] = Bn[s[d]] : s[d] = lr(s[d]);
        return function(h) {
          var k = "", S;
          for (S = 0; S < m; S++) k += Re(s[S]) ? s[S].call(h, e) : s[S];
          return k;
        };
      }
      function Qs(e, s) {
        return e.isValid() ? (s = Wn(s, e.localeData()), mi[s] = mi[s] || wm(s), mi[s](e)) : e.localeData().invalidDate();
      }
      function Wn(e, s) {
        var d = 5;
        function m(h) {
          return s.longDateFormat(h) || h;
        }
      ...
      function dr(e) {
        var s = this._longDateFormat[e], d = this._longDateFormat[e.toUpperCase()];
        return s || !d ? s : (this._longDateFormat[e] = d.match(Ut).map(function(m) {
      ...
      function jo(e, s, d, m) {
        ...
        return Re(h) ? h(e, s, d, m) : h.replace(/%d/i, e);
      }
      function km(e, s) {
        var d = this._relativeTime[e > 0 ? "future" : "past"];
        return Re(d) ? d(s) : d.replace(/%s/i, s);
      }
      ...
      function wn(e) {
        var s = {}, d, m;
        for (m in e) p(e, m) && (d = Ie(m), d && (s[d] = e[m]));
        return s;
      }
      ...
      function Tm(e) {
        var s = [], d;
        for (d in e) p(e, d) && s.push({ unit: d, priority: ur[d] });
        return s.sort(function(m, h) {
          return m.priority - h.priority;
        }), s;
      }
      var Gn = /\d/, bt = /\d\d/, Vn = /\d{3}/, Xs = /\d{4}/, Jn = /[+-]?\d{6}/, Fe = /\d\d?/, cr = /\d\d\d\d?/, gr = /\d\d\d\d\d\d?/, Kn = /\d{1,3}/, Na = /\d{1,4}/, Zn = /[+-]?\d{1,6}/, en = /\d+/, Qn = /[+-]?\d+/, Dm = /Z|[+-]\d\d:?\d\d/gi, hr = /Z|[+-]\d\d(?::?\d\d)?/gi, Ym = /[+-]?\d+(\.\d{1,3})?/, Xn = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i, Mn = /^[1-9]\d?/, ui = /^([1-9]\d|\d)/, fr;
      fr = {};
      function $(e, s, d) {
        fr[e] = Re(s) ? s : function(m, h) {
          return m && d ? d : s;
        };
      }
      function Cm(e, s) {
        return p(fr, e) ? fr[e](s._strict, s._locale) : new RegExp(qo(e));
      }
      function qo(e) {
        return Ns(e.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function(s, d, m, h, k) {
          return d || m || h || k;
        }));
      }
      function Ns(e) {
      ...
      function _e(e) {
        var s = +e, d = 0;
        return s !== 0 && isFinite(s) && (d = zt(s)), d;
      }
      var Aa = {};
      function Ce(e, s) {
        var d, m = s, h;
        for (typeof e == "string" && (e = [e]), D(s) && (m = function(k, S) {
          S[s] = _e(k);
        }), h = e.length, d = 0; d < h; d++) Aa[e[d]] = m;
      }
      function Ln(e, s) {
        Ce(e, function(d, m, h, k) {
          h._w = h._w || {}, s(d, h._w, h, k);
        });
      }
      function bm(e, s, d) {
        s != null && p(Aa, e) && Aa[e](s, d._a, d, e);
      }
      function _r(e) {
      ...
      J("Y", 0, 0, function() {
        var e = this.year();
        return e <= 9999 ? Ct(e, 4) : "+" + e;
      }), J(0, ["YY", 2], 0, function() {
        return this.year() % 100;
      }), J(0, ["YYYY", 4], 0, "year"), J(0, ["YYYYY", 5], 0, "year"), J(0, ["YYYYYY", 6, true], 0, "year"), $("Y", Qn), $("YY", Fe, bt), $("YYYY", Na, Xs), $("YYYYY", Zn, Jn), $("YYYYYY", Zn, Jn), Ce(["YYYYY", "YYYYYY"], it), Ce("YYYY", function(e, s) {
        s[it] = e.length === 2 ? l.parseTwoDigitYear(e) : _e(e);
      }), Ce("YY", function(e, s) {
        s[it] = l.parseTwoDigitYear(e);
      }), Ce("Y", function(e, s) {
        s[it] = parseInt(e, 10);
      });
      function Ea(e) {
      ...
      var Oo = ea("FullYear", true);
      function xm() {
        return _r(this.year());
      }
      function ea(e, s) {
        return function(d) {
          return d != null ? (Ro(this, e, d), l.updateOffset(this, s), this) : sn(this, e);
        };
      }
      function sn(e, s) {
      ...
      function pr(e) {
        return e = Ie(e), Re(this[e]) ? this[e]() : this;
      }
      function Nm(e, s) {
        if (typeof e == "object") {
          e = wn(e);
        ...
        } else if (e = Ie(e), Re(this[e])) return this[e](s);
        return this;
      }
      function Am(e, s) {
        return (e % s + s) % s;
      ...
      Array.prototype.indexOf ? ze = Array.prototype.indexOf : ze = function(e) {
        var s;
        for (s = 0; s < this.length; ++s) if (this[s] === e) return s;
        return -1;
      };
      function yr(e, s) {
        if (isNaN(e) || isNaN(s)) return NaN;
        var d = Am(s, 12);
        return e += (s - d) / 12, d === 1 ? _r(e) ? 29 : 28 : 31 - d % 7 % 2;
      }
      ...
      }), $("M", Fe, Mn), $("MM", Fe, bt), $("MMM", function(e, s) {
        return s.monthsShortRegex(e);
      }), $("MMMM", function(e, s) {
        return s.monthsRegex(e);
      }), Ce(["M", "MM"], function(e, s) {
        s[As] = _e(e) - 1;
      }), Ce(["MMM", "MMMM"], function(e, s, d, m) {
        var h = d._locale.monthsParse(e, m, d._strict);
        h != null ? s[As] = h : x(d).invalidMonth = e;
      });
      var Io = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ci = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), Uo = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/, Em = Xn, Hm = Xn;
      function Pm(e, s) {
        return e ? g(this._months) ? this._months[e.month()] : this._months[(this._months.isFormat || Uo).test(s) ? "format" : "standalone"][e.month()] : g(this._months) ? this._months : this._months.standalone;
      }
      function zo(e, s) {
        return e ? g(this._monthsShort) ? this._monthsShort[e.month()] : this._monthsShort[Uo.test(s) ? "format" : "standalone"][e.month()] : g(this._monthsShort) ? this._monthsShort : this._monthsShort.standalone;
      }
      function Bo(e, s, d) {
        ...
        return d ? s === "MMM" ? (h = ze.call(this._shortMonthsParse, S), h !== -1 ? h : null) : (h = ze.call(this._longMonthsParse, S), h !== -1 ? h : null) : s === "MMM" ? (h = ze.call(this._shortMonthsParse, S), h !== -1 ? h : (h = ze.call(this._longMonthsParse, S), h !== -1 ? h : null)) : (h = ze.call(this._longMonthsParse, S), h !== -1 ? h : (h = ze.call(this._shortMonthsParse, S), h !== -1 ? h : null));
      }
      function Wo(e, s, d) {
        var m, h, k;
        if (this._monthsParseExact) return Bo.call(this, e, s, d);
        for (this._monthsParse || (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = []), m = 0; m < 12; m++) {
          if (h = q([2e3, m]), d && !this._longMonthsParse[m] && (this._longMonthsParse[m] = new RegExp("^" + this.months(h, "").replace(".", "") + "$", "i"), this._shortMonthsParse[m] = new RegExp("^" + this.monthsShort(h, "").replace(".", "") + "$", "i")), !d && !this._monthsParse[m] && (k = "^" + this.months(h, "") + "|^" + this.monthsShort(h, ""), this._monthsParse[m] = new RegExp(k.replace(".", ""), "i")), d && s === "MMMM" && this._longMonthsParse[m].test(e)) return m;
          if (d && s === "MMM" && this._shortMonthsParse[m].test(e)) return m;
      ...
      function vr(e, s) {
        ...
        if (typeof s == "string") {
          if (/^\d+$/.test(s)) s = _e(s);
          else if (s = e.localeData().monthsParse(s), !D(s)) return e;
        }
        var d = s, m = e.date();
      ...
      function Jo() {
        ...
        var s = [], d = [], m = [], h, k, S, W;
        for (h = 0; h < 12; h++) k = q([2e3, h]), S = Ns(this.monthsShort(k, "")), W = Ns(this.months(k, "")), s.push(S), d.push(W), m.push(W), m.push(S);
        s.sort(e), d.sort(e), m.sort(e), this._monthsRegex = new RegExp("^(" + m.join("|") + ")", "i"), this._monthsShortRegex = this._monthsRegex, this._monthsStrictRegex = new RegExp("^(" + d.join("|") + ")", "i"), this._monthsShortStrictRegex = new RegExp("^(" + s.join("|") + ")", "i");
      }
      function Ko(e, s, d, m, h, k, S) {
        var W;
        return e < 100 && e >= 0 ? (W = new Date(e + 400, s, d, m, h, k, S), isFinite(W.getFullYear()) && W.setFullYear(e)) : W = new Date(e, s, d, m, h, k, S), W;
      }
      function ta(e) {
        var s, d;
        return e < 100 && e >= 0 ? (d = Array.prototype.slice.call(arguments), d[0] = e + 400, s = new Date(Date.UTC.apply(null, d)), isFinite(s.getUTCFullYear()) && s.setUTCFullYear(e)) : s = new Date(Date.UTC.apply(null, arguments)), s;
      }
      function sa(e, s, d) {
        var m = 7 + s - d, h = (7 + ta(e, 0, m).getUTCDay() - s) % 7;
        return -h + m - 1;
      }
      function Zo(e, s, d, m, h) {
        var k = (7 + d - m) % 7, S = sa(e, m, h), W = 1 + 7 * (s - 1) + k + S, ie, ye;
        return W <= 0 ? (ie = e - 1, ye = Ea(ie) + W) : W > Ea(e) ? (ie = e + 1, ye = W - Ea(e)) : (ie = e, ye = W), { year: ie, dayOfYear: ye };
      }
      function na(e, s, d) {
        var m = sa(e.year(), s, d), h = Math.floor((e.dayOfYear() - m - 1) / 7) + 1, k, S;
        return h < 1 ? (S = e.year() - 1, k = h + ss(S, s, d)) : h > ss(e.year(), s, d) ? (k = h - ss(e.year(), s, d), S = e.year() + 1) : (S = e.year(), k = h), { week: k, year: S };
      }
      function ss(e, s, d) {
        var m = sa(e, s, d), h = sa(e + 1, s, d);
        return (Ea(e) - m + h) / 7;
      }
      J("w", ["ww", 2], "wo", "week"), J("W", ["WW", 2], "Wo", "isoWeek"), $("w", Fe, Mn), $("ww", Fe, bt), $("W", Fe, Mn), $("WW", Fe, bt), Ln(["w", "ww", "W", "WW"], function(e, s, d, m) {
        s[m.substr(0, 1)] = _e(e);
      });
      function gi(e) {
      ...
      function jm(e) {
        ...
        return e == null ? s : this.add((e - s) * 7, "d");
      }
      function el(e) {
        var s = na(this, 1, 4).week;
        return e == null ? s : this.add((e - s) * 7, "d");
      }
      ...
      }), J("e", 0, 0, "weekday"), J("E", 0, 0, "isoWeekday"), $("d", Fe), $("e", Fe), $("E", Fe), $("dd", function(e, s) {
        return s.weekdaysMinRegex(e);
      }), $("ddd", function(e, s) {
        return s.weekdaysShortRegex(e);
      }), $("dddd", function(e, s) {
        return s.weekdaysRegex(e);
      }), Ln(["dd", "ddd", "dddd"], function(e, s, d, m) {
        var h = d._locale.weekdaysParse(e, m, d._strict);
        h != null ? s.d = h : x(d).invalidWeekday = e;
      }), Ln(["d", "e", "E"], function(e, s, d, m) {
        s[m] = _e(e);
      });
      function tl(e, s) {
        return typeof e != "string" ? e : isNaN(e) ? (e = s.weekdaysParse(e), typeof e == "number" ? e : null) : parseInt(e, 10);
      }
      function sl(e, s) {
        return typeof e == "string" ? s.weekdaysParse(e) % 7 || 7 : isNaN(e) ? null : e;
      }
      function Mr(e, s) {
        return e.slice(s, 7).concat(e.slice(0, s));
      }
      var qm = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), nl = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), Om = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), al = Xn, Rm = Xn, Im = Xn;
      function Um(e, s) {
        var d = g(this._weekdays) ? this._weekdays : this._weekdays[e && e !== true && this._weekdays.isFormat.test(s) ? "format" : "standalone"];
      ...
      function Bm(e, s, d) {
        ...
        return d ? s === "dddd" ? (h = ze.call(this._weekdaysParse, S), h !== -1 ? h : null) : s === "ddd" ? (h = ze.call(this._shortWeekdaysParse, S), h !== -1 ? h : null) : (h = ze.call(this._minWeekdaysParse, S), h !== -1 ? h : null) : s === "dddd" ? (h = ze.call(this._weekdaysParse, S), h !== -1 || (h = ze.call(this._shortWeekdaysParse, S), h !== -1) ? h : (h = ze.call(this._minWeekdaysParse, S), h !== -1 ? h : null)) : s === "ddd" ? (h = ze.call(this._shortWeekdaysParse, S), h !== -1 || (h = ze.call(this._weekdaysParse, S), h !== -1) ? h : (h = ze.call(this._minWeekdaysParse, S), h !== -1 ? h : null)) : (h = ze.call(this._minWeekdaysParse, S), h !== -1 || (h = ze.call(this._weekdaysParse, S), h !== -1) ? h : (h = ze.call(this._shortWeekdaysParse, S), h !== -1 ? h : null));
      }
      function Wm(e, s, d) {
        var m, h, k;
        if (this._weekdaysParseExact) return Bm.call(this, e, s, d);
        for (this._weekdaysParse || (this._weekdaysParse = [], this._minWeekdaysParse = [], this._shortWeekdaysParse = [], this._fullWeekdaysParse = []), m = 0; m < 7; m++) {
          if (h = q([2e3, 1]).day(m), d && !this._fullWeekdaysParse[m] && (this._fullWeekdaysParse[m] = new RegExp("^" + this.weekdays(h, "").replace(".", "\\.?") + "$", "i"), this._shortWeekdaysParse[m] = new RegExp("^" + this.weekdaysShort(h, "").replace(".", "\\.?") + "$", "i"), this._minWeekdaysParse[m] = new RegExp("^" + this.weekdaysMin(h, "").replace(".", "\\.?") + "$", "i")), this._weekdaysParse[m] || (k = "^" + this.weekdays(h, "") + "|^" + this.weekdaysShort(h, "") + "|^" + this.weekdaysMin(h, ""), this._weekdaysParse[m] = new RegExp(k.replace(".", ""), "i")), d && s === "dddd" && this._fullWeekdaysParse[m].test(e)) return m;
          if (d && s === "ddd" && this._shortWeekdaysParse[m].test(e)) return m;
          if (d && s === "dd" && this._minWeekdaysParse[m].test(e)) return m;
      ...
      function $m(e) {
        ...
        var s = sn(this, "Day");
        return e != null ? (e = tl(e, this.localeData()), this.add(e - s, "d")) : s;
      }
      function Gm(e) {
        if (!this.isValid()) return e != null ? this : NaN;
        var s = (this.day() + 7 - this.localeData()._week.dow) % 7;
        return e == null ? s : this.add(e - s, "d");
      }
      function Vm(e) {
        if (!this.isValid()) return e != null ? this : NaN;
        if (e != null) {
          var s = sl(e, this.localeData());
      ...
      function Jm(e) {
        return this._weekdaysParseExact ? (p(this, "_weekdaysRegex") || fi.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (p(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Im), this._weekdaysMinStrictRegex && e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex);
      }
      function fi() {
        function e(nt, Ds) {
          return Ds.length - nt.length;
        }
        var s = [], d = [], m = [], h = [], k, S, W, ie, ye;
        for (k = 0; k < 7; k++) S = q([2e3, 1]).day(k), W = Ns(this.weekdaysMin(S, "")), ie = Ns(this.weekdaysShort(S, "")), ye = Ns(this.weekdays(S, "")), s.push(W), d.push(ie), m.push(ye), h.push(W), h.push(ie), h.push(ye);
        s.sort(e), d.sort(e), m.sort(e), h.sort(e), this._weekdaysRegex = new RegExp("^(" + h.join("|") + ")", "i"), this._weekdaysShortRegex = this._weekdaysRegex, this._weekdaysMinRegex = this._weekdaysRegex, this._weekdaysStrictRegex = new RegExp("^(" + m.join("|") + ")", "i"), this._weekdaysShortStrictRegex = new RegExp("^(" + d.join("|") + ")", "i"), this._weekdaysMinStrictRegex = new RegExp("^(" + s.join("|") + ")", "i");
      }
      function _i() {
      ...
      J("H", ["HH", 2], 0, "hour"), J("h", ["hh", 2], 0, _i), J("k", ["kk", 2], 0, Km), J("hmm", 0, 0, function() {
        return "" + _i.apply(this) + Ct(this.minutes(), 2);
      }), J("hmmss", 0, 0, function() {
        return "" + _i.apply(this) + Ct(this.minutes(), 2) + Ct(this.seconds(), 2);
      }), J("Hmm", 0, 0, function() {
      ...
      $("a", il), $("A", il), $("H", Fe, ui), $("h", Fe, Mn), $("k", Fe, Mn), $("HH", Fe, bt), $("hh", Fe, bt), $("kk", Fe, bt), $("hmm", cr), $("hmmss", gr), $("Hmm", cr), $("Hmmss", gr), Ce(["H", "HH"], Ze), Ce(["k", "kk"], function(e, s, d) {
        var m = _e(e);
        s[Ze] = m === 24 ? 0 : m;
      }), Ce(["a", "A"], function(e, s, d) {
        d._isPm = d._locale.isPM(e), d._meridiem = e;
      }), Ce(["h", "hh"], function(e, s, d) {
        s[Ze] = _e(e), x(d).bigHour = true;
      }), Ce("hmm", function(e, s, d) {
        var m = e.length - 2;
        s[Ze] = _e(e.substr(0, m)), s[ts] = _e(e.substr(m)), x(d).bigHour = true;
      }), Ce("hmmss", function(e, s, d) {
        var m = e.length - 4, h = e.length - 2;
        s[Ze] = _e(e.substr(0, m)), s[ts] = _e(e.substr(m, 2)), s[Es] = _e(e.substr(h)), x(d).bigHour = true;
      }), Ce("Hmm", function(e, s, d) {
        var m = e.length - 2;
        s[Ze] = _e(e.substr(0, m)), s[ts] = _e(e.substr(m));
      }), Ce("Hmmss", function(e, s, d) {
        var m = e.length - 4, h = e.length - 2;
        s[Ze] = _e(e.substr(0, m)), s[ts] = _e(e.substr(m, 2)), s[Es] = _e(e.substr(h));
      });
      function ol(e) {
      ...
      var nn = { calendar: Zs, longDateFormat: Mm, invalidDate: mr, ordinal: es, dayOfMonthOrdinalParse: xa, relativeTime: xs, months: Io, monthsShort: ci, week: aa, weekdays: qm, weekdaysMin: Om, weekdaysShort: nl, meridiemParse: Zm }, Pe = {}, kn = {}, ot;
      function ll(e, s) {
        var d, m = Math.min(e.length, s.length);
        for (d = 0; d < m; d += 1) if (e[d] !== s[d]) return d;
        return m;
      }
      function yi(e) {
      ...
      function dl(e) {
        for (var s = 0, d, m, h, k; s < e.length; ) {
          for (k = yi(e[s]).split("-"), d = k.length, m = yi(e[s + 1]), m = m ? m.split("-") : null; d > 0; ) {
      ...
      function Ha(e) {
        var s = null, d;
        if (Pe[e] === void 0 && a && a.exports && ml(e)) try {
          s = ot._abbr, d = X_, d("./locale/" + e), Hs(s);
        } catch {
          Pe[e] = null;
        }
        return Pe[e];
      ...
      function Hs(e, s) {
        var d;
        return e && (w(s) ? d = Ge(e) : d = mt(e, s), d ? ot = d : typeof console < "u" && console.warn && console.warn("Locale " + e + " not found. Did you forget to load it?")), ot._abbr;
      }
      function mt(e, s) {
        if (s !== null) {
          var d, m = nn;
          if (s.abbr = e, Pe[e] != null) It("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), m = Pe[e]._config;
          else if (s.parentLocale != null) if (Pe[s.parentLocale] != null) m = Pe[s.parentLocale]._config;
          else if (d = Ha(s.parentLocale), d != null) m = d._config;
          else return kn[s.parentLocale] || (kn[s.parentLocale] = []), kn[s.parentLocale].push({ name: e, config: s }), null;
          return Pe[e] = new Fa(Ks(m, s)), kn[e] && kn[e].forEach(function(h) {
            mt(h.name, h.config);
          }), Hs(e), Pe[e];
      ...
      function Qm(e, s) {
        if (s != null) {
          var d, m, h = nn;
          Pe[e] != null && Pe[e].parentLocale != null ? Pe[e].set(Ks(Pe[e]._config, s)) : (m = Ha(e), m != null && (h = m._config), s = Ks(h, s), m == null && (s.abbr = e), d = new Fa(s), d.parentLocale = Pe[e], Pe[e] = d), Hs(e);
      ...
      function Lr(e) {
        var s, d = e._a;
        return d && x(e).overflow === -2 && (s = d[As] < 0 || d[As] > 11 ? As : d[gs] < 1 || d[gs] > yr(d[it], d[As]) ? gs : d[Ze] < 0 || d[Ze] > 24 || d[Ze] === 24 && (d[ts] !== 0 || d[Es] !== 0 || d[tn] !== 0) ? Ze : d[ts] < 0 || d[ts] > 59 ? ts : d[Es] < 0 || d[Es] > 59 ? Es : d[tn] < 0 || d[tn] > 999 ? tn : -1, x(e)._overflowDayOfYear && (s < it || s > gs) && (s = gs), x(e)._overflowWeeks && s === -1 && (s = Sm), x(e)._overflowWeekday && s === -1 && (s = Fm), x(e).overflow = s), e;
      }
      ...
      function ul(e) {
        var s, d, m = e._i, h = an.exec(m) || kr.exec(m), k, S, W, ie, ye = xe.length, nt = hs.length;
        if (h) {
          for (x(e).iso = true, s = 0, d = ye; s < d; s++) if (xe[s][1].exec(h[1])) {
            S = xe[s][0], k = xe[s][2] !== false;
            break;
          }
          if (S == null) {
            e._isValid = false;
          ...
          if (h[3]) {
            for (s = 0, d = nt; s < d; s++) if (hs[s][1].exec(h[3])) {
              W = (h[2] || " ") + hs[s][0];
              break;
            }
            if (W == null) {
      ...
      function tu(e, s, d, m, h, k) {
        var S = [su(e), ci.indexOf(s), parseInt(d, 10), parseInt(m, 10), parseInt(h, 10)];
      ...
      function Tr(e, s, d) {
        if (e) {
          var m = nl.indexOf(e), h = new Date(s[0], s[1], s[2]).getDay();
      ...
      function gl(e) {
        var s = eu.exec(cl(e._i)), d;
        if (s) {
          if (d = tu(s[4], s[3], s[2], s[5], s[6], s[7]), !Tr(s[1], d, e)) return;
          e._a = d, e._tzm = ra(s[8], s[9], s[10]), e._d = ta.apply(null, e._a), e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), x(e).rfc2822 = true;
        } else e._isValid = false;
      }
      function hl(e) {
        var s = wi.exec(e._i);
        if (s !== null) {
          e._d = /* @__PURE__ */ new Date(+s[1]);
          return;
        }
      ...
      function Li(e) {
        var s = new Date(l.now());
        return e._useUTC ? [s.getUTCFullYear(), s.getUTCMonth(), s.getUTCDate()] : [s.getFullYear(), s.getMonth(), s.getDate()];
      }
      function Pa(e) {
        var s, d, m = [], h, k, S;
        if (!e._d) {
          for (h = Li(e), e._w && e._a[gs] == null && e._a[As] == null && fl(e), e._dayOfYear != null && (S = Tn(e._a[it], h[it]), (e._dayOfYear > Ea(S) || e._dayOfYear === 0) && (x(e)._overflowDayOfYear = true), d = ta(S, 0, e._dayOfYear), e._a[As] = d.getUTCMonth(), e._a[gs] = d.getUTCDate()), s = 0; s < 3 && e._a[s] == null; ++s) e._a[s] = m[s] = h[s];
          for (; s < 7; s++) e._a[s] = m[s] = e._a[s] == null ? s === 2 ? 1 : 0 : e._a[s];
      ...
      function fl(e) {
        var s, d, m, h, k, S, W, ie, ye;
        s = e._w, s.GG != null || s.W != null || s.E != null ? (k = 1, S = 4, d = Tn(s.GG, e._a[it], na(Ae(), 1, 4).year), m = Tn(s.W, 1), h = Tn(s.E, 1), (h < 1 || h > 7) && (ie = true)) : (k = e._locale._week.dow, S = e._locale._week.doy, ye = na(Ae(), k, S), d = Tn(s.gg, e._a[it], ye.year), m = Tn(s.w, ye.week), s.d != null ? (h = s.d, (h < 0 || h > 6) && (ie = true)) : s.e != null ? (h = s.e + k, (s.e < 0 || s.e > 6) && (ie = true)) : h = k), m < 1 || m > ss(d, k, S) ? x(e)._overflowWeeks = true : ie != null ? x(e)._overflowWeekday = true : (W = Zo(d, m, h, k, S), e._a[it] = W.year, e._dayOfYear = W.dayOfYear);
      }
      l.ISO_8601 = function() {
      }, l.RFC_2822 = function() {
      };
      function ki(e) {
        ...
        e._a = [], x(e).empty = true;
        var s = "" + e._i, d, m, h, k, S, W = s.length, ie = 0, ye, nt;
        for (h = Wn(e._f, e._locale).match(Ut) || [], nt = h.length, d = 0; d < nt; d++) k = h[d], m = (s.match(Cm(k, e)) || [])[0], m && (S = s.substr(0, s.indexOf(m)), S.length > 0 && x(e).unusedInput.push(S), s = s.slice(s.indexOf(m) + m.length), ie += m.length), Bn[k] ? (m ? x(e).empty = false : x(e).unusedTokens.push(k), bm(k, m, e)) : e._strict && !m && x(e).unusedTokens.push(k);
        x(e).charsLeftOver = W - ie, s.length > 0 && x(e).unusedInput.push(s), e._a[Ze] <= 12 && x(e).bigHour === true && e._a[Ze] > 0 && (x(e).bigHour = void 0), x(e).parsedDateParts = e._a.slice(0), x(e).meridiem = e._meridiem, e._a[Ze] = Ti(e._locale, e._a[Ze], e._meridiem), ye = x(e).era, ye !== null && (e._a[it] = e._locale.erasConvertYear(ye, e._a[it])), Pa(e), Lr(e);
      }
      function Ti(e, s, d) {
        var m;
        return d == null ? s : e.meridiemHour != null ? e.meridiemHour(s, d) : (e.isPM != null && (m = e.isPM(d), m && s < 12 && (s += 12), !m && s === 12 && (s = 0)), s);
      }
      function Di(e) {
        var s, d, m, h, k, S, W = false, ie = e._f.length;
        if (ie === 0) {
          x(e).invalidFormat = true, e._d = /* @__PURE__ */ new Date(NaN);
          return;
        }
        for (h = 0; h < ie; h++) k = 0, S = false, s = B({}, e), e._useUTC != null && (s._useUTC = e._useUTC), s._f = e._f[h], ki(s), X(s) && (S = true), k += x(s).charsLeftOver, k += x(s).unusedTokens.length * 10, x(s).score = k, W ? k < m && (m = k, d = s) : (m == null || k < m || S) && (m = k, d = s, S && (W = true));
        N(e, d || s);
      }
      function nu(e) {
        if (!e._d) {
          var s = wn(e._i), d = s.day === void 0 ? s.date : s.day;
          e._a = H([s.year, s.month, d, s.hour, s.minute, s.second, s.millisecond], function(m) {
      ...
      function _t(e) {
        var s = e._i, d = e._f;
        return e._locale = e._locale || Ge(e._l), s === null || d === void 0 && s === "" ? te({ nullInput: true }) : (typeof s == "string" && (e._i = s = e._locale.preparse(s)), he(s) ? new V(Lr(s)) : (b(s) ? e._d = s : g(d) ? Di(e) : d ? ki(e) : Yi(e), X(e) || (e._d = null), e));
      }
      function Yi(e) {
        var s = e._i;
        w(s) ? e._d = new Date(l.now()) : b(s) ? e._d = new Date(s.valueOf()) : typeof s == "string" ? hl(e) : g(s) ? (e._a = H(s.slice(0), function(d) {
          return parseInt(d, 10);
        }), Pa(e)) : f(s) ? nu(e) : D(s) ? e._d = new Date(s) : l.createFromInputFallback(e);
      }
      function ia(e, s, d, m, h) {
        var k = {};
        return (s === true || s === false) && (m = s, s = void 0), (d === true || d === false) && (m = d, d = void 0), (f(e) && L(e) || g(e) && e.length === 0) && (e = void 0), k._isAMomentObject = true, k._useUTC = k._isUTC = h, k._l = d, k._i = e, k._f = s, k._strict = m, _l(k);
      }
      function Ae(e, s, d, m) {
        return ia(e, s, d, m, false);
      }
      ...
      function yl(e, s) {
        var d, m;
        if (s.length === 1 && g(s[0]) && (s = s[0]), !s.length) return Ae();
        for (d = s[0], m = 1; m < s.length; ++m) (!s[m].isValid() || s[m][e](d)) && (d = s[m]);
        return d;
      }
      function ru() {
      ...
      function lu(e) {
        var s, d = false, m, h = fs.length;
        for (s in e) if (p(e, s) && !(ze.call(fs, s) !== -1 && (e[s] == null || !isNaN(e[s])))) return false;
      ...
      function ja(e) {
        var s = wn(e), d = s.year || 0, m = s.quarter || 0, h = s.month || 0, k = s.week || s.isoWeek || 0, S = s.day || 0, W = s.hour || 0, ie = s.minute || 0, ye = s.second || 0, nt = s.millisecond || 0;
        this._isValid = lu(s), this._milliseconds = +nt + ye * 1e3 + ie * 6e4 + W * 1e3 * 60 * 60, this._days = +S + k * 7, this._months = +h + m * 3 + d * 12, this._data = {}, this._locale = Ge(), this._bubble();
      }
      function ns(e) {
      ...
      function mu(e, s, d) {
        var m = Math.min(e.length, s.length), h = Math.abs(e.length - s.length), k = 0, S;
        for (S = 0; S < m; S++) _e(e[S]) !== _e(s[S]) && k++;
        return k + h;
      }
      function vl(e, s) {
        J(e, 0, 0, function() {
          var d = this.utcOffset(), m = "+";
          return d < 0 && (d = -d, m = "-"), m + Ct(~~(d / 60), 2) + s + Ct(~~d % 60, 2);
        });
      }
      vl("Z", ":"), vl("ZZ", ""), $("Z", hr), $("ZZ", hr), Ce(["Z", "ZZ"], function(e, s, d) {
        d._useUTC = true, d._tzm = rn(hr, e);
      });
      var uu = /([\+\-]|\d\d)/gi;
      function rn(e, s) {
        var d = (s || "").match(e), m, h, k;
        return d === null ? null : (m = d[d.length - 1] || [], h = (m + "").match(uu) || ["-", 0, 0], k = +(h[1] * 60) + _e(h[2]), k === 0 ? 0 : h[0] === "+" ? k : -k);
      }
      function St(e, s) {
        var d, m;
        return s._isUTC ? (d = s.clone(), m = (he(e) || b(e) ? e.valueOf() : Ae(e).valueOf()) - d.valueOf(), d._d.setTime(d._d.valueOf() + m), l.updateOffset(d, false), d) : Ae(e).local();
      }
      function Dr(e) {
      ...
      function cu(e, s, d) {
        ...
        if (e != null) {
          ...
          return !this._isUTC && s && (h = Dr(this)), this._offset = e, this._isUTC = true, h != null && this.add(h, "m"), m !== e && (!s || this._changeInProgress ? Ml(this, fe(e - m, "m"), 1, false) : this._changeInProgress || (this._changeInProgress = true, l.updateOffset(this, true), this._changeInProgress = null)), this;
        } else return this._isUTC ? m : Dr(this);
      }
      function gu(e, s) {
        return e != null ? (typeof e != "string" && (e = -e), this.utcOffset(e, s), this) : -this.utcOffset();
      }
      function hu(e) {
      ...
      function A() {
        ...
        var e = {}, s;
        return B(e, this), e = _t(e), e._a ? (s = e._isUTC ? q(e._a) : Ae(e._a), this._isDSTShifted = this.isValid() && mu(e._a, s.toArray()) > 0) : this._isDSTShifted = false, this._isDSTShifted;
      }
      function F() {
      ...
      function fe(e, s) {
        ...
        return ns(e) ? d = { ms: e._milliseconds, d: e._days, M: e._months } : D(e) || !isNaN(+e) ? (d = {}, s ? d[s] = +e : d.milliseconds = +e) : (m = Te.exec(e)) ? (h = m[1] === "-" ? -1 : 1, d = { y: 0, d: _e(m[gs]) * h, h: _e(m[Ze]) * h, m: _e(m[ts]) * h, s: _e(m[Es]) * h, ms: _e(oa(m[tn] * 1e3)) * h }) : (m = Qe.exec(e)) ? (h = m[1] === "-" ? -1 : 1, d = { y: Ps(m[2], h), M: Ps(m[3], h), w: Ps(m[4], h), d: Ps(m[5], h), h: Ps(m[6], h), m: Ps(m[7], h), s: Ps(m[8], h) }) : d == null ? d = {} : typeof d == "object" && ("from" in d || "to" in d) && (S = Bt(Ae(d.from), Ae(d.to)), d = {}, d.ms = S.milliseconds, d.M = S.months), k = new ja(d), ns(e) && p(e, "_locale") && (k._locale = e._locale), ns(e) && p(e, "_isValid") && (k._isValid = e._isValid), k;
      }
      fe.fn = ja.prototype, fe.invalid = Ci;
      function Ps(e, s) {
        var d = e && parseFloat(e.replace(",", "."));
        return (isNaN(d) ? 0 : d) * s;
      }
      function wl(e, s) {
        var d = {};
        return d.months = s.month() - e.month() + (s.year() - e.year()) * 12, e.clone().add(d.months, "M").isAfter(s) && --d.months, d.milliseconds = +s - +e.clone().add(d.months, "M"), d;
      }
      function Bt(e, s) {
        var d;
        return e.isValid() && s.isValid() ? (s = St(s, e), e.isBefore(s) ? d = wl(e, s) : (d = wl(s, e), d.milliseconds = -d.milliseconds, d.months = -d.months), d) : { milliseconds: 0, months: 0 };
      }
      function qa(e, s) {
        return function(d, m) {
          var h, k;
          return m !== null && !isNaN(+m) && (It(s, "moment()." + s + "(period, number) is deprecated. Please use moment()." + s + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), k = d, d = m, m = k), h = fe(d, m), Ml(this, h, e), this;
        };
      }
      function Ml(e, s, d, m) {
        var h = s._milliseconds, k = oa(s._days), S = oa(s._months);
      ...
      function De(e) {
        return he(e) || b(e) || Oa(e) || D(e) || Ll(e) || pu(e) || e === null || e === void 0;
      }
      function pu(e) {
        var s = f(e) && !L(e), d = false, m = ["years", "year", "y", "months", "month", "M", "days", "day", "d", "dates", "date", "D", "hours", "hour", "h", "minutes", "minute", "m", "seconds", "second", "s", "milliseconds", "millisecond", "ms"], h, k, S = m.length;
        for (h = 0; h < S; h += 1) k = m[h], d = d || p(e, k);
        return s && d;
      }
      function Ll(e) {
        var s = g(e), d = false;
        return s && (d = e.filter(function(m) {
          return !D(m) && Oa(e);
        }).length === 0), s && d;
      }
      function Cr(e) {
        var s = f(e) && !L(e), d = false, m = ["sameDay", "nextDay", "lastDay", "nextWeek", "lastWeek", "sameElse"], h, k;
        for (h = 0; h < m.length; h += 1) k = m[h], d = d || p(e, k);
        return s && d;
      }
      function yu(e, s) {
        var d = e.diff(s, "days", true);
        return d < -6 ? "sameElse" : d < -1 ? "lastWeek" : d < 0 ? "lastDay" : d < 1 ? "sameDay" : d < 2 ? "nextDay" : d < 7 ? "nextWeek" : "sameElse";
      }
      function vu(e, s) {
        arguments.length === 1 && (arguments[0] ? De(arguments[0]) ? (e = arguments[0], s = void 0) : Cr(arguments[0]) && (s = arguments[0], e = void 0) : (e = void 0, s = void 0));
        var d = e || Ae(), m = St(d, this).startOf("day"), h = l.calendarFormat(this, m) || "sameElse", k = s && (Re(s[h]) ? s[h].call(this, d) : s[h]);
      ...
      function br(e, s) {
        var d = he(e) ? e : Ae(e);
        return this.isValid() && d.isValid() ? (s = Ie(s) || "millisecond", s === "millisecond" ? this.valueOf() > d.valueOf() : d.valueOf() < this.clone().startOf(s).valueOf()) : false;
      }
      function on(e, s) {
        var d = he(e) ? e : Ae(e);
        return this.isValid() && d.isValid() ? (s = Ie(s) || "millisecond", s === "millisecond" ? this.valueOf() < d.valueOf() : this.clone().endOf(s).valueOf() < d.valueOf()) : false;
      }
      function Sr(e, s, d, m) {
        var h = he(e) ? e : Ae(e), k = he(s) ? s : Ae(s);
      ...
      function kl(e, s) {
        var d = he(e) ? e : Ae(e), m;
        return this.isValid() && d.isValid() ? (s = Ie(s) || "millisecond", s === "millisecond" ? this.valueOf() === d.valueOf() : (m = d.valueOf(), this.clone().startOf(s).valueOf() <= m && m <= this.clone().endOf(s).valueOf())) : false;
      }
      function Fr(e, s) {
        return this.isSame(e, s) || this.isAfter(e, s);
      }
      function Tl(e, s) {
        return this.isSame(e, s) || this.isBefore(e, s);
      }
      function Dl(e, s, d) {
        var m, h, k;
        if (!this.isValid()) return NaN;
        if (m = St(e, this), !m.isValid()) return NaN;
        switch (h = (m.utcOffset() - this.utcOffset()) * 6e4, s = Ie(s), s) {
          case "year":
            k = Dn(this, m) / 12;
            break;
          case "month":
      ...
      function Dn(e, s) {
        if (e.date() < s.date()) return -Dn(s, e);
        var d = (s.year() - e.year()) * 12 + (s.month() - e.month()), m = e.clone().add(d, "months"), h, k;
        return s - m < 0 ? (h = e.clone().add(d - 1, "months"), k = (s - m) / (m - h)) : (h = e.clone().add(d + 1, "months"), k = (s - m) / (h - m)), -(d + k) || 0;
      }
      ...
      function Ra(e) {
        ...
        var s = e !== true, d = s ? this.clone().utc() : this;
        return d.year() < 0 || d.year() > 9999 ? Qs(d, s ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : Re(Date.prototype.toISOString) ? s ? this.toDate().toISOString() : new Date(this.valueOf() + this.utcOffset() * 60 * 1e3).toISOString().replace("Z", Qs(d, "Z")) : Qs(d, s ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ");
      }
      function Yn() {
        if (!this.isValid()) return "moment.invalid(/* " + this._i + " */)";
        var e = "moment", s = "", d, m, h, k;
        return this.isLocal() || (e = this.utcOffset() === 0 ? "moment.utc" : "moment.parseZone", s = "Z"), d = "[" + e + '("]', m = 0 <= this.year() && this.year() <= 9999 ? "YYYY" : "YYYYYY", h = "-MM-DD[T]HH:mm:ss.SSS", k = s + '[")]', this.format(d + m + h + k);
      }
      function xr(e) {
      ...
      function Mu(e, s) {
        return this.isValid() && (he(e) && e.isValid() || Ae(e).isValid()) ? fe({ to: this, from: e }).locale(this.locale()).humanize(!s) : this.localeData().invalidDate();
      }
      function Lu(e) {
        return this.from(Ae(), e);
      }
      function ku(e, s) {
        return this.isValid() && (he(e) && e.isValid() || Ae(e).isValid()) ? fe({ from: this, to: e }).locale(this.locale()).humanize(!s) : this.localeData().invalidDate();
      }
      function Nr(e) {
        return this.to(Ae(), e);
      }
      function Ia(e) {
        var s;
        return e === void 0 ? this._locale._abbr : (s = Ge(e), s != null && (this._locale = s), this);
      }
      ...
      function bl(e, s, d) {
        return e < 100 && e >= 0 ? new Date(e + 400, s, d) - Ve : new Date(e, s, d).valueOf();
      }
      function Sl(e, s, d) {
        return e < 100 && e >= 0 ? Date.UTC(e + 400, s, d) - Ve : Date.UTC(e, s, d);
      }
      function Fl(e) {
        var s, d;
        if (e = Ie(e), e === void 0 || e === "millisecond" || !this.isValid()) return this;
        switch (d = this._isUTC ? Sl : bl, e) {
          case "year":
            s = d(this.year(), 0, 1);
            break;
          case "quarter":
            s = d(this.year(), this.month() - this.month() % 3, 1);
            break;
          case "month":
            s = d(this.year(), this.month(), 1);
            break;
          case "week":
            s = d(this.year(), this.month(), this.date() - this.weekday());
            break;
          case "isoWeek":
            s = d(this.year(), this.month(), this.date() - (this.isoWeekday() - 1));
            break;
          case "day":
          case "date":
            s = d(this.year(), this.month(), this.date());
            break;
          case "hour":
            s = this._d.valueOf(), s -= Be(s + (this._isUTC ? 0 : this.utcOffset() * ma), Er);
            break;
          case "minute":
            s = this._d.valueOf(), s -= Be(s, ma);
            break;
          case "second":
            s = this._d.valueOf(), s -= Be(s, Ua);
            break;
        }
        return this._d.setTime(s), l.updateOffset(this, true), this;
      }
      function Tu(e) {
        var s, d;
        if (e = Ie(e), e === void 0 || e === "millisecond" || !this.isValid()) return this;
        switch (d = this._isUTC ? Sl : bl, e) {
          case "year":
            s = d(this.year() + 1, 0, 1) - 1;
            break;
          case "quarter":
            s = d(this.year(), this.month() - this.month() % 3 + 3, 1) - 1;
            break;
          case "month":
            s = d(this.year(), this.month() + 1, 1) - 1;
            break;
          case "week":
            s = d(this.year(), this.month(), this.date() - this.weekday() + 7) - 1;
            break;
          case "isoWeek":
            s = d(this.year(), this.month(), this.date() - (this.isoWeekday() - 1) + 7) - 1;
            break;
          case "day":
          case "date":
            s = d(this.year(), this.month(), this.date() + 1) - 1;
            break;
          case "hour":
            s = this._d.valueOf(), s += Er - Be(s + (this._isUTC ? 0 : this.utcOffset() * ma), Er) - 1;
            break;
          case "minute":
            s = this._d.valueOf(), s += ma - Be(s, ma) - 1;
            break;
          case "second":
            s = this._d.valueOf(), s += Ua - Be(s, Ua) - 1;
            break;
        }
        return this._d.setTime(s), l.updateOffset(this, true), this;
      }
      ...
      J("N", 0, 0, "eraAbbr"), J("NN", 0, 0, "eraAbbr"), J("NNN", 0, 0, "eraAbbr"), J("NNNN", 0, 0, "eraName"), J("NNNNN", 0, 0, "eraNarrow"), J("y", ["y", 1], "yo", "eraYear"), J("y", ["yy", 2], 0, "eraYear"), J("y", ["yyy", 3], 0, "eraYear"), J("y", ["yyyy", 4], 0, "eraYear"), $("N", ue), $("NN", ue), $("NNN", ue), $("NNNN", Fu), $("NNNNN", xu), Ce(["N", "NN", "NNN", "NNNN", "NNNNN"], function(e, s, d, m) {
        var h = d._locale.erasParse(e, m, d._strict);
        h ? x(d).era = h : x(d).invalidEra = e;
      }), $("y", en), $("yy", en), $("yyy", en), $("yyyy", en), $("yo", Nu), Ce(["y", "yy", "yyy", "yyyy"], it), Ce(["yo"], function(e, s, d, m) {
        var h;
        d._locale._eraYearOrdinalRegex && (h = e.match(d._locale._eraYearOrdinalRegex)), d._locale.eraYearOrdinalParse ? s[it] = d._locale.eraYearOrdinalParse(e, h) : s[it] = parseInt(e, 10);
      });
      function Cu(e, s) {
      ...
      function bu(e, s, d) {
        ...
        for (e = e.toUpperCase(), m = 0, h = k.length; m < h; ++m) if (S = k[m].name.toUpperCase(), W = k[m].abbr.toUpperCase(), ie = k[m].narrow.toUpperCase(), d) switch (s) {
          case "N":
          case "NN":
          case "NNN":
            if (W === e) return k[m];
      ...
      function Su(e, s) {
        ...
        return s === void 0 ? l(e.since).year() : l(e.since).year() + (s - e.offset) * d;
      }
      function Pr() {
        var e, s, d, m = this.localeData().eras();
        for (e = 0, s = m.length; e < s; ++e) if (d = this.clone().startOf("day").valueOf(), m[e].since <= d && d <= m[e].until || m[e].until <= d && d <= m[e].since) return m[e].name;
        return "";
      }
      function $a() {
        var e, s, d, m = this.localeData().eras();
        for (e = 0, s = m.length; e < s; ++e) if (d = this.clone().startOf("day").valueOf(), m[e].since <= d && d <= m[e].until || m[e].until <= d && d <= m[e].since) return m[e].narrow;
        return "";
      }
      function xl() {
        var e, s, d, m = this.localeData().eras();
        for (e = 0, s = m.length; e < s; ++e) if (d = this.clone().startOf("day").valueOf(), m[e].since <= d && d <= m[e].until || m[e].until <= d && d <= m[e].since) return m[e].abbr;
        return "";
      }
      function y() {
        var e, s, d, m, h = this.localeData().eras();
        for (e = 0, s = h.length; e < s; ++e) if (d = h[e].since <= h[e].until ? 1 : -1, m = this.clone().startOf("day").valueOf(), h[e].since <= m && m <= h[e].until || h[e].until <= m && m <= h[e].since) return (this.year() - l(h[e].since).year()) * d + h[e].offset;
        return this.year();
      }
      function ga(e) {
      ...
      function ue(e, s) {
        return s.erasAbbrRegex(e);
      }
      function Fu(e, s) {
        return s.erasNameRegex(e);
      }
      function xu(e, s) {
        return s.erasNarrowRegex(e);
      }
      function Nu(e, s) {
        return s._eraYearOrdinalRegex || en;
      }
      function js() {
        var e = [], s = [], d = [], m = [], h, k, S, W, ie, ye = this.eras();
        for (h = 0, k = ye.length; h < k; ++h) S = Ns(ye[h].name), W = Ns(ye[h].abbr), ie = Ns(ye[h].narrow), s.push(S), e.push(W), d.push(ie), m.push(S), m.push(W), m.push(ie);
        this._erasRegex = new RegExp("^(" + m.join("|") + ")", "i"), this._erasNameRegex = new RegExp("^(" + s.join("|") + ")", "i"), this._erasAbbrRegex = new RegExp("^(" + e.join("|") + ")", "i"), this._erasNarrowRegex = new RegExp("^(" + d.join("|") + ")", "i");
      }
      J(0, ["gg", 2], 0, function() {
      ...
      qr("gggg", "weekYear"), qr("ggggg", "weekYear"), qr("GGGG", "isoWeekYear"), qr("GGGGG", "isoWeekYear"), $("G", Qn), $("g", Qn), $("GG", Fe, bt), $("gg", Fe, bt), $("GGGG", Na, Xs), $("gggg", Na, Xs), $("GGGGG", Zn, Jn), $("ggggg", Zn, Jn), Ln(["gggg", "ggggg", "GGGG", "GGGGG"], function(e, s, d, m) {
        s[m.substr(0, 2)] = _e(e);
      }), Ln(["gg", "GG"], function(e, s, d, m) {
        s[m] = l.parseTwoDigitYear(e);
      });
      function Au(e) {
      ...
      function Nl(e, s, d, m, h) {
        var k;
        return e == null ? na(this, m, h).year : (k = ss(e, m, h), s > k && (s = k), qu.call(this, e, s, d, m, h));
      }
      function qu(e, s, d, m, h) {
        var k = Zo(e, s, d, m, h), S = ta(k.year, 0, k.dayOfYear);
        return this.year(S.getUTCFullYear()), this.month(S.getUTCMonth()), this.date(S.getUTCDate()), this;
      }
      J("Q", 0, "Qo", "quarter"), $("Q", Gn), Ce("Q", function(e, s) {
        s[As] = (_e(e) - 1) * 3;
      });
      function Ou(e) {
        return e == null ? Math.ceil((this.month() + 1) / 3) : this.month((e - 1) * 3 + this.month() % 3);
      }
      J("D", ["DD", 2], "Do", "date"), $("D", Fe, Mn), $("DD", Fe, bt), $("Do", function(e, s) {
        return e ? s._dayOfMonthOrdinalParse || s._ordinalParse : s._dayOfMonthOrdinalParseLenient;
      }), Ce(["D", "DD"], gs), Ce("Do", function(e, s) {
        s[gs] = _e(e.match(Fe)[0]);
      });
      var Al = ea("Date", true);
      J("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), $("DDD", Kn), $("DDDD", Vn), Ce(["DDD", "DDDD"], function(e, s, d) {
        d._dayOfYear = _e(e);
      });
      function Os(e) {
      ...
      J("m", ["mm", 2], 0, "minute"), $("m", Fe, ui), $("mm", Fe, bt), Ce(["m", "mm"], ts);
      var Ru = ea("Minutes", false);
      J("s", ["ss", 2], 0, "second"), $("s", Fe, ui), $("ss", Fe, bt), Ce(["s", "ss"], Es);
      var Iu = ea("Seconds", false);
      J("S", 0, 0, function() {
      ...
      var U = V.prototype;
      U.add = da, U.calendar = vu, U.clone = wu, U.diff = Dl, U.endOf = Tu, U.format = xr, U.from = Mu, U.fromNow = Lu, U.to = ku, U.toNow = Nr, U.get = pr, U.invalidAt = Du, U.isAfter = br, U.isBefore = on, U.isBetween = Sr, U.isSame = kl, U.isSameOrAfter = Fr, U.isSameOrBefore = Tl, U.isValid = Hr, U.lang = Ar, U.locale = Ia, U.localeData = Cl, U.max = au, U.min = pl, U.parsingFlags = ca, U.set = Nm, U.startOf = Fl, U.subtract = Yr, U.toArray = ua, U.toObject = Ba, U.toDate = Si, U.toISOString = Ra, U.inspect = Yn, typeof Symbol < "u" && Symbol.for != null && (U[Symbol.for("nodejs.util.inspect.custom")] = function() {
        return "Moment<" + this.format() + ">";
      }), U.toJSON = Wa, U.toString = Yl, U.unix = za, U.valueOf = bi, U.creationData = Yu, U.eraName = Pr, U.eraNarrow = $a, U.eraAbbr = xl, U.eraYear = y, U.year = Oo, U.isLeapYear = xm, U.weekYear = Au, U.isoWeekYear = Eu, U.quarter = U.quarters = Ou, U.month = $o, U.daysInMonth = Go, U.week = U.weeks = jm, U.isoWeek = U.isoWeeks = el, U.weeksInYear = qs, U.weeksInWeekYear = ju, U.isoWeeksInYear = Hu, U.isoWeeksInISOWeekYear = Pu, U.date = Al, U.day = U.days = $m, U.weekday = Gm, U.isoWeekday = Vm, U.dayOfYear = Os, U.hour = U.hours = tt, U.minute = U.minutes = Ru, U.second = U.seconds = Iu, U.millisecond = U.milliseconds = El, U.utcOffset = cu, U.utc = hu, U.local = fu, U.parseZone = _u, U.hasAlignedHourOffset = la, U.isDST = Y, U.isLocal = F, U.isUtcOffset = G, U.isUtc = oe, U.isUTC = oe, U.zoneAbbr = Cn, U.zoneName = zu, U.dates = ke("dates accessor is deprecated. Use date instead.", Al), U.months = ke("months accessor is deprecated. Use month instead", $o), U.years = ke("years accessor is deprecated. Use year instead", Oo), U.zone = ke("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", gu), U.isDSTShifted = ke("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", A);
      function as(e) {
        return Ae(e * 1e3);
      }
      function Bu() {
      ...
      function Or(e, s, d, m) {
        var h = Ge(), k = q().set(m, s);
        return h[d](k, e);
      }
      function Pl(e, s, d) {
        if (D(e) && (s = e, e = void 0), e = e || "", s != null) return Or(e, s, d, "month");
        var m, h = [];
        for (m = 0; m < 12; m++) h[m] = Or(e, m, d, "month");
        return h;
      }
      function Rr(e, s, d, m) {
        typeof e == "boolean" ? (D(s) && (d = s, s = void 0), s = s || "") : (s = e, d = s, e = false, D(s) && (d = s, s = void 0), s = s || "");
        var h = Ge(), k = e ? h._week.dow : 0, S, W = [];
        if (d != null) return Or(s, (d + k) % 7, m, "day");
        for (S = 0; S < 7; S++) W[S] = Or(s, (S + k) % 7, m, "day");
        return W;
      }
      function jl(e, s) {
        return Pl(e, s, "months");
      }
      function Wu(e, s) {
        return Pl(e, s, "monthsShort");
      }
      function $u(e, s, d) {
        return Rr(e, s, d, "weekdays");
      }
      function Fi(e, s, d) {
        return Rr(e, s, d, "weekdaysShort");
      }
      function Ga(e, s, d) {
        return Rr(e, s, d, "weekdaysMin");
      }
      Hs("en", { eras: [{ since: "0001-01-01", until: 1 / 0, offset: 1, name: "Anno Domini", narrow: "AD", abbr: "AD" }, { since: "0000-12-31", until: -1 / 0, offset: 1, name: "Before Christ", narrow: "BC", abbr: "BC" }], dayOfMonthOrdinalParse: /\d{1,2}(th|st|nd|rd)/, ordinal: function(e) {
        var s = e % 10, d = _e(e % 100 / 10) === 1 ? "th" : s === 1 ? "st" : s === 2 ? "nd" : s === 3 ? "rd" : "th";
        return e + d;
      ...
      function bn() {
        var e = this._milliseconds, s = this._days, d = this._months, m = this._data, h, k, S, W, ie;
        return e >= 0 && s >= 0 && d >= 0 || e <= 0 && s <= 0 && d <= 0 || (e += Ir(Ni(d) + s) * 864e5, s = 0, d = 0), m.milliseconds = e % 1e3, h = zt(e / 1e3), m.seconds = h % 60, k = zt(h / 60), m.minutes = k % 60, S = zt(k / 60), m.hours = S % 24, s += zt(S / 24), ie = zt(Ft(s)), d += ie, s -= Ir(Ni(ie)), W = zt(d / 12), d %= 12, m.days = s, m.months = d, m.years = W, this;
      }
      function Ft(e) {
      ...
      function ql(e) {
        if (!this.isValid()) return NaN;
        var s, d, m = this._milliseconds;
        if (e = Ie(e), e === "month" || e === "quarter" || e === "year") switch (s = this._days + m / 864e5, d = this._months + Ft(s), e) {
          case "month":
            return d;
          case "quarter":
            return d / 3;
        ...
        else switch (s = this._days + Math.round(Ni(this._months)), e) {
          case "week":
            return s / 7 + m / 6048e5;
          case "day":
            return s + m / 864e5;
          ...
          case "minute":
            return s * 1440 + m / 6e4;
          case "second":
            return s * 86400 + m / 1e3;
          case "millisecond":
            return Math.floor(s * 864e5) + m;
          default:
      ...
      var ha = _s("ms"), dn = _s("s"), Ol = _s("m"), Ju = _s("h"), Ur = _s("d"), Ku = _s("w"), Rl = _s("M"), st = _s("Q"), Ai = _s("y"), Il = ha;
      function ps() {
        return fe(this);
      }
      function Ei(e) {
      ...
      var Sn = ys("milliseconds"), Ul = ys("seconds"), ut = ys("minutes"), Hi = ys("hours"), Zu = ys("days"), Qu = ys("months"), Xu = ys("years");
      function Pi() {
        return zt(this.days() / 7);
      }
      var Is = Math.round, vs = { ss: 44, s: 45, m: 45, h: 22, d: 26, w: null, M: 11 };
      function zl(e, s, d, m, h) {
        return h.relativeTime(s || 1, !!d, e, m);
      }
      function ec(e, s, d, m) {
        var h = fe(e).abs(), k = Is(h.as("s")), S = Is(h.as("m")), W = Is(h.as("h")), ie = Is(h.as("d")), ye = Is(h.as("M")), nt = Is(h.as("w")), Ds = Is(h.as("y")), _n = k <= d.ss && ["s", k] || k < d.s && ["ss", k] || S <= 1 && ["m"] || S < d.m && ["mm", S] || W <= 1 && ["h"] || W < d.h && ["hh", W] || ie <= 1 && ["d"] || ie < d.d && ["dd", ie];
        return d.w != null && (_n = _n || nt <= 1 && ["w"] || nt < d.w && ["ww", nt]), _n = _n || ye <= 1 && ["M"] || ye < d.M && ["MM", ye] || Ds <= 1 && ["y"] || ["yy", Ds], _n[2] = s, _n[3] = +e > 0, _n[4] = m, zl.apply(null, _n);
      }
      function tc(e) {
        return e === void 0 ? Is : typeof e == "function" ? (Is = e, true) : false;
      }
      function Va(e, s) {
        return vs[e] === void 0 ? false : s === void 0 ? vs[e] : (vs[e] = s, e === "s" && (vs.ss = s - 1), true);
      }
      function sc(e, s) {
        if (!this.isValid()) return this.localeData().invalidDate();
        var d = false, m = vs, h, k;
        return typeof e == "object" && (s = e, e = false), typeof e == "boolean" && (d = e), typeof s == "object" && (m = Object.assign({}, vs, s), s.s != null && s.ss == null && (m.ss = s.s - 1)), h = this.localeData(), k = ec(this, !d, m, h), d && (k = h.pastFuture(+this, k)), h.postformat(k);
      }
      var ji = Math.abs;
      function mn(e) {
        return (e > 0) - (e < 0) || +e;
      ...
      function Ja() {
        if (!this.isValid()) return this.localeData().invalidDate();
        var e = ji(this._milliseconds) / 1e3, s = ji(this._days), d = ji(this._months), m, h, k, S, W = this.asSeconds(), ie, ye, nt, Ds;
        return W ? (m = zt(e / 60), h = zt(m / 60), e %= 60, m %= 60, k = zt(d / 12), d %= 12, S = e ? e.toFixed(3).replace(/\.?0+$/, "") : "", ie = W < 0 ? "-" : "", ye = mn(this._months) !== mn(W) ? "-" : "", nt = mn(this._days) !== mn(W) ? "-" : "", Ds = mn(this._milliseconds) !== mn(W) ? "-" : "", ie + "P" + (k ? ye + k + "Y" : "") + (d ? ye + d + "M" : "") + (s ? nt + s + "D" : "") + (h || m || e ? "T" : "") + (h ? Ds + h + "H" : "") + (m ? Ds + m + "M" : "") + (e ? Ds + S + "S" : "")) : "P0D";
      }
      var we = ja.prototype;
      we.isValid = du, we.abs = Gu, we.add = Vu, we.subtract = Rs, we.as = ql, we.asMilliseconds = ha, we.asSeconds = dn, we.asMinutes = Ol, we.asHours = Ju, we.asDays = Ur, we.asWeeks = Ku, we.asMonths = Rl, we.asQuarters = st, we.asYears = Ai, we.valueOf = Il, we._bubble = bn, we.clone = ps, we.get = Ei, we.milliseconds = Sn, we.seconds = Ul, we.minutes = ut, we.hours = Hi, we.days = Zu, we.weeks = Pi, we.months = Qu, we.years = Xu, we.humanize = sc, we.toISOString = Ja, we.toString = Ja, we.toJSON = Ja, we.locale = Ia, we.localeData = Cl, we.toIsoString = ke("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Ja), we.lang = Ar, J("X", 0, 0, "unix"), J("x", 0, 0, "valueOf"), $("x", Qn), $("X", Ym), Ce("X", function(e, s, d) {
        d._d = new Date(parseFloat(e) * 1e3);
      }), Ce("x", function(e, s, d) {
        d._d = new Date(_e(e));
      });
      l.version = "2.30.1", u(Ae), l.fn = U, l.min = ru, l.max = iu, l.now = ou, l.utc = q, l.unix = as, l.months = jl, l.isDate = b, l.locale = Hs, l.invalid = te, l.duration = fe, l.isMoment = he, l.weekdays = $u, l.parseZone = Bu, l.localeData = Ge, l.isDuration = ns, l.monthsShort = Wu, l.weekdaysMin = Ga, l.defineLocale = mt, l.updateLocale = Qm, l.locales = Xm, l.weekdaysShort = Fi, l.normalizeUnits = Ie, l.relativeTimeRounding = tc, l.relativeTimeThreshold = Va, l.calendarFormat = yu, l.prototype = U, l.HTML5_FMT = { DATETIME_LOCAL: "YYYY-MM-DDTHH:mm", DATETIME_LOCAL_SECONDS: "YYYY-MM-DDTHH:mm:ss", DATETIME_LOCAL_MS: "YYYY-MM-DDTHH:mm:ss.SSS", DATE: "YYYY-MM-DD", TIME: "HH:mm", TIME_SECONDS: "HH:mm:ss", TIME_MS: "HH:mm:ss.SSS", WEEK: "GGGG-[W]WW", MONTH: "YYYY-MM" };
      ...
      var Bl = function(e) {
        ...
        return function(s, d, m, h) {
          var k = Bl(s), S = nc[e][Bl(s)];
          return k === 2 && (S = S[d ? 0 : 1]), S.replace(/%d/i, s);
        };
      ...
      l.defineLocale("ar-ps", { months: "كانون الثاني_شباط_آذار_نيسان_أيّار_حزيران_تمّوز_آب_أيلول_تشري الأوّل_تشرين الثاني_كانون الأوّل".split("_"), monthsShort: "ك٢_شباط_آذار_نيسان_أيّار_حزيران_تمّوز_آب_أيلول_ت١_ت٢_ك١".split("_"), weekdays: "الأحد_الإثنين_الثلاثاء_الأربعاء_الخميس_الجمعة_السبت".split("_"), weekdaysShort: "أحد_إثنين_ثلاثاء_أربعاء_خميس_جمعة_سبت".split("_"), weekdaysMin: "ح_ن_ث_ر_خ_ج_س".split("_"), weekdaysParseExact: true, longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD/MM/YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY HH:mm", LLLL: "dddd D MMMM YYYY HH:mm" }, meridiemParse: /ص|م/, isPM: function(e) {
        ...
        return e.replace(/[٣٤٥٦٧٨٩٠]/g, function(s) {
          return $l[s];
        }).split("").reverse().join("").replace(/[١٢](?![\u062a\u0643])/g, function(s) {
          return $l[s];
      ...
      var rc = { 1: "١", 2: "٢", 3: "٣", 4: "٤", 5: "٥", 6: "٦", 7: "٧", 8: "٨", 9: "٩", 0: "٠" }, Jl = { "١": "1", "٢": "2", "٣": "3", "٤": "4", "٥": "5", "٦": "6", "٧": "7", "٨": "8", "٩": "9", "٠": "0" }, Kl = function(e) {
        return e === 0 ? 0 : e === 1 ? 1 : e === 2 ? 2 : e % 100 >= 3 && e % 100 <= 10 ? 3 : e % 100 >= 11 ? 4 : 5;
      }, Oi = { s: ["أقل من ثانية", "ثانية واحدة", ["ثانيتان", "ثانيتين"], "%d ثوان", "%d ثانية", "%d ثانية"], m: ["أقل من دقيقة", "دقيقة واحدة", ["دقيقتان", "دقيقتين"], "%d دقائق", "%d دقيقة", "%d دقيقة"], h: ["أقل من ساعة", "ساعة واحدة", ["ساعتان", "ساعتين"], "%d ساعات", "%d ساعة", "%d ساعة"], d: ["أقل من يوم", "يوم واحد", ["يومان", "يومين"], "%d أيام", "%d يومًا", "%d يوم"], M: ["أقل من شهر", "شهر واحد", ["شهران", "شهرين"], "%d أشهر", "%d شهرا", "%d شهر"], y: ["أقل من عام", "عام واحد", ["عامان", "عامين"], "%d أعوام", "%d عامًا", "%d عام"] }, At = function(e) {
        return function(s, d, m, h) {
          var k = Kl(s), S = Oi[e][Kl(s)];
          return k === 2 && (S = S[d ? 0 : 1]), S.replace(/%d/i, s);
        };
      ...
      l.defineLocale("ar", { months: $r, monthsShort: $r, weekdays: "الأحد_الإثنين_الثلاثاء_الأربعاء_الخميس_الجمعة_السبت".split("_"), weekdaysShort: "أحد_إثنين_ثلاثاء_أربعاء_خميس_جمعة_سبت".split("_"), weekdaysMin: "ح_ن_ث_ر_خ_ج_س".split("_"), weekdaysParseExact: true, longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "D/‏M/‏YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY HH:mm", LLLL: "dddd D MMMM YYYY HH:mm" }, meridiemParse: /ص|م/, isPM: function(e) {
        ...
        return e < 12 ? "ص" : "م";
      }, calendar: { sameDay: "[اليوم عند الساعة] LT", nextDay: "[غدًا عند الساعة] LT", nextWeek: "dddd [عند الساعة] LT", lastDay: "[أمس عند الساعة] LT", lastWeek: "dddd [عند الساعة] LT", sameElse: "L" }, relativeTime: { future: "بعد %s", past: "منذ %s", s: At("s"), ss: At("s"), m: At("m"), mm: At("m"), h: At("h"), hh: At("h"), d: At("d"), dd: At("d"), M: At("M"), MM: At("M"), y: At("y"), yy: At("y") }, preparse: function(e) {
        return e.replace(/[١٢٣٤٥٦٧٨٩٠]/g, function(s) {
          return Jl[s];
        }).replace(/،/g, ",");
      }, postformat: function(e) {
      ...
      l.defineLocale("az", { months: "yanvar_fevral_mart_aprel_may_iyun_iyul_avqust_sentyabr_oktyabr_noyabr_dekabr".split("_"), monthsShort: "yan_fev_mar_apr_may_iyn_iyl_avq_sen_okt_noy_dek".split("_"), weekdays: "Bazar_Bazar ertəsi_Çərşənbə axşamı_Çərşənbə_Cümə axşamı_Cümə_Şənbə".split("_"), weekdaysShort: "Baz_BzE_ÇAx_Çər_CAx_Cüm_Şən".split("_"), weekdaysMin: "Bz_BE_ÇA_Çə_CA_Cü_Şə".split("_"), weekdaysParseExact: true, longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD.MM.YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY HH:mm", LLLL: "dddd, D MMMM YYYY HH:mm" }, calendar: { sameDay: "[bugün saat] LT", nextDay: "[sabah saat] LT", nextWeek: "[gələn həftə] dddd [saat] LT", lastDay: "[dünən] LT", lastWeek: "[keçən həftə] dddd [saat] LT", sameElse: "L" }, relativeTime: { future: "%s sonra", past: "%s əvvəl", s: "bir neçə saniyə", ss: "%d saniyə", m: "bir dəqiqə", mm: "%d dəqiqə", h: "bir saat", hh: "%d saat", d: "bir gün", dd: "%d gün", M: "bir ay", MM: "%d ay", y: "bir il", yy: "%d il" }, meridiemParse: /gecə|səhər|gündüz|axşam/, isPM: function(e) {
        ...
        var s = e % 10, d = e % 100 - s, m = e >= 100 ? 100 : null;
        return e + (Ri[s] || Ri[d] || Ri[m]);
      }, week: { dow: 1, doy: 7 } });
      function Ii(e, s) {
        var d = e.split("_");
        return s % 10 === 1 && s % 100 !== 11 ? d[0] : s % 10 >= 2 && s % 10 <= 4 && (s % 100 < 10 || s % 100 >= 20) ? d[1] : d[2];
      }
      function le(e, s, d) {
        var m = { ss: s ? "секунда_секунды_секунд" : "секунду_секунды_секунд", mm: s ? "хвіліна_хвіліны_хвілін" : "хвіліну_хвіліны_хвілін", hh: s ? "гадзіна_гадзіны_гадзін" : "гадзіну_гадзіны_гадзін", dd: "дзень_дні_дзён", MM: "месяц_месяцы_месяцаў", yy: "год_гады_гадоў" };
        return d === "m" ? s ? "хвіліна" : "хвіліну" : d === "h" ? s ? "гадзіна" : "гадзіну" : e + " " + Ii(m[d], +e);
      }
      ...
      }, dayOfMonthOrdinalParse: /\d{1,2}-(і|ы|га)/, ordinal: function(e, s) {
        switch (s) {
          case "M":
          case "d":
          case "DDD":
      ...
      l.defineLocale("bg", { months: "януари_февруари_март_април_май_юни_юли_август_септември_октомври_ноември_декември".split("_"), monthsShort: "яну_фев_мар_апр_май_юни_юли_авг_сеп_окт_ное_дек".split("_"), weekdays: "неделя_понеделник_вторник_сряда_четвъртък_петък_събота".split("_"), weekdaysShort: "нед_пон_вто_сря_чет_пет_съб".split("_"), weekdaysMin: "нд_пн_вт_ср_чт_пт_сб".split("_"), longDateFormat: { LT: "H:mm", LTS: "H:mm:ss", L: "D.MM.YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY H:mm", LLLL: "dddd, D MMMM YYYY H:mm" }, calendar: { sameDay: "[Днес в] LT", nextDay: "[Утре в] LT", nextWeek: "dddd [в] LT", lastDay: "[Вчера в] LT", lastWeek: function() {
        ...
        var s = e % 10, d = e % 100;
        return e === 0 ? e + "-ев" : d === 0 ? e + "-ен" : d > 10 && d < 20 ? e + "-ти" : s === 1 ? e + "-ви" : s === 2 ? e + "-ри" : s === 7 || s === 8 ? e + "-ми" : e + "-ти";
      }, week: { dow: 1, doy: 7 } });
      ...
      }, meridiemParse: /রাত|ভোর|সকাল|দুপুর|বিকাল|সন্ধ্যা|রাত/, meridiemHour: function(e, s) {
        if (e === 12 && (e = 0), s === "রাত") return e < 4 ? e : e + 12;
        if (s === "ভোর") return e;
        if (s === "সকাল") return e;
      ...
      }, meridiemParse: /রাত|সকাল|দুপুর|বিকাল|রাত/, meridiemHour: function(e, s) {
        return e === 12 && (e = 0), s === "রাত" && e >= 4 || s === "দুপুর" && e < 5 || s === "বিকাল" ? e + 12 : e;
      }, meridiem: function(e, s, d) {
      ...
      }, meridiemParse: /མཚན་མོ|ཞོགས་ཀས|ཉིན་གུང|དགོང་དག|མཚན་མོ/, meridiemHour: function(e, s) {
        return e === 12 && (e = 0), s === "མཚན་མོ" && e >= 4 || s === "ཉིན་གུང" && e < 5 || s === "དགོང་དག" ? e + 12 : e;
      }, meridiem: function(e, s, d) {
      ...
      function Wi(e, s, d, m) {
        switch (d) {
          case "m":
            return s ? "jedna minuta" : m ? "jednu minutu" : "jedne minute";
        }
      }
      function cn(e, s, d) {
        var m = e + " ";
      ...
      }, sameElse: "L" }, relativeTime: { future: "d'aquí %s", past: "fa %s", s: "uns segons", ss: "%d segons", m: "un minut", mm: "%d minuts", h: "una hora", hh: "%d hores", d: "un dia", dd: "%d dies", M: "un mes", MM: "%d mesos", y: "un any", yy: "%d anys" }, dayOfMonthOrdinalParse: /\d{1,2}(r|n|t|è|a)/, ordinal: function(e, s) {
        var d = e === 1 ? "r" : e === 2 ? "n" : e === 3 ? "r" : e === 4 ? "t" : "è";
        return (s === "w" || s === "W") && (d = "a"), e + d;
      }, week: { dow: 1, doy: 4 } });
      ...
      function Ht(e, s, d, m) {
        ...
        switch (d) {
          case "s":
            return s || m ? "pár sekund" : "pár sekundami";
          case "ss":
            return s || m ? h + (Et(e) ? "sekundy" : "sekund") : h + "sekundami";
          case "m":
            return s ? "minuta" : m ? "minutu" : "minutou";
          case "mm":
            return s || m ? h + (Et(e) ? "minuty" : "minut") : h + "minutami";
          case "h":
            return s ? "hodina" : m ? "hodinu" : "hodinou";
          case "hh":
            return s || m ? h + (Et(e) ? "hodiny" : "hodin") : h + "hodinami";
          case "d":
            return s || m ? "den" : "dnem";
          case "dd":
            return s || m ? h + (Et(e) ? "dny" : "dní") : h + "dny";
          case "M":
            return s || m ? "měsíc" : "měsícem";
          case "MM":
            return s || m ? h + (Et(e) ? "měsíce" : "měsíců") : h + "měsíci";
          case "y":
            return s || m ? "rok" : "rokem";
          case "yy":
            return s || m ? h + (Et(e) ? "roky" : "let") : h + "lety";
        }
      }
      ...
      }, sameElse: "L" }, relativeTime: { future: "za %s", past: "před %s", s: Ht, ss: Ht, m: Ht, mm: Ht, h: Ht, hh: Ht, d: Ht, dd: Ht, M: Ht, MM: Ht, y: Ht, yy: Ht }, dayOfMonthOrdinalParse: /\d{1,2}\./, ordinal: "%d.", week: { dow: 1, doy: 4 } });
      l.defineLocale("cv", { months: "кӑрлач_нарӑс_пуш_ака_май_ҫӗртме_утӑ_ҫурла_авӑн_юпа_чӳк_раштав".split("_"), monthsShort: "кӑр_нар_пуш_ака_май_ҫӗр_утӑ_ҫур_авн_юпа_чӳк_раш".split("_"), weekdays: "вырсарникун_тунтикун_ытларикун_юнкун_кӗҫнерникун_эрнекун_шӑматкун".split("_"), weekdaysShort: "выр_тун_ытл_юн_кӗҫ_эрн_шӑм".split("_"), weekdaysMin: "вр_тн_ыт_юн_кҫ_эр_шм".split("_"), longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD-MM-YYYY", LL: "YYYY [ҫулхи] MMMM [уйӑхӗн] D[-мӗшӗ]", LLL: "YYYY [ҫулхи] MMMM [уйӑхӗн] D[-мӗшӗ], HH:mm", LLLL: "dddd, YYYY [ҫулхи] MMMM [уйӑхӗн] D[-мӗшӗ], HH:mm" }, calendar: { sameDay: "[Паян] LT [сехетре]", nextDay: "[Ыран] LT [сехетре]", lastDay: "[Ӗнер] LT [сехетре]", nextWeek: "[Ҫитес] dddd LT [сехетре]", lastWeek: "[Иртнӗ] dddd LT [сехетре]", sameElse: "L" }, relativeTime: { future: function(e) {
        var s = /сехет$/i.exec(e) ? "рен" : /ҫул$/i.exec(e) ? "тан" : "ран";
        return e + s;
      ...
      l.defineLocale("cy", { months: "Ionawr_Chwefror_Mawrth_Ebrill_Mai_Mehefin_Gorffennaf_Awst_Medi_Hydref_Tachwedd_Rhagfyr".split("_"), monthsShort: "Ion_Chwe_Maw_Ebr_Mai_Meh_Gor_Aws_Med_Hyd_Tach_Rhag".split("_"), weekdays: "Dydd Sul_Dydd Llun_Dydd Mawrth_Dydd Mercher_Dydd Iau_Dydd Gwener_Dydd Sadwrn".split("_"), weekdaysShort: "Sul_Llun_Maw_Mer_Iau_Gwe_Sad".split("_"), weekdaysMin: "Su_Ll_Ma_Me_Ia_Gw_Sa".split("_"), weekdaysParseExact: true, longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD/MM/YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY HH:mm", LLLL: "dddd, D MMMM YYYY HH:mm" }, calendar: { sameDay: "[Heddiw am] LT", nextDay: "[Yfory am] LT", nextWeek: "dddd [am] LT", lastDay: "[Ddoe am] LT", lastWeek: "dddd [diwethaf am] LT", sameElse: "L" }, relativeTime: { future: "mewn %s", past: "%s yn ôl", s: "ychydig eiliadau", ss: "%d eiliad", m: "munud", mm: "%d munud", h: "awr", hh: "%d awr", d: "diwrnod", dd: "%d diwrnod", M: "mis", MM: "%d mis", y: "blwyddyn", yy: "%d flynedd" }, dayOfMonthOrdinalParse: /\d{1,2}(fed|ain|af|il|ydd|ed|eg)/, ordinal: function(e) {
        var s = e, d = "", m = ["", "af", "il", "ydd", "ydd", "ed", "ed", "ed", "fed", "fed", "fed", "eg", "fed", "eg", "eg", "fed", "eg", "eg", "fed", "eg", "fed"];
        return s > 20 ? s === 40 || s === 50 || s === 60 || s === 80 || s === 100 ? d = "fed" : d = "ain" : s > 0 && (d = m[s]), e + d;
      }, week: { dow: 1, doy: 4 } });
      ...
      l.defineLocale("el", { monthsNominativeEl: "Ιανουάριος_Φεβρουάριος_Μάρτιος_Απρίλιος_Μάιος_Ιούνιος_Ιούλιος_Αύγουστος_Σεπτέμβριος_Οκτώβριος_Νοέμβριος_Δεκέμβριος".split("_"), monthsGenitiveEl: "Ιανουαρίου_Φεβρουαρίου_Μαρτίου_Απριλίου_Μαΐου_Ιουνίου_Ιουλίου_Αυγούστου_Σεπτεμβρίου_Οκτωβρίου_Νοεμβρίου_Δεκεμβρίου".split("_"), months: function(e, s) {
        return e ? typeof s == "string" && /D/.test(s.substring(0, s.indexOf("MMMM"))) ? this._monthsGenitiveEl[e.month()] : this._monthsNominativeEl[e.month()] : this._monthsNominativeEl;
      }, monthsShort: "Ιαν_Φεβ_Μαρ_Απρ_Μαϊ_Ιουν_Ιουλ_Αυγ_Σεπ_Οκτ_Νοε_Δεκ".split("_"), weekdays: "Κυριακή_Δευτέρα_Τρίτη_Τετάρτη_Πέμπτη_Παρασκευή_Σάββατο".split("_"), weekdaysShort: "Κυρ_Δευ_Τρι_Τετ_Πεμ_Παρ_Σαβ".split("_"), weekdaysMin: "Κυ_Δε_Τρ_Τε_Πε_Πα_Σα".split("_"), meridiem: function(e, s, d) {
      ...
      }, sameElse: "L" }, calendar: function(e, s) {
        var d = this._calendarEl[e], m = s && s.hours();
        return nd(d) && (d = d.apply(s)), d.replace("{}", m % 12 === 1 ? "στη" : "στις");
      ...
      l.defineLocale("en-au", { months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), monthsShort: "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), weekdaysShort: "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), weekdaysMin: "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), longDateFormat: { LT: "h:mm A", LTS: "h:mm:ss A", L: "DD/MM/YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY h:mm A", LLLL: "dddd, D MMMM YYYY h:mm A" }, calendar: { sameDay: "[Today at] LT", nextDay: "[Tomorrow at] LT", nextWeek: "dddd [at] LT", lastDay: "[Yesterday at] LT", lastWeek: "[Last] dddd [at] LT", sameElse: "L" }, relativeTime: { future: "in %s", past: "%s ago", s: "a few seconds", ss: "%d seconds", m: "a minute", mm: "%d minutes", h: "an hour", hh: "%d hours", d: "a day", dd: "%d days", M: "a month", MM: "%d months", y: "a year", yy: "%d years" }, dayOfMonthOrdinalParse: /\d{1,2}(st|nd|rd|th)/, ordinal: function(e) {
        var s = e % 10, d = ~~(e % 100 / 10) === 1 ? "th" : s === 1 ? "st" : s === 2 ? "nd" : s === 3 ? "rd" : "th";
        return e + d;
      }, week: { dow: 0, doy: 4 } });
      ...
      l.defineLocale("es-do", { months: "enero_febrero_marzo_abril_mayo_junio_julio_agosto_septiembre_octubre_noviembre_diciembre".split("_"), monthsShort: function(e, s) {
        return e ? /-MMM-/.test(s) ? uc[e.month()] : Vi[e.month()] : Vi;
      ...
      l.defineLocale("es-mx", { months: "enero_febrero_marzo_abril_mayo_junio_julio_agosto_septiembre_octubre_noviembre_diciembre".split("_"), monthsShort: function(e, s) {
        return e ? /-MMM-/.test(s) ? Ls[e.month()] : ct[e.month()] : ct;
      ...
      l.defineLocale("es-us", { months: "enero_febrero_marzo_abril_mayo_junio_julio_agosto_septiembre_octubre_noviembre_diciembre".split("_"), monthsShort: function(e, s) {
        return e ? /-MMM-/.test(s) ? fa[e.month()] : Qa[e.month()] : Qa;
      ...
      l.defineLocale("es", { months: "enero_febrero_marzo_abril_mayo_junio_julio_agosto_septiembre_octubre_noviembre_diciembre".split("_"), monthsShort: function(e, s) {
        return e ? /-MMM-/.test(s) ? id[e.month()] : rd[e.month()] : rd;
      ...
      function is(e, s, d, m) {
        ...
        return s ? h[d][2] ? h[d][2] : h[d][1] : m ? h[d][0] : h[d][1];
      }
      ...
      l.defineLocale("fa", { months: "ژانویه_فوریه_مارس_آوریل_مه_ژوئن_ژوئیه_اوت_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"), monthsShort: "ژانویه_فوریه_مارس_آوریل_مه_ژوئن_ژوئیه_اوت_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"), weekdays: "یک‌شنبه_دوشنبه_سه‌شنبه_چهارشنبه_پنج‌شنبه_جمعه_شنبه".split("_"), weekdaysShort: "یک‌شنبه_دوشنبه_سه‌شنبه_چهارشنبه_پنج‌شنبه_جمعه_شنبه".split("_"), weekdaysMin: "ی_د_س_چ_پ_ج_ش".split("_"), weekdaysParseExact: true, longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD/MM/YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY HH:mm", LLLL: "dddd, D MMMM YYYY HH:mm" }, meridiemParse: /قبل از ظهر|بعد از ظهر/, isPM: function(e) {
        ...
        return e.replace(/[۰-۹]/g, function(s) {
          return ld[s];
        }).replace(/،/g, ",");
      }, postformat: function(e) {
        return e.replace(/\d/g, function(s) {
      ...
      var Fn = "nolla yksi kaksi kolme neljä viisi kuusi seitsemän kahdeksan yhdeksän".split(" "), dd = ["nolla", "yhden", "kahden", "kolmen", "neljän", "viiden", "kuuden", Fn[7], Fn[8], Fn[9]];
      function gt(e, s, d, m) {
        var h = "";
        switch (d) {
          case "s":
      ...
      l.defineLocale("fy", { months: "jannewaris_febrewaris_maart_april_maaie_juny_july_augustus_septimber_oktober_novimber_desimber".split("_"), monthsShort: function(e, s) {
        return e ? /-MMM-/.test(s) ? to[e.month()] : eo[e.month()] : eo;
      ...
      }, week: { dow: 0, doy: 3 }, meridiemParse: /राती|सकाळीं|दनपारां|सांजे/, meridiemHour: function(e, s) {
        if (e === 12 && (e = 0), s === "राती") return e < 4 ? e : e + 12;
        if (s === "सकाळीं") return e;
        if (s === "दनपारां") return e > 12 ? e : e + 12;
      ...
      }, week: { dow: 0, doy: 3 }, meridiemParse: /rati|sokallim|donparam|sanje/, meridiemHour: function(e, s) {
      ...
      }, meridiemParse: /રાત|બપોર|સવાર|સાંજ/, meridiemHour: function(e, s) {
        if (e === 12 && (e = 0), s === "રાત") return e < 4 ? e : e + 12;
        if (s === "સવાર") return e;
      ...
      }, meridiemParse: /रात|सुबह|दोपहर|शाम/, meridiemHour: function(e, s) {
        if (e === 12 && (e = 0), s === "रात") return e < 4 ? e : e + 12;
        if (s === "सुबह") return e;
        if (s === "दोपहर") return e >= 10 ? e : e + 12;
      ...
      function Lt(e, s, d, m) {
        ...
        switch (d) {
          case "s":
            return m || s ? "néhány másodperc" : "néhány másodperce";
          case "ss":
            return h + (m || s) ? " másodperc" : " másodperce";
          case "m":
            return "egy" + (m || s ? " perc" : " perce");
          case "mm":
            return h + (m || s ? " perc" : " perce");
          case "h":
            return "egy" + (m || s ? " óra" : " órája");
          case "hh":
            return h + (m || s ? " óra" : " órája");
          case "d":
            return "egy" + (m || s ? " nap" : " napja");
          case "dd":
            return h + (m || s ? " nap" : " napja");
          case "M":
            return "egy" + (m || s ? " hónap" : " hónapja");
          case "MM":
            return h + (m || s ? " hónap" : " hónapja");
          case "y":
            return "egy" + (m || s ? " év" : " éve");
          case "yy":
            return h + (m || s ? " év" : " éve");
        }
        return "";
      ...
      }, dayOfMonthOrdinalParse: /\d{1,2}|\d{1,2}-(ին|րդ)/, ordinal: function(e, s) {
        switch (s) {
          case "DDD":
          case "w":
          case "W":
      ...
      function os(e, s, d, m) {
        ...
        switch (d) {
          case "s":
            return s || m ? "nokkrar sekúndur" : "nokkrum sekúndum";
          case "ss":
            return We(e) ? h + (s || m ? "sekúndur" : "sekúndum") : h + "sekúnda";
          case "m":
            return s ? "mínúta" : "mínútu";
          case "mm":
            return We(e) ? h + (s || m ? "mínútur" : "mínútum") : s ? h + "mínúta" : h + "mínútu";
          case "hh":
            return We(e) ? h + (s || m ? "klukkustundir" : "klukkustundum") : h + "klukkustund";
          case "d":
            return s ? "dagur" : m ? "dag" : "degi";
          case "dd":
            return We(e) ? s ? h + "dagar" : h + (m ? "daga" : "dögum") : s ? h + "dagur" : h + (m ? "dag" : "degi");
          case "M":
            return s ? "mánuður" : m ? "mánuð" : "mánuði";
          case "MM":
            return We(e) ? s ? h + "mánuðir" : h + (m ? "mánuði" : "mánuðum") : s ? h + "mánuður" : h + (m ? "mánuð" : "mánuði");
          case "y":
            return s || m ? "ár" : "ári";
          case "yy":
            return We(e) ? h + (s || m ? "ár" : "árum") : h + (s || m ? "ár" : "ári");
        }
      }
      ...
      }, sameElse: "L" }, dayOfMonthOrdinalParse: /\d{1,2}日/, ordinal: function(e, s) {
        switch (s) {
          case "y":
            return e === 1 ? "元年" : e + "年";
          case "d":
      ...
      l.defineLocale("ka", { months: "იანვარი_თებერვალი_მარტი_აპრილი_მაისი_ივნისი_ივლისი_აგვისტო_სექტემბერი_ოქტომბერი_ნოემბერი_დეკემბერი".split("_"), monthsShort: "იან_თებ_მარ_აპრ_მაი_ივნ_ივლ_აგვ_სექ_ოქტ_ნოე_დეკ".split("_"), weekdays: { standalone: "კვირა_ორშაბათი_სამშაბათი_ოთხშაბათი_ხუთშაბათი_პარასკევი_შაბათი".split("_"), format: "კვირას_ორშაბათს_სამშაბათს_ოთხშაბათს_ხუთშაბათს_პარასკევს_შაბათს".split("_"), isFormat: /(წინა|შემდეგ)/ }, weekdaysShort: "კვი_ორშ_სამ_ოთხ_ხუთ_პარ_შაბ".split("_"), weekdaysMin: "კვ_ორ_სა_ოთ_ხუ_პა_შა".split("_"), longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD/MM/YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY HH:mm", LLLL: "dddd, D MMMM YYYY HH:mm" }, calendar: { sameDay: "[დღეს] LT[-ზე]", nextDay: "[ხვალ] LT[-ზე]", lastDay: "[გუშინ] LT[-ზე]", nextWeek: "[შემდეგ] dddd LT[-ზე]", lastWeek: "[წინა] dddd LT-ზე", sameElse: "L" }, relativeTime: { future: function(e) {
        return e.replace(/(წამ|წუთ|საათ|წელ|დღ|თვ)(ი|ე)/, function(s, d, m) {
      ...
      l.defineLocale("kk", { months: "қаңтар_ақпан_наурыз_сәуір_мамыр_маусым_шілде_тамыз_қыркүйек_қазан_қараша_желтоқсан".split("_"), monthsShort: "қаң_ақп_нау_сәу_мам_мау_шіл_там_қыр_қаз_қар_жел".split("_"), weekdays: "жексенбі_дүйсенбі_сейсенбі_сәрсенбі_бейсенбі_жұма_сенбі".split("_"), weekdaysShort: "жек_дүй_сей_сәр_бей_жұм_сен".split("_"), weekdaysMin: "жк_дй_сй_ср_бй_жм_сн".split("_"), longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD.MM.YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY HH:mm", LLLL: "dddd, D MMMM YYYY HH:mm" }, calendar: { sameDay: "[Бүгін сағат] LT", nextDay: "[Ертең сағат] LT", nextWeek: "dddd [сағат] LT", lastDay: "[Кеше сағат] LT", lastWeek: "[Өткен аптаның] dddd [сағат] LT", sameElse: "L" }, relativeTime: { future: "%s ішінде", past: "%s бұрын", s: "бірнеше секунд", ss: "%d секунд", m: "бір минут", mm: "%d минут", h: "бір сағат", hh: "%d сағат", d: "бір күн", dd: "%d күн", M: "бір ай", MM: "%d ай", y: "бір жыл", yy: "%d жыл" }, dayOfMonthOrdinalParse: /\d{1,2}-(ші|шы)/, ordinal: function(e) {
        var s = e % 10, d = e >= 100 ? 100 : null;
        return e + (ro[e] || ro[s] || ro[d]);
      }, week: { dow: 1, doy: 7 } });
      ...
      }, meridiemParse: /ರಾತ್ರಿ|ಬೆಳಿಗ್ಗೆ|ಮಧ್ಯಾಹ್ನ|ಸಂಜೆ/, meridiemHour: function(e, s) {
        if (e === 12 && (e = 0), s === "ರಾತ್ರಿ") return e < 4 ? e : e + 12;
        if (s === "ಬೆಳಿಗ್ಗೆ") return e;
        if (s === "ಮಧ್ಯಾಹ್ನ") return e >= 10 ? e : e + 12;
      ...
      function wc(e) {
        e = "" + e;
        var s = e.substring(e.length - 1), d = e.length > 1 ? e.substring(e.length - 2) : "";
        return !(d == 12 || d == 13) && (s == "2" || s == "3" || d == "50" || s == "70" || s == "80") ? "yê" : "ê";
      }
      l.defineLocale("ku-kmr", { months: "Rêbendan_Sibat_Adar_Nîsan_Gulan_Hezîran_Tîrmeh_Tebax_Îlon_Cotmeh_Mijdar_Berfanbar".split("_"), monthsShort: "Rêb_Sib_Ada_Nîs_Gul_Hez_Tîr_Teb_Îlo_Cot_Mij_Ber".split("_"), monthsParseExact: true, weekdays: "Yekşem_Duşem_Sêşem_Çarşem_Pêncşem_În_Şemî".split("_"), weekdaysShort: "Yek_Du_Sê_Çar_Pên_În_Şem".split("_"), weekdaysMin: "Ye_Du_Sê_Ça_Pê_În_Şe".split("_"), meridiem: function(e, s, d) {
        return e < 12 ? d ? "bn" : "BN" : d ? "pn" : "PN";
      }, meridiemParse: /bn|BN|pn|PN/, longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD.MM.YYYY", LL: "Do MMMM[a] YYYY[an]", LLL: "Do MMMM[a] YYYY[an] HH:mm", LLLL: "dddd, Do MMMM[a] YYYY[an] HH:mm", ll: "Do MMM[.] YYYY[an]", lll: "Do MMM[.] YYYY[an] HH:mm", llll: "ddd[.], Do MMM[.] YYYY[an] HH:mm" }, calendar: { sameDay: "[Îro di saet] LT [de]", nextDay: "[Sibê di saet] LT [de]", nextWeek: "dddd [di saet] LT [de]", lastDay: "[Duh di saet] LT [de]", lastWeek: "dddd[a borî di saet] LT [de]", sameElse: "L" }, relativeTime: { future: "di %s de", past: "berî %s", s: kt, ss: kt, m: kt, mm: kt, h: kt, hh: kt, d: kt, dd: kt, w: kt, ww: kt, M: kt, MM: kt, y: kt, yy: kt }, dayOfMonthOrdinalParse: /\d{1,2}(?:yê|ê|\.)/, ordinal: function(e, s) {
        var d = s.toLowerCase();
      ...
      function Mc(e) {
        ...
        return ks(s) ? "a " + e : "an " + e;
      }
      function Lc(e) {
        var s = e.substr(0, e.indexOf(" "));
        return ks(s) ? "viru " + e : "virun " + e;
      }
      function ks(e) {
      ...
      } }, relativeTime: { future: Mc, past: Lc, s: "e puer Sekonnen", ss: "%d Sekonnen", m: xn, mm: "%d Minutten", h: xn, hh: "%d Stonnen", d: xn, dd: "%d Deeg", M: xn, MM: "%d Méint", y: xn, yy: "%d Joer" }, dayOfMonthOrdinalParse: /\d{1,2}\./, ordinal: "%d.", week: { dow: 1, doy: 4 } });
      ...
      function pd(e, s, d, m) {
        return s ? "kelios sekundės" : m ? "kelių sekundžių" : "kelias sekundes";
      }
      function va(e, s, d, m) {
        return s ? hn(d)[0] : m ? hn(d)[1] : hn(d)[2];
      }
      function yd(e) {
      ...
      function wa(e, s, d, m) {
        var h = e + " ";
        return e === 1 ? h + va(e, s, d[0], m) : s ? h + (yd(e) ? hn(d)[1] : hn(d)[0]) : m ? h + hn(d)[1] : h + (yd(e) ? hn(d)[1] : hn(d)[2]);
      }
      ...
      function lo(e, s, d) {
        return d ? s % 10 === 1 && s % 100 !== 11 ? e[2] : e[3] : s % 10 === 1 && s % 100 !== 11 ? e[0] : e[1];
      }
      function Ma(e, s, d) {
        return e + " " + lo(oo[d], e, s);
      }
      function Nn(e, s, d) {
        return lo(oo[d], e, s);
      }
      ...
      l.defineLocale("lv", { months: "janvāris_februāris_marts_aprīlis_maijs_jūnijs_jūlijs_augusts_septembris_oktobris_novembris_decembris".split("_"), monthsShort: "jan_feb_mar_apr_mai_jūn_jūl_aug_sep_okt_nov_dec".split("_"), weekdays: "svētdiena_pirmdiena_otrdiena_trešdiena_ceturtdiena_piektdiena_sestdiena".split("_"), weekdaysShort: "Sv_P_O_T_C_Pk_S".split("_"), weekdaysMin: "Sv_P_O_T_C_Pk_S".split("_"), weekdaysParseExact: true, longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD.MM.YYYY.", LL: "YYYY. [gada] D. MMMM", LLL: "YYYY. [gada] D. MMMM, HH:mm", LLLL: "YYYY. [gada] D. MMMM, dddd, HH:mm" }, calendar: { sameDay: "[Šodien pulksten] LT", nextDay: "[Rīt pulksten] LT", nextWeek: "dddd [pulksten] LT", lastDay: "[Vakar pulksten] LT", lastWeek: "[Pagājušā] dddd [pulksten] LT", sameElse: "L" }, relativeTime: { future: "pēc %s", past: "pirms %s", s: vd, ss: Ma, m: Nn, mm: Ma, h: Nn, hh: Ma, d: Nn, dd: Ma, M: Nn, MM: Ma, y: Nn, yy: Ma }, dayOfMonthOrdinalParse: /\d{1,2}\./, ordinal: "%d.", week: { dow: 1, doy: 4 } });
      var Tt = { words: { ss: ["sekund", "sekunda", "sekundi"], m: ["jedan minut", "jednog minuta"], mm: ["minut", "minuta", "minuta"], h: ["jedan sat", "jednog sata"], hh: ["sat", "sata", "sati"], dd: ["dan", "dana", "dana"], MM: ["mjesec", "mjeseca", "mjeseci"], yy: ["godina", "godine", "godina"] }, correctGrammaticalCase: function(e, s) {
        return e === 1 ? s[0] : e >= 2 && e <= 4 ? s[1] : s[2];
      }, translate: function(e, s, d) {
        var m = Tt.words[d];
        return d.length === 1 ? s ? m[0] : m[1] : e + " " + Tt.correctGrammaticalCase(e, m);
      } };
      ...
      function Dt(e, s, d, m) {
        switch (d) {
          case "s":
            return s ? "хэдхэн секунд" : "хэдхэн секундын";
          case "ss":
            return e + (s ? " секунд" : " секундын");
          case "m":
          case "mm":
            return e + (s ? " минут" : " минутын");
          case "h":
          case "hh":
            return e + (s ? " цаг" : " цагийн");
          case "d":
          case "dd":
            return e + (s ? " өдөр" : " өдрийн");
          case "M":
          case "MM":
            return e + (s ? " сар" : " сарын");
          case "y":
          case "yy":
            return e + (s ? " жил" : " жилийн");
          default:
            return e;
        }
      }
      l.defineLocale("mn", { months: "Нэгдүгээр сар_Хоёрдугаар сар_Гуравдугаар сар_Дөрөвдүгээр сар_Тавдугаар сар_Зургадугаар сар_Долдугаар сар_Наймдугаар сар_Есдүгээр сар_Аравдугаар сар_Арван нэгдүгээр сар_Арван хоёрдугаар сар".split("_"), monthsShort: "1 сар_2 сар_3 сар_4 сар_5 сар_6 сар_7 сар_8 сар_9 сар_10 сар_11 сар_12 сар".split("_"), monthsParseExact: true, weekdays: "Ням_Даваа_Мягмар_Лхагва_Пүрэв_Баасан_Бямба".split("_"), weekdaysShort: "Ням_Дав_Мяг_Лха_Пүр_Баа_Бям".split("_"), weekdaysMin: "Ня_Да_Мя_Лх_Пү_Ба_Бя".split("_"), weekdaysParseExact: true, longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "YYYY-MM-DD", LL: "YYYY оны MMMMын D", LLL: "YYYY оны MMMMын D HH:mm", LLLL: "dddd, YYYY оны MMMMын D HH:mm" }, meridiemParse: /ҮӨ|ҮХ/i, isPM: function(e) {
        ...
        return e < 12 ? "ҮӨ" : "ҮХ";
      }, calendar: { sameDay: "[Өнөөдөр] LT", nextDay: "[Маргааш] LT", nextWeek: "[Ирэх] dddd LT", lastDay: "[Өчигдөр] LT", lastWeek: "[Өнгөрсөн] dddd LT", sameElse: "L" }, relativeTime: { future: "%s дараа", past: "%s өмнө", s: Dt, ss: Dt, m: Dt, mm: Dt, h: Dt, hh: Dt, d: Dt, dd: Dt, M: Dt, MM: Dt, y: Dt, yy: Dt }, dayOfMonthOrdinalParse: /\d{1,2} өдөр/, ordinal: function(e, s) {
        switch (s) {
          case "d":
          case "D":
          case "DDD":
      ...
      }, meridiemParse: /पहाटे|सकाळी|दुपारी|सायंकाळी|रात्री/, meridiemHour: function(e, s) {
        if (e === 12 && (e = 0), s === "पहाटे" || s === "सकाळी") return e;
        if (s === "दुपारी" || s === "सायंकाळी" || s === "रात्री") return e >= 12 ? e : e + 12;
      }, meridiem: function(e, s, d) {
      ...
      var An = { 1: "१", 2: "२", 3: "३", 4: "४", 5: "५", 6: "६", 7: "७", 8: "८", 9: "९", 0: "०" }, kc = { "१": "1", "२": "2", "३": "3", "४": "4", "५": "5", "६": "6", "७": "7", "८": "8", "९": "9", "०": "0" };
      ...
      }, meridiemParse: /राति|बिहान|दिउँसो|साँझ/, meridiemHour: function(e, s) {
        if (e === 12 && (e = 0), s === "राति") return e < 4 ? e : e + 12;
        if (s === "बिहान") return e;
        if (s === "दिउँसो") return e >= 10 ? e : e + 12;
      ...
      l.defineLocale("nl-be", { months: "januari_februari_maart_april_mei_juni_juli_augustus_september_oktober_november_december".split("_"), monthsShort: function(e, s) {
        return e ? /-MMM-/.test(s) ? Tc[e.month()] : mo[e.month()] : mo;
      ...
      l.defineLocale("nl", { months: "januari_februari_maart_april_mei_juni_juli_augustus_september_oktober_november_december".split("_"), monthsShort: function(e, s) {
        return e ? /-MMM-/.test(s) ? Dc[e.month()] : Td[e.month()] : Td;
      ...
      }, meridiemParse: /ਰਾਤ|ਸਵੇਰ|ਦੁਪਹਿਰ|ਸ਼ਾਮ/, meridiemHour: function(e, s) {
        if (e === 12 && (e = 0), s === "ਰਾਤ") return e < 4 ? e : e + 12;
        if (s === "ਸਵੇਰ") return e;
        if (s === "ਦੁਪਹਿਰ") return e >= 10 ? e : e + 12;
      ...
      function $s(e, s, d) {
        ...
        switch (d) {
          case "ss":
            return m + (En(e) ? "sekundy" : "sekund");
          case "m":
            return s ? "minuta" : "minutę";
          case "mm":
            return m + (En(e) ? "minuty" : "minut");
          case "h":
            return s ? "godzina" : "godzinę";
          case "hh":
            return m + (En(e) ? "godziny" : "godzin");
          case "ww":
            return m + (En(e) ? "tygodnie" : "tygodni");
          case "MM":
            return m + (En(e) ? "miesiące" : "miesięcy");
          case "yy":
            return m + (En(e) ? "lata" : "lat");
        }
      }
      l.defineLocale("pl", { months: function(e, s) {
        return e ? /D MMMM/.test(s) ? bc[e.month()] : Yd[e.month()] : Yd;
      ...
      }, dayOfMonthOrdinalParse: /\d{1,2}-(й|го|я)/, ordinal: function(e, s) {
        switch (s) {
          case "M":
          case "d":
          case "DDD":
      ...
      function Gt(e, s, d, m) {
        ...
        switch (d) {
          case "s":
            return s || m ? "pár sekúnd" : "pár sekundami";
          case "ss":
            return s || m ? h + (La(e) ? "sekundy" : "sekúnd") : h + "sekundami";
          case "m":
            return s ? "minúta" : m ? "minútu" : "minútou";
          case "mm":
            return s || m ? h + (La(e) ? "minúty" : "minút") : h + "minútami";
          case "h":
            return s ? "hodina" : m ? "hodinu" : "hodinou";
          case "hh":
            return s || m ? h + (La(e) ? "hodiny" : "hodín") : h + "hodinami";
          case "d":
            return s || m ? "deň" : "dňom";
          case "dd":
            return s || m ? h + (La(e) ? "dni" : "dní") : h + "dňami";
          case "M":
            return s || m ? "mesiac" : "mesiacom";
          case "MM":
            return s || m ? h + (La(e) ? "mesiace" : "mesiacov") : h + "mesiacmi";
          case "y":
            return s || m ? "rok" : "rokom";
          case "yy":
            return s || m ? h + (La(e) ? "roky" : "rokov") : h + "rokmi";
        }
      }
      ...
      function Oe(e, s, d, m) {
        ...
        switch (d) {
          case "s":
            return s || m ? "nekaj sekund" : "nekaj sekundami";
          case "ss":
            return e === 1 ? h += s ? "sekundo" : "sekundi" : e === 2 ? h += s || m ? "sekundi" : "sekundah" : e < 5 ? h += s || m ? "sekunde" : "sekundah" : h += "sekund", h;
          case "m":
            return s ? "ena minuta" : "eno minuto";
          case "mm":
            return e === 1 ? h += s ? "minuta" : "minuto" : e === 2 ? h += s || m ? "minuti" : "minutama" : e < 5 ? h += s || m ? "minute" : "minutami" : h += s || m ? "minut" : "minutami", h;
          case "h":
            return s ? "ena ura" : "eno uro";
          case "hh":
            return e === 1 ? h += s ? "ura" : "uro" : e === 2 ? h += s || m ? "uri" : "urama" : e < 5 ? h += s || m ? "ure" : "urami" : h += s || m ? "ur" : "urami", h;
          case "d":
            return s || m ? "en dan" : "enim dnem";
          case "dd":
            return e === 1 ? h += s || m ? "dan" : "dnem" : e === 2 ? h += s || m ? "dni" : "dnevoma" : h += s || m ? "dni" : "dnevi", h;
          case "M":
            return s || m ? "en mesec" : "enim mesecem";
          case "MM":
            return e === 1 ? h += s || m ? "mesec" : "mesecem" : e === 2 ? h += s || m ? "meseca" : "mesecema" : e < 5 ? h += s || m ? "mesece" : "meseci" : h += s || m ? "mesecev" : "meseci", h;
          case "y":
            return s || m ? "eno leto" : "enim letom";
          case "yy":
            return e === 1 ? h += s || m ? "leto" : "letom" : e === 2 ? h += s || m ? "leti" : "letoma" : e < 5 ? h += s || m ? "leta" : "leti" : h += s || m ? "let" : "leti", h;
        }
      }
      ...
      }, sameElse: "L" }, relativeTime: { future: "čez %s", past: "pred %s", s: Oe, ss: Oe, m: Oe, mm: Oe, h: Oe, hh: Oe, d: Oe, dd: Oe, M: Oe, MM: Oe, y: Oe, yy: Oe }, dayOfMonthOrdinalParse: /\d{1,2}\./, ordinal: "%d.", week: { dow: 1, doy: 7 } });
      ...
      var Pt = { words: { ss: ["секунда", "секунде", "секунди"], m: ["један минут", "једног минута"], mm: ["минут", "минута", "минута"], h: ["један сат", "једног сата"], hh: ["сат", "сата", "сати"], d: ["један дан", "једног дана"], dd: ["дан", "дана", "дана"], M: ["један месец", "једног месеца"], MM: ["месец", "месеца", "месеци"], y: ["једну годину", "једне године"], yy: ["годину", "године", "година"] }, correctGrammaticalCase: function(e, s) {
        return e % 10 >= 1 && e % 10 <= 4 && (e % 100 < 10 || e % 100 >= 20) ? e % 10 === 1 ? s[0] : s[1] : s[2];
      }, translate: function(e, s, d, m) {
        var h = Pt.words[d], k;
        return d.length === 1 ? d === "y" && s ? "једна година" : m || s ? h[0] : h[1] : (k = Pt.correctGrammaticalCase(e, h), d === "yy" && s && k === "годину" ? e + " година" : e + " " + k);
      } };
      l.defineLocale("sr-cyrl", { months: "јануар_фебруар_март_април_мај_јун_јул_август_септембар_октобар_новембар_децембар".split("_"), monthsShort: "јан._феб._мар._апр._мај_јун_јул_авг._сеп._окт._нов._дец.".split("_"), monthsParseExact: true, weekdays: "недеља_понедељак_уторак_среда_четвртак_петак_субота".split("_"), weekdaysShort: "нед._пон._уто._сре._чет._пет._суб.".split("_"), weekdaysMin: "не_по_ут_ср_че_пе_су".split("_"), weekdaysParseExact: true, longDateFormat: { LT: "H:mm", LTS: "H:mm:ss", L: "D. M. YYYY.", LL: "D. MMMM YYYY.", LLL: "D. MMMM YYYY. H:mm", LLLL: "dddd, D. MMMM YYYY. H:mm" }, calendar: { sameDay: "[данас у] LT", nextDay: "[сутра у] LT", nextWeek: function() {
        ...
        return e[this.day()];
      }, sameElse: "L" }, relativeTime: { future: "за %s", past: "пре %s", s: "неколико секунди", ss: Pt.translate, m: Pt.translate, mm: Pt.translate, h: Pt.translate, hh: Pt.translate, d: Pt.translate, dd: Pt.translate, M: Pt.translate, MM: Pt.translate, y: Pt.translate, yy: Pt.translate }, dayOfMonthOrdinalParse: /\d{1,2}\./, ordinal: "%d.", week: { dow: 1, doy: 7 } });
      var jt = { words: { ss: ["sekunda", "sekunde", "sekundi"], m: ["jedan minut", "jednog minuta"], mm: ["minut", "minuta", "minuta"], h: ["jedan sat", "jednog sata"], hh: ["sat", "sata", "sati"], d: ["jedan dan", "jednog dana"], dd: ["dan", "dana", "dana"], M: ["jedan mesec", "jednog meseca"], MM: ["mesec", "meseca", "meseci"], y: ["jednu godinu", "jedne godine"], yy: ["godinu", "godine", "godina"] }, correctGrammaticalCase: function(e, s) {
        return e % 10 >= 1 && e % 10 <= 4 && (e % 100 < 10 || e % 100 >= 20) ? e % 10 === 1 ? s[0] : s[1] : s[2];
      }, translate: function(e, s, d, m) {
        var h = jt.words[d], k;
        return d.length === 1 ? d === "y" && s ? "jedna godina" : m || s ? h[0] : h[1] : (k = jt.correctGrammaticalCase(e, h), d === "yy" && s && k === "godinu" ? e + " godina" : e + " " + k);
      } };
      l.defineLocale("sr", { months: "januar_februar_mart_april_maj_jun_jul_avgust_septembar_oktobar_novembar_decembar".split("_"), monthsShort: "jan._feb._mar._apr._maj_jun_jul_avg._sep._okt._nov._dec.".split("_"), monthsParseExact: true, weekdays: "nedelja_ponedeljak_utorak_sreda_četvrtak_petak_subota".split("_"), weekdaysShort: "ned._pon._uto._sre._čet._pet._sub.".split("_"), weekdaysMin: "ne_po_ut_sr_če_pe_su".split("_"), weekdaysParseExact: true, longDateFormat: { LT: "H:mm", LTS: "H:mm:ss", L: "D. M. YYYY.", LL: "D. MMMM YYYY.", LLL: "D. MMMM YYYY. H:mm", LLLL: "dddd, D. MMMM YYYY. H:mm" }, calendar: { sameDay: "[danas u] LT", nextDay: "[sutra u] LT", nextWeek: function() {
        ...
        return e[this.day()];
      }, sameElse: "L" }, relativeTime: { future: "za %s", past: "pre %s", s: "nekoliko sekundi", ss: jt.translate, m: jt.translate, mm: jt.translate, h: jt.translate, hh: jt.translate, d: jt.translate, dd: jt.translate, M: jt.translate, MM: jt.translate, y: jt.translate, yy: jt.translate }, dayOfMonthOrdinalParse: /\d{1,2}\./, ordinal: "%d.", week: { dow: 1, doy: 7 } });
      ...
      l.defineLocale("sv", { months: "januari_februari_mars_april_maj_juni_juli_augusti_september_oktober_november_december".split("_"), monthsShort: "jan_feb_mar_apr_maj_jun_jul_aug_sep_okt_nov_dec".split("_"), weekdays: "söndag_måndag_tisdag_onsdag_torsdag_fredag_lördag".split("_"), weekdaysShort: "sön_mån_tis_ons_tor_fre_lör".split("_"), weekdaysMin: "sö_må_ti_on_to_fr_lö".split("_"), longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "YYYY-MM-DD", LL: "D MMMM YYYY", LLL: "D MMMM YYYY [kl.] HH:mm", LLLL: "dddd D MMMM YYYY [kl.] HH:mm", lll: "D MMM YYYY HH:mm", llll: "ddd D MMM YYYY HH:mm" }, calendar: { sameDay: "[Idag] LT", nextDay: "[Imorgon] LT", lastDay: "[Igår] LT", nextWeek: "[På] dddd LT", lastWeek: "[I] dddd[s] LT", sameElse: "L" }, relativeTime: { future: "om %s", past: "för %s sedan", s: "några sekunder", ss: "%d sekunder", m: "en minut", mm: "%d minuter", h: "en timme", hh: "%d timmar", d: "en dag", dd: "%d dagar", M: "en månad", MM: "%d månader", y: "ett år", yy: "%d år" }, dayOfMonthOrdinalParse: /\d{1,2}(\:e|\:a)/, ordinal: function(e) {
        var s = e % 10, d = ~~(e % 100 / 10) === 1 ? ":e" : s === 1 || s === 2 ? ":a" : ":e";
        return e + d;
      }, week: { dow: 1, doy: 4 } });
      ...
      }, meridiemParse: /யாமம்|வைகறை|காலை|நண்பகல்|எற்பாடு|மாலை/, meridiem: function(e, s, d) {
        return e < 2 ? " யாமம்" : e < 6 ? " வைகறை" : e < 10 ? " காலை" : e < 14 ? " நண்பகல்" : e < 18 ? " எற்பாடு" : e < 22 ? " மாலை" : " யாமம்";
      }, meridiemHour: function(e, s) {
        return e === 12 && (e = 0), s === "யாமம்" ? e < 2 ? e : e + 12 : s === "வைகறை" || s === "காலை" || s === "நண்பகல்" && e >= 10 ? e : e + 12;
      }, week: { dow: 0, doy: 6 } });
      l.defineLocale("te", { months: "జనవరి_ఫిబ్రవరి_మార్చి_ఏప్రిల్_మే_జూన్_జులై_ఆగస్టు_సెప్టెంబర్_అక్టోబర్_నవంబర్_డిసెంబర్".split("_"), monthsShort: "జన._ఫిబ్ర._మార్చి_ఏప్రి._మే_జూన్_జులై_ఆగ._సెప్._అక్టో._నవ._డిసె.".split("_"), monthsParseExact: true, weekdays: "ఆదివారం_సోమవారం_మంగళవారం_బుధవారం_గురువారం_శుక్రవారం_శనివారం".split("_"), weekdaysShort: "ఆది_సోమ_మంగళ_బుధ_గురు_శుక్ర_శని".split("_"), weekdaysMin: "ఆ_సో_మం_బు_గు_శు_శ".split("_"), longDateFormat: { LT: "A h:mm", LTS: "A h:mm:ss", L: "DD/MM/YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY, A h:mm", LLLL: "dddd, D MMMM YYYY, A h:mm" }, calendar: { sameDay: "[నేడు] LT", nextDay: "[రేపు] LT", nextWeek: "dddd, LT", lastDay: "[నిన్న] LT", lastWeek: "[గత] dddd, LT", sameElse: "L" }, relativeTime: { future: "%s లో", past: "%s క్రితం", s: "కొన్ని క్షణాలు", ss: "%d సెకన్లు", m: "ఒక నిమిషం", mm: "%d నిమిషాలు", h: "ఒక గంట", hh: "%d గంటలు", d: "ఒక రోజు", dd: "%d రోజులు", M: "ఒక నెల", MM: "%d నెలలు", y: "ఒక సంవత్సరం", yy: "%d సంవత్సరాలు" }, dayOfMonthOrdinalParse: /\d{1,2}వ/, ordinal: "%dవ", meridiemParse: /రాత్రి|ఉదయం|మధ్యాహ్నం|సాయంత్రం/, meridiemHour: function(e, s) {
        if (e === 12 && (e = 0), s === "రాత్రి") return e < 4 ? e : e + 12;
        if (s === "ఉదయం") return e;
        if (s === "మధ్యాహ్నం") return e >= 10 ? e : e + 12;
        if (s === "సాయంత్రం") return e + 12;
      }, meridiem: function(e, s, d) {
      ...
      function Ac(e) {
        var s = e;
        return s = e.indexOf("jaj") !== -1 ? s.slice(0, -3) + "leS" : e.indexOf("jar") !== -1 ? s.slice(0, -3) + "waQ" : e.indexOf("DIS") !== -1 ? s.slice(0, -3) + "nem" : s + " pIq", s;
      }
      function po(e) {
        var s = e;
        return s = e.indexOf("jaj") !== -1 ? s.slice(0, -3) + "Hu’" : e.indexOf("jar") !== -1 ? s.slice(0, -3) + "wen" : e.indexOf("DIS") !== -1 ? s.slice(0, -3) + "ben" : s + " ret", s;
      }
      function ka(e, s, d, m) {
        var h = Ec(e);
        switch (d) {
      ...
      function Ec(e) {
        var s = Math.floor(e % 1e3 / 100), d = Math.floor(e % 100 / 10), m = e % 10, h = "";
        return s > 0 && (h += _o[s] + "vatlh"), d > 0 && (h += (h !== "" ? " " : "") + _o[d] + "maH"), m > 0 && (h += (h !== "" ? " " : "") + _o[m]), h === "" ? "pagh" : h;
      }
      ...
      l.defineLocale("tr", { months: "Ocak_Şubat_Mart_Nisan_Mayıs_Haziran_Temmuz_Ağustos_Eylül_Ekim_Kasım_Aralık".split("_"), monthsShort: "Oca_Şub_Mar_Nis_May_Haz_Tem_Ağu_Eyl_Eki_Kas_Ara".split("_"), weekdays: "Pazar_Pazartesi_Salı_Çarşamba_Perşembe_Cuma_Cumartesi".split("_"), weekdaysShort: "Paz_Pzt_Sal_Çar_Per_Cum_Cmt".split("_"), weekdaysMin: "Pz_Pt_Sa_Ça_Pe_Cu_Ct".split("_"), meridiem: function(e, s, d) {
        return e < 12 ? d ? "öö" : "ÖÖ" : d ? "ös" : "ÖS";
      }, meridiemParse: /öö|ÖÖ|ös|ÖS/, isPM: function(e) {
        return e === "ös" || e === "ÖS";
      }, longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD.MM.YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY HH:mm", LLLL: "dddd, D MMMM YYYY HH:mm" }, calendar: { sameDay: "[bugün saat] LT", nextDay: "[yarın saat] LT", nextWeek: "[gelecek] dddd [saat] LT", lastDay: "[dün] LT", lastWeek: "[geçen] dddd [saat] LT", sameElse: "L" }, relativeTime: { future: "%s sonra", past: "%s önce", s: "birkaç saniye", ss: "%d saniye", m: "bir dakika", mm: "%d dakika", h: "bir saat", hh: "%d saat", d: "bir gün", dd: "%d gün", w: "bir hafta", ww: "%d hafta", M: "bir ay", MM: "%d ay", y: "bir yıl", yy: "%d yıl" }, ordinal: function(e, s) {
        switch (s) {
          case "d":
          case "D":
          case "Do":
      ...
      l.defineLocale("ug-cn", { months: "يانۋار_فېۋرال_مارت_ئاپرېل_ماي_ئىيۇن_ئىيۇل_ئاۋغۇست_سېنتەبىر_ئۆكتەبىر_نويابىر_دېكابىر".split("_"), monthsShort: "يانۋار_فېۋرال_مارت_ئاپرېل_ماي_ئىيۇن_ئىيۇل_ئاۋغۇست_سېنتەبىر_ئۆكتەبىر_نويابىر_دېكابىر".split("_"), weekdays: "يەكشەنبە_دۈشەنبە_سەيشەنبە_چارشەنبە_پەيشەنبە_جۈمە_شەنبە".split("_"), weekdaysShort: "يە_دۈ_سە_چا_پە_جۈ_شە".split("_"), weekdaysMin: "يە_دۈ_سە_چا_پە_جۈ_شە".split("_"), longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "YYYY-MM-DD", LL: "YYYY-يىلىM-ئاينىڭD-كۈنى", LLL: "YYYY-يىلىM-ئاينىڭD-كۈنى، HH:mm", LLLL: "dddd، YYYY-يىلىM-ئاينىڭD-كۈنى، HH:mm" }, meridiemParse: /يېرىم كېچە|سەھەر|چۈشتىن بۇرۇن|چۈش|چۈشتىن كېيىن|كەچ/, meridiemHour: function(e, s) {
        return e === 12 && (e = 0), s === "يېرىم كېچە" || s === "سەھەر" || s === "چۈشتىن بۇرۇن" ? e : s === "چۈشتىن كېيىن" || s === "كەچ" ? e + 12 : e >= 11 ? e : e + 12;
      }, meridiem: function(e, s, d) {
        var m = e * 100 + s;
        return m < 600 ? "يېرىم كېچە" : m < 900 ? "سەھەر" : m < 1130 ? "چۈشتىن بۇرۇن" : m < 1230 ? "چۈش" : m < 1800 ? "چۈشتىن كېيىن" : "كەچ";
      }, calendar: { sameDay: "[بۈگۈن سائەت] LT", nextDay: "[ئەتە سائەت] LT", nextWeek: "[كېلەركى] dddd [سائەت] LT", lastDay: "[تۆنۈگۈن] LT", lastWeek: "[ئالدىنقى] dddd [سائەت] LT", sameElse: "L" }, relativeTime: { future: "%s كېيىن", past: "%s بۇرۇن", s: "نەچچە سېكونت", ss: "%d سېكونت", m: "بىر مىنۇت", mm: "%d مىنۇت", h: "بىر سائەت", hh: "%d سائەت", d: "بىر كۈن", dd: "%d كۈن", M: "بىر ئاي", MM: "%d ئاي", y: "بىر يىل", yy: "%d يىل" }, dayOfMonthOrdinalParse: /\d{1,2}(-كۈنى|-ئاي|-ھەپتە)/, ordinal: function(e, s) {
        switch (s) {
          case "d":
          case "D":
          case "DDD":
      ...
      function Pn(e, s, d) {
        var m = { ss: s ? "секунда_секунди_секунд" : "секунду_секунди_секунд", mm: s ? "хвилина_хвилини_хвилин" : "хвилину_хвилини_хвилин", hh: s ? "година_години_годин" : "годину_години_годин", dd: "день_дні_днів", MM: "місяць_місяці_місяців", yy: "рік_роки_років" };
        return d === "m" ? s ? "хвилина" : "хвилину" : d === "h" ? s ? "година" : "годину" : e + " " + Hc(m[d], +e);
      }
      function Pc(e, s) {
        ...
        return e === true ? d.nominative.slice(1, 7).concat(d.nominative.slice(0, 1)) : e ? (m = /(\[[ВвУу]\]) ?dddd/.test(s) ? "accusative" : /\[?(?:минулої|наступної)? ?\] ?dddd/.test(s) ? "genitive" : "nominative", d[m][e.day()]) : d.nominative;
      }
      function Ta(e) {
        return function() {
      ...
      }, sameElse: "L" }, relativeTime: { future: "за %s", past: "%s тому", s: "декілька секунд", ss: Pn, m: Pn, mm: Pn, h: "годину", hh: Pn, d: "день", dd: Pn, M: "місяць", MM: Pn, y: "рік", yy: Pn }, meridiemParse: /ночі|ранку|дня|вечора/, isPM: function(e) {
        return /^(дня|вечора)$/.test(e);
      }, meridiem: function(e, s, d) {
        return e < 4 ? "ночі" : e < 12 ? "ранку" : e < 17 ? "дня" : "вечора";
      }, dayOfMonthOrdinalParse: /\d{1,2}-(й|го)/, ordinal: function(e, s) {
        switch (s) {
          case "M":
          case "d":
          case "DDD":
      ...
      l.defineLocale("zh-cn", { months: "一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"), monthsShort: "1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"), weekdays: "星期日_星期一_星期二_星期三_星期四_星期五_星期六".split("_"), weekdaysShort: "周日_周一_周二_周三_周四_周五_周六".split("_"), weekdaysMin: "日_一_二_三_四_五_六".split("_"), longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "YYYY/MM/DD", LL: "YYYY年M月D日", LLL: "YYYY年M月D日Ah点mm分", LLLL: "YYYY年M月D日ddddAh点mm分", l: "YYYY/M/D", ll: "YYYY年M月D日", lll: "YYYY年M月D日 HH:mm", llll: "YYYY年M月D日dddd HH:mm" }, meridiemParse: /凌晨|早上|上午|中午|下午|晚上/, meridiemHour: function(e, s) {
        return e === 12 && (e = 0), s === "凌晨" || s === "早上" || s === "上午" ? e : s === "下午" || s === "晚上" ? e + 12 : e >= 11 ? e : e + 12;
      }, meridiem: function(e, s, d) {
        var m = e * 100 + s;
      ...
      }, sameElse: "L" }, dayOfMonthOrdinalParse: /\d{1,2}(日|月|周)/, ordinal: function(e, s) {
        switch (s) {
          case "d":
          case "D":
          case "DDD":
      ...
      l.defineLocale("zh-hk", { months: "一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"), monthsShort: "1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"), weekdays: "星期日_星期一_星期二_星期三_星期四_星期五_星期六".split("_"), weekdaysShort: "週日_週一_週二_週三_週四_週五_週六".split("_"), weekdaysMin: "日_一_二_三_四_五_六".split("_"), longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "YYYY/MM/DD", LL: "YYYY年M月D日", LLL: "YYYY年M月D日 HH:mm", LLLL: "YYYY年M月D日dddd HH:mm", l: "YYYY/M/D", ll: "YYYY年M月D日", lll: "YYYY年M月D日 HH:mm", llll: "YYYY年M月D日dddd HH:mm" }, meridiemParse: /凌晨|早上|上午|中午|下午|晚上/, meridiemHour: function(e, s) {
        if (e === 12 && (e = 0), s === "凌晨" || s === "早上" || s === "上午") return e;
        if (s === "中午") return e >= 11 ? e : e + 12;
        if (s === "下午" || s === "晚上") return e + 12;
      }, meridiem: function(e, s, d) {
        var m = e * 100 + s;
        return m < 600 ? "凌晨" : m < 900 ? "早上" : m < 1200 ? "上午" : m === 1200 ? "中午" : m < 1800 ? "下午" : "晚上";
      }, calendar: { sameDay: "[今天]LT", nextDay: "[明天]LT", nextWeek: "[下]ddddLT", lastDay: "[昨天]LT", lastWeek: "[上]ddddLT", sameElse: "L" }, dayOfMonthOrdinalParse: /\d{1,2}(日|月|週)/, ordinal: function(e, s) {
        switch (s) {
          case "d":
          case "D":
          case "DDD":
      ...
      l.defineLocale("zh-mo", { months: "一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"), monthsShort: "1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"), weekdays: "星期日_星期一_星期二_星期三_星期四_星期五_星期六".split("_"), weekdaysShort: "週日_週一_週二_週三_週四_週五_週六".split("_"), weekdaysMin: "日_一_二_三_四_五_六".split("_"), longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD/MM/YYYY", LL: "YYYY年M月D日", LLL: "YYYY年M月D日 HH:mm", LLLL: "YYYY年M月D日dddd HH:mm", l: "D/M/YYYY", ll: "YYYY年M月D日", lll: "YYYY年M月D日 HH:mm", llll: "YYYY年M月D日dddd HH:mm" }, meridiemParse: /凌晨|早上|上午|中午|下午|晚上/, meridiemHour: function(e, s) {
        if (e === 12 && (e = 0), s === "凌晨" || s === "早上" || s === "上午") return e;
        if (s === "中午") return e >= 11 ? e : e + 12;
        if (s === "下午" || s === "晚上") return e + 12;
      }, meridiem: function(e, s, d) {
        var m = e * 100 + s;
        return m < 600 ? "凌晨" : m < 900 ? "早上" : m < 1130 ? "上午" : m < 1230 ? "中午" : m < 1800 ? "下午" : "晚上";
      }, calendar: { sameDay: "[今天] LT", nextDay: "[明天] LT", nextWeek: "[下]dddd LT", lastDay: "[昨天] LT", lastWeek: "[上]dddd LT", sameElse: "L" }, dayOfMonthOrdinalParse: /\d{1,2}(日|月|週)/, ordinal: function(e, s) {
        switch (s) {
          case "d":
          case "D":
          case "DDD":
    ...
    (function(i, r) {
      ...
      r.defaults = { oldestFirst: true, text: "Toastify is awesome!", node: void 0, duration: 3e3, selector: void 0, callback: function() {
        ...
        if (typeof this.options.destination < "u" && f.addEventListener("click", function(x) {
          ...
          var H = u("x", this.options), N = u("y", this.options), q = this.options.position == "left" ? H : "-" + H, I = this.options.gravity == "toastify-top" ? N : "-" + N;
          f.style.transform = "translate(" + q + "," + I + ")";
        }
        return f;
      }, showToast: function() {
...
const lL = Kc(oL);
b_();
const dL = Zc({ __name: "NcDialogButton", props: { callback: { type: Function, default: () => {
} }, disabled: { type: Boolean, default: false }, icon: { default: void 0 }, label: {}, type: { default: "button" }, variant: { default: "tertiary" } }, emits: ["click"], setup(a, { emit: i }) {
  const r = a, l = i, u = tr(false);
  async function g(f) {
    if (!u.value) {
      u.value = true;
      try {
  ...
  return (f, p) => (qe(), Ya(qd(Vw), { "aria-label": f.label, disabled: f.disabled, type: f.type, variant: f.variant, onClick: g }, { icon: sr(() => [Js(f.$slots, "icon", {}, () => [u.value ? (qe(), Ya(qd($w), { key: 0, name: qd(S_)("Loading …") }, null, 8, ["name"])) : f.icon !== void 0 ? (qe(), Ya(qd(Gw), { key: 1, svg: f.icon }, null, 8, ["svg"])) : Cs("", true)])]), default: sr(() => [Qc(Ca(f.label) + " ", 1)]), _: 3 }, 8, ["aria-label", "disabled", "type", "variant"]));
} }), np = C_().detectLanguage();
...
Language: zu_ZA
Plural-Forms: nplurals=2; plural=(n != 1);
`] }, Undo: { msgid: "Undo", comments: { reference: "lib/toast.ts:223" }, msgstr: [""] } } } } }].map((a) => np.addTranslation(a.locale, a.json));
const sm = np.build();
sm.ngettext.bind(sm), sm.gettext.bind(sm);
Y_().setApp("@nextcloud/dialogs").detectLogLevel().build();
const mL = "off", uL = "polite", cL = "assertive";
var hg = ((a) => (a[a.OFF = mL] = "OFF", a[a.POLITE = uL] = "POLITE", a[a.ASSERTIVE = cL] = "ASSERTIVE", a))(hg || {});
const gL = 7e3;
function fg(a, i) {
  if (i = { timeout: gL, isHTML: false, type: void 0, selector: void 0, onRemove: () => {
  }, onClick: void 0, close: true, ...i }, typeof a == "string" && !i.isHTML) {
    const f = document.createElement("div");
    f.innerHTML = a, a = f.innerText;
  }
  let r = i.type ?? "";
  typeof i.onClick == "function" && (r += " toast-with-click ");
  const l = a instanceof Node;
  let u = hg.POLITE;
  i.ariaLive ? u = i.ariaLive : (i.type === "toast-error" || i.type === "toast-undo") && (u = hg.ASSERTIVE);
  const g = lL({ [l ? "node" : "text"]: a, duration: i.timeout, callback: i.onRemove, onClick: i.onClick, close: i.close, gravity: "top", selector: i.selector, position: "right", backgroundColor: "", className: "dialogs " + r, escapeMarkup: !i.isHTML, ariaLive: u });
  return g.showToast(), g;
}
function _g(a, i) {
  return fg(a, { ...i, type: "toast-error" });
}
function hL(a, i) {
  return fg(a, { ...i, type: "toast-info" });
}
function fL(a, i) {
  return fg(a, { ...i, type: "toast-success" });
}
var Do = { exports: {} };
var _L = Do.exports, ap;
function pL() {
  return ap || (ap = 1, (function(a, i) {
    (function() {
      var r, l = "4.17.21", u = 200, g = "Unsupported core-js use. Try https://npms.io/search?q=ponyfill.", f = "Expected a function", p = "Invalid `variable` option passed into `_.template`", L = "__lodash_hash_undefined__", w = 500, D = "__lodash_placeholder__", b = 1, H = 2, N = 4, q = 1, I = 2, x = 1, Q = 2, X = 4, te = 8, Z = 16, ge = 32, B = 64, V = 128, he = 256, je = 512, ke = 30, pe = "...", It = 800, Re = 16, zn = 1, Ks = 2, Fa = 3, Fs = 1 / 0, Zs = 9007199254740991, vm = 17976931348623157e292, Ct = NaN, Ut = 4294967295, or = Ut - 1, mi = Ut >>> 1, Bn = [["ary", V], ["bind", x], ["bindKey", Q], ["curry", te], ["curryRight", Z], ["flip", je], ["partial", ge], ["partialRight", B], ["rearg", he]], J = "[object Arguments]", lr = "[object Array]", wm = "[object AsyncFunction]", Qs = "[object Boolean]", Wn = "[object Date]", Mm = "[object DOMException]", dr = "[object Error]", mr = "[object Function]", Po = "[object GeneratorFunction]", es = "[object Map]", xa = "[object Number]", Lm = "[object Null]", xs = "[object Object]", jo = "[object Promise]", km = "[object Proxy]", $n = "[object RegExp]", Ie = "[object Set]", wn = "[object String]", ur = "[object Symbol]", Tm = "[object Undefined]", Gn = "[object WeakMap]", bt = "[object WeakSet]", Vn = "[object ArrayBuffer]", Xs = "[object DataView]", Jn = "[object Float32Array]", Fe = "[object Float64Array]", cr = "[object Int8Array]", gr = "[object Int16Array]", Kn = "[object Int32Array]", Na = "[object Uint8Array]", Zn = "[object Uint8ClampedArray]", en = "[object Uint16Array]", Qn = "[object Uint32Array]", Dm = /\b__p \+= '';/g, hr = /\b(__p \+=) '' \+/g, Ym = /(__e\(.*?\)|\b__t\)) \+\n'';/g, Xn = /&(?:amp|lt|gt|quot|#39);/g, Mn = /[&<>"']/g, ui = RegExp(Xn.source), fr = RegExp(Mn.source), $ = /<%-([\s\S]+?)%>/g, Cm = /<%([\s\S]+?)%>/g, qo = /<%=([\s\S]+?)%>/g, Ns = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, zt = /^\w*$/, _e = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Aa = /[\\^$.*+?()[\]{}|]/g, Ce = RegExp(Aa.source), Ln = /^\s+/, bm = /\s/, _r = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, it = /\{\n\/\* \[wrapped with (.+)\] \*/, As = /,? & /, gs = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, Ze = /[()=,{}\[\]\/\s]/, ts = /\\(\\)?/g, Es = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, tn = /\w*$/, Sm = /^[-+]0x[0-9a-f]+$/i, Fm = /^0b[01]+$/i, Ea = /^\[object .+?Constructor\]$/, Oo = /^0o[0-7]+$/i, xm = /^(?:0|[1-9]\d*)$/, ea = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, sn = /($^)/, Ro = /['\n\r\u2028\u2029\\]/g, pr = "\\ud800-\\udfff", Nm = "\\u0300-\\u036f", Am = "\\ufe20-\\ufe2f", ze = "\\u20d0-\\u20ff", yr = Nm + Am + ze, Io = "\\u2700-\\u27bf", ci = "a-z\\xdf-\\xf6\\xf8-\\xff", Uo = "\\xac\\xb1\\xd7\\xf7", Em = "\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf", Hm = "\\u2000-\\u206f", Pm = " \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", zo = "A-Z\\xc0-\\xd6\\xd8-\\xde", Bo = "\\ufe0e\\ufe0f", Wo = Uo + Em + Hm + Pm, vr = "['’]", $o = "[" + pr + "]", Go = "[" + Wo + "]", wr = "[" + yr + "]", Vo = "\\d+", Jo = "[" + Io + "]", Ko = "[" + ci + "]", ta = "[^" + pr + Wo + Vo + Io + ci + zo + "]", sa = "\\ud83c[\\udffb-\\udfff]", Zo = "(?:" + wr + "|" + sa + ")", na = "[^" + pr + "]", ss = "(?:\\ud83c[\\udde6-\\uddff]){2}", gi = "[\\ud800-\\udbff][\\udc00-\\udfff]", aa = "[" + zo + "]", Qo = "\\u200d", Xo = "(?:" + Ko + "|" + ta + ")", jm = "(?:" + aa + "|" + ta + ")", el = "(?:" + vr + "(?:d|ll|m|re|s|t|ve))?", tl = "(?:" + vr + "(?:D|LL|M|RE|S|T|VE))?", sl = Zo + "?", Mr = "[" + Bo + "]?", qm = "(?:" + Qo + "(?:" + [na, ss, gi].join("|") + ")" + Mr + sl + ")*", nl = "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", Om = "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", al = Mr + sl + qm, Rm = "(?:" + [Jo, ss, gi].join("|") + ")" + al, Im = "(?:" + [na + wr + "?", wr, ss, gi, $o].join("|") + ")", Um = RegExp(vr, "g"), zm = RegExp(wr, "g"), hi = RegExp(sa + "(?=" + sa + ")|" + Im + al, "g"), Bm = RegExp([aa + "?" + Ko + "+" + el + "(?=" + [Go, aa, "$"].join("|") + ")", jm + "+" + tl + "(?=" + [Go, aa + Xo, "$"].join("|") + ")", aa + "?" + Xo + "+" + el, aa + "+" + tl, Om, nl, Vo, Rm].join("|"), "g"), Wm = RegExp("[" + Qo + pr + yr + Bo + "]"), $m = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, Gm = ["Array", "Buffer", "DataView", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Map", "Math", "Object", "Promise", "RegExp", "Set", "String", "Symbol", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "_", "clearTimeout", "isFinite", "parseInt", "setTimeout"], Vm = -1, He = {};
      He[Jn] = He[Fe] = He[cr] = He[gr] = He[Kn] = He[Na] = He[Zn] = He[en] = He[Qn] = true, He[J] = He[lr] = He[Vn] = He[Qs] = He[Xs] = He[Wn] = He[dr] = He[mr] = He[es] = He[xa] = He[xs] = He[$n] = He[Ie] = He[wn] = He[Gn] = false;
      var Ne = {};
      Ne[J] = Ne[lr] = Ne[Vn] = Ne[Xs] = Ne[Qs] = Ne[Wn] = Ne[Jn] = Ne[Fe] = Ne[cr] = Ne[gr] = Ne[Kn] = Ne[es] = Ne[xa] = Ne[xs] = Ne[$n] = Ne[Ie] = Ne[wn] = Ne[ur] = Ne[Na] = Ne[Zn] = Ne[en] = Ne[Qn] = true, Ne[dr] = Ne[mr] = Ne[Gn] = false;
      var Jm = { À: "A", Á: "A", Â: "A", Ã: "A", Ä: "A", Å: "A", à: "a", á: "a", â: "a", ã: "a", ä: "a", å: "a", Ç: "C", ç: "c", Ð: "D", ð: "d", È: "E", É: "E", Ê: "E", Ë: "E", è: "e", é: "e", ê: "e", ë: "e", Ì: "I", Í: "I", Î: "I", Ï: "I", ì: "i", í: "i", î: "i", ï: "i", Ñ: "N", ñ: "n", Ò: "O", Ó: "O", Ô: "O", Õ: "O", Ö: "O", Ø: "O", ò: "o", ó: "o", ô: "o", õ: "o", ö: "o", ø: "o", Ù: "U", Ú: "U", Û: "U", Ü: "U", ù: "u", ú: "u", û: "u", ü: "u", Ý: "Y", ý: "y", ÿ: "y", Æ: "Ae", æ: "ae", Þ: "Th", þ: "th", ß: "ss", Ā: "A", Ă: "A", Ą: "A", ā: "a", ă: "a", ą: "a", Ć: "C", Ĉ: "C", Ċ: "C", Č: "C", ć: "c", ĉ: "c", ċ: "c", č: "c", Ď: "D", Đ: "D", ď: "d", đ: "d", Ē: "E", Ĕ: "E", Ė: "E", Ę: "E", Ě: "E", ē: "e", ĕ: "e", ė: "e", ę: "e", ě: "e", Ĝ: "G", Ğ: "G", Ġ: "G", Ģ: "G", ĝ: "g", ğ: "g", ġ: "g", ģ: "g", Ĥ: "H", Ħ: "H", ĥ: "h", ħ: "h", Ĩ: "I", Ī: "I", Ĭ: "I", Į: "I", İ: "I", ĩ: "i", ī: "i", ĭ: "i", į: "i", ı: "i", Ĵ: "J", ĵ: "j", Ķ: "K", ķ: "k", ĸ: "k", Ĺ: "L", Ļ: "L", Ľ: "L", Ŀ: "L", Ł: "L", ĺ: "l", ļ: "l", ľ: "l", ŀ: "l", ł: "l", Ń: "N", Ņ: "N", Ň: "N", Ŋ: "N", ń: "n", ņ: "n", ň: "n", ŋ: "n", Ō: "O", Ŏ: "O", Ő: "O", ō: "o", ŏ: "o", ő: "o", Ŕ: "R", Ŗ: "R", Ř: "R", ŕ: "r", ŗ: "r", ř: "r", Ś: "S", Ŝ: "S", Ş: "S", Š: "S", ś: "s", ŝ: "s", ş: "s", š: "s", Ţ: "T", Ť: "T", Ŧ: "T", ţ: "t", ť: "t", ŧ: "t", Ũ: "U", Ū: "U", Ŭ: "U", Ů: "U", Ű: "U", Ų: "U", ũ: "u", ū: "u", ŭ: "u", ů: "u", ű: "u", ų: "u", Ŵ: "W", ŵ: "w", Ŷ: "Y", ŷ: "y", Ÿ: "Y", Ź: "Z", Ż: "Z", Ž: "Z", ź: "z", ż: "z", ž: "z", Ĳ: "IJ", ĳ: "ij", Œ: "Oe", œ: "oe", ŉ: "'n", ſ: "s" }, fi = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }, _i = { "&amp;": "&", "&lt;": "<", "&gt;": ">", "&quot;": '"', "&#39;": "'" }, Km = { "\\": "\\", "'": "'", "\n": "n", "\r": "r", "\u2028": "u2028", "\u2029": "u2029" }, rl = parseFloat, il = parseInt, ol = typeof Od == "object" && Od && Od.Object === Object && Od, Zm = typeof self == "object" && self && self.Object === Object && self, tt = ol || Zm || Function("return this")(), pi = i && !i.nodeType && i, nn = pi && true && a && !a.nodeType && a, Pe = nn && nn.exports === pi, kn = Pe && ol.process, ot = (function() {
        try {
          var Y = nn && nn.require && nn.require("util").types;
          return Y || kn && kn.binding && kn.binding("util");
        } catch {
        }
      ...
      function _l(Y) {
        return Y && Y.slice(0, Dr(Y) + 1).replace(Ln, "");
      }
      function _t(Y) {
        return function(A) {
          return Y(A);
      ...
      var _u = (function Y(A) {
        ...
        var F = A.Array, G = A.Date, oe = A.Error, Te = A.Function, Qe = A.Math, fe = A.Object, Ps = A.RegExp, wl = A.String, Bt = A.TypeError, qa = F.prototype, Ml = Te.prototype, da = fe.prototype, Yr = A["__core-js_shared__"], Oa = Ml.toString, De = da.hasOwnProperty, pu = 0, Ll = (function() {
          var t = /[^.]+$/.exec(Yr && Yr.keys && Yr.keys.IE_PROTO || "");
          return t ? "Symbol(src)_1." + t : "";
        })(), Cr = da.toString, yu = Oa.call(fe), vu = tt._, wu = Ps("^" + Oa.call(De).replace(Aa, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), br = Pe ? A.Buffer : r, on = A.Symbol, Sr = A.Uint8Array, kl = br ? br.allocUnsafe : r, Fr = ja(fe.getPrototypeOf, fe), Tl = fe.create, Dl = da.propertyIsEnumerable, Dn = qa.splice, Yl = on ? on.isConcatSpreadable : r, Ra = on ? on.iterator : r, Yn = on ? on.toStringTag : r, xr = (function() {
          try {
            var t = Mt(fe, "defineProperty");
            return t({}, "", {}), t;
          } catch {
          }
        })(), Mu = A.clearTimeout !== tt.clearTimeout && A.clearTimeout, Lu = G && G.now !== tt.Date.now && G.now, ku = A.setTimeout !== tt.setTimeout && A.setTimeout, Nr = Qe.ceil, Ia = Qe.floor, Ar = fe.getOwnPropertySymbols, Cl = br ? br.isBuffer : r, Ua = A.isFinite, ma = qa.join, Er = ja(fe.keys, fe), Ve = Qe.max, Be = Qe.min, bl = G.now, Sl = A.parseInt, Fl = Qe.random, Tu = qa.reverse, bi = Mt(A, "DataView"), za = Mt(A, "Map"), Si = Mt(A, "Promise"), ua = Mt(A, "Set"), Ba = Mt(A, "WeakMap"), Wa = Mt(fe, "create"), Hr = Ba && new Ba(), ca = {}, Du = An(bi), Yu = An(za), Cu = An(Si), bu = An(ua), Su = An(Ba), Pr = on ? on.prototype : r, $a = Pr ? Pr.valueOf : r, xl = Pr ? Pr.toString : r;
        function y(t) {
        ...
        function Nu() {
          var t = this.__wrapped__.value(), n = this.__dir__, o = de(t), c = n < 0, _ = o ? t.length : 0, v = os(0, _, this.__views__), M = v.start, T = v.end, C = T - M, P = c ? T : M - 1, j = this.__iteratees__, R = j.length, z = 0, K = Be(C, this.__takeCount__);
          if (!o || !c && _ == C && K == C) return Bi(t, this.__actions__);
          var ne = [];
          e: for (; C-- && z < K; ) {
            P += n;
            for (var ce = -1, ae = t[P]; ++ce < R; ) {
              var ve = j[ce], Me = ve.iteratee, ds = ve.type, qt = Me(ae);
              if (ds == Ks) ae = qt;
              else if (!qt) {
                if (ds == zn) continue e;
                break e;
        ...
        function Hu(t) {
          var n = this.__data__;
          return Wa ? n[t] !== r : De.call(n, t);
        }
        function Pu(t, n) {
          var o = this.__data__;
          return this.size += this.has(t) ? 0 : 1, o[t] = Wa && n === r ? L : n, this;
        }
        ...
        function Nl(t) {
          var n = this.__data__, o = $t(n, t);
          if (o < 0) return false;
          var c = n.length - 1;
          return o == c ? n.pop() : Dn.call(n, o, 1), --this.size, true;
        }
        function qu(t) {
          var n = this.__data__, o = $t(n, t);
          return o < 0 ? r : n[o][1];
        ...
        function Al(t, n) {
          ...
          return c < 0 ? (++this.size, o.push([t, n])) : o[c][1] = n, this;
        }
        qs.prototype.clear = ju, qs.prototype.delete = Nl, qs.prototype.get = qu, qs.prototype.has = Ou, qs.prototype.set = Al;
        function Os(t) {
          var n = -1, o = t == null ? 0 : t.length;
          for (this.clear(); ++n < o; ) {
            var c = t[n];
        ...
        function Uu(t, n) {
          ...
          return o.set(t, n), this.size += o.size == c ? 0 : 1, this;
        }
        Os.prototype.clear = Ru, Os.prototype.delete = Iu, Os.prototype.get = ln, Os.prototype.has = El, Os.prototype.set = Uu;
        function Cn(t) {
          var n = -1, o = t == null ? 0 : t.length;
          for (this.__data__ = new Os(); ++n < o; ) this.add(t[n]);
        }
        function zu(t) {
        ...
        Cn.prototype.add = Cn.prototype.push = zu, Cn.prototype.has = U;
        function as(t) {
          var n = this.__data__ = new qs(t);
          this.size = n.size;
        }
        function Bu() {
        ...
        function Pl(t, n) {
          ...
          if (o instanceof qs) {
            var c = o.__data__;
            if (!za || c.length < u - 1) return c.push([t, n]), this.size = ++o.size, this;
            o = this.__data__ = new Os(c);
          }
          return o.set(t, n), this.size = o.size, this;
        }
        as.prototype.clear = Bu, as.prototype.delete = Hl, as.prototype.get = Le, as.prototype.has = Or, as.prototype.set = Pl;
        function Rr(t, n) {
          var o = de(t), c = !o && er(t), _ = !o && !c && Da(t), v = !o && !c && !_ && si(t), M = o || c || _ || v, T = M ? Di(t.length, wl) : [], C = T.length;
          for (var P in t) (n || De.call(t, P)) && !(M && (P == "length" || _ && (P == "offset" || P == "parent") || v && (P == "buffer" || P == "byteLength" || P == "byteOffset") || Ws(P, C))) && T.push(P);
          return T;
        }
        function jl(t) {
          var n = t.length;
          return n ? t[$r(0, n - 1)] : r;
        }
        function Wu(t, n) {
          return ft(ct(t), bn(n, 0, t.length));
        }
        function $u(t) {
          return ft(ct(t));
        }
        function Fi(t, n, o) {
          (o !== r && !Gs(t[n], o) || o === r && !(n in t)) && Rs(t, n, o);
        }
        function Ga(t, n, o) {
          var c = t[n];
          (!(De.call(t, n) && Gs(c, o)) || o === r && !(n in t)) && Rs(t, n, o);
        }
        function $t(t, n) {
          for (var o = t.length; o--; ) if (Gs(t[o][0], n)) return o;
          return -1;
        }
        function Gu(t, n, o, c) {
        ...
        function xi(t, n) {
          return t && Ls(n, lt(n), t);
        }
        function Vu(t, n) {
          return t && Ls(n, Kt(n), t);
        }
        function Rs(t, n, o) {
          n == "__proto__" && xr ? xr(t, n, { configurable: true, enumerable: true, value: o, writable: true }) : t[n] = o;
        }
        function Ir(t, n) {
          for (var o = -1, c = n.length, _ = F(c), v = t == null; ++o < c; ) _[o] = v ? r : Ic(t, n[o]);
          return _;
        }
        function bn(t, n, o) {
          return t === t && (o !== r && (t = t <= o ? t : o), n !== r && (t = t >= n ? t : n)), t;
        }
        function Ft(t, n, o, c, _, v) {
          var M, T = n & b, C = n & H, P = n & N;
          ...
          var K = v.get(t);
          if (K) return K;
          v.set(t, M), u_(t) ? t.forEach(function(ae) {
            M.add(Ft(ae, n, o, ae, t, v));
          }) : d_(t) && t.forEach(function(ae, ve) {
            M.set(ve, Ft(ae, n, o, ve, t, v));
          });
          var ne = P ? C ? wt : vt : C ? Kt : lt, ce = j ? r : ne(t);
          return Ge(ce || t, function(ae, ve) {
            ce && (ve = ae, ae = t[ve]), Ga(M, ve, Ft(ae, n, o, ve, t, v));
          }), M;
        }
        function Ni(t) {
          var n = lt(t);
        ...
        function ha(t, n, o, c) {
          var _ = -1, v = kr, M = true, T = t.length, C = [], P = n.length;
          if (!T) return C;
          o && (n = xe(n, _t(o))), c ? (v = vi, M = false) : n.length >= u && (v = ia, M = false, n = new Cn(n));
          e: for (; ++_ < T; ) {
            var j = t[_], R = o == null ? j : o(j);
            if (j = c || j !== 0 ? j : 0, M && R === R) {
              for (var z = P; z--; ) if (n[z] === R) continue e;
              C.push(j);
            } else v(n, R, c) || C.push(j);
          }
          return C;
        }
        var dn = Kr(ps), Ol = Kr(Ei, true);
        function Ju(t, n) {
          var o = true;
        ...
        function Ku(t, n, o, c) {
          var _ = t.length;
          for (o = me(o), o < 0 && (o = -o > _ ? 0 : _ + o), c = c === r || c > _ ? _ : me(c), c < 0 && (c += _), c = o > c ? 0 : g_(c); o < c; ) t[o++] = n;
          return t;
        }
        function Rl(t, n) {
          var o = [];
        ...
        function st(t, n, o, c, _) {
          var v = -1, M = t.length;
          for (o || (o = wc), _ || (_ = []); ++v < M; ) {
            var T = t[v];
            n > 0 && o(T) ? n > 1 ? st(T, n - 1, o, c, _) : hs(_, T) : c || (_[_.length] = T);
          }
          return _;
        }
        var Ai = Zi(), Il = Zi(true);
        function ps(t, n) {
          return t && Ai(t, n, lt);
        }
        function Ei(t, n) {
        ...
        function Sn(t, n) {
          n = ws(n, t);
          for (var o = 0, c = n.length; t != null && o < c; ) t = t[Ts(n[o++])];
          return o && o == c ? t : r;
        }
        function Ul(t, n, o) {
          var c = n(t);
        ...
        function ut(t) {
          return t == null ? t === r ? Tm : Lm : Yn && Yn in fe(t) ? pc(t) : wa(t);
        }
        function Hi(t, n) {
          return t > n;
        }
        ...
        function Qu(t, n) {
          return t != null && n in fe(t);
        }
        function Xu(t, n, o) {
          return t >= Be(n, o) && t < Ve(n, o);
        }
        function Pi(t, n, o) {
          for (var c = o ? vi : kr, _ = t[0].length, v = t.length, M = v, T = F(v), C = 1 / 0, P = []; M--; ) {
            var j = t[M];
            M && n && (j = xe(j, _t(n))), C = Be(j.length, C), T[M] = !o && (n || _ >= 120 && j.length >= 120) ? new Cn(M && j) : r;
          }
          j = t[0];
          var R = -1, z = T[0];
          e: for (; ++R < _ && P.length < C; ) {
            var K = j[R], ne = n ? n(K) : K;
        ...
        function Va(t, n, o, c, _) {
          return t === n ? true : t == null || n == null || !Je(t) && !Je(n) ? t !== t && n !== n : sc(t, n, o, c, Va, _);
        }
        function sc(t, n, o, c, _, v) {
          var M = de(t), T = de(n), C = M ? lr : We(t), P = T ? lr : We(n);
          ...
          if (z && !j) return v || (v = new as()), M || si(t) ? gd(t, n, o, c, _, v) : fc(t, n, C, o, c, _, v);
          if (!(o & q)) {
            var K = j && De.call(t, "__wrapped__"), ne = R && De.call(n, "__wrapped__");
            if (K || ne) {
              var ce = K ? t.value() : t, ae = ne ? n.value() : n;
              return v || (v = new as()), _(ce, ae, o, c, v);
            }
          }
          return z ? (v || (v = new as()), _c(t, n, o, c, _, v)) : false;
        }
        function ji(t) {
          return Je(t) && We(t) == es;
        }
        function mn(t, n, o, c) {
          ...
          for (; ++_ < v; ) {
            ...
            if (M && T[2]) {
              ...
              var R = new as();
              if (c) var z = c(P, j, C, t, n, R);
              if (!(z === r ? Va(j, P, q | I, c, R) : z)) return false;
            }
          }
          return true;
        }
        ...
        function xt(t) {
          return typeof t == "function" ? t : t == null ? Zt : typeof t == "object" ? de(t) ? qi(t[0], t[1]) : Nt(t) : T_(t);
        }
        function zr(t) {
          if (!ks(t)) return Er(t);
          var n = [];
          for (var o in fe(t)) De.call(t, o) && o != "constructor" && n.push(o);
          return n;
        }
        function ac(t) {
          if (!$e(t)) return hn(t);
          var n = ks(t), o = [];
          for (var c in t) c == "constructor" && (n || !De.call(t, c)) || o.push(c);
          return o;
        }
        function Br(t, n) {
          return t < n;
        ...
        function Nt(t) {
          var n = no(t);
          return n.length == 1 && n[0][2] ? pd(n[0][0], n[0][1]) : function(o) {
            return o === t || mn(o, t, n);
          };
        }
        function qi(t, n) {
          return Xr(t) && _d(n) ? pd(Ts(t), n) : function(o) {
            var c = Ic(o, t);
            return c === r && c === n ? Uc(o, t) : Va(n, c, q | I);
          };
        }
        function Wr(t, n, o, c, _) {
          t !== n && Ai(n, function(v, M) {
            if (_ || (_ = new as()), $e(v)) $l(t, n, M, o, Wr, c, _);
            else {
              var T = c ? c(Nn(t, M), v, M + "", t, n, _) : r;
              T === r && (T = v), Fi(t, M, T);
            }
          }, Kt);
        }
        function $l(t, n, o, c, _, v, M) {
          var T = Nn(t, o), C = Nn(n, o), P = M.get(C);
          if (P) {
            Fi(t, o, P);
            return;
          }
          var j = v ? v(T, C, o + "", t, n, M) : r, R = j === r;
          if (R) {
            var z = de(C), K = !z && Da(C), ne = !z && !K && si(C);
            j = C, z || K || ne ? de(T) ? j = T : Xe(T) ? j = ct(T) : K ? (R = false, j = Ms(C, true)) : ne ? (R = false, j = nd(C, true)) : j = [] : wo(C) || er(C) ? (j = T, er(T) ? j = h_(T) : (!$e(T) || jn(T)) && (j = fd(C))) : R = false;
          }
          R && (M.set(C, j), _(j, C, c, v, M), M.delete(C)), Fi(t, o, j);
        }
        function Gl(t, n) {
          var o = t.length;
          if (o) return n += n < 0 ? o : 0, Ws(n, o) ? t[n] : r;
        }
        function Vl(t, n, o) {
          n.length ? n = xe(n, function(v) {
            return de(v) ? function(M) {
              return Sn(M, v.length === 1 ? v[0] : v);
            } : v;
          }) : n = [Zt];
          var c = -1;
          n = xe(n, _t(ee()));
          var _ = Wl(t, function(v, M, T) {
            var C = xe(n, function(P) {
              return P(v);
            });
        ...
        function Oi(t, n, o, c) {
          var _ = c ? gl : ra, v = -1, M = n.length, T = t;
          for (t === n && (n = ct(n)), o && (T = xe(t, _t(o))); ++v < M; ) for (var C = 0, P = n[v], j = o ? o(P) : P; (C = _(T, j, C, c)) > -1; ) T !== t && Dn.call(T, C, 1), Dn.call(t, C, 1);
          return t;
        }
        function At(t, n) {
          for (var o = t ? n.length : 0, c = o - 1; o--; ) {
            var _ = n[o];
            if (o == c || _ !== v) {
              var v = _;
              Ws(_) ? Dn.call(t, _, 1) : zi(t, _);
            }
          }
          return t;
        }
        function $r(t, n) {
          return t + Ia(Fl() * (n - t + 1));
        }
        function Ri(t, n, o, c) {
          for (var _ = -1, v = Ve(Nr((n - t) / (o || 1)), 0), M = F(v); v--; ) M[c ? v : ++_] = t, t += o;
          return M;
        }
        function Ii(t, n) {
          var o = "";
          if (!t || n < 1 || n > Zs) return o;
          do
            n % 2 && (o += t), n = Ia(n / 2), n && (t += t);
          while (n);
          return o;
        }
        function le(t, n) {
          return Dt(oo(t, n, Zt), t + "");
        }
        function ic(t) {
          return jl(ni(t));
        }
        function oc(t, n) {
          var o = ni(t);
          return ft(o, bn(n, 0, o.length));
        }
        function Ka(t, n, o, c) {
          if (!$e(t)) return t;
          n = ws(n, t);
          for (var _ = -1, v = n.length, M = v - 1, T = t; T != null && ++_ < v; ) {
            var C = Ts(n[_]), P = o;
            if (C === "__proto__" || C === "constructor" || C === "prototype") return t;
            if (_ != M) {
              var j = T[C];
              P = c ? c(j, C, T) : r, P === r && (P = $e(j) ? j : Ws(n[_ + 1]) ? [] : {});
            }
            Ga(T, C, P), T = T[C];
          }
          return t;
        }
        var Zl = Hr ? function(t, n) {
          return Hr.set(t, n), t;
        } : Zt, lc = xr ? function(t, n) {
          return xr(t, "toString", { configurable: true, enumerable: false, value: Bc(n), writable: true });
        } : Zt;
        function dc(t) {
          return ft(ni(t));
        }
        function pt(t, n, o) {
          var c = -1, _ = t.length;
          n < 0 && (n = -n > _ ? 0 : _ + n), o = o > _ ? _ : o, o < 0 && (o += _), _ = n > o ? 0 : o - n >>> 0, n >>>= 0;
          for (var v = F(_); ++c < _; ) v[c] = t[c + n];
          return v;
        }
        function mc(t, n) {
          var o;
        ...
        function Za(t, n, o) {
          ...
          if (typeof n == "number" && n === n && _ <= mi) {
            for (; c < _; ) {
              var v = c + _ >>> 1, M = t[v];
              M !== null && !ls(M) && (o ? M <= n : M < n) ? c = v + 1 : _ = v;
            }
            return _;
          }
          return Ui(t, n, Zt, o);
        ...
        function Ui(t, n, o, c) {
          ...
          if (v === 0) return 0;
          n = o(n);
          for (var M = n !== n, T = n === null, C = ls(n), P = n === r; _ < v; ) {
            var j = Ia((_ + v) / 2), R = o(t[j]), z = R !== r, K = R === null, ne = R === R, ce = ls(R);
            if (M) var ae = c || ne;
            else P ? ae = ne && (c || z) : T ? ae = ne && z && (c || !K) : C ? ae = ne && z && !K && (c || !ce) : K || ce ? ae = false : ae = c ? R <= n : R < n;
            ae ? _ = j + 1 : v = j;
          }
          return Be(v, or);
        }
        ...
        function Gr(t) {
          return typeof t == "number" ? t : ls(t) ? Ct : +t;
        }
        function yt(t) {
        ...
        function zi(t, n) {
          return n = ws(n, t), t = lo(t, n), t == null || delete t[Ts(Oe(n))];
        }
        function Xl(t, n, o, c) {
          return Ka(t, n, o(Sn(t, n)), c);
        }
        function Vr(t, n, o, c) {
          for (var _ = t.length, v = c ? _ : -1; (c ? v-- : ++v < _) && n(t[v], v, t); ) ;
          return o ? pt(t, c ? 0 : v, c ? v + 1 : _) : pt(t, c ? v + 1 : 0, c ? _ : v);
        }
        function Bi(t, n) {
          var o = t;
          return o instanceof ue && (o = o.value()), wi(n, function(c, _) {
        ...
        function Wi(t, n, o) {
          ...
          for (var _ = -1, v = F(c); ++_ < c; ) for (var M = t[_], T = -1; ++T < c; ) T != _ && (v[_] = ha(v[_] || M, t[T], n, o));
          return un(st(v, 1), n, o);
        }
        function cn(t, n, o) {
          for (var c = -1, _ = t.length, v = n.length, M = {}; ++c < _; ) {
            var T = c < v ? n[c] : r;
            o(M, t[c], T);
          }
          return M;
        ...
        function ws(t, n) {
          return de(t) ? t : Xr(t, n) ? [t] : Ld(be(t));
        }
        var ed = le;
        function Et(t, n, o) {
          var c = t.length;
          return o = o === r ? c : o, !n && o >= c ? t : pt(t, n, o);
        }
        var Ht = Mu || function(t) {
        ...
        function Vi(t, n) {
          if (t !== n) {
            var o = t !== r, c = t === null, _ = t === t, v = ls(t), M = n !== r, T = n === null, C = n === n, P = ls(n);
            if (!T && !P && !v && t > n || v && M && C && !T && !P || c && M && C || !o && C || !_) return 1;
            if (!c && !v && !P && t < n || P && o && _ && !c && !v || T && o && _ || !M && _ || !C) return -1;
          }
          return 0;
        }
        function uc(t, n, o) {
          for (var c = -1, _ = t.criteria, v = n.criteria, M = _.length, T = o.length; ++c < M; ) {
            var C = Vi(_[c], v[c]);
            if (C) {
              if (c >= T) return C;
              var P = o[c];
        ...
        function Jr(t, n, o, c) {
          for (var _ = -1, v = t.length, M = o.length, T = -1, C = n.length, P = Ve(v - M, 0), j = F(C + P), R = !c; ++T < C; ) j[T] = n[T];
          for (; ++_ < M; ) (R || _ < v) && (j[o[_]] = t[_]);
          for (; P--; ) j[T++] = t[_++];
          return j;
        }
        function Ji(t, n, o, c) {
          for (var _ = -1, v = t.length, M = -1, T = o.length, C = -1, P = n.length, j = Ve(v - T, 0), R = F(j + P), z = !c; ++_ < j; ) R[_] = t[_];
          for (var K = _; ++C < P; ) R[K + C] = n[C];
          for (; ++M < T; ) (z || _ < v) && (R[K + o[M]] = t[_++]);
          return R;
        }
        function ct(t, n) {
          var o = -1, c = t.length;
          for (n || (n = F(c)); ++o < c; ) n[o] = t[o];
          return n;
        }
        function Ls(t, n, o, c) {
          var _ = !o;
          o || (o = {});
          for (var v = -1, M = n.length; ++v < M; ) {
            var T = n[v], C = c ? c(o[T], t[T], T, o, t) : r;
        ...
        function Qa(t, n) {
          return function(o, c) {
            var _ = de(o) ? Qm : Gu, v = n ? n() : {};
            return _(o, t, ee(c, 2), v);
          };
        }
        function fa(t) {
          return le(function(n, o) {
            var c = -1, _ = o.length, v = _ > 1 ? o[_ - 1] : r, M = _ > 2 ? o[2] : r;
            for (v = t.length > 3 && typeof v == "function" ? (_--, v) : r, M && ht(o[0], o[1], M) && (v = _ < 3 ? r : v, _ = 1), n = fe(n); ++c < _; ) {
              var T = o[c];
              T && t(n, T, c, v);
            }
            return n;
        ...
        function Kr(t, n) {
          return function(o, c) {
            ...
            for (var _ = o.length, v = n ? _ : -1, M = fe(o); (n ? v-- : ++v < _) && c(M[v], v, M) !== false; ) ;
            return o;
          };
        }
        function Zi(t) {
          return function(n, o, c) {
            for (var _ = -1, v = fe(n), M = c(n), T = M.length; T--; ) {
              var C = M[t ? T : ++_];
        ...
        function id(t) {
          return function(n) {
            n = be(n);
            var o = fs(n) ? St(n) : r, c = o ? o[0] : n.charAt(0), _ = o ? Et(o, 1).join("") : n.slice(1);
            return c[t]() + _;
          };
        }
        function gn(t) {
          return function(n) {
            return wi(L_(M_(n).replace(Um, "")), t, "");
          };
        }
        function _a(t) {
          return function() {
            ...
            var o = ga(t.prototype), c = t.apply(o, n);
            return $e(c) ? c : o;
          };
        }
        function is(t, n, o) {
          ...
          function _() {
            ...
            if (v -= P.length, v < o) return eo(t, n, Fn, _.placeholder, r, M, P, r, r, o - v);
        ...
        function od(t) {
          return function(n, o, c) {
            ...
            var M = t(n, o, c);
            return M > -1 ? _[v ? n[M] : M] : r;
          };
        }
        function ld(t) {
          return Bs(function(n) {
            var o = n.length, c = o, _ = Wt.prototype.thru;
            for (t && n.reverse(); c--; ) {
              var v = n[c];
            ...
            for (c = M ? c : o; ++c < o; ) {
              ...
              C && xn(C[0]) && C[1] == (V | te | ge | he) && !C[4].length && C[9] == 1 ? M = M[Qr(C[0])].apply(M, C[3]) : M = v.length == 1 && xn(v) ? M[T]() : M.thru(v);
            }
            return function() {
              var P = arguments, j = P[0];
              if (M && P.length == 1 && de(j)) return M.plant(j).value();
              for (var R = 0, z = o ? n[R].apply(this, P) : j; ++R < o; ) z = n[R].call(this, z);
              return z;
            };
          });
        }
        function Fn(t, n, o, c, _, v, M, T, C, P) {
          var j = n & V, R = n & x, z = n & Q, K = n & (te | Z), ne = n & je, ce = z ? r : _a(t);
          function ae() {
            for (var ve = arguments.length, Me = F(ve), ds = ve; ds--; ) Me[ds] = arguments[ds];
            if (K) var qt = ya(ae), ms = au(Me, qt);
            if (c && (Me = Jr(Me, c, _, K)), v && (Me = Ji(Me, v, M, K)), ve -= ms, K && ve < P) {
              var et = ns(Me, qt);
              return eo(t, n, Fn, ae.placeholder, o, Me, et, T, C, P - ve);
            }
            var Vs = R ? o : this, On = z ? Vs[t] : t;
            return ve = Me.length, T ? Me = Ma(Me, T) : ne && ve > 1 && Me.reverse(), j && C < ve && (Me.length = C), this && this !== tt && this instanceof ae && (On = ce || _a(On)), On.apply(Vs, Me);
          }
          return ae;
        }
        function dd(t, n) {
        ...
        function Qi(t) {
          return Bs(function(n) {
            return n = xe(n, _t(ee())), le(function(o) {
              var c = this;
        ...
        function Zr(t, n) {
          n = n === r ? " " : yt(n);
          var o = n.length;
          if (o < 2) return o ? Ii(n, t) : n;
          var c = Ii(n, Nr(t / rn(n)));
          return fs(n) ? Et(St(c), 0, t).join("") : c.slice(0, t);
        }
        function cc(t, n, o, c) {
          var _ = n & x, v = _a(t);
          function M() {
        ...
        function Xi(t) {
          return function(n, o, c) {
            return c && typeof c != "number" && ht(n, o, c) && (o = c = r), n = qn(n), o === r ? (o = n, n = 0) : o = qn(o), c = c === r ? n < o ? 1 : -1 : qn(c), Ri(n, o, c, t);
          };
        }
        function pa(t) {
          return function(n, o) {
            return typeof n == "string" && typeof o == "string" || (n = Ys(n), o = Ys(o)), t(n, o);
          };
        }
        function eo(t, n, o, c, _, v, M, T, C, P) {
          var j = n & te, R = j ? M : r, z = j ? r : M, K = j ? v : r, ne = j ? r : v;
          n |= j ? ge : B, n &= ~(j ? B : ge), n & X || (n &= -4);
          var ce = [t, n, _, K, R, ne, z, T, C, P], ae = o.apply(r, ce);
          return xn(t) && vd(ae, ce), ae.placeholder = c, wd(ae, t, n);
        }
        function to(t) {
          var n = Qe[t];
          return function(o, c) {
            if (o = Ys(o), c = c == null ? 0 : Be(me(c), 292), c && Ua(o)) {
              var _ = (be(o) + "e").split("e"), v = n(_[0] + "e" + (+_[1] + c));
        ...
        function md(t) {
          return function(n) {
            var o = We(n);
            return o == es ? Ci(n) : o == Ie ? mu(n) : nu(n, t(n));
          };
        }
        function zs(t, n, o, c, _, v, M, T) {
          var C = n & Q;
          if (!C && typeof t != "function") throw new Bt(f);
          var P = c ? c.length : 0;
          if (P || (n &= -97, c = _ = r), M = M === r ? M : Ve(me(M), 0), T = T === r ? T : me(T), P -= _ ? _.length : 0, n & B) {
            var j = c, R = _;
            c = _ = r;
          }
          var z = C ? r : so(t), K = [t, n, o, c, _, j, R, v, M, T];
          if (z && yd(K, z), t = K[0], n = K[1], o = K[2], c = K[3], _ = K[4], T = K[9] = K[9] === r ? C ? 0 : t.length : Ve(K[9] - P, 0), !T && n & (te | Z) && (n &= -25), !n || n == x) var ne = rd(t, n, o);
          else n == te || n == Z ? ne = is(t, n, T) : (n == ge || n == (x | ge)) && !_.length ? ne = cc(t, n, o, c) : ne = Fn.apply(r, K);
          var ce = z ? Zl : vd;
          return wd(ce(ne, K), t, n);
        }
        function ud(t, n, o, c) {
          return t === r || Gs(t, da[o]) && !De.call(c, o) ? n : t;
        }
        function cd(t, n, o, c, _, v) {
          return $e(t) && $e(n) && (v.set(n, t), Wr(t, n, r, cd, v), v.delete(n)), t;
        }
        function hc(t) {
          return wo(t) ? r : t;
        }
        function gd(t, n, o, c, _, v) {
          var M = o & q, T = t.length, C = n.length;
          if (T != C && !(M && C > T)) return false;
          var P = v.get(t), j = v.get(n);
          if (P && j) return P == n && j == t;
          var R = -1, z = true, K = o & I ? new Cn() : r;
          for (v.set(t, n), v.set(n, t); ++R < T; ) {
            var ne = t[R], ce = n[R];
            if (c) var ae = M ? c(ce, ne, R, n, t, v) : c(ne, ce, R, t, n, v);
            if (ae !== r) {
              if (ae) continue;
              z = false;
              break;
          ...
          return v.delete(t), v.delete(n), z;
        }
        function fc(t, n, o, c, _, v, M) {
          switch (o) {
            case Xs:
              if (t.byteLength != n.byteLength || t.byteOffset != n.byteOffset) return false;
              t = t.buffer, n = n.buffer;
            case Vn:
              return !(t.byteLength != n.byteLength || !v(new Sr(t), new Sr(n)));
            case Qs:
            case Wn:
            case xa:
              return Gs(+t, +n);
            ...
            case Ie:
              var C = c & q;
              if (T || (T = oa), t.size != n.size && !C) return false;
              var P = M.get(t);
              if (P) return P == n;
              c |= I, M.set(t, n);
              var j = gd(T(t), T(n), c, _, v, M);
              return M.delete(t), j;
            case ur:
              if ($a) return $a.call(t) == $a.call(n);
          }
          return false;
        }
        function _c(t, n, o, c, _, v) {
          var M = o & q, T = vt(t), C = T.length, P = vt(n), j = P.length;
          if (C != j && !M) return false;
          for (var R = C; R--; ) {
            var z = T[R];
            if (!(M ? z in n : De.call(n, z))) return false;
          }
          var K = v.get(t), ne = v.get(n);
          if (K && ne) return K == n && ne == t;
          var ce = true;
          v.set(t, n), v.set(n, t);
          for (var ae = M; ++R < C; ) {
            z = T[R];
            var ve = t[z], Me = n[z];
            if (c) var ds = M ? c(Me, ve, z, n, t, v) : c(ve, Me, z, t, n, v);
          ...
          if (ce && !ae) {
            var qt = t.constructor, ms = n.constructor;
            qt != ms && "constructor" in t && "constructor" in n && !(typeof qt == "function" && qt instanceof qt && typeof ms == "function" && ms instanceof ms) && (ce = false);
          }
        ...
        function Qr(t) {
          for (var n = t.name + "", o = ca[n], c = De.call(ca, n) ? o.length : 0; c--; ) {
            var _ = o[c], v = _.func;
        ...
        function ya(t) {
          var n = De.call(y, "placeholder") ? y : t;
          return n.placeholder;
        }
        function ee() {
          var t = y.iteratee || Wc;
          return t = t === Wc ? xt : t, arguments.length ? t(arguments[0], arguments[1]) : t;
        }
        function Xa(t, n) {
          var o = t.__data__;
          return io(n) ? o[typeof n == "string" ? "string" : "hash"] : o.map;
        }
        function no(t) {
          for (var n = lt(t), o = n.length; o--; ) {
            var c = n[o], _ = t[c];
            n[o] = [c, _, _d(_)];
          }
          return n;
        ...
        function pc(t) {
          ...
          var _ = Cr.call(t);
          return c && (n ? t[Yn] = o : delete t[Yn]), _;
        }
        var Lt = Ar ? function(t) {
          return t == null ? [] : (t = fe(t), an(Ar(t), function(n) {
            return Dl.call(t, n);
          }));
        } : Vc, ao = Ar ? function(t) {
          for (var n = []; t; ) hs(n, Lt(t)), t = Fr(t);
          return n;
        } : Vc, We = ut;
        (bi && We(new bi(new ArrayBuffer(1))) != Xs || za && We(new za()) != es || Si && We(Si.resolve()) != jo || ua && We(new ua()) != Ie || Ba && We(new Ba()) != Gn) && (We = function(t) {
          var n = ut(t), o = n == xs ? t.constructor : r, c = o ? An(o) : "";
          if (c) switch (c) {
            case Du:
              return Xs;
            case Yu:
        ...
        function ro(t) {
          var n = t.match(it);
          return n ? n[1].split(As) : [];
        }
        function hd(t, n, o) {
          n = ws(n, t);
          for (var c = -1, _ = n.length, v = false; ++c < _; ) {
            var M = Ts(n[c]);
        ...
        function kt(t, n) {
          ...
          if (!o) return t;
          var c = o - 1;
          return n[c] = (o > 1 ? "& " : "") + n[c], n = n.join(o > 2 ? ", " : " "), t.replace(_r, `{
/* [wrapped with ` + n + `] */
`);
        }
        function wc(t) {
        ...
        function Ws(t, n) {
          var o = typeof t;
          return n = n ?? Zs, !!n && (o == "number" || o != "symbol" && xm.test(t)) && t > -1 && t % 1 == 0 && t < n;
        }
        function ht(t, n, o) {
          if (!$e(o)) return false;
          var c = typeof n;
          return (c == "number" ? Jt(o) && Ws(n, o.length) : c == "string" && n in o) ? Gs(o[n], t) : false;
        }
        function Xr(t, n) {
          if (de(t)) return false;
          var o = typeof t;
          return o == "number" || o == "symbol" || o == "boolean" || t == null || ls(t) ? true : zt.test(t) || !Ns.test(t) || n != null && t in fe(n);
        }
        function io(t) {
          var n = typeof t;
        ...
        function xn(t) {
          var n = Qr(t), o = y[n];
          if (typeof o != "function" || !(n in ue.prototype)) return false;
          if (t === o) return true;
          var c = so(o);
          return !!c && t === c[0];
        }
        ...
        var Lc = Yr ? jn : Jc;
        function ks(t) {
          var n = t && t.constructor, o = typeof n == "function" && n.prototype || da;
          return t === o;
        }
        function _d(t) {
          return t === t && !$e(t);
        ...
        function pd(t, n) {
          return function(o) {
            return o == null ? false : o[t] === n && (n !== r || t in fe(o));
          };
        }
        function va(t) {
          var n = Ad(t, function(c) {
            return o.size === w && o.clear(), c;
          }), o = n.cache;
          return n;
        }
        function yd(t, n) {
          var o = t[1], c = n[1], _ = o | c, v = _ < (x | Q | V), M = c == V && o == te || c == V && o == he && t[7].length <= n[8] || c == (V | he) && n[7].length <= n[8] && o == te;
          if (!(v || M)) return t;
          c & x && (t[2] = n[2], _ |= o & x ? 0 : X);
          var T = n[3];
          if (T) {
            var C = t[3];
            t[3] = C ? Jr(C, T, n[4]) : T, t[4] = C ? ns(t[3], D) : n[4];
          }
          return T = n[5], T && (C = t[5], t[5] = C ? Ji(C, T, n[6]) : T, t[6] = C ? ns(t[5], D) : n[6]), T = n[7], T && (t[7] = T), c & V && (t[8] = t[8] == null ? n[8] : Be(t[8], n[8])), t[9] == null && (t[9] = n[9]), t[0] = n[0], t[1] = _, t;
        }
        function hn(t) {
          var n = [];
          if (t != null) for (var o in fe(t)) n.push(o);
          return n;
        }
        function wa(t) {
          return Cr.call(t);
        ...
        function oo(t, n, o) {
          return n = Ve(n === r ? t.length - 1 : n, 0), function() {
            for (var c = arguments, _ = -1, v = Ve(c.length - n, 0), M = F(v); ++_ < v; ) M[_] = c[n + _];
            _ = -1;
            for (var T = F(n + 1); ++_ < n; ) T[_] = c[_];
            return T[n] = o(M), mt(t, this, T);
          };
        }
        function lo(t, n) {
          return n.length < 2 ? t : Sn(t, pt(n, 0, -1));
        }
        function Ma(t, n) {
          for (var o = t.length, c = Be(n.length, o), _ = ct(t); c--; ) {
            var v = n[c];
            t[c] = Ws(v, o) ? _[v] : r;
          }
          return t;
        ...
        var vd = Md(Zl), Tt = ku || function(t, n) {
        ...
        var Ld = va(function(t) {
          var n = [];
          return t.charCodeAt(0) === 46 && n.push(""), t.replace(_e, function(o, c, _, v) {
            n.push(_ ? v.replace(ts, "$1") : c || o);
          }), n;
        });
        function Ts(t) {
        ...
        function Tc(t, n, o) {
          (o ? ht(t, n, o) : n === r) ? n = 1 : n = Ve(me(n), 0);
          var c = t == null ? 0 : t.length;
          if (!c || n < 1) return [];
          for (var _ = 0, v = 0, M = F(Nr(c / n)); _ < c; ) M[v++] = pt(t, _, _ += n);
          return M;
        }
        function uo(t) {
          for (var n = -1, o = t == null ? 0 : t.length, c = 0, _ = []; ++n < o; ) {
            var v = t[n];
            v && (_[c++] = v);
          }
          return _;
        ...
        function kd() {
          ...
          if (!t) return [];
          for (var n = F(t - 1), o = arguments[0], c = t; c--; ) n[c - 1] = arguments[c];
          return hs(de(o) ? ct(o) : [o], st(n, 1));
        }
        var Td = le(function(t, n) {
          return Xe(t) ? ha(t, st(n, 1, Xe, true)) : [];
        }), Dc = le(function(t, n) {
          var o = Oe(n);
          return Xe(o) && (o = r), Xe(t) ? ha(t, st(n, 1, Xe, true), ee(o, 2)) : [];
        }), co = le(function(t, n) {
          var o = Oe(n);
          return Xe(o) && (o = r), Xe(t) ? ha(t, st(n, 1, Xe, true), r, o) : [];
        });
        function Dd(t, n, o) {
          var c = t == null ? 0 : t.length;
          return c ? (n = o || n === r ? 1 : me(n), pt(t, n < 0 ? 0 : n, c)) : [];
        }
        function Yc(t, n, o) {
          var c = t == null ? 0 : t.length;
          return c ? (n = o || n === r ? 1 : me(n), n = c - n, pt(t, 0, n < 0 ? 0 : n)) : [];
        }
        function Cc(t, n) {
          return t && t.length ? Vr(t, ee(n, 3), true, true) : [];
        }
        function Yd(t, n) {
          return t && t.length ? Vr(t, ee(n, 3), true) : [];
        }
        function bc(t, n, o, c) {
          var _ = t == null ? 0 : t.length;
          return _ ? (o && typeof o != "number" && ht(t, n, o) && (o = 0, c = _), Ku(t, n, o, c)) : [];
        }
        function ei(t, n, o) {
          var c = t == null ? 0 : t.length;
          if (!c) return -1;
          var _ = o == null ? 0 : me(o);
          return _ < 0 && (_ = Ve(c + _, 0)), Tr(t, ee(n, 3), _);
        }
        function En(t, n, o) {
          var c = t == null ? 0 : t.length;
          if (!c) return -1;
          var _ = c - 1;
          return o !== r && (_ = me(o), _ = o < 0 ? Ve(c + _, 0) : Be(_, c - 1)), Tr(t, ee(n, 3), _, true);
        }
        function $s(t) {
        ...
        function Sc(t, n) {
          ...
          return o ? (n = n === r ? 1 : me(n), st(t, n)) : [];
        }
        function fn(t) {
          for (var n = -1, o = t == null ? 0 : t.length, c = {}; ++n < o; ) {
            var _ = t[n];
            c[_[0]] = _[1];
          }
          return c;
        ...
        function Cd(t, n, o) {
          ...
          if (!c) return -1;
          var _ = o == null ? 0 : me(o);
          return _ < 0 && (_ = Ve(c + _, 0)), ra(t, n, _);
        }
        function go(t) {
          var n = t == null ? 0 : t.length;
          return n ? pt(t, 0, -1) : [];
        ...
        var Fc = le(function(t) {
          ...
          var n = Oe(t), o = xe(t, $i);
          return n === Oe(o) ? n = r : o.pop(), o.length && o[0] === t[0] ? Pi(o, ee(n, 2)) : [];
        }), La = le(function(t) {
          var n = Oe(t), o = xe(t, $i);
          return n = typeof n == "function" ? n : r, n && o.pop(), o.length && o[0] === t[0] ? Pi(o, r, n) : [];
        });
        function Gt(t, n) {
          return t == null ? "" : ma.call(t, n);
        }
        function Oe(t) {
          var n = t == null ? 0 : t.length;
          return n ? t[n - 1] : r;
        ...
        function Pt(t, n, o) {
          ...
          if (!c) return -1;
          var _ = c;
          return o !== r && (_ = me(o), _ = _ < 0 ? Ve(c + _, 0) : Be(_, c - 1)), n === n ? uu(t, n, _) : Tr(t, hl, _, true);
        }
        function jt(t, n) {
          return t && t.length ? Gl(t, me(n)) : r;
        }
        var Nc = le(bd);
        function bd(t, n) {
        ...
        function ho(t, n, o) {
          return t && t.length && n && n.length ? Oi(t, n, ee(o, 2)) : t;
        }
        function fo(t, n, o) {
          return t && t.length && n && n.length ? Oi(t, n, r, o) : t;
        }
        var _o = Bs(function(t, n) {
          var o = t == null ? 0 : t.length, c = Ir(t, n);
          return At(t, xe(n, function(_) {
            return Ws(_, o) ? +_ : _;
          }).sort(Vi)), c;
        });
        function Ac(t, n) {
        ...
        function ka(t, n, o) {
          var c = t == null ? 0 : t.length;
          return c ? (o && typeof o != "number" && ht(t, n, o) ? (n = 0, o = c) : (n = n == null ? 0 : me(n), o = o === r ? c : me(o)), pt(t, n, o)) : [];
        }
        function Ec(t, n) {
          return Za(t, n);
        }
        function yo(t, n, o) {
          return Ui(t, n, ee(o, 2));
        }
        function Vt(t, n) {
          var o = t == null ? 0 : t.length;
          if (o) {
            var c = Za(t, n);
            if (c < o && Gs(t[c], n)) return c;
          }
          return -1;
        }
        function Hc(t, n) {
        ...
        function Pn(t, n, o) {
          return Ui(t, n, ee(o, 2), true);
        }
        function Pc(t, n) {
          var o = t == null ? 0 : t.length;
          if (o) {
            var c = Za(t, n, true) - 1;
            if (Gs(t[c], n)) return c;
          }
          return -1;
        }
        function Ta(t) {
        ...
        function e(t, n, o) {
          return t && t.length ? (n = o || n === r ? 1 : me(n), pt(t, 0, n < 0 ? 0 : n)) : [];
        }
        function s(t, n, o) {
          var c = t == null ? 0 : t.length;
          return c ? (n = o || n === r ? 1 : me(n), n = c - n, pt(t, n < 0 ? 0 : n, c)) : [];
        }
        function d(t, n) {
          return t && t.length ? Vr(t, ee(n, 3), false, true) : [];
        }
        function m(t, n) {
          return t && t.length ? Vr(t, ee(n, 3)) : [];
        }
        var h = le(function(t) {
          return un(st(t, 1, Xe, true));
        }), k = le(function(t) {
          var n = Oe(t);
          return Xe(n) && (n = r), un(st(t, 1, Xe, true), ee(n, 2));
        }), S = le(function(t) {
          var n = Oe(t);
          return n = typeof n == "function" ? n : r, un(st(t, 1, Xe, true), r, n);
        });
        function W(t) {
          return t && t.length ? un(t) : [];
        }
        function ie(t, n) {
          return t && t.length ? un(t, ee(n, 2)) : [];
        }
        function ye(t, n) {
        ...
        function nt(t) {
          ...
          return t = an(t, function(o) {
            if (Xe(o)) return n = Ve(o.length, n), true;
          }), Di(n, function(o) {
            return xe(t, Li(o));
          });
        }
        function Ds(t, n) {
          if (!(t && t.length)) return [];
          var o = nt(t);
          return n == null ? o : xe(o, function(c) {
            return mt(n, r, c);
          });
        }
        var _n = le(function(t, n) {
          return Xe(t) ? ha(t, n) : [];
        }), C1 = le(function(t) {
          return Wi(an(t, Xe));
        }), b1 = le(function(t) {
          var n = Oe(t);
          return Xe(n) && (n = r), Wi(an(t, Xe), ee(n, 2));
        }), S1 = le(function(t) {
          var n = Oe(t);
          return n = typeof n == "function" ? n : r, Wi(an(t, Xe), r, n);
        }), F1 = le(nt);
        function x1(t, n) {
          return cn(t || [], n || [], Ga);
        }
        ...
        var H1 = Bs(function(t) {
          var n = t.length, o = n ? t[0] : 0, c = this.__wrapped__, _ = function(v) {
            return Ir(v, t);
          };
          return n > 1 || this.__actions__.length || !(c instanceof ue) || !Ws(o) ? this.thru(_) : (c = c.slice(o, +o + (n ? 1 : 0)), c.__actions__.push({ func: Fd, args: [_], thisArg: r }), new Wt(c, this.__chain__).thru(function(v) {
        ...
        function q1() {
          this.__values__ === r && (this.__values__ = c_(this.value()));
        ...
        function R1(t) {
          for (var n, o = this; o instanceof jr; ) {
            var c = mo(o);
            c.__index__ = 0, c.__values__ = r, n ? _.__wrapped__ = c : n = c;
            var _ = c;
            o = o.__wrapped__;
          }
        ...
        function I1() {
          ...
          if (t instanceof ue) {
            var n = t;
            return this.__actions__.length && (n = new ue(this)), n = n.reverse(), n.__actions__.push({ func: Fd, args: [po], thisArg: r }), new Wt(n, this.__chain__);
          }
          return this.thru(po);
        }
        function U1() {
        ...
        var z1 = Qa(function(t, n, o) {
          De.call(t, o) ? ++t[o] : Rs(t, o, 1);
        });
        function B1(t, n, o) {
          var c = de(t) ? Lr : Ju;
          return o && ht(t, n, o) && (n = r), c(t, ee(n, 3));
        }
        function W1(t, n) {
          var o = de(t) ? an : Rl;
          return o(t, ee(n, 3));
        }
        var $1 = od(ei), G1 = od(En);
        function V1(t, n) {
          return st(xd(t, n), 1);
        }
        function J1(t, n) {
        ...
        function K1(t, n, o) {
          return o = o === r ? 1 : me(o), st(xd(t, n), o);
        }
        function Xf(t, n) {
          var o = de(t) ? Ge : dn;
          return o(t, ee(n, 3));
        ...
        var Z1 = Qa(function(t, n, o) {
          De.call(t, o) ? t[o].push(n) : Rs(t, o, [n]);
        });
        function Q1(t, n, o, c) {
          t = Jt(t) ? t : ni(t), o = o && !c ? me(o) : 0;
          var _ = t.length;
          return o < 0 && (o = Ve(_ + o, 0)), Pd(t) ? o <= _ && t.indexOf(n, o) > -1 : !!_ && ra(t, n, o) > -1;
        }
        var X1 = le(function(t, n, o) {
          var c = -1, _ = typeof n == "function", v = Jt(t) ? F(t.length) : [];
          return dn(t, function(M) {
            v[++c] = _ ? mt(n, M, o) : vs(M, n, o);
          }), v;
        }), ev = Qa(function(t, n, o) {
          Rs(t, o, n);
        });
        function xd(t, n) {
          var o = de(t) ? xe : Wl;
        ...
        function tv(t, n, o, c) {
          return t == null ? [] : (de(n) || (n = n == null ? [] : [n]), o = c ? r : o, de(o) || (o = o == null ? [] : [o]), Vl(t, n, o));
        }
        var sv = Qa(function(t, n, o) {
          t[o ? 0 : 1].push(n);
        }, function() {
          return [[], []];
        });
        function nv(t, n, o) {
          ...
          return c(t, ee(n, 4), o, _, dn);
        }
        function av(t, n, o) {
          var c = de(t) ? eu : fl, _ = arguments.length < 3;
          return c(t, ee(n, 4), o, _, Ol);
        }
        function rv(t, n) {
          var o = de(t) ? an : Rl;
          return o(t, Ed(ee(n, 3)));
        }
        function iv(t) {
          var n = de(t) ? jl : ic;
          return n(t);
        ...
        function dv(t) {
          ...
          var n = We(t);
          return n == es || n == Ie ? t.size : zr(t).length;
        }
        function mv(t, n, o) {
          var c = de(t) ? Mi : mc;
          return o && ht(t, n, o) && (n = r), c(t, ee(n, 3));
        }
        var uv = le(function(t, n) {
          if (t == null) return [];
          var o = n.length;
          return o > 1 && ht(t, n[0], n[1]) ? n = [] : o > 2 && ht(n[0], n[1], n[2]) && (n = [n[0]]), Vl(t, st(n, 1), []);
        }), Nd = Lu || function() {
          return tt.Date.now();
        };
        function cv(t, n) {
          if (typeof n != "function") throw new Bt(f);
          return t = me(t), function() {
            if (--t < 1) return n.apply(this, arguments);
          };
        }
        function t_(t, n, o) {
          return n = o ? r : n, n = t && n == null ? t.length : n, zs(t, V, r, r, r, r, n);
        }
        function s_(t, n) {
          var o;
          if (typeof n != "function") throw new Bt(f);
        ...
        function a_(t, n, o) {
          n = o ? r : n;
          var c = zs(t, te, r, r, r, r, r, n);
          return c.placeholder = a_.placeholder, c;
        }
        function r_(t, n, o) {
          n = o ? r : n;
          var c = zs(t, Z, r, r, r, r, r, n);
          return c.placeholder = r_.placeholder, c;
        }
        function i_(t, n, o) {
          var c, _, v, M, T, C, P = 0, j = false, R = false, z = true;
          if (typeof t != "function") throw new Bt(f);
          n = Ys(n) || 0, $e(o) && (j = !!o.leading, R = "maxWait" in o, v = R ? Ve(Ys(o.maxWait) || 0, n) : v, z = "trailing" in o ? !!o.trailing : z);
          function K(et) {
            var Vs = c, On = _;
            return c = _ = r, P = et, M = t.apply(On, Vs), M;
          }
          function ne(et) {
            return P = et, T = Tt(ve, n), j ? K(et) : M;
          }
          function ce(et) {
            var Vs = et - C, On = et - P, D_ = n - Vs;
            return R ? Be(D_, v - On) : D_;
          }
          function ae(et) {
            var Vs = et - C, On = et - P;
            return C === r || Vs >= n || Vs < 0 || R && On >= v;
          }
          function ve() {
            var et = Nd();
          ...
          function ms() {
            ...
            if (c = arguments, _ = this, C = et, Vs) {
              if (T === r) return ne(C);
              if (R) return Ht(T), T = Tt(ve, n), K(C);
            }
            return T === r && (T = Tt(ve, n)), M;
          }
          return ms.cancel = ds, ms.flush = qt, ms;
        }
        var gv = le(function(t, n) {
          return _s(t, 1, n);
        }), hv = le(function(t, n, o) {
          return _s(t, Ys(n) || 0, o);
        });
        function fv(t) {
          return zs(t, je);
        }
        function Ad(t, n) {
          if (typeof t != "function" || n != null && typeof n != "function") throw new Bt(f);
          var o = function() {
            var c = arguments, _ = n ? n.apply(this, c) : c[0], v = o.cache;
            if (v.has(_)) return v.get(_);
            var M = t.apply(this, c);
            return o.cache = v.set(_, M) || v, M;
          };
          return o.cache = new (Ad.Cache || Os)(), o;
        }
        Ad.Cache = Os;
        function Ed(t) {
          if (typeof t != "function") throw new Bt(f);
        ...
        var pv = ed(function(t, n) {
          n = n.length == 1 && de(n[0]) ? xe(n[0], _t(ee())) : xe(st(n, 1), _t(ee()));
          var o = n.length;
          return le(function(c) {
            for (var _ = -1, v = Be(c.length, o); ++_ < v; ) c[_] = n[_].call(this, c[_]);
            return mt(t, this, c);
          });
        }), qc = le(function(t, n) {
          var o = ns(n, ya(qc));
          return zs(t, ge, r, n, o);
        }), o_ = le(function(t, n) {
          var o = ns(n, ya(o_));
          return zs(t, B, r, n, o);
        }), yv = Bs(function(t, n) {
          return zs(t, he, r, r, r, n);
        });
        function vv(t, n) {
          if (typeof t != "function") throw new Bt(f);
          return n = n === r ? n : me(n), le(t, n);
        }
        function wv(t, n) {
          if (typeof t != "function") throw new Bt(f);
          return n = n == null ? 0 : Ve(me(n), 0), le(function(o) {
            var c = o[n], _ = Et(o, 0, n);
        ...
        function Mv(t, n, o) {
          var c = true, _ = true;
          if (typeof t != "function") throw new Bt(f);
          return $e(o) && (c = "leading" in o ? !!o.leading : c, _ = "trailing" in o ? !!o.trailing : _), i_(t, n, { leading: c, maxWait: n, trailing: _ });
        }
        function Lv(t) {
          return t_(t, 1);
        }
        ...
        function Yv(t, n) {
          return n = typeof n == "function" ? n : r, Ft(t, N, n);
        }
        function Cv(t) {
          return Ft(t, b | N);
        }
        function bv(t, n) {
          return n = typeof n == "function" ? n : r, Ft(t, b | N, n);
        }
        function Sv(t, n) {
          return n == null || ql(t, n, lt(n));
        }
        function Gs(t, n) {
          return t === n || t !== t && n !== n;
        }
        var Fv = pa(Hi), xv = pa(function(t, n) {
          return t >= n;
        }), er = zl(/* @__PURE__ */ (function() {
          return arguments;
        })()) ? zl : function(t) {
          return Je(t) && De.call(t, "callee") && !Dl.call(t, "callee");
        }, de = F.isArray, Nv = ll ? _t(ll) : ec;
        function Jt(t) {
          return t != null && Hd(t.length) && !jn(t);
        }
        function Xe(t) {
          return Je(t) && Jt(t);
        }
        ...
        function qv(t, n, o) {
          ...
          var c = o ? o(t, n) : r;
          return c === r ? Va(t, n, r, o) : !!c;
        }
        function Oc(t) {
          if (!Je(t)) return false;
          var n = ut(t);
          return n == dr || n == Mm || typeof t.message == "string" && typeof t.name == "string" && !wo(t);
        }
        function Ov(t) {
        ...
        var d_ = dl ? _t(dl) : ji;
        function Rv(t, n) {
          return t === n || mn(t, n, no(n));
        }
        function Iv(t, n, o) {
          return o = typeof o == "function" ? o : r, mn(t, n, no(n), o);
        }
        function Uv(t) {
          return m_(t) && t != +t;
        }
        ...
        function wo(t) {
          ...
          return typeof o == "function" && o instanceof o && Oa.call(o) == yu;
        }
        var Rc = ml ? _t(ml) : we;
        function $v(t) {
          return l_(t) && t >= -Zs && t <= Zs;
        }
        var u_ = Ha ? _t(Ha) : Bl;
        function Pd(t) {
          return typeof t == "string" || !de(t) && Je(t) && ut(t) == wn;
        }
        function ls(t) {
        ...
        var Kv = pa(Br), Zv = pa(function(t, n) {
          return t <= n;
        });
        function c_(t) {
          if (!t) return [];
          if (Jt(t)) return Pd(t) ? St(t) : ct(t);
          if (Ra && t[Ra]) return du(t[Ra]());
          var n = We(t), o = n == es ? Ci : n == Ie ? oa : ni;
          return o(t);
        }
        function qn(t) {
          if (!t) return t === 0 ? t : 0;
        ...
        function Ys(t) {
          ...
          t = _l(t);
          var o = Fm.test(t);
          return o || Oo.test(t) ? il(t.slice(2), o ? 2 : 8) : Sm.test(t) ? Ct : +t;
        }
        function h_(t) {
          return Ls(t, Kt(t));
        }
        function Qv(t) {
          return t ? bn(me(t), -Zs, Zs) : t === 0 ? t : 0;
        }
        function be(t) {
          return t == null ? "" : yt(t);
        }
        var Xv = fa(function(t, n) {
          if (ks(n) || Jt(n)) {
            Ls(n, lt(n), t);
            return;
          }
          for (var o in n) De.call(n, o) && Ga(t, o, n[o]);
        }), f_ = fa(function(t, n) {
          Ls(n, Kt(n), t);
        }), jd = fa(function(t, n, o, c) {
          Ls(n, Kt(n), t, c);
        }), e2 = fa(function(t, n, o, c) {
          Ls(n, lt(n), t, c);
        }), t2 = Bs(Ir);
        function s2(t, n) {
          var o = ga(t);
          return n == null ? o : xi(o, n);
        }
        var n2 = le(function(t, n) {
          t = fe(t);
          var o = -1, c = n.length, _ = c > 2 ? n[2] : r;
          for (_ && ht(n[0], n[1], _) && (c = 1); ++o < c; ) for (var v = n[o], M = Kt(v), T = -1, C = M.length; ++T < C; ) {
            var P = M[T], j = t[P];
            (j === r || Gs(j, da[P]) && !De.call(t, P)) && (t[P] = v[P]);
          }
          return t;
        }), a2 = le(function(t) {
          return t.push(r, cd), mt(__, r, t);
        });
        function r2(t, n) {
          return cl(t, ee(n, 3), ps);
        }
        function i2(t, n) {
          return cl(t, ee(n, 3), Ei);
        }
        function o2(t, n) {
          return t == null ? t : Ai(t, ee(n, 3), Kt);
        }
        function l2(t, n) {
          return t == null ? t : Il(t, ee(n, 3), Kt);
        }
        function d2(t, n) {
          return t && ps(t, ee(n, 3));
        }
        function m2(t, n) {
          return t && Ei(t, ee(n, 3));
        }
        function u2(t) {
        ...
        function Ic(t, n, o) {
          var c = t == null ? r : Sn(t, n);
          return c === r ? o : c;
        }
        function g2(t, n) {
          return t != null && hd(t, n, Zu);
        }
        function Uc(t, n) {
          return t != null && hd(t, n, Qu);
        }
        var h2 = dd(function(t, n, o) {
          n != null && typeof n.toString != "function" && (n = Cr.call(n)), t[n] = o;
        }, Bc(Zt)), f2 = dd(function(t, n, o) {
          n != null && typeof n.toString != "function" && (n = Cr.call(n)), De.call(t, n) ? t[n].push(o) : t[n] = [o];
        }, ee), _2 = le(vs);
        function lt(t) {
        ...
        function p2(t, n) {
          var o = {};
          return n = ee(n, 3), ps(t, function(c, _, v) {
            Rs(o, n(c, _, v), c);
          }), o;
        }
        function y2(t, n) {
        ...
        var v2 = fa(function(t, n, o) {
          Wr(t, n, o);
        }), __ = fa(function(t, n, o, c) {
          Wr(t, n, o, c);
        }), w2 = Bs(function(t, n) {
          var o = {};
          if (t == null) return o;
          ...
          }), Ls(t, wt(t), o), c && (o = Ft(o, b | H | N, hc));
          for (var _ = n.length; _--; ) zi(o, n[_]);
          return o;
        });
        function M2(t, n) {
          return p_(t, Ed(ee(n)));
        }
        var L2 = Bs(function(t, n) {
          return t == null ? {} : rc(t, n);
        });
        function p_(t, n) {
          if (t == null) return {};
          ...
          return n = ee(n), Jl(t, o, function(c, _) {
            return n(c, _[0]);
          });
        }
        function k2(t, n, o) {
          ...
          var c = -1, _ = n.length;
          for (_ || (_ = 1, t = r); ++c < _; ) {
            var v = t == null ? r : t[Ts(n[c])];
            v === r && (c = _, v = o), t = jn(v) ? v.call(t) : v;
          }
          return t;
        }
        function T2(t, n, o) {
          return t == null ? t : Ka(t, n, o);
        }
        function D2(t, n, o, c) {
          return c = typeof c == "function" ? c : r, t == null ? t : Ka(t, n, o, c);
        }
        var y_ = md(lt), v_ = md(Kt);
        function Y2(t, n, o) {
          var c = de(t), _ = c || Da(t) || si(t);
          if (n = ee(n, 4), o == null) {
            var v = t && t.constructor;
            _ ? o = c ? new v() : [] : $e(t) ? o = jn(v) ? ga(Fr(t)) : {} : o = {};
          }
        ...
        function C2(t, n) {
          return t == null ? true : zi(t, n);
        }
        function b2(t, n, o) {
          return t == null ? t : Xl(t, n, Gi(o));
        }
        function S2(t, n, o, c) {
          return c = typeof c == "function" ? c : r, t == null ? t : Xl(t, n, Gi(o), c);
        }
        function ni(t) {
        ...
        function x2(t, n, o) {
          return o === r && (o = n, n = r), o !== r && (o = Ys(o), o = o === o ? o : 0), n !== r && (n = Ys(n), n = n === n ? n : 0), bn(Ys(t), n, o);
        }
        function N2(t, n, o) {
          return n = qn(n), o === r ? (o = n, n = 0) : o = qn(o), t = Ys(t), Xu(t, n, o);
        }
        function A2(t, n, o) {
          if (o && typeof o != "boolean" && ht(t, n, o) && (n = o = r), o === r && (typeof n == "boolean" ? (o = n, n = r) : typeof t == "boolean" && (o = t, t = r)), t === r && n === r ? (t = 0, n = 1) : (t = qn(t), n === r ? (n = t, t = 0) : n = qn(n)), t > n) {
            var c = t;
            t = n, n = c;
          }
          if (o || t % 1 || n % 1) {
            var _ = Fl();
            return Be(t + _ * (n - t + rl("1e-" + ((_ + "").length - 1))), n);
          }
          return $r(t, n);
        }
        var E2 = gn(function(t, n, o) {
          return n = n.toLowerCase(), t + (o ? w_(n) : n);
        });
        function w_(t) {
        ...
        function H2(t, n, o) {
          ...
          o = o === r ? c : bn(me(o), 0, c);
          var _ = o;
          return o -= n.length, o >= 0 && t.slice(o, _) == n;
        }
        function P2(t) {
          return t = be(t), t && fr.test(t) ? t.replace(Mn, ru) : t;
        }
        function j2(t) {
          return t = be(t), t && Ce.test(t) ? t.replace(Aa, "\\$&") : t;
        }
        var q2 = gn(function(t, n, o) {
          return t + (o ? "-" : "") + n.toLowerCase();
        }), O2 = gn(function(t, n, o) {
          return t + (o ? " " : "") + n.toLowerCase();
        }), R2 = id("toLowerCase");
        function I2(t, n, o) {
          t = be(t), n = me(n);
          ...
          if (!n || c >= n) return t;
          var _ = (n - c) / 2;
          return Zr(Ia(_), o) + t + Zr(Nr(_), o);
        }
        function U2(t, n, o) {
          t = be(t), n = me(n);
          var c = n ? rn(t) : 0;
          return n && c < n ? t + Zr(n - c, o) : t;
        }
        function z2(t, n, o) {
          t = be(t), n = me(n);
          var c = n ? rn(t) : 0;
          return n && c < n ? Zr(n - c, o) + t : t;
        }
        function B2(t, n, o) {
          return o || n == null ? n = 0 : n && (n = +n), Sl(be(t).replace(Ln, ""), n || 0);
        }
        function W2(t, n, o) {
          return (o ? ht(t, n, o) : n === r) ? n = 1 : n = me(n), Ii(be(t), n);
        }
        function $2() {
          var t = arguments, n = be(t[0]);
          return t.length < 3 ? n : n.replace(t[1], t[2]);
        }
        var G2 = gn(function(t, n, o) {
          return t + (o ? "_" : "") + n.toLowerCase();
        });
        function V2(t, n, o) {
          return o && typeof o != "number" && ht(t, n, o) && (n = o = r), o = o === r ? Ut : o >>> 0, o ? (t = be(t), t && (typeof n == "string" || n != null && !Rc(n)) && (n = yt(n), !n && fs(t)) ? Et(St(t), 0, o) : t.split(n, o)) : [];
        }
        var J2 = gn(function(t, n, o) {
          return t + (o ? " " : "") + zc(n);
        });
        function K2(t, n, o) {
          return t = be(t), o = o == null ? 0 : bn(me(o), 0, t.length), n = yt(n), t.slice(o, o + n.length) == n;
        }
        function Z2(t, n, o) {
          var c = y.templateSettings;
          o && ht(t, n, o) && (n = r), t = be(t), n = jd({}, n, c, ud);
          var _ = jd({}, n.imports, c.imports, ud), v = lt(_), M = Yi(_, v), T, C, P = 0, j = n.interpolate || sn, R = "__p += '", z = Ps((n.escape || sn).source + "|" + j.source + "|" + (j === qo ? Es : sn).source + "|" + (n.evaluate || sn).source + "|$", "g"), K = "//# sourceURL=" + (De.call(n, "sourceURL") ? (n.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Vm + "]") + `
`;
          t.replace(z, function(ae, ve, Me, ds, qt, ms) {
...
`) + R + `return __p
        ...
        function ew(t, n, o) {
          if (t = be(t), t && (o || n === r)) return _l(t);
          if (!t || !(n = yt(n))) return t;
          var c = St(t), _ = St(n), v = Ae(c, _), M = pl(c, _) + 1;
          return Et(c, v, M).join("");
        }
        function tw(t, n, o) {
          if (t = be(t), t && (o || n === r)) return t.slice(0, Dr(t) + 1);
          if (!t || !(n = yt(n))) return t;
          var c = St(t), _ = pl(c, St(n)) + 1;
          return Et(c, 0, _).join("");
        }
        function sw(t, n, o) {
          if (t = be(t), t && (o || n === r)) return t.replace(Ln, "");
          if (!t || !(n = yt(n))) return t;
          var c = St(t), _ = Ae(c, St(n));
          return Et(c, _).join("");
        }
        function nw(t, n) {
          var o = ke, c = pe;
          if ($e(n)) {
            ...
            o = "length" in n ? me(n.length) : o, c = "omission" in n ? yt(n.omission) : c;
          }
          t = be(t);
          var v = t.length;
          if (fs(t)) {
          ...
          var T = o - rn(c);
          if (T < 1) return c;
          var C = M ? Et(M, 0, T).join("") : t.slice(0, T);
          if (_ === r) return C + c;
        ...
        var rw = gn(function(t, n, o) {
          return t + (o ? " " : "") + n.toUpperCase();
        }), zc = id("toUpperCase");
        function L_(t, n, o) {
          return t = be(t), n = o ? r : n, n === r ? lu(t) ? fu(t) : su(t) : t.match(n) || [];
        }
        var k_ = le(function(t, n) {
          try {
            return mt(t, r, n);
          } catch (o) {
        ...
        function ow(t) {
          var n = t == null ? 0 : t.length, o = ee();
          return t = n ? xe(t, function(c) {
        ...
        var mw = ld(), uw = ld(true);
        function Zt(t) {
          return t;
        }
        function Wc(t) {
          return xt(typeof t == "function" ? t : Ft(t, b));
        }
        function cw(t) {
          return Nt(Ft(t, b));
        }
        ...
        function $c(t, n, o) {
          var c = lt(n), _ = ys(n, c);
          o == null && !($e(n) && (_.length || !c.length)) && (o = n, n = t, t = this, _ = ys(n, lt(n)));
          var v = !($e(o) && "chain" in o) || !!o.chain, M = jn(t);
        ...
        function pw(t) {
          return t = me(t), le(function(n) {
            return Gl(n, t);
          });
        }
        var yw = Qi(xe), vw = Qi(Lr), ww = Qi(Mi);
        function T_(t) {
          return Xr(t) ? Li(Ts(t)) : Kl(t);
        }
        function Mw(t) {
          return function(n) {
            return t == null ? r : Sn(t, n);
          };
        }
        var Lw = Xi(), kw = Xi(true);
        function Vc() {
          return [];
        }
        function Jc() {
        ...
        var Fw = gt(function(t, n) {
          return t + n;
        }, 0), xw = to("ceil"), Nw = gt(function(t, n) {
          return t / n;
        }, 1), Aw = to("floor");
        function Ew(t) {
        ...
        function Hw(t, n) {
          return t && t.length ? Ur(t, ee(n, 2), Hi) : r;
        }
        function Pw(t) {
          return Tn(t, Zt);
        }
        ...
        function Ow(t, n) {
          return t && t.length ? Ur(t, ee(n, 2), Br) : r;
        }
        var Rw = gt(function(t, n) {
          return t * n;
        }, 1), Iw = to("round"), Uw = gt(function(t, n) {
          return t - n;
        }, 0);
        function zw(t) {
        ...
        function Bw(t, n) {
          return t && t.length ? Ti(t, ee(n, 2)) : 0;
        }
        return y.after = cv, y.ary = t_, y.assign = Xv, y.assignIn = f_, y.assignInWith = jd, y.assignWith = e2, y.at = t2, y.before = s_, y.bind = jc, y.bindAll = iw, y.bindKey = n_, y.castArray = Tv, y.chain = Qf, y.chunk = Tc, y.compact = uo, y.concat = kd, y.cond = ow, y.conforms = lw, y.constant = Bc, y.countBy = z1, y.create = s2, y.curry = a_, y.curryRight = r_, y.debounce = i_, y.defaults = n2, y.defaultsDeep = a2, y.defer = gv, y.delay = hv, y.difference = Td, y.differenceBy = Dc, y.differenceWith = co, y.drop = Dd, y.dropRight = Yc, y.dropRightWhile = Cc, y.dropWhile = Yd, y.fill = bc, y.filter = W1, y.flatMap = V1, y.flatMapDeep = J1, y.flatMapDepth = K1, y.flatten = $s, y.flattenDeep = Hn, y.flattenDepth = Sc, y.flip = fv, y.flow = mw, y.flowRight = uw, y.fromPairs = fn, y.functions = u2, y.functionsIn = c2, y.groupBy = Z1, y.initial = go, y.intersection = Fc, y.intersectionBy = xc, y.intersectionWith = La, y.invert = h2, y.invertBy = f2, y.invokeMap = X1, y.iteratee = Wc, y.keyBy = ev, y.keys = lt, y.keysIn = Kt, y.map = xd, y.mapKeys = p2, y.mapValues = y2, y.matches = cw, y.matchesProperty = gw, y.memoize = Ad, y.merge = v2, y.mergeWith = __, y.method = hw, y.methodOf = fw, y.mixin = $c, y.negate = Ed, y.nthArg = pw, y.omit = w2, y.omitBy = M2, y.once = _v, y.orderBy = tv, y.over = yw, y.overArgs = pv, y.overEvery = vw, y.overSome = ww, y.partial = qc, y.partialRight = o_, y.partition = sv, y.pick = L2, y.pickBy = p_, y.property = T_, y.propertyOf = Mw, y.pull = Nc, y.pullAll = bd, y.pullAllBy = ho, y.pullAllWith = fo, y.pullAt = _o, y.range = Lw, y.rangeRight = kw, y.rearg = yv, y.reject = rv, y.remove = Ac, y.rest = vv, y.reverse = po, y.sampleSize = ov, y.set = T2, y.setWith = D2, y.shuffle = lv, y.slice = ka, y.sortBy = uv, y.sortedUniq = Ta, y.sortedUniqBy = Sd, y.split = V2, y.spread = wv, y.tail = vo, y.take = e, y.takeRight = s, y.takeRightWhile = d, y.takeWhile = m, y.tap = E1, y.throttle = Mv, y.thru = Fd, y.toArray = c_, y.toPairs = y_, y.toPairsIn = v_, y.toPath = bw, y.toPlainObject = h_, y.transform = Y2, y.unary = Lv, y.union = h, y.unionBy = k, y.unionWith = S, y.uniq = W, y.uniqBy = ie, y.uniqWith = ye, y.unset = C2, y.unzip = nt, y.unzipWith = Ds, y.update = b2, y.updateWith = S2, y.values = ni, y.valuesIn = F2, y.without = _n, y.words = L_, y.wrap = kv, y.xor = C1, y.xorBy = b1, y.xorWith = S1, y.zip = F1, y.zipObject = x1, y.zipObjectDeep = N1, y.zipWith = A1, y.entries = y_, y.entriesIn = v_, y.extend = f_, y.extendWith = jd, $c(y, y), y.add = Fw, y.attempt = k_, y.camelCase = E2, y.capitalize = w_, y.ceil = xw, y.clamp = x2, y.clone = Dv, y.cloneDeep = Cv, y.cloneDeepWith = bv, y.cloneWith = Yv, y.conformsTo = Sv, y.deburr = M_, y.defaultTo = dw, y.divide = Nw, y.endsWith = H2, y.eq = Gs, y.escape = P2, y.escapeRegExp = j2, y.every = B1, y.find = $1, y.findIndex = ei, y.findKey = r2, y.findLast = G1, y.findLastIndex = En, y.findLastKey = i2, y.floor = Aw, y.forEach = Xf, y.forEachRight = e_, y.forIn = o2, y.forInRight = l2, y.forOwn = d2, y.forOwnRight = m2, y.get = Ic, y.gt = Fv, y.gte = xv, y.has = g2, y.hasIn = Uc, y.head = ti, y.identity = Zt, y.includes = Q1, y.indexOf = Cd, y.inRange = N2, y.invoke = _2, y.isArguments = er, y.isArray = de, y.isArrayBuffer = Nv, y.isArrayLike = Jt, y.isArrayLikeObject = Xe, y.isBoolean = Av, y.isBuffer = Da, y.isDate = Ev, y.isElement = Hv, y.isEmpty = Pv, y.isEqual = jv, y.isEqualWith = qv, y.isError = Oc, y.isFinite = Ov, y.isFunction = jn, y.isInteger = l_, y.isLength = Hd, y.isMap = d_, y.isMatch = Rv, y.isMatchWith = Iv, y.isNaN = Uv, y.isNative = zv, y.isNil = Wv, y.isNull = Bv, y.isNumber = m_, y.isObject = $e, y.isObjectLike = Je, y.isPlainObject = wo, y.isRegExp = Rc, y.isSafeInteger = $v, y.isSet = u_, y.isString = Pd, y.isSymbol = ls, y.isTypedArray = si, y.isUndefined = Gv, y.isWeakMap = Vv, y.isWeakSet = Jv, y.join = Gt, y.kebabCase = q2, y.last = Oe, y.lastIndexOf = Pt, y.lowerCase = O2, y.lowerFirst = R2, y.lt = Kv, y.lte = Zv, y.max = Ew, y.maxBy = Hw, y.mean = Pw, y.meanBy = jw, y.min = qw, y.minBy = Ow, y.stubArray = Vc, y.stubFalse = Jc, y.stubObject = Tw, y.stubString = Dw, y.stubTrue = Yw, y.multiply = Rw, y.nth = jt, y.noConflict = _w, y.noop = Gc, y.now = Nd, y.pad = I2, y.padEnd = U2, y.padStart = z2, y.parseInt = B2, y.random = A2, y.reduce = nv, y.reduceRight = av, y.repeat = W2, y.replace = $2, y.result = k2, y.round = Iw, y.runInContext = Y, y.sample = iv, y.size = dv, y.snakeCase = G2, y.some = mv, y.sortedIndex = Ec, y.sortedIndexBy = yo, y.sortedIndexOf = Vt, y.sortedLastIndex = Hc, y.sortedLastIndexBy = Pn, y.sortedLastIndexOf = Pc, y.startCase = J2, y.startsWith = K2, y.subtract = Uw, y.sum = zw, y.sumBy = Bw, y.template = Z2, y.times = Cw, y.toFinite = qn, y.toInteger = me, y.toLength = g_, y.toLower = Q2, y.toNumber = Ys, y.toSafeInteger = Qv, y.toString = be, y.toUpper = X2, y.trim = ew, y.trimEnd = tw, y.trimStart = sw, y.truncate = nw, y.unescape = aw, y.uniqueId = Sw, y.upperCase = rw, y.upperFirst = zc, y.each = Xf, y.eachRight = e_, y.first = ti, $c(y, (function() {
          var t = {};
          return ps(y, function(n, o) {
            De.call(y.prototype, o) || (t[o] = n);
          }), t;
        ...
        }, ue.prototype.invokeMap = le(function(t, n) {
          ...
          t = me(t);
          var o = this;
          return o.__filtered__ && (t > 0 || n < 0) ? new ue(o) : (t < 0 ? o = o.takeRight(-t) : t && (o = o.drop(t)), n !== r && (n = me(n), o = n < 0 ? o.dropRight(-n) : o.take(n - t)), o);
        }, ue.prototype.takeRightWhile = function(t) {
          return this.reverse().takeWhile(t).reverse();
        }, ue.prototype.toArray = function() {
          return this.take(Ut);
        }, ps(ue.prototype, function(t, n) {
          var o = /^(?:filter|find|map|reject)|While$/.test(n), c = /^(?:head|last)$/.test(n), _ = y[c ? "take" + (n == "last" ? "Right" : "") : n], v = c || /^find/.test(n);
          ...
          var n = qa[t], o = /^(?:push|sort|unshift)$/.test(t) ? "tap" : "thru", c = /^(?:pop|shift)$/.test(t);
          y.prototype[t] = function() {
            var _ = arguments;
            if (c && !this.__chain__) {
              var v = this.value();
              return n.apply(de(v) ? v : [], _);
            }
            return this[o](function(M) {
              return n.apply(de(M) ? M : [], _);
            });
          };
        }), ps(ue.prototype, function(t, n) {
          var o = y[n];
          if (o) {
            var c = o.name + "";
            De.call(ca, c) || (ca[c] = []), ca[c].push({ name: n, func: o });
          }
        }), ca[Fn(r, Q).name] = [{ name: "wrapper", func: r }], ue.prototype.clone = Fu, ue.prototype.reverse = xu, ue.prototype.value = Nu, y.prototype.at = H1, y.prototype.chain = P1, y.prototype.commit = j1, y.prototype.next = q1, y.prototype.plant = R1, y.prototype.reverse = I1, y.prototype.toJSON = y.prototype.valueOf = y.prototype.value = U1, y.prototype.first = y.prototype.head, Ra && (y.prototype[Ra] = O1), y;
      }), la = _u();
...
function up() {
  if (mp) return Mg;
  mp = 1;
  var a = Id(), i = Xc(), r = "[object AsyncFunction]", l = "[object Function]", u = "[object GeneratorFunction]", g = "[object Proxy]";
  function f(p) {
    if (!i(p)) return false;
    var L = a(p);
...
function yL() {
  if (cp) return Lg;
  cp = 1;
  var a = ba(), i = a["__core-js_shared__"];
  return Lg = i, Lg;
}
var kg, gp;
function vL() {
...
function fp() {
  if (hp) return Tg;
  hp = 1;
  var a = Function.prototype, i = a.toString;
  function r(l) {
    if (l != null) {
      try {
        return i.call(l);
...
function wL() {
  if (_p) return Dg;
  _p = 1;
  var a = up(), i = vL(), r = Xc(), l = fp(), u = /[\\^$.*+?()[\]{}|]/g, g = /^\[object .+?Constructor\]$/, f = Function.prototype, p = Object.prototype, L = f.toString, w = p.hasOwnProperty, D = RegExp("^" + L.call(w).replace(u, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
  function b(H) {
...
function TL() {
  if (Lp) return xg;
  Lp = 1;
  var a = nm(), i = "__lodash_hash_undefined__", r = Object.prototype, l = r.hasOwnProperty;
  function u(g) {
    var f = this.__data__;
    if (a) {
      var p = f[g];
...
function DL() {
  if (kp) return Ng;
  kp = 1;
  var a = nm(), i = Object.prototype, r = i.hasOwnProperty;
  function l(u) {
    var g = this.__data__;
    return a ? g[u] !== void 0 : r.call(g, u);
  }
  return Ng = l, Ng;
}
var Ag, Tp;
function YL() {
  if (Tp) return Ag;
  Tp = 1;
  var a = nm(), i = "__lodash_hash_undefined__";
  function r(l, u) {
    var g = this.__data__;
    return this.size += this.has(l) ? 0 : 1, g[l] = a && u === void 0 ? i : u, this;
  }
  return Ag = r, Ag;
}
var Eg, Dp;
function CL() {
  ...
  return g.prototype.clear = a, g.prototype.delete = i, g.prototype.get = r, g.prototype.has = l, g.prototype.set = u, Eg = g, Eg;
}
var Hg, Yp;
function bL() {
  if (Yp) return Hg;
...
function am() {
  ...
  var a = bp();
  function i(r, l) {
    for (var u = r.length; u--; ) if (a(r[u][0], l)) return u;
    return -1;
  }
  return jg = i, jg;
}
...
function SL() {
  if (Fp) return qg;
  Fp = 1;
  var a = am(), i = Array.prototype, r = i.splice;
  function l(u) {
    var g = this.__data__, f = a(g, u);
    if (f < 0) return false;
    var p = g.length - 1;
...
function rm() {
  ...
  return g.prototype.clear = a, g.prototype.delete = i, g.prototype.get = r, g.prototype.has = l, g.prototype.set = u, Ug = g, Ug;
}
var zg, Hp;
function Bg() {
  if (Hp) return zg;
  Hp = 1;
  var a = ri(), i = ba(), r = a(i, "Map");
  return zg = r, zg;
}
var Wg, Pp;
function AL() {
...
function im() {
  ...
  function i(r, l) {
    var u = r.__data__;
    return a(l) ? u[typeof l == "string" ? "string" : "hash"] : u.map;
  }
  return Gg = i, Gg;
}
var Vg, Op;
...
function Xg() {
  ...
  return g.prototype.clear = a, g.prototype.delete = i, g.prototype.get = r, g.prototype.has = l, g.prototype.set = u, Qg = g, Qg;
}
var eh, Bp;
function OL() {
  if (Bp) return eh;
  Bp = 1;
  var a = Xg(), i = "Expected a function";
  function r(l, u) {
    ...
    return g.cache = new (r.Cache || a)(), g;
  }
  return r.Cache = a, eh = r, eh;
}
var th, Wp;
function RL() {
  if (Wp) return th;
...
function IL() {
  if ($p) return sh;
  $p = 1;
  var a = RL(), i = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, r = /\\(\\)?/g, l = a(function(u) {
    var g = [];
...
function UL() {
  if (Gp) return nh;
  Gp = 1;
  var a = F_(), i = op(), r = yn(), l = Rd(), u = a ? a.prototype : void 0, g = u ? u.toString : void 0;
  function f(p) {
...
function Kp() {
  if (Jp) return rh;
  Jp = 1;
  var a = yn(), i = wg(), r = IL(), l = zL();
  function u(g, f) {
    return a(g) ? g : i(g, f) ? [g] : r(l(g));
  }
  return rh = u, rh;
}
var ih, Zp;
...
function ry() {
  if (ay) return hh;
  ay = 1;
  var a = rm(), i = BL(), r = WL(), l = $L(), u = GL(), g = VL();
  function f(p) {
    var L = this.__data__ = new a(p);
    this.size = L.size;
  }
...
function ZL() {
  ...
  function l(u) {
    ...
    for (this.__data__ = new a(); ++g < f; ) this.add(u[g]);
  }
...
function cy() {
  if (uy) return wh;
  uy = 1;
  var a = ZL(), i = QL(), r = XL(), l = 1, u = 2;
  function g(f, p, L, w, D, b) {
    var H = L & l, N = f.length, q = p.length;
    if (N != q && !(H && q > N)) return false;
    var I = b.get(f), x = b.get(p);
    if (I && x) return I == p && x == f;
    var Q = -1, X = true, te = L & u ? new a() : void 0;
    for (b.set(f, p), b.set(p, f); ++Q < N; ) {
      ...
      if (te) {
        if (!i(p, function(V, he) {
          if (!r(te, he) && (Z === V || D(Z, V, L, w, b))) return te.push(he);
        })) {
          X = false;
          break;
        }
...
function nk() {
  if (_y) return Th;
  _y = 1;
  var a = F_(), i = ek(), r = bp(), l = cy(), u = tk(), g = sk(), f = 1, p = 2, L = "[object Boolean]", w = "[object Date]", D = "[object Error]", b = "[object Map]", H = "[object Number]", N = "[object RegExp]", q = "[object Set]", I = "[object String]", x = "[object Symbol]", Q = "[object ArrayBuffer]", X = "[object DataView]", te = a ? a.prototype : void 0, Z = te ? te.valueOf : void 0;
  function ge(B, V, he, je, ke, pe, It) {
    switch (he) {
      case X:
      ...
      case q:
        ...
        if (Ks) return Ks == V;
        je |= p, It.set(B, V);
        var Fa = l(Re(B), Re(V), je, ke, pe, It);
        return It.delete(B), Fa;
      case x:
...
function lk() {
  if (My) return Sh;
  My = 1;
  var a = ik(), i = ok(), r = Object.prototype, l = r.propertyIsEnumerable, u = Object.getOwnPropertySymbols, g = u ? function(f) {
    return f == null ? [] : (f = Object(f), a(u(f), function(p) {
      return l.call(f, p);
    }));
  } : i;
  return Sh = g, Sh;
...
function mk() {
  if (ky) return xh;
  ky = 1;
  var a = Id(), i = Ud(), r = "[object Arguments]";
  function l(u) {
    return i(u) && a(u) == r;
  }
  return xh = l, xh;
...
function Dy() {
  if (Ty) return Nh;
  Ty = 1;
  var a = mk(), i = Ud(), r = Object.prototype, l = r.hasOwnProperty, u = r.propertyIsEnumerable, g = a(/* @__PURE__ */ (function() {
    return arguments;
  })()) ? a : function(f) {
...
var Cy;
function by() {
  return Cy || (Cy = 1, (function(a, i) {
    var r = ba(), l = uk(), u = i && !i.nodeType && i, g = u && true && a && !a.nodeType && a, f = g && g.exports === u, p = f ? r.Buffer : void 0, L = p ? p.isBuffer : void 0, w = L || l;
    a.exports = w;
...
function Fy() {
  if (Sy) return Eh;
  Sy = 1;
  var a = 9007199254740991, i = /^(?:0|[1-9]\d*)$/;
  function r(l, u) {
    var g = typeof l;
    return u = u ?? a, !!u && (g == "number" || g != "symbol" && i.test(l)) && l > -1 && l % 1 == 0 && l < u;
  }
  return Eh = r, Eh;
}
var Hh, xy;
...
function ck() {
  if (Ny) return jh;
  Ny = 1;
  var a = Id(), i = Ph(), r = Ud(), l = "[object Arguments]", u = "[object Array]", g = "[object Boolean]", f = "[object Date]", p = "[object Error]", L = "[object Function]", w = "[object Map]", D = "[object Number]", b = "[object Object]", H = "[object RegExp]", N = "[object Set]", q = "[object String]", I = "[object WeakMap]", x = "[object ArrayBuffer]", Q = "[object DataView]", X = "[object Float32Array]", te = "[object Float64Array]", Z = "[object Int8Array]", ge = "[object Int16Array]", B = "[object Int32Array]", V = "[object Uint8Array]", he = "[object Uint8ClampedArray]", je = "[object Uint16Array]", ke = "[object Uint32Array]", pe = {};
  pe[X] = pe[te] = pe[Z] = pe[ge] = pe[B] = pe[V] = pe[he] = pe[je] = pe[ke] = true, pe[l] = pe[u] = pe[x] = pe[g] = pe[Q] = pe[f] = pe[p] = pe[L] = pe[w] = pe[D] = pe[b] = pe[H] = pe[N] = pe[q] = pe[I] = false;
  function It(Re) {
    return r(Re) && i(Re.length) && !!pe[a(Re)];
  }
  return jh = It, jh;
}
var qh, Ay;
...
var Hy;
function gk() {
  return Hy || (Hy = 1, (function(a, i) {
    var r = Jw(), l = i && !i.nodeType && i, u = l && true && a && !a.nodeType && a, g = u && u.exports === l, f = g && r.process, p = (function() {
      try {
...
function jy() {
  if (Py) return Oh;
  Py = 1;
  var a = ck(), i = Ey(), r = gk(), l = r && r.isTypedArray, u = l ? i(l) : a;
  return Oh = u, Oh;
}
var Rh, qy;
function hk() {
  if (qy) return Rh;
  qy = 1;
  var a = dk(), i = Dy(), r = yn(), l = by(), u = Fy(), g = jy(), f = Object.prototype, p = f.hasOwnProperty;
  function L(w, D) {
    var b = r(w), H = !b && i(w), N = !b && !H && l(w), q = !b && !H && !N && g(w), I = b || H || N || q, x = I ? a(w.length, String) : [], Q = x.length;
    for (var X in w) (D || p.call(w, X)) && !(I && (X == "length" || N && (X == "offset" || X == "parent") || q && (X == "buffer" || X == "byteLength" || X == "byteOffset") || u(X, Q))) && x.push(X);
    return x;
  }
  return Rh = L, Rh;
}
...
function fk() {
  ...
  function i(r) {
    var l = r && r.constructor, u = typeof l == "function" && l.prototype || a;
    return r === u;
  }
  return Ih = i, Ih;
}
...
function pk() {
  if (Iy) return zh;
  Iy = 1;
  var a = _k(), i = a(Object.keys, Object);
  return zh = i, zh;
}
var Bh, Uy;
function yk() {
  if (Uy) return Bh;
  Uy = 1;
  var a = fk(), i = pk(), r = Object.prototype, l = r.hasOwnProperty;
  function u(g) {
    if (!a(g)) return i(g);
    var f = [];
...
function wk() {
  if ($y) return Kh;
  $y = 1;
  var a = vk(), i = 1, r = Object.prototype, l = r.hasOwnProperty;
  function u(g, f, p, L, w, D) {
    var b = p & i, H = a(g), N = H.length, q = a(f), I = q.length;
    if (N != I && !b) return false;
    for (var x = N; x--; ) {
      var Q = H[x];
      if (!(b ? Q in f : l.call(f, Q))) return false;
    }
    var X = D.get(g), te = D.get(f);
    if (X && te) return X == f && te == g;
    var Z = true;
    D.set(g, f), D.set(f, g);
    for (var ge = b; ++x < N; ) {
      Q = H[x];
...
function Dk() {
  if (Zy) return tf;
  Zy = 1;
  var a = Mk(), i = Bg(), r = Lk(), l = kk(), u = Tk(), g = Id(), f = fp(), p = "[object Map]", L = "[object Object]", w = "[object Promise]", D = "[object Set]", b = "[object WeakMap]", H = "[object DataView]", N = f(a), q = f(i), I = f(r), x = f(l), Q = f(u), X = g;
  return (a && X(new a(new ArrayBuffer(1))) != H || i && X(new i()) != p || r && X(r.resolve()) != w || l && X(new l()) != D || u && X(new u()) != b) && (X = function(te) {
    var Z = g(te), ge = Z == L ? te.constructor : void 0, B = ge ? f(ge) : "";
    if (B) switch (B) {
      case N:
        return H;
      case q:
...
function Yk() {
  if (Qy) return sf;
  Qy = 1;
  var a = ry(), i = cy(), r = nk(), l = wk(), u = Dk(), g = yn(), f = by(), p = jy(), L = 1, w = "[object Arguments]", D = "[object Array]", b = "[object Object]", H = Object.prototype, N = H.hasOwnProperty;
  function q(I, x, Q, X, te, Z) {
    var ge = g(I), B = g(x), V = ge ? D : u(I), he = B ? D : u(x);
    ...
    if (pe && !je) return Z || (Z = new a()), ge || p(I) ? i(I, x, Q, X, te, Z) : r(I, x, V, Q, X, te, Z);
    if (!(Q & L)) {
      var It = je && N.call(I, "__wrapped__"), Re = ke && N.call(x, "__wrapped__");
      if (It || Re) {
        var zn = It ? I.value() : I, Ks = Re ? x.value() : x;
        return Z || (Z = new a()), te(zn, Ks, Q, X, Z);
      }
    }
    return pe ? (Z || (Z = new a()), l(I, x, Q, X, te, Z)) : false;
  }
  return sf = q, sf;
}
var nf, Xy;
function e0() {
  ...
  function r(l, u, g, f, p) {
    return l === u ? true : l == null || u == null || !i(l) && !i(u) ? l !== l && u !== u : a(l, u, g, f, r, p);
  }
  return nf = r, nf;
}
var af, t0;
function Ck() {
  ...
  function u(g, f, p, L) {
    ...
    for (; ++w < D; ) {
      H = p[w];
      var N = H[0], q = g[N], I = H[1];
      if (b && H[2]) {
        if (q === void 0 && !(N in g)) return false;
      } else {
        var x = new a();
        if (L) var Q = L(q, I, N, g, f, x);
        if (!(Q === void 0 ? i(I, q, r | l, L, x) : Q)) return false;
      }
    }
    return true;
  }
...
function Nk() {
  if (m0) return cf;
  m0 = 1;
  var a = Kp(), i = Dy(), r = yn(), l = Fy(), u = Ph(), g = om();
  function f(p, L, w) {
    L = a(L, p);
...
function Ek() {
  if (c0) return hf;
  c0 = 1;
  var a = e0(), i = Fk(), r = Ak(), l = wg(), u = n0(), g = i0(), f = om(), p = 1, L = 2;
  function w(D, b) {
    return l(D) && u(b) ? g(f(D), b) : function(H) {
      var N = i(H, D);
      return N === void 0 && N === b ? r(H, D) : a(b, N, p | L);
    };
  }
  return hf = w, hf;
}
...
function jk() {
  if (p0) return yf;
  p0 = 1;
  var a = Hk(), i = Pk(), r = wg(), l = om();
  function u(g) {
    return r(g) ? a(l(g)) : i(g);
  }
  return yf = u, yf;
}
var vf, y0;
function qk() {
  if (y0) return vf;
  y0 = 1;
  var a = Sk(), i = Ek(), r = h0(), l = yn(), u = jk();
  function g(f) {
    return typeof f == "function" ? f : f == null ? r : typeof f == "object" ? l(f) ? i(f[0], f[1]) : a(f) : u(f);
  }
  return vf = g, vf;
}
var wf, v0;
...
function $k() {
  ...
  function i(r, l) {
    if (r !== l) {
      var u = r !== void 0, g = r === null, f = r === r, p = a(r), L = l !== void 0, w = l === null, D = l === l, b = a(l);
...
function Vk() {
  if (b0) return Sf;
  b0 = 1;
  var a = op(), i = lh(), r = qk(), l = Bk(), u = Wk(), g = Ey(), f = Gk(), p = h0(), L = yn();
  function w(D, b, H) {
    b.length ? b = a(b, function(I) {
      return L(I) ? function(x) {
        return i(x, I.length === 1 ? I[0] : I);
      } : I;
    }) : b = [p];
    var N = -1;
    b = a(b, g(r));
    var q = l(D, function(I, x, Q) {
      var X = a(b, function(te) {
        return te(I);
      });
      return { criteria: X, index: ++N, value: I };
    });
    return u(q, function(I, x) {
      return f(I, x, H);
    });
  }
  return Sf = w, Sf;
...
function Jk() {
  ...
  var a = Vk(), i = yn();
  function r(l, u, g, f) {
    return l == null ? [] : (i(u) || (u = u == null ? [] : [u]), g = f ? void 0 : g, i(g) || (g = g == null ? [] : [g]), a(l, u, g));
  }
  return Ff = r, Ff;
}
var Kk = Jk();
const ir = Kc(Kk), ii = Rn("inquiryGroups", () => {
  const a = tr([]), i = tr(false), r = zd(() => {
    const N = Ee();
    if (N.route.name === "group") return a.value.find((q) => q.slug === N.route.params.slug);
  }), l = zd(() => rp.orderBy(a.value.filter((N) => g.value[N.id] > 0), ["title"], ["asc"])), u = zd(() => {
    const N = Yt();
    return r.value ? N.inquiries.filter((q) => r.value?.inquiryIds.includes(q.id)) : [];
  }), g = zd(() => {
    const N = {}, q = Yt();
    return a.value.forEach((I) => {
      N[I.id] = q.inquiries.filter((x) => I.inquiryIds.includes(x.id)).length;
    }), N;
  });
  function f(N) {
    return a.value.filter((q) => !q.inquiryIds.includes(N));
  }
  function p(N) {
    if (!r.value) throw new Error("No current inquiry group set");
    a.value = a.value.map((q) => q.id === r.value?.id ? { ...q, name: N.name ?? q.name, titleExt: N.titleExt ?? q.titleExt, description: N.description ?? q.description } : q);
  }
  async function L() {
    if (!r.value) throw new Error("No current inquiry group set");
    try {
      ...
      throw se.error("Error updating inquiry group", { error: N, inquiryGroup: r.value }), N;
    }
  }
  function w(N) {
    a.value = a.value.filter((q) => q.id !== N.inquiryGroup.id).concat(N.inquiryGroup);
  }
  async function D(N) {
    const q = Yt();
    try {
      const I = await dm.addInquiryToGroup(N.inquiryId, N.inquiryGroupId, N.groupTitle);
      w({ inquiryGroup: I.data.inquiryGroup }), q.addOrUpdateInquiryGroupInList({ inquiry: I.data.inquiry });
    } catch (I) {
      if (I?.code === "ERR_CANCELED") return;
      throw se.error("Error adding inquiry to group", { error: I, payload: N }), q.load(), I;
    }
  }
  async function b(N) {
    const q = Yt();
    try {
      const I = await dm.removeInquiryFromGroup(N.inquiryGroupId, N.inquiryId);
      if (q.addOrUpdateInquiryGroupInList({ inquiry: I.data.inquiry }), I.data.inquiryGroup === null) {
        a.value = a.value.filter((x) => x.id !== N.inquiryGroupId);
        return;
      }
      w({ inquiryGroup: I.data.inquiryGroup });
    } catch (I) {
      if (I?.code !== "ERR_CANCELED") throw se.error("Error removing inquiry from group", { error: I, payload: N }), I;
    } finally {
    }
  }
  function H(N) {
    const q = a.value.find((I) => I.id === N);
    return q ? q.name : re("inquiries", "Invalid Group ID");
  }
  return { inquiryGroups: a, updating: i, inquiryGroupsSorted: l, countInquiriesInInquiryGroups: g, currentInquiryGroup: r, inquiriesInCurrendInquiryGroup: u, addableInquiryGroups: f, setCurrentInquiryGroup: p, setInquiryGroupElement: w, writeCurrentInquiryGroup: L, addInquiryToInquiryGroup: D, removeInquiryFromGroup: b, getInquiryGroupName: H };
}), Zk = { created: "status.created", title: "title", type: "type", access: "configuration.access", owner: "owner.displayName", expire: "configuration.expire", interaction: "status.lastInteraction", countComments: "status.countComments", countSupports: "status.countSupports" }, Qk = { created: re("agora", "Created"), title: re("agora", "Title"), type: re("agora", "Type"), access: re("agora", "Access"), owner: re("agora", "Owner"), expire: re("agora", "Expire"), interaction: re("agora", "Last interaction"), countComments: re("agora", "Comments count"), countSupports: re("agora", "Supports count") }, Xk = { relevant: { id: "relevant", title: re("agora", "Relevant"), titleExt: re("agora", "Relevant inquiries"), description: re("agora", "Relevant inquiries which are relevant to you, because you are a participant, the owner or you are invited. Only inquiries not older than 100 days compared to creation, last interaction, expiration or latest option (for date inquiries) are shown."), pinned: false, showInNavigation: () => true, filterCondition: (a) => !a.status.isArchived && Kw.fromSeconds(a.status.relevantThreshold).diffNow("days").days > -100 && (a.currentUserStatus.isInvolved || a.permissions.view && a.configuration.access !== "open") }, my: { id: "my", title: re("agora", "My inquiries"), titleExt: re("agora", "My inquiries"), description: re("agora", "These are all inquiries where you are the owner."), pinned: false, showInNavigation: () => Ee().appPermissions.inquiryCreation, filterCondition: (a) => !a.status.isArchived && a.currentUserStatus.isOwner }, private: { id: "private", title: re("agora", "Private inquiries"), titleExt: re("agora", "Private inquiries"), description: re("agora", "All private inquiries, to which you have access."), pinned: false, showInNavigation: () => Ee().appPermissions.inquiryCreation, filterCondition: (a) => !a.status.isArchived && a.permissions.view && a.configuration.access === "private" }, participated: { id: "participated", title: re("agora", "Participated"), titleExt: re("agora", "Participated"), description: re("agora", "All inquiries who get participation."), pinned: false, showInNavigation: () => true, filterCondition: (a) => !a.status.isArchived && a.status.countParticipants > 0 }, open: { id: "open", title: re("agora", "Openly accessible inquiries"), titleExt: re("agora", "Openly accessible inquiries"), description: re("agora", "A complete list with all openly accessible inquiries on this site."), pinned: false, showInNavigation: () => Ee().appPermissions.inquiryCreation, filterCondition: (a) => !a.status.isArchived && a.configuration.access === "open" }, all: { id: "all", title: re("agora", "All inquiries"), titleExt: re("agora", "All inquiries"), description: re("agora", "All inquiries, where you have access to."), pinned: false, showInNavigation: () => true, filterCondition: (a) => !a.status.isArchived && a.permissions.view }, closed: { id: "closed", title: re("agora", "Closed inquiries"), titleExt: re("agora", "Closed inquiries"), description: re("agora", "All closed inquiries, where voting is disabled."), pinned: false, showInNavigation: () => true, filterCondition: (a) => !a.status.isArchived && a.status.isExpired && a.permissions.view }, archived: { id: "archived", title: re("agora", "Archive"), titleExt: re("agora", "My archived inquiries"), description: re("agora", "Your archived inquiries are only accessible to you."), pinned: true, showInNavigation: () => Ee().appPermissions.inquiryCreation, filterCondition: (a) => a.status.isArchived && a.permissions.view }, admin: { id: "admin", title: re("agora", "Administration"), titleExt: re("agora", "Administrative access"), description: re("agora", "You can delete, archive and take over inquiries in this list, but access is still not possible."), pinned: true, showInNavigation: () => !!Ee().currentUser?.isAdmin, filterCondition: (a) => a.permissions.view } }, Yt = Rn("inquiries", { state: () => ({ inquiries: [], meta: { chunks: { size: 20, loaded: 1 }, maxInquiriesInNavigation: 6, status: "" }, sort: { by: "created", reverse: true }, status: { loadingGroups: false }, categories: Xk, currentFilter: "relevant", advancedFilters: {} }), getters: { navigationCategories(a) {
  return Object.values(a.categories).filter((i) => i.showInNavigation());
}, navigationListWithFilters: (a) => (i) => {
  let r = a.inquiries.filter((l) => a.categories[i].filterCondition(l));
  return a.advancedFilters.type && (r = r.filter((l) => l.type === a.advancedFilters.type)), ir(r, ["created"], ["desc"]).slice(0, a.meta.maxInquiriesInNavigation);
}, navigationList: (a) => (i) => ir(a.inquiries.filter((r) => a.categories[i].filterCondition(r)) ?? [], ["created"], ["desc"]).slice(0, a.meta.maxInquiriesInNavigation), currentCategory(a) {
  const i = Ee();
  return i.route.name === "list" && i.route.params.type ? a.categories[i.route.params.type] : a.categories.relevant;
}, inquiriesFilteredSorted(a) {
  const i = Ee(), r = ii();
  if (i.route.name === "group") return r.inquiriesInCurrendInquiryGroup;
  let l = a.inquiries.filter((u) => this.currentCategory?.filterCondition(u)) ?? [];
  if (a.advancedFilters.type && (l = l.filter((u) => u.type === a.advancedFilters.type)), a.advancedFilters.categoryId && (l = l.filter((u) => u.categoryId === a.advancedFilters.categoryId)), a.advancedFilters.locationId && (l = l.filter((u) => u.locationId === a.advancedFilters.locationId)), a.advancedFilters.hasComments === true && (l = l.filter((u) => u.status.countComments > 0)), a.advancedFilters.hasComments === false && (l = l.filter((u) => u.status.countComments === 0)), a.advancedFilters.hasSupports === true ? l = l.filter((u) => u.status.countSupports > 0) : a.advancedFilters.hasSupports === false && (l = l.filter((u) => u.status.countSupports === 0)), a.advancedFilters.search) {
    const u = (p) => p.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(), g = u(a.advancedFilters.search);
    l = l.filter((p) => {
      const L = u(p.title), w = u(p.description || ""), D = L.includes(g), b = w.includes(g);
      return D || b;
    });
  }
  return ir(l, [Zk[a.sort.by]], [a.sort.reverse ? "desc" : "asc"]);
}, chunkedList() {
  return this.inquiriesFilteredSorted.slice(0, this.loaded);
}, inquiriesCount(a) {
  const i = {};
  for (const [r, l] of Object.entries(a.categories)) i[r] = a.inquiries.filter((u) => l.filterCondition(u)).length;
  return i;
}, dashboardList(a) {
  return ir(a.inquiries.filter((i) => a.categories.relevant.filterCondition(i)), ["created"], ["desc"]).slice(0, 7);
}, loaded(a) {
  return a.meta.chunks.loaded * a.meta.chunks.size;
}, proposalInquiries(a) {
  return a.inquiries.filter((i) => i.type === "proposal" && !i.status.isArchived);
}, inquiriesLoading(a) {
  return a.meta.status === "loading";
}, countByCategory: (a) => (i) => a.inquiries.filter((r) => a.categories[i].filterCondition(r)).length }, actions: { setFilters(a) {
  this.advancedFilters = { ...a }, this.resetChunks();
}, resetFilters() {
  this.advancedFilters = {}, this.resetChunks();
}, setCurrentFilter(a) {
  this.currentFilter = a, this.resetChunks(), this.resetFilters();
}, updateFilter(a, i) {
  this.advancedFilters[a] = i, this.resetChunks();
}, async load(a = true) {
  const i = ii();
  if (this.meta.status === "loading" || !a && this.meta.status === "loaded") {
    se.debug("Inquiries already loaded or loading, skipping load", { status: this.meta.status, forced: a });
    return;
  }
  ...
  try {
    ...
    throw this.meta.status = "error", se.error("Error loading inquiries", { error: r }), r;
  }
}, groupList(a) {
  return ir(this.inquiries.filter((i) => a.includes(i.id)) ?? [], ["created"], ["desc"]).slice(0, this.meta.maxInquiriesInNavigation);
}, addOrUpdateInquiryGroupInList(a) {
  this.inquiries = this.inquiries.filter((i) => i.id !== a.inquiry?.id).concat(a.inquiry);
}, reset() {
  this.$reset();
}, async changeOwner(a) {
  try {
    await at.changeOwner(a.inquiryId, a.userId);
  } catch (i) {
    if (i?.code === "ERR_CANCELED") return;
    throw se.error("Error changing inquiry owner", { error: i, payload: a }), i;
  } finally {
    this.load();
  }
}, addChunk() {
  ...
  try {
    await at.cloneInquiry(a.inquiryId);
  } catch (i) {
    if (i?.code === "ERR_CANCELED") return;
    throw se.error("Error cloning inquiry", { error: i, payload: a }), i;
  } finally {
    this.load();
  }
}, async delete(a) {
  try {
    await at.deleteInquiry(a.inquiryId);
  } catch (i) {
    if (i?.code === "ERR_CANCELED") return;
    throw se.error("Error deleting inquiry", { error: i, payload: a }), i;
  } finally {
    this.load();
  }
}, async toggleArchive(a) {
  try {
    await at.toggleArchive(a.inquiryId);
  } catch (i) {
    if (i?.code === "ERR_CANCELED") return;
    throw se.error("Error archiving/restoring inquiry", { error: i, payload: a }), i;
  } finally {
    this.load();
  }
}, async takeOver(a) {
  try {
    await at.takeOver(a.inquiryId);
  } catch (i) {
    if (i?.code === "ERR_CANCELED") return;
    throw se.error("Error archiving/restoring inquiry", { error: i, payload: a }), i;
  } finally {
...
} } }), xf = Rn("comments", { state: () => ({ comments: [] }), getters: { count: (a) => a.comments.length, groupedComments: (a) => gM(a.comments) }, actions: { async load() {
  const a = Ee();
  try {
    const i = await (a.route.name === "publicInquiry" ? rt.getComments(a.route.params.token) : a.route.name === "inquiry" ? So.getComments(a.currentInquiryId) : null);
    if (!i) {
      this.$reset();
      return;
    }
  ...
  const i = Ee();
  try {
    if (!await (i.route.name === "publicInquiry" ? rt.addComment(i.publicToken, a.message, a.confidential) : i.route.name === "inquiry" ? So.addComment(i.currentInquiryId, a.message, a.confidential) : null)) {
      this.$reset();
      return;
    }
    this.load();
    ...
    if (r?.code === "ERR_CANCELED") return;
    throw se.error("Error writing comment", { error: r, payload: a }), r;
  }
}, setItem(a) {
  const i = this.comments.findIndex((r) => r.id === a.comment.id);
  i < 0 ? this.comments.push(a.comment) : this.comments[i] = Object.assign(this.comments[i], a.comment);
}, async delete(a) {
  const i = Ee();
  try {
    const r = await (i.route.name === "publicInquiry" ? rt.deleteComment(i.publicToken, a.comment.id) : So.deleteComment(a.comment.id));
    this.setItem({ comment: r.data.comment });
  } catch (r) {
    if (r?.code === "ERR_CANCELED") return;
    throw se.error("Error deleting comment", { error: r, payload: a }), r;
  }
}, async restore(a) {
  const i = Ee();
  try {
    const r = await (i.route.name === "publicInquiry" ? rt.restoreComment(i.publicToken, a.comment.id) : So.restoreComment(a.comment.id));
    this.setItem({ comment: r.data.comment });
  } catch (r) {
    if (r?.code === "ERR_CANCELED") return;
    throw se.error("Error restoring comment", { error: r, payload: a }), r;
  }
} } }), Nf = Rn("options", { state: () => ({ options: [], ranked: "no" }), getters: { countAvailable(a) {
  return a.options.filter((i) => !i.locked && !i.deleted).length;
}, countInquirydByCurrentUser(a) {
  return a.options.filter((i) => i.inquiries.currentUser === "yes").length;
}, countOptionsLeft() {
  return this.countAvailable - this.countInquirydByCurrentUser;
}, rankedOptions(a) {
  return ir(a.options, ["inquiries.yes", "inquiries.maybe"], ["desc", "desc"]);
}, sortedOptions(a) {
  return oi().type === "proposal" ? ir(a.options, ["timestamp", "duration"], ["asc", "asc"]) : a.options;
}, orderedOptions(a) {
  return a.ranked === "yes" ? this.rankedOptions : this.sortedOptions;
}, confirmed(a) {
  return a.options.filter((i) => i.confirmed > 0);
}, countSuggestions(a) {
  return a.options.filter((i) => i.owner !== null).length;
} }, actions: { find(a, i) {
  return this.options.find((r) => r.timestamp === a && r.duration === i);
}, async load() {
  const a = Ee();
  try {
    const i = await (a.route.name === "publicInquiry" ? rt.getOptions(a.route.params.token) : a.currentInquiryId ? Ss.getOptions(a.currentInquiryId) : null);
    if (!i) {
      this.$reset();
      return;
    }
    ...
    if (i?.code === "ERR_CANCELED") return;
    throw se.error("Error loding options", { error: i, inquiryId: a.currentInquiryId }), i;
  }
}, updateOption(a) {
  const i = this.options.findIndex((r) => r.id === a.option.id);
  i < 0 ? this.options.push(a.option) : this.options.splice(i, 1, a.option), this.options.sort((r, l) => r.order < l.order ? -1 : r.order > l.order ? 1 : 0);
}, async add(a, i = null, r = false) {
  const l = Ee();
  try {
    const u = await (l.route.name === "publicInquiry" ? rt.addOption(l.route.params.token, a, i, r) : Ss.addOption(l.currentInquiryId, a, i, r));
    if (this.options = u.data.options, u.data.inquiries) {
      const g = Yt();
      g.inquiries = u.data.inquiries;
    }
  } catch (u) {
    if (u?.code !== "ERR_CANCELED") throw se.error("Error adding option", { error: u, simpleOption: a }), this.load(), u;
  }
}, async update(a) {
  try {
    const i = await Ss.updateOption(a.option);
    this.updateOption({ option: i.data.option });
  } catch (i) {
    throw se.error("Error updating option", { error: i, payload: a }), this.load(), i;
  }
}, async delete(a) {
  const i = Ee();
  try {
    const r = await (i.route.name === "publicInquiry" ? rt.deleteOption(i.route.params.token, a.option.id) : Ss.deleteOption(a.option.id));
    this.updateOption({ option: r.data.option });
  } catch (r) {
    if (r?.code === "ERR_CANCELED") return;
    throw se.error("Error deleting option", { error: r, payload: a }), r;
  }
}, async restore(a) {
  const i = Ee();
  try {
    const r = await (i.route.name === "publicInquiry" ? rt.restoreOption(i.route.params.token, a.option.id) : Ss.restoreOption(a.option.id));
    this.updateOption({ option: r.data.option });
  } catch (r) {
    if (r?.code === "ERR_CANCELED") return;
    throw se.error("Error restoring option", { error: r, payload: a }), r;
  }
}, async addBulk(a) {
  const i = Ee();
  try {
    const r = await Ss.addOptions(i.currentInquiryId, a.text);
    this.options = r.data.options;
  } catch (r) {
    if (r?.code === "ERR_CANCELED") return;
    throw se.error("Error adding option", { error: r, payload: a }), this.load(), r;
  }
}, async confirm(a) {
  const i = this.options.findIndex((r) => r.id === a.option.id);
  this.options[i].confirmed = Math.abs(this.options[i].confirmed - 1);
  try {
    const r = await Ss.confirmOption(a.option.id);
    this.updateOption({ option: r.data.option });
  } catch (r) {
    if (r?.code === "ERR_CANCELED") return;
    throw se.error("Error confirming option", { error: r, payload: a }), this.load(), r;
  }
}, async changeOrder(a, i) {
  const r = Ee();
  this.options.splice(i, 0, this.options.splice(a, 1)[0]);
  try {
    const l = await Ss.reorderOptions(r.currentInquiryId, this.options.map(({ id: u, text: g }) => ({ id: u, text: g })));
    this.options = l.data.options;
  } catch (l) {
    throw se.error("Error reordering option", { error: l, options: this.options, oldIndex: a, newIndex: i }), this.load(), l;
  }
}, async sequence(a) {
  try {
    const i = await Ss.addOptionsSequence(a.option.id, a.sequence);
    this.options = i.data.options;
  } catch (i) {
    if (i?.code === "ERR_CANCELED") return;
    throw se.error("Error creating sequence", { error: i, payload: a }), this.load(), i;
  }
}, async shift(a) {
  const i = Ee();
  try {
    const r = await Ss.shiftOptions(i.currentInquiryId, a.shift.value, a.shift.unit.id);
    this.options = r.data.options;
  } catch (r) {
    if (r?.code === "ERR_CANCELED") return;
    throw se.error("Error shifting dates", { error: r, payload: a }), this.load(), r;
  }
} } }), Af = Rn("shares", { state: () => ({ shares: [] }), getters: { active: (a) => {
  const i = ["email", "external", "contact"], r = ["user", "group", "admin", "public"];
  return a.shares.filter((l) => !l.locked && (r.includes(l.type) || i.includes(l.type) && (l.type === "external" || l.invitationSent || l.supportedd)));
}, locked: (a) => a.shares.filter((i) => !!i.locked), unsentInvitations: (a) => a.shares.filter((i) => (i.user.emailAddress || i.type === "group" || i.type === "contactGroup" || i.type === "circle") && !i.invitationSent && !i.locked && !i.supported), public: (a) => a.shares.filter((i) => i.type === "public"), hasShares: (a) => a.shares.length > 0, hasLocked() {
  return this.locked.length > 0;
} }, actions: { async load(a = "inquiry") {
  let i = 0;
  if (a === "inquiryGroup") {
    const r = ii();
    if (se.info("Loading group shares"), !r.currentInquiryGroup) throw new Error("Current group is not set");
    i = r.currentInquiryGroup.id;
  } else se.info("Loading inquiry shares"), i = Ee().currentInquiryId;
  try {
    const r = await Qt.getShares(i, a);
    this.shares = r.data.shares;
  } catch (r) {
    this.handleError(r, "Error loading shares", { inquiryId: i });
  }
}, async add(a, i = "inquiry") {
  let r = 0;
  if (i === "inquiryGroup") {
    const l = ii();
  ...
  try {
    const l = await Qt.addUserShare(r, a, i);
    this.shares.push(l.data.share);
  } catch (l) {
    this.handleError(l, "Error adding user share", { purpose: i, id: r, payload: a });
  }
}, async addPublicShare() {
  const a = Ee();
  try {
    const i = await Qt.addPublicShare(a.currentInquiryId);
    this.shares.push(i.data.share);
  } catch (i) {
    this.handleError(i, "Error adding public share", { inquiryId: a.currentInquiryId });
  }
}, update(a) {
  const i = this.shares.findIndex((r) => r.id === a.share.id);
  Object.assign(this.shares[i], a.share);
}, async switchAdmin(a) {
  const i = a.share.type === "user" ? "admin" : "user";
  try {
    const r = await Qt.switchAdmin(a.share.token, i);
    this.update(r.data);
  } catch (r) {
    this.handleError(r, `Error switching type to ${i}`, a);
  }
}, async setPublicInquiryEmail(a) {
  try {
    const i = await Qt.setEmailAddressConstraint(a.share.token, a.value);
    this.update(i.data);
  } catch (i) {
    this.handleError(i, "Error changing email register setting", a);
  }
}, async writeLabel(a) {
  try {
    const i = await Qt.writeLabel(a.token, a.label);
    this.update(i.data);
  } catch (i) {
    this.handleError(i, "Error writing label", a);
  }
}, async inviteAll(a) {
  try {
    const i = await Qt.inviteAll(a.inquiryId);
    return this.load(), i;
  } catch (i) {
    this.handleError(i, "Error inviting all users", a);
  }
}, async sendInvitation(a) {
  try {
    const i = await Qt.sendInvitation(a.share.token);
    return this.load(), i.data;
  } catch (i) {
    this.handleError(i, "Error sending share invitation", a);
  }
}, async resolveGroup(a) {
  try {
    await Qt.resolveShare(a.share.token), this.load();
  } catch (i) {
    this.handleError(i, "Error resolving group share", a);
  }
}, async lock(a) {
  try {
    const i = await Qt.lockShare(a.share.token);
    this.update(i.data);
  } catch (i) {
    this.handleError(i, "Error locking share", a);
  }
}, async unlock(a) {
  try {
    const i = await Qt.unlockShare(a.share.token);
    this.update(i.data);
  } catch (i) {
    this.handleError(i, "Error unlocking share", a);
  }
}, async delete(a) {
  try {
    const i = await Qt.deleteShare(a.share.token);
    this.update(i.data);
  } catch (i) {
    this.handleError(i, "Error deleting share", a);
  }
}, async restore(a) {
  try {
    const i = await Qt.restoreShare(a.share.token);
    this.update(i.data);
  } catch (i) {
    this.handleError(i, "Error restoring share", a);
  }
}, handleError(a, i, r) {
  if (a?.code !== "ERR_CANCELED") throw se.error(i, { error: a, payload: r }), this.load(), a;
} } });
re("inquiries", "Minute"), re("inquiries", "Hour"), re("inquiries", "Day"), re("inquiries", "Week"), re("inquiries", "Month"), re("inquiries", "Year");
var Ef = ((a) => (a.TransitionsOff = "agora:transitions:off", a.TransitionsOn = "agora:transitions:on", a.UpdateInquiry = "agora:inquiry:update", a.LoadInquiry = "agora:inquiry:load", a.SidebarChangeTab = "agora:sidebar:changeTab", a.SidebarToggle = "agora:sidebar:toggle", a.ChangeShares = "agora:change:shares", a.UpdateOptions = "agora:options:update", a.AddDate = "agora:options:add-date", a.UpdateComments = "agora:comments:update", a.UpdateSupports = "agora:supports:update", a.UpdateActivity = "agora:activity:update", a.ShowSettings = "agora:settings:show", a))(Ef || {});
function bo() {
  return {};
}
const F0 = Rn("subscription", () => {
  const a = tr(false), i = () => {
    a.value = false;
  };
  async function r() {
    ...
    try {
      ...
      if (g) {
        a.value = g.data.subscribed;
        return;
      }
      a.value = false;
    } catch (g) {
      if (g?.code === "ERR_CANCELED") return;
      throw a.value = false, g;
    }
  }
  async function l() {
    const u = Ee();
    try {
      const g = await (u.route.name === "publicInquiry" ? rt.setSubscription(u.route.params.token, !a.value) : u.route.name === "inquiry" ? at.setSubscription(u.currentInquiryId, !a.value) : null);
      if (g) {
        a.value = g.data.subscribed;
        return;
      }
      ...
      if (g?.code === "ERR_CANCELED") return;
      throw se.error("Error on changing subscription", { error: g }), g;
    }
  }
  return { subscribed: a, load: r, reset: i, write: l };
});
let x0 = null;
const Ee = Rn("session", { state: () => ({ appPermissions: { addShares: false, addSharesExternal: false, allAccess: false, changeForeignInquiries: false, comboView: false, deanonymizeInquiry: false, inquiryCreation: false, inquiryDownload: false, publicShares: false, seeMailAddresses: false, unrestrictedOwner: false }, appSettings: bo(), route: { currentRoute: "", name: "", path: "", params: { id: 0, token: "", type: "relevant", slug: "" } }, userStatus: { isLoggedin: !!Bd(), isAdmin: !!Bd()?.isAdmin, isOfficial: !!Bd()?.isOfficial, isModerator: !!Bd()?.isModerator }, watcher: { id: "", mode: "noInquirying", status: "stopped", lastUpdate: Math.floor(Date.now() / 1e3) }, token: null, currentUser: bo(), share: bo(), isLoaded: false }), getters: { publicToken(a) {
  return a.route.params.token ? a.route.params.token : "";
}, currentInquiryId(a) {
  return a.route.name === "inquiry" ? Number(a.route.params.id) : 0;
}, windowTitle(a) {
  const i = oi(), r = { prefix: `${re("agora", "Agora")}`, name: "Nextcloud" };
  if (a.route.name === "list") {
    const l = Yt();
    r.name = l.categories[this.route.params.type].titleExt;
  } else if (a.route.name === "group") {
    const l = ii();
    r.name = l.currentInquiryGroup?.titleExt || l.currentInquiryGroup?.name || "";
  } else a.route.name === "publicInquiry" ? r.name = i.title : a.route.name === "inquiry" && (r.name = i.title ?? re("agora", "Enter title"));
  return `${r.prefix} – ${r.name}`;
} }, actions: { generateWatcherId() {
  this.watcher.id = Math.random().toString(36).substring(2);
}, async load(a, i = false, r = false) {
  if (se.debug("Loading session"), !r && this.isLoaded && this.currentUser.id === x0) {
    se.debug("Session already loaded for same user, skipping, route set to:", a), a !== null && await this.setRouter(a);
    return;
  }
  if (this.generateWatcherId(), a !== null && (se.debug("Set requested route", { to: a }), await this.setRouter(a), se.debug("Route set", { route: this.route })), i) {
    se.debug("Same route, skipping session load");
    return;
  }
  try {
    const l = await (this.route.name === "publicInquiry" ? rt.getSession(this.publicToken) : U0.getSession());
    this.$patch(l.data), this.isLoaded = true, x0 = this.currentUser.id;
  } catch (l) {
    if (l?.code === "ERR_CANCELED") return;
    if (this.$reset(), this.route.name === null) this.$reset();
    else throw l;
  }
  se.debug("Session loaded");
}, setViewProposalInquiry(a) {
  this.sessionSettings.manualViewProposalInquiry = a;
}, setViewProjectInquiry(a) {
  this.sessionSettings.manualViewProjectInquiry = a;
}, setViewDebateInquiry(a) {
  this.sessionSettings.manualViewDebateInquiry = a;
}, setViewPetitionInquiry(a) {
  this.sessionSettings.manualViewPetitionInquiry = a;
}, setViewGrievanceInquiry(a) {
  this.sessionSettings.manualViewGrievanceInquiry = a;
}, async setRouter(a) {
  this.route.currentRoute = a.fullPath, this.route.name = a.name, this.route.path = a.path, this.route.params.id = a.params.id, this.route.params.token = a.params.token, this.route.params.type = a.params.type, this.route.params.slug = a.params.slug;
}, async loadShare() {
  ...
  try {
    const a = await rt.getShare(this.publicToken);
    this.share = a.data.share;
  } catch (a) {
    if (a?.code === "ERR_CANCELED") return;
    throw se.error("Error retrieving share", { error: a }), a;
  }
}, async updateEmailAddress(a) {
  const i = oi();
  if (this.route.name === "publicInquiry") try {
    const r = await rt.setEmailAddress(this.publicToken, a.emailAddress);
    this.share = r.data.share, i.load();
  } catch (r) {
    if (r?.code === "ERR_CANCELED") return;
    throw se.error("Error writing email address", { error: r, payload: a }), r;
  }
}, async updateDisplayName(a) {
  const i = oi();
  if (this.route.name === "publicInquiry") try {
    const r = await rt.setDisplayName(this.publicToken, a.displayName);
    this.share = r.data.share, i.load();
  } catch (r) {
    if (r?.code === "ERR_CANCELED") return;
    throw se.error("Error changing name", { error: r, payload: a }), r;
  }
}, async deleteEmailAddress() {
  const a = oi(), i = F0();
  if (this.route.name === "publicInquiry") try {
    const r = await rt.deleteEmailAddress(this.publicToken);
    this.share = r.data.share, i.$state.subscribed = false, i.write(), a.load();
  } catch (r) {
    if (r?.code === "ERR_CANCELED") return;
    throw se.error("Error deleting email address", { error: r }), r;
  }
  ...
  try {
    ...
    if (a?.code === "ERR_CANCELED") return;
    throw se.error("Error sending invitation", { error: a, token: this.route.params.token }), a;
  }
} } }), eT = { baseURL: Zw("apps/agora/"), headers: { Accept: "application/json", "Nc-Agora-Client-Time-Zone": Intl.DateTimeFormat().resolvedOptions().timeZone } }, tT = { baseURL: Qw("apps/"), headers: { Accept: "application/json" } }, sT = eg.CancelToken, O = eg.create(eT), nT = eg.create(tT);
O.interceptors.request.use((a) => {
  try {
    const i = Ee();
    a.headers = { ...a.headers, "Nc-Agora-Client-Id": i.watcher.id };
  } catch {
  }
  return a;
});
const Rt = (a) => {
  const i = {};
  return Object.getOwnPropertyNames(a).forEach((r) => {
    const l = { cancelToken: void 0 };
    i[r] = { handleRequestCancellation: () => (l.cancelToken && l.cancelToken.cancel(`${r} canceled`), l.cancelToken = sT.source(), l.cancelToken) };
  }), i;
}, N0 = { getActivities(a) {
  return nT.request({ method: "GET", url: "activity/api/v2/activity/inquiries", params: { format: "json", since: 0, limit: 50, object_type: "inquiry", object_id: a }, cancelToken: aT[this.getActivities.name].handleRequestCancellation().token });
} }, aT = Rt(N0), A0 = { runAutoReminder() {
  return O.request({ method: "GET", url: "administration/autoreminder/run", cancelToken: Hf[this.runAutoReminder.name].handleRequestCancellation().token });
}, runJanitor() {
  return O.request({ method: "GET", url: "administration/janitor/run", cancelToken: Hf[this.runJanitor.name].handleRequestCancellation().token });
}, runNotification() {
  return O.request({ method: "GET", url: "administration/notification/run", cancelToken: Hf[this.runNotification.name].handleRequestCancellation().token });
} }, Hf = Rt(A0), E0 = { getAppSettings() {
  return O.request({ method: "GET", url: "settings/app", params: { time: +/* @__PURE__ */ new Date() }, cancelToken: us[this.getAppSettings.name].handleRequestCancellation().token });
}, writeAppSettings(a) {
  return O.request({ method: "POST", url: "settings/app", data: { appSettings: a }, cancelToken: us[this.writeAppSettings.name].handleRequestCancellation().token });
}, getGroups(a) {
  return O.request({ method: "GET", url: `groups${a.trim() ? `/${a.trim()}` : ""}`, cancelToken: us[this.getGroups.name].handleRequestCancellation().token });
}, getUsers(a, i) {
  return O.request({ method: "GET", url: `search/users${a.trim() ? `/${a.trim()}` : ""}`, params: { types: i.toString() }, cancelToken: us[this.getUsers.name].handleRequestCancellation().token });
}, addCategory(a) {
  return O.request({ method: "POST", url: "settings/categories", data: { category: a }, cancelToken: us[this.addCategory.name].handleRequestCancellation().token });
}, deleteCategory(a) {
  return O.request({ method: "DELETE", url: `settings/categories/${a}`, cancelToken: us[this.deleteCategory.name].handleRequestCancellation().token });
}, updateCategory(a, i, r) {
  return O.request({ method: "PUT", url: `settings/categories/${a}`, data: { name: i, parentId: r }, cancelToken: us[this.updateCategory.name].handleRequestCancellation().token });
}, addLocation(a) {
  return O.request({ method: "POST", url: "settings/locations", data: { location: a }, cancelToken: us[this.addLocation.name].handleRequestCancellation().token });
}, deleteLocation(a) {
  return O.request({ method: "DELETE", url: `settings/locations/${a}`, cancelToken: us[this.deleteLocation.name].handleRequestCancellation().token });
}, updateLocation(a, i, r) {
  return O.request({ method: "PUT", url: `settings/locations/${a}`, data: { name: i, parentId: r }, cancelToken: us[this.updateLocation.name].handleRequestCancellation().token });
}, addModerationStatus(a) {
  return O.request({ method: "POST", url: "settings/moderation-statuses", data: { moderationStatus: a }, cancelToken: us[this.addModerationStatus.name].handleRequestCancellation().token });
}, deleteModerationStatus(a) {
  return O.request({ method: "DELETE", url: `settings/moderation-statuses/${a}`, cancelToken: us[this.deleteModerationStatus.name].handleRequestCancellation().token });
}, updateModerationStatus(a, i) {
  return O.request({ method: "PUT", url: `settings/moderation-statuses/${a}`, data: { moderationStatus: i }, cancelToken: us[this.updateModerationStatus.name].handleRequestCancellation().token });
} }, us = Rt(E0), H0 = { getCalendars() {
  return O.request({ method: "GET", url: "calendars", params: { time: +/* @__PURE__ */ new Date() }, cancelToken: P0[this.getCalendars.name].handleRequestCancellation().token });
}, getEvents(a) {
  return O.request({ method: "GET", url: `option/${a}/events`, params: { tz: Intl.DateTimeFormat().resolvedOptions().timeZone, time: +/* @__PURE__ */ new Date() }, cancelToken: P0[this.getEvents.name].handleRequestCancellation().token });
} }, P0 = Rt(H0), So = { getComments(a) {
  return O.request({ method: "GET", url: `inquiry/${a}/comments`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: lm[this.getComments.name].handleRequestCancellation().token });
}, addComment(a, i, r = false) {
  return O.request({ method: "POST", url: `inquiry/${a}/comment`, data: { message: i, confidential: r }, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: lm[this.addComment.name].handleRequestCancellation().token });
}, deleteComment(a) {
  return O.request({ method: "DELETE", url: `comment/${a}`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: lm[this.deleteComment.name].handleRequestCancellation().token });
}, restoreComment(a) {
  return O.request({ method: "PUT", url: `comment/${a}/restore`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: lm[this.restoreComment.name].handleRequestCancellation().token });
} }, lm = Rt(So), Ss = { getOptions(a) {
  return O.request({ method: "GET", url: `inquiry/${a}/options`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: vn[this.getOptions.name].handleRequestCancellation().token });
}, addOption(a, i, r) {
  return O.request({ method: "POST", url: `inquiry/${a}/option`, data: { option: i, sequence: r }, cancelToken: vn[this.addOption.name].handleRequestCancellation().token });
}, updateOption(a) {
  return O.request({ method: "PUT", url: `option/${a.id}`, data: { ...a }, cancelToken: vn[this.updateOption.name].handleRequestCancellation().token });
}, deleteOption(a) {
  return O.request({ method: "DELETE", url: `option/${a}`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: vn[this.deleteOption.name].handleRequestCancellation().token });
}, restoreOption(a) {
  return O.request({ method: "PUT", url: `option/${a}/restore`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: vn[this.restoreOption.name].handleRequestCancellation().token });
}, addOptions(a, i) {
  return O.request({ method: "POST", url: "option/bulk", data: { inquiryId: a, text: i }, cancelToken: vn[this.addOptions.name].handleRequestCancellation().token });
}, confirmOption(a) {
  return O.request({ method: "PUT", url: `option/${a}/confirm`, cancelToken: vn[this.confirmOption.name].handleRequestCancellation().token });
}, reorderOptions(a, i) {
  return O.request({ method: "POST", url: `inquiry/${a}/options/reorder`, data: { options: i }, cancelToken: vn[this.reorderOptions.name].handleRequestCancellation().token });
}, addOptionsSequence(a, i) {
  return O.request({ method: "POST", url: `option/${a}/sequence`, data: { sequence: i }, cancelToken: vn[this.addOptionsSequence.name].handleRequestCancellation().token });
}, shiftOptions(a, i, r) {
  return O.request({ method: "POST", url: `inquiry/${a}/shift`, data: { step: i, unit: r }, cancelToken: vn[this.shiftOptions.name].handleRequestCancellation().token });
} }, vn = Rt(Ss), at = { getInquiries() {
  return O.request({ method: "GET", url: "inquiries", params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ue[this.getInquiries.name].handleRequestCancellation().token });
}, getChildInquiryIds(a) {
  return O.request({ method: "GET", url: `inquiry/${a}/childs`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ue[this.getInquiry.name].handleRequestCancellation().token });
}, getInquiry(a) {
  return O.request({ method: "GET", url: `inquiry/${a}/inquiry`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ue[this.getInquiry.name].handleRequestCancellation().token });
}, getFullInquiry(a) {
  return O.request({ method: "GET", url: `inquiry/${a}`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ue[this.getInquiry.name].handleRequestCancellation().token });
}, takeOver(a) {
  return O.request({ method: "PUT", url: `administration/inquiry/${a}/takeover`, cancelToken: Ue[this.takeOver.name].handleRequestCancellation().token });
}, changeOwner(a, i) {
  return O.request({ method: "PUT", url: `inquiry/${a}/changeowner/${i}`, cancelToken: Ue[this.changeOwner.name].handleRequestCancellation().token });
}, updateModerationStatus(a, i) {
  return O.request({ method: "PUT", url: `inquiry/updatemoderation/${a}/${i}`, cancelToken: Ue[this.updateModerationStatus.name].handleRequestCancellation().token });
}, updateInquiryConfig(a, i) {
  return O.request({ method: "PUT", url: `inquiry/updateconfig/${a}`, data: { inquiry: i }, cancelToken: Ue[this.updateInquiryConfig.name].handleRequestCancellation().token });
}, addInquiry(a) {
  return O.request({ method: "POST", url: "inquiry/add", data: a, cancelToken: Ue[this.addInquiry.name].handleRequestCancellation().token });
}, updateInquiry(a, i) {
  return O.request({ method: "PUT", url: `inquiry/${a}`, data: i, cancelToken: Ue[this.updateInquiry.name].handleRequestCancellation().token });
}, lockAnonymous(a) {
  return O.request({ method: "PUT", url: `inquiry/${a}/lockAnonymous`, cancelToken: Ue[this.lockAnonymous.name].handleRequestCancellation().token });
}, deleteInquiry(a) {
  return O.request({ method: "DELETE", url: `inquiry/${a}`, cancelToken: Ue[this.deleteInquiry.name].handleRequestCancellation().token });
}, closeInquiry(a) {
  return O.request({ method: "PUT", url: `inquiry/${a}/close`, cancelToken: Ue[this.closeInquiry.name].handleRequestCancellation().token });
}, reopenInquiry(a) {
  return O.request({ method: "PUT", url: `inquiry/${a}/reopen`, cancelToken: Ue[this.reopenInquiry.name].handleRequestCancellation().token });
}, toggleArchive(a) {
  return O.request({ method: "PUT", url: `inquiry/${a}/toggleArchive`, cancelToken: Ue[this.toggleArchive.name].handleRequestCancellation().token });
}, cloneInquiry(a) {
  return O.request({ method: "POST", url: `inquiry/${a}/clone`, cancelToken: Ue[this.cloneInquiry.name].handleRequestCancellation().token });
}, sendConfirmation(a) {
  return O.request({ method: "POST", url: `inquiry/${a}/confirmation`, cancelToken: Ue[this.sendConfirmation.name].handleRequestCancellation().token });
}, getParticipantsEmailAddresses(a) {
  return O.request({ method: "GET", url: `inquiry/${a}/addresses`, cancelToken: Ue[this.getParticipantsEmailAddresses.name].handleRequestCancellation().token });
}, getSubscription(a) {
  return O.request({ method: "GET", url: `inquiry/${a}/subscription`, cancelToken: Ue[this.getSubscription.name].handleRequestCancellation().token });
}, setSubscription(a, i) {
  return O.request({ method: "PUT", url: `inquiry/${a}${i ? "/subscribe" : "/unsubscribe"}`, cancelToken: Ue[this.setSubscription.name].handleRequestCancellation().token });
}, getCommentsCount(a) {
  return O.request({ method: "GET", url: `inquiry/${a}/comment-count`, cancelToken: Ue[this.getCommentsCount.name].handleRequestCancellation().token });
}, getSupportsCount(a) {
  return O.request({ method: "GET", url: `inquiry/${a}/support-count`, cancelToken: Ue[this.getSupportsCount.name].handleRequestCancellation().token });
}, getCategories() {
  return O.request({ method: "GET", url: `inquiry/${inquiryId}/categories`, cancelToken: Ue[this.getCategories.name].handleRequestCancellation().token });
}, getLocations() {
  return O.request({ method: "GET", url: `inquiry/${inquiryId}/locations`, cancelToken: Ue[this.getLocations.name].handleRequestCancellation().token });
} }, Ue = Rt(at), dm = { getInquiryGroups() {
  return O.request({ method: "GET", url: "inquirygroups", params: { time: +/* @__PURE__ */ new Date() }, cancelToken: mm[this.getInquiryGroups.name].handleRequestCancellation().token });
}, addInquiryToGroup(a, i, r) {
  let l = "", u = "PUT", g = {};
  if (i) l = `inquirygroup/${i}/inquiry/${a}`;
  else if (r) u = "POST", l = `inquirygroup/new/inquiry/${a}`, g = { inquiryGroupName: r };
  else throw new Error("You must provide either a inquiryGroupId or a inquiryGroupName");
  return O.request({ method: u, url: l, data: g, cancelToken: mm[this.addInquiryToGroup.name].handleRequestCancellation().token });
}, removeInquiryFromGroup(a, i) {
  return O.request({ method: "DELETE", url: `inquirygroup/${a}/inquiry/${i}`, cancelToken: mm[this.removeInquiryFromGroup.name].handleRequestCancellation().token });
}, updateInquiryGroup(a) {
  return O.request({ method: "PUT", url: `inquirygroup/${a.id}/update`, data: { name: a.name, titleExt: a.titleExt, description: a.description }, cancelToken: mm[this.updateInquiryGroup.name].handleRequestCancellation().token });
} }, mm = Rt(dm), rt = { getInquiry(a) {
  return O.request({ method: "GET", url: `/s/${a}/inquiry`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.getInquiry.name].handleRequestCancellation().token });
}, getSession(a) {
  return O.request({ method: "GET", url: `/s/${a}/session`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.getSession.name].handleRequestCancellation().token });
}, getOptions(a) {
  return O.request({ method: "GET", url: `/s/${a}/options`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.getOptions.name].handleRequestCancellation().token });
}, addOption(a, i, r, l = false) {
  return O.request({ method: "POST", url: `/s/${a}/option`, data: { option: i, sequence: r, inquiryYes: l }, cancelToken: Ke[this.addOption.name].handleRequestCancellation().token });
}, deleteOption(a, i) {
  return O.request({ method: "DELETE", url: `s/${a}/option/${i}`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.deleteOption.name].handleRequestCancellation().token });
}, restoreOption(a, i) {
  return O.request({ method: "PUT", url: `s/${a}/option/${i}/restore`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.restoreOption.name].handleRequestCancellation().token });
}, getInquiries(a) {
  return O.request({ method: "GET", url: `/s/${a}/inquiries`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.getInquiries.name].handleRequestCancellation().token });
}, setInquiry(a, i, r) {
  return O.request({ method: "PUT", url: `s/${a}/inquiry`, data: { optionId: i, setTo: r }, cancelToken: Ke[this.setInquiry.name].handleRequestCancellation().token });
}, resetInquiries(a) {
  return O.request({ method: "DELETE", url: `s/${a}/user`, cancelToken: Ke[this.resetInquiries.name].handleRequestCancellation().token });
}, removeOrphanedInquiries(a) {
  return O.request({ method: "DELETE", url: `s/${a}/inquiries/orphaned`, cancelToken: Ke[this.removeOrphanedInquiries.name].handleRequestCancellation().token });
}, getComments(a) {
  return O.request({ method: "GET", url: `/s/${a}/comments`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.getComments.name].handleRequestCancellation().token });
}, addComment(a, i, r = false) {
  return O.request({ method: "POST", url: `s/${a}/comment`, data: { message: i, confidential: r }, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.addComment.name].handleRequestCancellation().token });
}, deleteComment(a, i) {
  return O.request({ method: "DELETE", url: `s/${a}/comment/${i}`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.deleteComment.name].handleRequestCancellation().token });
}, restoreComment(a, i) {
  return O.request({ method: "PUT", url: `s/${a}/comment/${i}/restore`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.restoreComment.name].handleRequestCancellation().token });
}, getShare(a) {
  return O.request({ method: "GET", url: `s/${a}/share`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.getShare.name].handleRequestCancellation().token });
}, setEmailAddress(a, i) {
  return O.request({ method: "PUT", url: `s/${a}/email/${i}`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.setEmailAddress.name].handleRequestCancellation().token });
}, deleteEmailAddress(a) {
  return O.request({ method: "DELETE", url: `s/${a}/email`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.deleteEmailAddress.name].handleRequestCancellation().token });
}, setDisplayName(a, i) {
  return O.request({ method: "PUT", url: `s/${a}/name/${i}`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.setDisplayName.name].handleRequestCancellation().token });
}, resendInvitation(a) {
  return O.request({ method: "POST", url: `s/${a}/resend`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.resendInvitation.name].handleRequestCancellation().token });
}, getSubscription(a) {
  return O.request({ method: "GET", url: `s/${a}/subscription`, cancelToken: Ke[this.getSubscription.name].handleRequestCancellation().token });
}, setSubscription(a, i) {
  return O.request({ method: "PUT", url: `s/${a}${i ? "/subscribe" : "/unsubscribe"}`, cancelToken: Ke[this.setSubscription.name].handleRequestCancellation().token });
}, register(a, i, r, l = void 0) {
  return O.request({ method: "POST", url: `s/${a}/register`, data: { displayName: i, emailAddress: r, timeZone: l }, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Ke[this.register.name].handleRequestCancellation().token });
} }, Ke = Rt(rt), Qt = { getShares(a, i = "inquiry") {
  return O.request({ method: "GET", url: `${i.toLowerCase()}/${a}/shares`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: cs[this.getShares.name].handleRequestCancellation().token });
}, addUserShare(a, i, r = "inquiry") {
  return O.request({ method: "POST", url: `${r.toLowerCase()}/${a}/share`, data: i, cancelToken: cs[this.addUserShare.name].handleRequestCancellation().token });
}, addPublicShare(a) {
  return O.request({ method: "POST", url: `inquiry/${a}/publicshare`, cancelToken: cs[this.addPublicShare.name].handleRequestCancellation().token });
}, writeLabel(a, i) {
  return O.request({ method: "PUT", url: `share/${a}/setlabel`, data: { label: i }, cancelToken: cs[this.writeLabel.name].handleRequestCancellation().token });
}, switchAdmin(a, i) {
  return O.request({ method: "PUT", url: `share/${a}/${i}`, cancelToken: cs[this.switchAdmin.name].handleRequestCancellation().token });
}, setEmailAddressConstraint(a, i) {
  return O.request({ method: "PUT", url: `share/${a}/publicinquiryemail/${i}`, cancelToken: cs[this.setEmailAddressConstraint.name].handleRequestCancellation().token });
}, sendInvitation(a) {
  return O.request({ method: "POST", url: `share/${a}/invite`, cancelToken: cs[this.sendInvitation.name].handleRequestCancellation().token });
}, resolveShare(a) {
  return O.request({ method: "GET", url: `share/${a}/resolve`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: cs[this.resolveShare.name].handleRequestCancellation().token });
}, deleteShare(a) {
  return O.request({ method: "DELETE", url: `share/${a}`, cancelToken: cs[this.deleteShare.name].handleRequestCancellation().token });
}, restoreShare(a) {
  return O.request({ method: "PUT", url: `share/${a}/restore`, cancelToken: cs[this.restoreShare.name].handleRequestCancellation().token });
}, lockShare(a) {
  return O.request({ method: "PUT", url: `share/${a}/lock`, cancelToken: cs[this.lockShare.name].handleRequestCancellation().token });
}, unlockShare(a) {
  return O.request({ method: "PUT", url: `share/${a}/unlock`, cancelToken: cs[this.unlockShare.name].handleRequestCancellation().token });
}, inviteAll(a) {
  return O.request({ method: "PUT", url: `inquiry/${a}/inviteAll`, cancelToken: cs[this.inviteAll.name].handleRequestCancellation().token });
} }, cs = Rt(Qt), j0 = { getUserSettings() {
  return O.request({ method: "GET", url: "preferences", params: { time: +/* @__PURE__ */ new Date() }, cancelToken: q0[this.getUserSettings.name].handleRequestCancellation().token });
}, writeUserSettings(a) {
  return O.request({ method: "POST", url: "preferences", data: { preferences: a }, cancelToken: q0[this.writeUserSettings.name].handleRequestCancellation().token });
} }, q0 = Rt(j0), O0 = { validateEmailAddress(a) {
  return O.request({ method: "GET", url: `check/emailaddress/${a}`, cancelToken: R0[this.validateEmailAddress.name].handleRequestCancellation().token });
}, validateName(a, i) {
  return O.request({ method: "POST", url: "check/username", cancelToken: R0[this.validateName.name].handleRequestCancellation().token, data: { displayName: i, token: a }, headers: { "Nc-Agora-Share-Token": a } });
} }, R0 = Rt(O0), I0 = { addSupport(a, i) {
  return O.request({ method: "POST", url: `inquiry/support/${a}/${i}`, cancelToken: Fo[this.addSupport.name].handleRequestCancellation().token });
}, removeSupport(a, i) {
  return O.request({ method: "DELETE", url: `inquiry/support/${a}/${i}`, cancelToken: Fo[this.removeSupport.name].handleRequestCancellation().token });
}, getByInquiryId(a) {
  return O.request({ method: "GET", url: `inquiry/support/inquiry/${a}`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Fo[this.getByInquiryId.name].handleRequestCancellation().token });
}, getByUserId(a) {
  return O.request({ method: "GET", url: `inquiry/support/user/${a}`, params: { time: +/* @__PURE__ */ new Date() }, cancelToken: Fo[this.getByUserId.name].handleRequestCancellation().token });
}, getSupportStats() {
  return O.request({ method: "GET", url: "inquiry/support/stats/grouped", cancelToken: Fo[this.getSupportStats.name].handleRequestCancellation().token });
} }, Fo = Rt(I0), U0 = { getSession() {
  return O.request({ method: "GET", url: "/session", params: { time: +/* @__PURE__ */ new Date() }, cancelToken: rT[this.getSession.name].handleRequestCancellation().token });
} }, rT = Rt(U0), um = { uploadAttachment(a, i) {
  const r = new FormData();
  return r.append("file", i), O.request({ method: "POST", url: `inquiry/${a}/attachment`, data: r, headers: { "X-Requested-With": "XMLHttpRequest", requesttoken: OC.requestToken || "" }, cancelToken: Pf[this.uploadAttachment.name].handleRequestCancellation().token });
}, deleteAttachment(a) {
  return O.request({ method: "DELETE", url: `attachment/${a}`, cancelToken: Pf[this.deleteAttachment.name].handleRequestCancellation().token });
}, getAttachments(a) {
  return O.request({ method: "GET", url: `inquiry/${a}/attachments`, cancelToken: Pf[this.getAttachments.name].handleRequestCancellation().token });
} }, Pf = Rt(um), z0 = Rn("attachments", { state: () => ({ attachments: [] }), getters: { getByCommentId: (a) => (i) => a.attachments.filter((r) => r.inquiryId === i) }, actions: { async upload(a, i) {
  try {
    return (await um.uploadAttachment(a, i)).data.attachment;
  } catch (r) {
    if (r?.code === "ERR_CANCELED") return;
    throw se.error("Error uploading attachment", { error: r }), r;
  }
}, async delete(a) {
  try {
    await um.deleteAttachment(a);
  } catch (i) {
    if (i?.code === "ERR_CANCELED") return;
    throw se.error("Error deleting attachment", { error: i }), i;
  }
}, async load(a) {
  try {
    const i = await um.getAttachments(a);
    this.attachments = this.attachments.filter((r) => r.inquiryId !== a), this.attachments.push(...i.data.attachments);
  } catch (i) {
    if (i?.code === "ERR_CANCELED") return;
    throw se.error("Error loading attachments", { error: i }), i;
  }
} } }), iT = { prefix: "desc-" }, oi = Rn("inquiry", { state: () => ({ id: 0, title: "", type: "proposal", description: "", descriptionSafe: "", moderationStatus: "draft", parentId: 0, locationId: 0, categoryId: 0, childs: [], configuration: { description: "", access: "private", anonymous: false, autoReminder: false, collapseDescription: true, expire: 0, forceConfidentialComments: false, hideBookedUp: false, suggestionsExpire: 0, showResults: "always", maxInquiriesPerOption: 0, maxInquiriesPerUser: 0 }, owner: bo(), inquiryGroups: [], status: { forceEditMode: false, anonymizeLevel: "ANON_NONE", lastInteraction: 0, created: 0, isAnonymous: false, isArchived: false, isExpired: false, isRealAnonymous: false, relevantThreshold: 0, deletionDate: 0, archivedDate: 0, countParticipants: 0, countComments: 0, countSupports: 0 }, currentUserStatus: { groupInvitations: [], isInvolved: false, hasSupported: false, isLocked: false, isLoggedIn: false, isOwner: false, orphanedInquiries: 0, shareToken: "", userId: "", userRole: "", countInquiries: 0 }, permissions: { addOptions: false, addShares: false, addSharesExternal: false, archive: false, changeForeignInquiries: false, changeOwner: false, clone: false, comment: false, support: false, confirmOptions: false, deanonymize: false, delete: false, edit: false, reorderOptions: false, seeResults: false, seeUsernames: false, subscribe: false, takeOver: false, view: false, suppport: false }, revealParticipants: false, sortParticipants: "alphabetical", meta: { chunking: { size: 0, loaded: 0 }, status: "loaded" } }), getters: { safeParticipants() {
  const a = Ee(), i = Yt();
  return this.viewMode === "list-view" ? [a.currentUser] : i.getChunkedParticipants;
}, displayResults(a) {
  return a.configuration.showResults === "always" || a.configuration.showResults === "closed" && !this.status.isExpired;
}, isConfirmationAllowed(a) {
  return a.permissions.confirmOptions || !this.isClosed;
}, isOptionCloneAllowed(a) {
  return !this.isClosed && a.permissions.edit;
}, isSuggestionExpired(a) {
  return this.isSuggestionAllowed && a.configuration.suggestionsExpire > 0 && bs.unix(a.configuration.suggestionsExpire).diff() < 0;
}, isSuggestionExpirySet(a) {
  return this.isSuggestionAllowed && a.configuration.suggestionsExpire > 0;
}, suggestionsExpireRelative(a) {
  return bs.unix(a.configuration.suggestionsExpire).fromNow();
}, suggestionsExpire_d(a) {
  return bs.unix(a.configuration.suggestionsExpire)._d;
}, isClosed(a) {
  return a.status.isExpired || a.configuration.expire > 0 && bs.unix(a.configuration.expire).diff() < 1e3;
}, descriptionMarkDown() {
  return Ye.use(Q_(iT)), eM.sanitize(Ye.parse(this.description).toString());
} }, actions: { reset() {
  this.$reset();
}, setSuggestionExpiration(a) {
  this.configuration.suggestionsExpire = bs(a.expire).unix(), this.write();
}, setExpiration(a) {
  this.configuration.suggestionsExpire = bs(a.expire).unix(), this.write();
}, async resetInquiry() {
  const a = Yt(), i = Nf(), r = Af(), l = xf(), u = useSupportsStore();
  this.$reset(), a.$reset(), i.$reset(), r.$reset(), l.$reset(), u.$reset();
}, async load(a = null) {
  Yt();
  const i = Ee(), r = Nf(), l = Af(), u = xf(), g = z0(), f = F0();
  this.meta.status = "loading";
  try {
    const p = await (() => {
      if (i.route.name === "publicInquiry") return rt.getInquiry(i.route.params.token);
      if (i.route.name === "inquiry") return at.getFullInquiry(a ?? i.currentInquiryId);
    })();
    if (!p) {
      this.$reset();
      return;
    }
    return this.$patch(p.data.inquiry), r.options = p.data.options, l.shares = p.data.shares, u.comments = p.data.comments, f.subscribed = p.data.subscribed, g.attachments = p.data.attachments, p.data.inquiry.owner.id === i.currentUser.id ? i.currentUser.isOwner = true : i.currentUser.isOwner = false, this.meta.status = "loaded", p;
  } catch (p) {
    if (p?.code === "ERR_CANCELED") return;
    throw this.meta.status = "error", se.error("Error loading inquiry", { error: p }), p;
  }
}, async add(a) {
  const i = Yt();
  try {
    return (await at.addInquiry({ title: a.title, type: a.type, configuration: a.configuration, description: a.description, parentId: a.parentId, locationId: a.locationId, categoryId: a.categoryId, owner: a.owner, currentUserStatus: a.currentUserStatus, permissions: a.permissions })).data.inquiry;
  } catch (r) {
    if (r?.code === "ERR_CANCELED") return;
    throw se.error("Error adding inquiry:", { error: r, payload: a, state: this.$state }), r;
  } finally {
    i.load();
  }
}, async update(a) {
  ...
  this.$debounce(async () => {
    try {
      return (await at.updateInquiry(a.id, { title: a.title, type: a.type, description: a.description, parentId: a.parentId, locationId: a.locationId, categoryId: a.categoryId })).data.inquiry;
    } catch (l) {
      if (l?.code === "ERR_CANCELED") return;
      throw se.error("Error updating inquiry", { error: l, state: this.$state }), l;
    } finally {
      this.load(), i.load();
    }
  }, 500)();
}, async setModerationStatus(a) {
  try {
    await at.updateModerationStatus(this.id, a);
  } catch (i) {
    if (i?.code === "ERR_CANCELED") return;
    throw se.error("Error setting moderation status:", { error: i, state: this.$state }), i;
  }
}, async LockAnonymous() {
  try {
    ...
    if (a?.code === "ERR_CANCELED") return;
    throw se.error("Error locking inquiry to anonymous:", { error: a, state: this.$state }), a;
  } finally {
    this.load();
  }
}, write() {
  ...
  this.$debounce(async () => {
    ...
    try {
      ...
      this.$patch(r.data.inquiry), Xw(Ef.UpdateInquiry, { store: "inquiry", message: re("inquiries", "Inquiry updated") });
    } catch (r) {
      if (r?.code === "ERR_CANCELED") return;
      throw se.error("Error updating inquiry:", { error: r, inquiry: this.$state }), _g(re("agora", "Error writing inquiry")), r;
    } finally {
      this.load(), a.load();
    }
  }, 500)();
  ...
  try {
    ...
    if (i?.code === "ERR_CANCELED") return;
    throw se.error("Error closing inquiry", { error: i, inquiryId: this.id }), this.load(), i;
  } finally {
    a.load();
  }
}, async reopen() {
  ...
  try {
    ...
    if (i?.code === "ERR_CANCELED") return;
    throw se.error("Error reopening inquiry", { error: i, inquiryId: this.id }), this.load(), i;
  } finally {
    a.load();
  }
}, async toggleArchive(a) {
  const i = Yt();
  try {
    const r = await at.toggleArchive(a.inquiryId);
    this.id === a.inquiryId && this.$patch(r.data.inquiry);
  } catch (r) {
    if (r?.code === "ERR_CANCELED") return;
    throw se.error("Error archiving/restoring", { error: r, payload: a }), r;
  } finally {
    i.load();
  }
} } }), B0 = /^[a-z0-9]+(-[a-z0-9]+)*$/, cm = (a, i, r, l = "") => {
  const u = a.split(":");
  if (a.slice(0, 1) === "@") {
  ...
  return null;
}, gm = (a, i) => a ? !!((i && a.prefix === "" || a.prefix) && a.name) : false, W0 = Object.freeze({ left: 0, top: 0, width: 16, height: 16 }), hm = Object.freeze({ rotate: 0, vFlip: false, hFlip: false }), fm = Object.freeze({ ...W0, ...hm }), jf = Object.freeze({ ...fm, body: "", hidden: false });
function oT(a, i) {
  const r = {};
  !a.hFlip != !i.hFlip && (r.hFlip = true), !a.vFlip != !i.vFlip && (r.vFlip = true);
  const l = ((a.rotate || 0) + (i.rotate || 0)) % 4;
  return l && (r.rotate = l), r;
}
function $0(a, i) {
  const r = oT(a, i);
  for (const l in jf) l in hm ? l in a && !(l in r) && (r[l] = hm[l]) : l in i ? r[l] = i[l] : l in a && (r[l] = a[l]);
  return r;
}
function lT(a, i) {
  const r = a.icons, l = a.aliases || /* @__PURE__ */ Object.create(null), u = /* @__PURE__ */ Object.create(null);
  function g(f) {
    if (r[f]) return u[f] = [];
    if (!(f in u)) {
      u[f] = null;
...
function dT(a, i, r) {
  const l = a.icons, u = a.aliases || /* @__PURE__ */ Object.create(null);
  let g = {};
  function f(p) {
    g = $0(l[p] || u[p], g);
  }
  return f(i), r.forEach(f), $0(a, g);
}
function G0(a, i) {
  const r = [];
  if (typeof a != "object" || typeof a.icons != "object") return r;
  a.not_found instanceof Array && a.not_found.forEach((u) => {
    i(u, null), r.push(u);
  });
  const l = lT(a);
  for (const u in l) {
    const g = l[u];
    g && (i(u, dT(a, u, g)), r.push(u));
  }
  return r;
}
const mT = { provider: "", aliases: {}, not_found: {}, ...W0 };
function qf(a, i) {
  for (const r in i) if (r in a && typeof a[r] != typeof i[r]) return false;
  return true;
}
function V0(a) {
  if (typeof a != "object" || a === null) return null;
  const i = a;
  if (typeof i.prefix != "string" || !a.icons || typeof a.icons != "object" || !qf(a, mT)) return null;
  const r = i.icons;
  for (const u in r) {
    const g = r[u];
    if (!u || typeof g.body != "string" || !qf(g, jf)) return null;
  }
  const l = i.aliases || /* @__PURE__ */ Object.create(null);
  for (const u in l) {
    const g = l[u], f = g.parent;
    if (!u || typeof f != "string" || !r[f] && !l[f] || !qf(g, jf)) return null;
  }
  return i;
}
const J0 = /* @__PURE__ */ Object.create(null);
function uT(a, i) {
  return { provider: a, prefix: i, icons: /* @__PURE__ */ Object.create(null), missing: /* @__PURE__ */ new Set() };
}
function li(a, i) {
  const r = J0[a] || (J0[a] = /* @__PURE__ */ Object.create(null));
  return r[i] || (r[i] = uT(a, i));
}
function K0(a, i) {
  return V0(i) ? G0(i, (r, l) => {
    l ? a.icons[r] = l : a.missing.add(r);
  }) : [];
}
function cT(a, i, r) {
  try {
    if (typeof r.body == "string") return a.icons[i] = { ...r }, true;
  } catch {
  }
  return false;
}
let xo = false;
function Z0(a) {
  return typeof a == "boolean" && (xo = a), xo;
}
function gT(a) {
  const i = typeof a == "string" ? cm(a, true, xo) : a;
  if (i) {
...
function hT(a, i) {
  const r = cm(a, true, xo);
  if (!r) return false;
  const l = li(r.provider, r.prefix);
  return i ? cT(l, r.name, i) : (l.missing.add(r.name), true);
}
function fT(a, i) {
  if (typeof a != "object") return false;
  if (typeof i != "string" && (i = a.provider || ""), xo && !i && !a.prefix) {
    let u = false;
    return V0(a) && (a.prefix = "", G0(a, (g, f) => {
      hT(g, f) && (u = true);
    })), u;
  }
  const r = a.prefix;
...
const Q0 = Object.freeze({ width: null, height: null }), X0 = Object.freeze({ ...Q0, ...hm }), _T = /(-?[0-9.]*[0-9]+[0-9.]*)/g, pT = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function e1(a, i, r) {
  if (i === 1) return a;
  if (r = r || 100, typeof a == "number") return Math.ceil(a * i * r) / r;
  if (typeof a != "string") return a;
  const l = a.split(_T);
  if (l === null || !l.length) return a;
  const u = [];
  let g = l.shift(), f = pT.test(g);
  for (; ; ) {
    if (f) {
...
function yT(a, i = "defs") {
  let r = "";
  const l = a.indexOf("<" + i);
  for (; l >= 0; ) {
    const u = a.indexOf(">", l), g = a.indexOf("</" + i);
    if (u === -1 || g === -1) break;
    const f = a.indexOf(">", g);
    if (f === -1) break;
    r += a.slice(u + 1, g).trim(), a = a.slice(0, l).trim() + a.slice(f + 1);
  }
  return { defs: r, content: a };
}
function vT(a, i) {
  return a ? "<defs>" + a + "</defs>" + i : i;
}
function wT(a, i, r) {
  const l = yT(a);
  return vT(l.defs, i + l.content + r);
}
const MT = (a) => a === "unset" || a === "undefined" || a === "none";
function LT(a, i) {
  const r = { ...fm, ...a }, l = { ...X0, ...i }, u = { left: r.left, top: r.top, width: r.width, height: r.height };
  let g = r.body;
  [r, l].forEach((I) => {
    const x = [], Q = I.hFlip, X = I.vFlip;
    let te = I.rotate;
    Q ? X ? te += 2 : (x.push("translate(" + (u.width + u.left).toString() + " " + (0 - u.top).toString() + ")"), x.push("scale(-1 1)"), u.top = u.left = 0) : X && (x.push("translate(" + (0 - u.left).toString() + " " + (u.height + u.top).toString() + ")"), x.push("scale(1 -1)"), u.top = u.left = 0);
    let Z;
    switch (te < 0 && (te -= Math.floor(te / 4) * 4), te = te % 4, te) {
      case 1:
    ...
    te % 2 === 1 && (u.left !== u.top && (Z = u.left, u.left = u.top, u.top = Z), u.width !== u.height && (Z = u.width, u.width = u.height, u.height = Z)), x.length && (g = wT(g, '<g transform="' + x.join(" ") + '">', "</g>"));
  });
  const f = l.width, p = l.height, L = u.width, w = u.height;
  let D, b;
  f === null ? (b = p === null ? "1em" : p === "auto" ? w : p, D = e1(b, L / w)) : (D = f === "auto" ? L : f, b = p === null ? e1(D, w / L) : p === "auto" ? w : p);
  const H = {}, N = (I, x) => {
    MT(x) || (H[I] = x.toString());
  };
...
const kT = /\sid="(\S+)"/g, TT = "IconifyId" + Date.now().toString(16) + (Math.random() * 16777216 | 0).toString(16);
let DT = 0;
function YT(a, i = TT) {
  const r = [];
  let l;
  for (; l = kT.exec(a); ) r.push(l[1]);
  if (!r.length) return a;
  const u = "suffix" + (Math.random() * 16777216 | Date.now()).toString(16);
  return r.forEach((g) => {
    const f = typeof i == "function" ? i(g) : i + (DT++).toString(), p = g.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    a = a.replace(new RegExp('([#;"])(' + p + ')([")]|\\.[a-z])', "g"), "$1" + f + u + "$3");
  }), a = a.replace(new RegExp(u, "g"), ""), a;
}
...
function If(a) {
  let i;
  if (typeof a.resources == "string") i = [a.resources];
  else if (i = a.resources, !(i instanceof Array) || !i.length) return null;
  return { resources: i, path: a.path || "/", maxURL: a.maxURL || 500, rotate: a.rotate || 750, timeout: a.timeout || 5e3, random: a.random === true, index: a.index || 0, dataAfterTimeout: a.dataAfterTimeout !== false };
}
const Uf = /* @__PURE__ */ Object.create(null), No = ["https://api.simplesvg.com", "https://api.unisvg.com"], _m = [];
for (; No.length > 0; ) No.length === 1 || Math.random() > 0.5 ? _m.push(No.shift()) : _m.push(No.pop());
Uf[""] = If({ resources: ["https://api.iconify.design"].concat(_m) });
function bT(a, i) {
  const r = If(i);
  return r === null ? false : (Uf[a] = r, true);
}
function zf(a) {
  return Uf[a];
}
...
const NT = (a, i, r) => {
  const l = [], u = FT(a, i), g = "icons";
  let f = { type: g, provider: a, prefix: i, icons: [] }, p = 0;
  return r.forEach((L, w) => {
    p += L.length + 1, p >= u && w > 0 && (l.push(f), f = { type: g, provider: a, prefix: i, icons: [] }, p = L.length), f.icons.push(L);
  }), l.push(f), l;
};
function AT(a) {
  if (typeof a == "string") {
...
}, HT = { prepare: NT, send: ET };
function PT(a) {
  const i = { loaded: [], missing: [], pending: [] }, r = /* @__PURE__ */ Object.create(null);
  a.sort((u, g) => u.provider !== g.provider ? u.provider.localeCompare(g.provider) : u.prefix !== g.prefix ? u.prefix.localeCompare(g.prefix) : u.name.localeCompare(g.name));
...
function jT(a) {
  a.pendingCallbacksFlag || (a.pendingCallbacksFlag = true, setTimeout(() => {
    a.pendingCallbacksFlag = false;
    const i = a.loaderCallbacks ? a.loaderCallbacks.slice(0) : [];
    if (!i.length) return;
    let r = false;
    const l = a.provider, u = a.prefix;
    i.forEach((g) => {
      const f = g.icons, p = f.pending.length;
      f.pending = f.pending.filter((L) => {
        if (L.prefix !== u) return true;
        const w = L.name;
        if (a.icons[w]) f.loaded.push({ provider: l, prefix: u, name: w });
        else if (a.missing.has(w)) f.missing.push({ provider: l, prefix: u, name: w });
        else return r = true, true;
        return false;
      }), f.pending.length !== p && (r || s1([a], g.id), g.callback(f.loaded.slice(0), f.missing.slice(0), f.pending.slice(0), g.abort));
    });
  }));
}
let qT = 0;
function OT(a, i, r) {
  const l = qT++, u = s1.bind(null, r, l);
  if (!i.pending.length) return u;
  const g = { id: l, icons: i, callback: a, abort: u };
  return r.forEach((f) => {
    (f.loaderCallbacks || (f.loaderCallbacks = [])).push(g);
  }), u;
}
function RT(a, i = true, r = false) {
  const l = [];
  return a.forEach((u) => {
...
var IT = { resources: [], index: 0, timeout: 2e3, rotate: 750, random: false, dataAfterTimeout: false };
function UT(a, i, r, l) {
  const u = a.resources.length, g = a.random ? Math.floor(Math.random() * u) : a.index;
  let f;
  if (a.random) {
    ...
    f = f.concat(B);
  } else f = a.resources.slice(g).concat(a.resources.slice(0, g));
  const p = Date.now();
  ...
  function Q() {
    return { startTime: p, payload: i, status: L, queriesSent: w, queriesPending: H.length, subscribe: x, abort: I };
  }
  function X() {
  ...
  function Z(B, V, he) {
    ...
    switch (H = H.filter((ke) => ke !== B), L) {
      case "pending":
        break;
      case "failed":
        if (je || !a.dataAfterTimeout) return;
        break;
      default:
        return;
    }
    ...
    if (q(), te(), !a.random) {
      const ke = a.resources.indexOf(B.resource);
      ke !== -1 && ke !== a.index && (a.index = ke);
    }
  ...
  function ge() {
    ...
    H.push(V), w++, b = setTimeout(ge, a.rotate), r(B, i, V.callback);
  }
...
const Bf = /* @__PURE__ */ Object.create(null);
function zT(a) {
  if (!Bf[a]) {
    const i = zf(a);
    if (!i) return;
    const r = n1(i), l = { config: i, redundancy: r };
    Bf[a] = l;
  }
  return Bf[a];
}
function BT(a, i, r) {
  ...
  if (typeof a == "string") {
    ...
    if (g) {
      l = n1(g);
      const f = a.resources ? a.resources[0] : "", p = Rf(f);
      p && (u = p.send);
    }
  }
  return !l || !u ? (r(void 0, 424), a1) : l.query(i, u, r)().abort;
}
function r1() {
}
function WT(a) {
  a.iconsLoaderFlag || (a.iconsLoaderFlag = true, setTimeout(() => {
    a.iconsLoaderFlag = false, jT(a);
  }));
}
function $T(a) {
  const i = [], r = [];
  return a.forEach((l) => {
    (l.match(B0) ? i : r).push(l);
  }), { valid: i, invalid: r };
}
function Ao(a, i, r) {
  function l() {
    const u = a.pendingIcons;
    i.forEach((g) => {
      u && u.delete(g), a.icons[g] || a.missing.add(g);
    });
  }
...
function GT(a, i) {
  a.iconsToLoad ? a.iconsToLoad = a.iconsToLoad.concat(i).sort() : a.iconsToLoad = i, a.iconsQueueFlag || (a.iconsQueueFlag = true, setTimeout(() => {
    a.iconsQueueFlag = false;
    const { provider: r, prefix: l } = a, u = a.iconsToLoad;
    if (delete a.iconsToLoad, !u || !u.length) return;
    const g = a.loadIcon;
    if (a.loadIcons && (u.length > 1 || !g)) {
      i1(a.loadIcons(u, l, r), (D) => {
        Ao(a, u, D);
      });
      return;
    }
    ...
    const { valid: f, invalid: p } = $T(u);
    if (p.length && Ao(a, p, null), !f.length) return;
    const L = l.match(B0) ? Rf(r) : null;
    if (!L) {
      Ao(a, f, null);
      return;
    }
...
const VT = (a, i) => {
  const r = RT(a, true, Z0()), l = PT(r);
  if (!l.pending.length) {
    let L = true;
    return i && setTimeout(() => {
      L && i(l.loaded, l.missing, l.pending, r1);
    }), () => {
      L = false;
    };
  }
...
function JT(a, i) {
  ...
  for (const l in i) {
    ...
    l in Q0 ? (u === null || u && (g === "string" || g === "number")) && (r[l] = u) : g === typeof r[l] && (r[l] = l === "rotate" ? u % 4 : u);
  }
  return r;
}
const KT = /[\s,]+/;
function ZT(a, i) {
  i.split(KT).forEach((r) => {
    switch (r.trim()) {
      case "horizontal":
        a.hFlip = true;
        break;
...
function QT(a, i = 0) {
  ...
  if (r === "") {
    ...
    if (u) {
      let g = parseFloat(a.slice(0, a.length - r.length));
...
function XT(a, i) {
  let r = a.indexOf("xlink:") === -1 ? "" : ' xmlns:xlink="http://www.w3.org/1999/xlink"';
  for (const l in i) r += " " + l + '="' + i[l] + '"';
  return '<svg xmlns="http://www.w3.org/2000/svg"' + r + ">" + a + "</svg>";
}
function eD(a) {
  return a.replace(/"/g, "'").replace(/%/g, "%25").replace(/#/g, "%23").replace(/</g, "%3C").replace(/>/g, "%3E").replace(/\s+/g, " ");
}
function tD(a) {
  return "data:image/svg+xml," + eD(a);
}
function sD(a) {
  return 'url("' + tD(a) + '")';
}
const o1 = { ...X0, inline: false }, nD = { xmlns: "http://www.w3.org/2000/svg", "xmlns:xlink": "http://www.w3.org/1999/xlink", "aria-hidden": true, role: "img" }, aD = { display: "inline-block" }, Wf = { backgroundColor: "currentColor" }, l1 = { backgroundColor: "transparent" }, d1 = { Image: "var(--svg)", Repeat: "no-repeat", Size: "100% 100%" }, m1 = { webkitMask: Wf, mask: Wf, background: l1 };
for (const a in m1) {
  const i = m1[a];
  for (const r in d1) i[a + r] = d1[r];
}
const pm = {};
["horizontal", "vertical"].forEach((a) => {
  const i = a.slice(0, 1) + "Flip";
  pm[a + "-flip"] = i, pm[a.slice(0, 1) + "-flip"] = i, pm[a + "Flip"] = i;
});
function u1(a) {
  return a + (a.match(/^[-0-9.]+$/) ? "px" : "");
}
const c1 = (a, i) => {
  const r = JT(o1, i), l = { ...nD }, u = i.mode || "svg", g = {}, f = i.style, p = typeof f == "object" && !(f instanceof Array) ? f : {};
  for (let I in i) {
    const x = i[I];
    if (x !== void 0) switch (I) {
      case "icon":
      case "style":
      case "onLoad":
      case "mode":
      ...
      case "hFlip":
      case "vFlip":
        r[I] = x === true || x === "true" || x === 1;
        break;
      case "flip":
        typeof x == "string" && ZT(r, x);
        break;
      case "color":
        g.color = x;
        break;
      case "rotate":
        typeof x == "string" ? r[I] = QT(x) : typeof x == "number" && (r[I] = x);
        break;
      case "ariaHidden":
      case "aria-hidden":
      ...
      default: {
        const Q = pm[I];
        Q ? (x === true || x === "true" || x === 1) && (r[Q] = true) : o1[I] === void 0 && (l[I] = x);
      }
    }
  }
  const L = LT(a, r), w = L.attributes;
  if (r.inline && (g.verticalAlign = "-0.125em"), u === "svg") {
    l.style = { ...g, ...p }, Object.assign(l, w);
    let I = 0, x = i.id;
    return typeof x == "string" && (x = x.replace(/-/g, "_")), l.innerHTML = YT(L.body, x ? () => x + "ID" + I++ : "iconifyVue"), tg("svg", l);
  }
  const { body: D, width: b, height: H } = a, N = u === "mask" || (u === "bg" ? false : D.indexOf("currentColor") !== -1), q = XT(D, { ...w, width: b + "", height: H + "" });
  return l.style = { ...g, "--svg": sD(q), width: u1(w.width), height: u1(w.height), ...aD, ...N ? Wf : l1, ...p }, tg("span", l);
};
if (Z0(true), CT("", HT), typeof document < "u" && typeof window < "u") {
  const a = window;
  if (a.IconifyPreload !== void 0) {
    const i = a.IconifyPreload, r = "Invalid IconifyPreload syntax.";
    typeof i == "object" && i !== null && (i instanceof Array ? i : [i]).forEach((l) => {
      try {
        (typeof l != "object" || l === null || l instanceof Array || typeof l.icons != "object" || typeof l.prefix != "string" || !fT(l)) && console.error(r);
      } catch {
        console.error(r);
      }
    });
...
const rD = { ...fm, body: "" }, iD = Zc((a, { emit: i }) => {
  const r = tr(null);
  function l() {
    r.value && (r.value.abort?.(), r.value = null);
  }
  const u = tr(!!a.ssr), g = tr(""), f = tM(null);
  function p() {
    const w = a.icon;
    ...
    if (!b) {
      const q = r.value;
      return (!q || q.name !== w) && (b === null ? r.value = { name: w } : r.value = { name: w, abort: VT([D], L) }), null;
    }
    l(), g.value !== w && (g.value = w, rM(() => {
      i("load", w);
    }));
    const H = a.customise;
    if (H) {
  ...
  return u.value ? L() : sM(() => {
    ...
    if (!w) return c1(rD, a);
    let D = a;
    return w.classes && (D = { ...a, class: w.classes.join(" ") }), c1({ ...fm, ...w.data }, D);
  };
}, { props: ["icon", "mode", "ssr", "width", "height", "style", "color", "inline", "rotate", "hFlip", "horizontalFlip", "vFlip", "verticalFlip", "flip", "id", "ariaHidden", "customise", "title"], emits: ["load"] }), oD = { width: 24, height: 24, body: '<path fill="currentColor" d="M12 6a6 6 0 0 1 6 6c0 2.22-1.21 4.16-3 5.2V19a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1v-1.8c-1.79-1.04-3-2.98-3-5.2a6 6 0 0 1 6-6m2 15v1a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-1h4m6-10h3v2h-3v-2M1 11h3v2H1v-2M13 1v3h-2V1h2M4.92 3.5l2.13 2.14l-1.42 1.41L3.5 4.93L4.92 3.5m12.03 2.13l2.12-2.13l1.43 1.43l-2.13 2.12l-1.42-1.42Z"/>' }, lD = { width: 24, height: 24, body: '<path fill="currentColor" d="M17 12V3a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v14l4-4h10a1 1 0 0 0 1-1m4-6h-2v9H6v2a1 1 0 0 0 1 1h11l4 4V7a1 1 0 0 0-1-1Z"/>' }, dD = { width: 24, height: 24, body: '<path fill="currentColor" d="M20 17q.86 0 1.45.6t.58 1.4L14 22l-7-2v-9h1.95l7.27 2.69q.78.31.78 1.12q0 .47-.34.82t-.86.37H13l-1.75-.67l-.33.94L13 17h7M16 3.23Q17.06 2 18.7 2q1.36 0 2.3 1t1 2.3q0 1.03-1 2.46t-1.97 2.39T16 13q-2.08-1.89-3.06-2.85t-1.97-2.39T10 5.3q0-1.36.97-2.3t2.34-1q1.6 0 2.69 1.23M.984 11H5v11H.984V11Z"/>' }, mD = { width: 24, height: 24, body: '<path fill="currentColor" d="M3 3h6v4H3V3m12 7h6v4h-6v-4m0 7h6v4h-6v-4m-2-4H7v5h6v2H5V9h2v2h6v2Z"/>' }, uD = { width: 24, height: 24, body: '<path fill="currentColor" d="M13 13h-2V7h2m0 10h-2v-2h2M12 2A10 10 0 0 0 2 12a10 10 0 0 0 10 10a10 10 0 0 0 10-10A10 10 0 0 0 12 2Z"/>' }, cD = { width: 24, height: 24, body: '<path fill="currentColor" d="M11.5 1L2 6v2h19V6m-5 4v7h3v-7M2 22h19v-3H2m8-9v7h3v-7m-9 0v7h3v-7H4Z"/>' }, gD = { width: 24, height: 24, body: '<path fill="currentColor" d="M21 10.12h-6.78l2.74-2.82c-2.73-2.7-7.15-2.8-9.88-.1a6.887 6.887 0 0 0 0 9.8c2.73 2.7 7.15 2.7 9.88 0c1.36-1.35 2.04-2.92 2.04-4.9h2c0 1.98-.88 4.55-2.64 6.29c-3.51 3.48-9.21 3.48-12.72 0c-3.5-3.47-3.53-9.11-.02-12.58a8.987 8.987 0 0 1 12.65 0L21 3v7.12M12.5 8v4.25l3.5 2.08l-.72 1.21L11 13V8h1.5Z"/>' }, g1 = { width: 24, height: 24, body: '<path fill="currentColor" d="M19 19H5V8h14m-3-7v2H8V1H6v2H5c-1.11 0-2 .89-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-1V1m-1 11h-5v5h5v-5Z"/>' }, h1 = { width: 24, height: 24, body: '<path fill="currentColor" d="M20.8 22.7L15 16.9V20H9v-6H5l3.6-3.6L1.1 3l1.3-1.3l19.7 19.7l-1.3 1.3M19 6V4H7.2l2 2H19m-1.8 8H19l-7-7l-.9.9l6.1 6.1Z"/>' }, Eo = { width: 24, height: 24, body: '<path fill="currentColor" d="M3 3h18v4H3V3m1 5h16v13H4V8m5.5 3a.5.5 0 0 0-.5.5V13h6v-1.5a.5.5 0 0 0-.5-.5h-5Z"/>' }, di = { width: 24, height: 24, body: '<path fill="currentColor" d="M12 17a2 2 0 0 0 2-2a2 2 0 0 0-2-2a2 2 0 0 0-2 2a2 2 0 0 0 2 2m6-9a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V10a2 2 0 0 1 2-2h1V6a5 5 0 0 1 5-5a5 5 0 0 1 5 5v2h1m-6-5a3 3 0 0 0-3 3v2h6V6a3 3 0 0 0-3-3Z"/>' }, $f = { width: 24, height: 24, body: '<path fill="currentColor" d="M12 20a8 8 0 0 0 8-8a8 8 0 0 0-8-8a8 8 0 0 0-8 8a8 8 0 0 0 8 8m0-18a10 10 0 0 1 10 10a10 10 0 0 1-10 10C6.47 22 2 17.5 2 12A10 10 0 0 1 12 2m.5 5v5.25l4.5 2.67l-.75 1.23L11 13V7h1.5Z"/>' }, ym = { width: 24, height: 24, body: '<path fill="currentColor" d="M22 14v8h-2v-4l-4 4v-3h-5v-2h5v-3l4 4v-4h2M5 19h4v2H5c-1.1 0-2-.9-2-2V5a2 2 0 0 1 2-2h1V.998h2V3h8V.998h2V3h1c1.11 0 2 .89 2 2v7h-2V8H5v11Z"/>' }, hD = { width: 24, height: 24, body: '<path fill="currentColor" d="M12 2c5.5 0 10 4.5 10 10s-4.5 10-10 10S2 17.5 2 12S6.5 2 12 2m0 2c-1.9 0-3.6.6-4.9 1.7l11.2 11.2c1-1.4 1.7-3.1 1.7-4.9c0-4.4-3.6-8-8-8m4.9 14.3L5.7 7.1C4.6 8.4 4 10.1 4 12c0 4.4 3.6 8 8 8c1.9 0 3.6-.6 4.9-1.7Z"/>' }, fD = { width: 24, height: 24, body: '<path fill="currentColor" d="M21 7L9 19l-5.5-5.5l1.41-1.41L9 16.17L19.59 5.59L21 7Z"/>' }, _D = { width: 24, height: 24, body: '<path fill="currentColor" d="M12 9a3 3 0 0 1 3 3a3 3 0 0 1-3 3a3 3 0 0 1-3-3a3 3 0 0 1 3-3m0-4.5c5 0 9.27 3.11 11 7.5c-1.73 4.39-6 7.5-11 7.5S2.73 16.39 1 12c1.73-4.39 6-7.5 11-7.5M3.18 12a9.821 9.821 0 0 0 17.64 0a9.821 9.821 0 0 0-17.64 0Z"/>' }, pD = { width: 24, height: 24, body: '<path fill="currentColor" d="M9.5 3A6.5 6.5 0 0 1 16 9.5c0 1.61-.59 3.09-1.56 4.23l.27.27h.79l5 5l-1.5 1.5l-5-5v-.79l-.27-.27A6.516 6.516 0 0 1 9.5 16A6.5 6.5 0 0 1 3 9.5A6.5 6.5 0 0 1 9.5 3m0 2C7 5 5 7 5 9.5S7 14 9.5 14S14 12 14 9.5S12 5 9.5 5Z"/>' }, yD = { width: 24, height: 24, body: '<path fill="currentColor" d="M11 15h2v2h-2v-2m0-8h2v6h-2V7m1-5C6.47 2 2 6.5 2 12a10 10 0 0 0 10 10a10 10 0 0 0 10-10A10 10 0 0 0 12 2m0 18a8 8 0 0 1-8-8a8 8 0 0 1 8-8a8 8 0 0 1 8 8a8 8 0 0 1-8 8Z"/>' }, vD = { width: 24, height: 24, body: '<path fill="currentColor" d="M15 4v7H5.17L4 12.17V4h11m1-2H3a1 1 0 0 0-1 1v14l4-4h10a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1m5 4h-2v9H6v2a1 1 0 0 0 1 1h11l4 4V7a1 1 0 0 0-1-1Z"/>' }, f1 = { width: 24, height: 24, body: '<path fill="currentColor" d="M21 13c.6 0 1.1.2 1.4.6c.4.4.6.9.6 1.4l-8 3l-7-2V7h1.9l7.3 2.7c.5.2.8.6.8 1.1c0 .3-.1.6-.3.8c-.2.2-.5.4-.9.4H14l-1.7-.7l-.3.9l2 .8h7M2 7h4v11H2V7Z"/>' }, wD = { width: 24, height: 24, body: '<path fill="currentColor" d="M12 8a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 2a2 2 0 0 0-2 2a2 2 0 0 0 2 2a2 2 0 0 0 2-2a2 2 0 0 0-2-2m-2 12c-.25 0-.46-.18-.5-.42l-.37-2.65c-.63-.25-1.17-.59-1.69-.99l-2.49 1.01c-.22.08-.49 0-.61-.22l-2-3.46a.493.493 0 0 1 .12-.64l2.11-1.66L4.5 12l.07-1l-2.11-1.63a.493.493 0 0 1-.12-.64l2-3.46c.12-.22.39-.31.61-.22l2.49 1c.52-.39 1.06-.73 1.69-.98l.37-2.65c.04-.24.25-.42.5-.42h4c.25 0 .46.18.5.42l.37 2.65c.63.25 1.17.59 1.69.98l2.49-1c.22-.09.49 0 .61.22l2 3.46c.13.22.07.49-.12.64L19.43 11l.07 1l-.07 1l2.11 1.63c.19.15.25.42.12.64l-2 3.46c-.12.22-.39.31-.61.22l-2.49-1c-.52.39-1.06.73-1.69.98l-.37 2.65c-.04.24-.25.42-.5.42h-4m1.25-18l-.37 2.61c-1.2.25-2.26.89-3.03 1.78L5.44 7.35l-.75 1.3L6.8 10.2a5.55 5.55 0 0 0 0 3.6l-2.12 1.56l.75 1.3l2.43-1.04c.77.88 1.82 1.52 3.01 1.76l.37 2.62h1.52l.37-2.61c1.19-.25 2.24-.89 3.01-1.77l2.43 1.04l.75-1.3l-2.12-1.55c.4-1.17.4-2.44 0-3.61l2.11-1.55l-.75-1.3l-2.41 1.04a5.42 5.42 0 0 0-3.03-1.77L12.75 4h-1.5Z"/>' }, MD = { width: 24, height: 24, body: '<path fill="currentColor" d="M8.5 8.64L13.77 12L8.5 15.36V8.64M6.5 5v14l11-7"/>' }, Gf = { width: 24, height: 24, body: '<path fill="currentColor" d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2Z"/>' }, _1 = { width: 24, height: 24, body: '<path fill="currentColor" d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.62L12 2L9.19 8.62L2 9.24l5.45 4.73L5.82 21L12 17.27Z"/>' }, p1 = { width: 24, height: 24, body: '<path fill="currentColor" d="M18 8a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V10a2 2 0 0 1 2-2h9V6a3 3 0 0 0-3-3a3 3 0 0 0-3 3H7a5 5 0 0 1 5-5a5 5 0 0 1 5 5v2h1m-6 9a2 2 0 0 0 2-2a2 2 0 0 0-2-2a2 2 0 0 0-2 2a2 2 0 0 0 2 2Z"/>' }, LD = { width: 24, height: 24, body: '<path fill="currentColor" d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83l3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25Z"/>' }, kD = { width: 24, height: 24, body: '<path fill="currentColor" d="m12 21.35l-1.45-1.32C5.4 15.36 2 12.27 2 8.5C2 5.41 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.08C13.09 3.81 14.76 3 16.5 3C19.58 3 22 5.41 22 8.5c0 3.77-3.4 6.86-8.55 11.53L12 21.35Z"/>' }, y1 = { width: 24, height: 24, body: '<path fill="currentColor" d="M23 10a2 2 0 0 0-2-2h-6.32l.96-4.57c.02-.1.03-.21.03-.32c0-.41-.17-.79-.44-1.06L14.17 1L7.59 7.58C7.22 7.95 7 8.45 7 9v10a2 2 0 0 0 2 2h9c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73v-2M1 21h4V9H1v12Z"/>' }, TD = { width: 24, height: 24, body: '<path fill="currentColor" d="M19 15h4V3h-4m-4 0H6c-.83 0-1.54.5-1.84 1.22l-3.02 7.05c-.09.23-.14.47-.14.73v2a2 2 0 0 0 2 2h6.31l-.95 4.57c-.02.1-.03.2-.03.31c0 .42.17.79.44 1.06L9.83 23l6.58-6.59c.37-.36.59-.86.59-1.41V5a2 2 0 0 0-2-2Z"/>' }, DD = { width: 24, height: 24, body: '<path fill="currentColor" d="M16 17v2H2v-2s0-4 7-4s7 4 7 4m-3.5-9.5A3.5 3.5 0 1 0 9 11a3.5 3.5 0 0 0 3.5-3.5m3.44 5.5A5.32 5.32 0 0 1 18 17v2h4v-2s0-3.63-6.06-4M15 4a3.39 3.39 0 0 0-1.93.59a5 5 0 0 1 0 5.82A3.39 3.39 0 0 0 15 11a3.5 3.5 0 0 0 0-7Z"/>' }, YD = { width: 24, height: 24, body: '<path fill="currentColor" d="M10.59 13.41c.41.39.41 1.03 0 1.42c-.39.39-1.03.39-1.42 0a5.003 5.003 0 0 1 0-7.07l3.54-3.54a5.003 5.003 0 0 1 7.07 0a5.003 5.003 0 0 1 0 7.07l-1.49 1.49c.01-.82-.12-1.64-.4-2.42l.47-.48a2.982 2.982 0 0 0 0-4.24a2.982 2.982 0 0 0-4.24 0l-3.53 3.53a2.982 2.982 0 0 0 0 4.24m2.82-4.24c.39-.39 1.03-.39 1.42 0a5.003 5.003 0 0 1 0 7.07l-3.54 3.54a5.003 5.003 0 0 1-7.07 0a5.003 5.003 0 0 1 0-7.07l1.49-1.49c-.01.82.12 1.64.4 2.43l-.47.47a2.982 2.982 0 0 0 0 4.24a2.982 2.982 0 0 0 4.24 0l3.53-3.53a2.982 2.982 0 0 0 0-4.24a.973.973 0 0 1 0-1.42Z"/>' }, CD = { width: 24, height: 24, body: '<path fill="currentColor" d="M2 3h20c1.05 0 2 .95 2 2v14c0 1.05-.95 2-2 2H2c-1.05 0-2-.95-2-2V5c0-1.05.95-2 2-2m12 3v1h8V6h-8m0 2v1h8V8h-8m0 2v1h7v-1h-7m-6 3.91C6 13.91 2 15 2 17v1h12v-1c0-2-4-3.09-6-3.09M8 6a3 3 0 0 0-3 3a3 3 0 0 0 3 3a3 3 0 0 0 3-3a3 3 0 0 0-3-3Z"/>' }, bD = { width: 24, height: 24, body: '<path fill="currentColor" d="m20 8l-8 5l-8-5V6l8 5l8-5m0-2H4c-1.11 0-2 .89-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2Z"/>' }, v1 = { width: 24, height: 24, body: '<path fill="currentColor" d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7c0-.24-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81a3 3 0 0 0 3-3a3 3 0 0 0-3-3a3 3 0 0 0-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9a3 3 0 0 0-3 3a3 3 0 0 0 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.15c-.05.21-.08.43-.08.66c0 1.61 1.31 2.91 2.92 2.91c1.61 0 2.92-1.3 2.92-2.91A2.92 2.92 0 0 0 18 16.08Z"/>' }, SD = { width: 24, height: 24, body: '<path fill="currentColor" d="M12 5a3.5 3.5 0 0 0-3.5 3.5A3.5 3.5 0 0 0 12 12a3.5 3.5 0 0 0 3.5-3.5A3.5 3.5 0 0 0 12 5m0 2a1.5 1.5 0 0 1 1.5 1.5A1.5 1.5 0 0 1 12 10a1.5 1.5 0 0 1-1.5-1.5A1.5 1.5 0 0 1 12 7M5.5 8A2.5 2.5 0 0 0 3 10.5c0 .94.53 1.75 1.29 2.18c.36.2.77.32 1.21.32c.44 0 .85-.12 1.21-.32c.37-.21.68-.51.91-.87A5.42 5.42 0 0 1 6.5 8.5v-.28c-.3-.14-.64-.22-1-.22m13 0c-.36 0-.7.08-1 .22v.28c0 1.2-.39 2.36-1.12 3.31c.12.19.25.34.4.49a2.482 2.482 0 0 0 1.72.7c.44 0 .85-.12 1.21-.32c.76-.43 1.29-1.24 1.29-2.18A2.5 2.5 0 0 0 18.5 8M12 14c-2.34 0-7 1.17-7 3.5V19h14v-1.5c0-2.33-4.66-3.5-7-3.5m-7.29.55C2.78 14.78 0 15.76 0 17.5V19h3v-1.93c0-1.01.69-1.85 1.71-2.52m14.58 0c1.02.67 1.71 1.51 1.71 2.52V19h3v-1.5c0-1.74-2.78-2.72-4.71-2.95M12 16c1.53 0 3.24.5 4.23 1H7.77c.99-.5 2.7-1 4.23-1Z"/>' }, FD = { width: 24, height: 24, body: '<path fill="currentColor" d="M18 19a2 2 0 0 1-2-2c0-1.11.89-2 2-2a2 2 0 0 1 2 2a2 2 0 0 1-2 2m0-6a4 4 0 0 0-4 4a4 4 0 0 0 4 4a4 4 0 0 0 4-4a4 4 0 0 0-4-4m-6-1.9a1.9 1.9 0 0 0-1.9 1.9a1.9 1.9 0 0 0 1.9 1.9a1.9 1.9 0 0 0 1.9-1.9a1.9 1.9 0 0 0-1.9-1.9M6 19a2 2 0 0 1-2-2c0-1.11.89-2 2-2a2 2 0 0 1 2 2a2 2 0 0 1-2 2m0-6a4 4 0 0 0-4 4a4 4 0 0 0 4 4a4 4 0 0 0 4-4a4 4 0 0 0-4-4m6-9a2 2 0 0 1 2 2a2 2 0 0 1-2 2a2 2 0 0 1-2-2c0-1.11.89-2 2-2m0 6a4 4 0 0 0 4-4a4 4 0 0 0-4-4a4 4 0 0 0-4 4a4 4 0 0 0 4 4Z"/>' }, xD = { width: 24, height: 24, body: '<path fill="currentColor" d="M12 4a4 4 0 0 1 4 4c0 1.95-1.4 3.58-3.25 3.93L8.07 7.25A4.004 4.004 0 0 1 12 4m.28 10l6 6L20 21.72L18.73 23l-3-3H4v-2c0-1.84 2.5-3.39 5.87-3.86L2.78 7.05l1.27-1.27L12.28 14M20 18v1.18l-4.86-4.86C18 14.93 20 16.35 20 18Z"/>' }, ND = { width: 24, height: 24, body: '<path fill="currentColor" d="M17.06 13c-1.86 0-3.42 1.33-3.82 3.1c-.95-.41-1.82-.3-2.48-.01C10.35 14.31 8.79 13 6.94 13C4.77 13 3 14.79 3 17s1.77 4 3.94 4c2.06 0 3.74-1.62 3.9-3.68c.34-.24 1.23-.69 2.32.02c.18 2.05 1.84 3.66 3.9 3.66c2.17 0 3.94-1.79 3.94-4s-1.77-4-3.94-4M6.94 19.86c-1.56 0-2.81-1.28-2.81-2.86s1.26-2.86 2.81-2.86c1.56 0 2.81 1.28 2.81 2.86s-1.25 2.86-2.81 2.86m10.12 0c-1.56 0-2.81-1.28-2.81-2.86s1.25-2.86 2.81-2.86s2.82 1.28 2.82 2.86s-1.27 2.86-2.82 2.86M22 10.5H2V12h20v-1.5m-6.47-7.87c-.22-.49-.78-.75-1.31-.58L12 2.79l-2.23-.74l-.05-.01c-.53-.15-1.09.13-1.29.64L6 9h12l-2.44-6.32l-.03-.05Z"/>' }, AD = { width: 24, height: 24, body: '<path fill="currentColor" d="M8 3a2 2 0 0 0-2 2v4a2 2 0 0 1-2 2H3v2h1a2 2 0 0 1 2 2v4a2 2 0 0 0 2 2h2v-2H8v-5a2 2 0 0 0-2-2a2 2 0 0 0 2-2V5h2V3m6 0a2 2 0 0 1 2 2v4a2 2 0 0 0 2 2h1v2h-1a2 2 0 0 0-2 2v4a2 2 0 0 1-2 2h-2v-2h2v-5a2 2 0 0 1 2-2a2 2 0 0 1-2-2V5h-2V3h2Z"/>' }, w1 = { width: 24, height: 24, body: '<path fill="currentColor" d="M9 22a1 1 0 0 1-1-1v-3H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-6.1l-3.7 3.71c-.2.19-.45.29-.7.29H9Z"/>' }, ED = { width: 24, height: 24, body: '<path fill="currentColor" d="M19 17v2H7v-2s0-4 6-4s6 4 6 4m-3-9a3 3 0 1 0-3 3a3 3 0 0 0 3-3m3.2 5.06A5.6 5.6 0 0 1 21 17v2h3v-2s0-3.45-4.8-3.94M18 5a2.91 2.91 0 0 0-.89.14a5 5 0 0 1 0 5.72A2.91 2.91 0 0 0 18 11a3 3 0 0 0 0-6M7.34 8.92l1.16 1.41l-4.75 4.75l-2.75-3l1.16-1.16l1.59 1.58l3.59-3.58"/>' }, M1 = { width: 24, height: 24, body: '<path fill="currentColor" d="m21.1 12.5l1.4 1.41l-6.53 6.59L12.5 17l1.4-1.41l2.07 2.08l5.13-5.17M10 17l3 3H3v-2c0-2.21 3.58-4 8-4l1.89.11L10 17m1-13a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4Z"/>' }, Ho = { width: 24, height: 24, body: '<path fill="currentColor" d="m12 1l9 4v6c0 5.55-3.84 10.74-9 12c-5.16-1.26-9-6.45-9-12V5l9-4m4 13H8v1.5c0 .27.19.46.47.5h6.96c.31 0 .52-.16.57-.41V14m1-6l-2.67 2.67L12 8.34l-2.33 2.33L7 8l1 5h8l1-5Z"/>' }, HD = { width: 24, height: 24, body: '<path fill="currentColor" d="M7 14c-1.1 0-2-.9-2-2s.9-2 2-2s2 .9 2 2s-.9 2-2 2m5.6-4c-.8-2.3-3-4-5.6-4c-3.3 0-6 2.7-6 6s2.7 6 6 6c2.6 0 4.8-1.7 5.6-4H16v4h4v-4h3v-4H12.6Z"/>' }, L1 = { width: 24, height: 24, body: '<path fill="currentColor" d="M17.9 17.39c-.26-.8-1.01-1.39-1.9-1.39h-1v-3a1 1 0 0 0-1-1H8v-2h2a1 1 0 0 0 1-1V7h2a2 2 0 0 0 2-2v-.41a7.984 7.984 0 0 1 2.9 12.8M11 19.93c-3.95-.49-7-3.85-7-7.93c0-.62.08-1.22.21-1.79L9 15v1a2 2 0 0 0 2 2m1-16A10 10 0 0 0 2 12a10 10 0 0 0 10 10a10 10 0 0 0 10-10A10 10 0 0 0 12 2Z"/>' }, PD = { width: 24, height: 24, body: '<path fill="currentColor" d="M10 20v-6h4v6h5v-8h3L12 3L2 12h3v8h5Z"/>' }, k1 = { width: 24, height: 24, body: '<path fill="currentColor" d="M12 15.5A3.5 3.5 0 0 1 8.5 12A3.5 3.5 0 0 1 12 8.5a3.5 3.5 0 0 1 3.5 3.5a3.5 3.5 0 0 1-3.5 3.5m7.43-2.53c.04-.32.07-.64.07-.97c0-.33-.03-.66-.07-1l2.11-1.63c.19-.15.24-.42.12-.64l-2-3.46c-.12-.22-.39-.31-.61-.22l-2.49 1c-.52-.39-1.06-.73-1.69-.98l-.37-2.65A.506.506 0 0 0 14 2h-4c-.25 0-.46.18-.5.42l-.37 2.65c-.63.25-1.17.59-1.69.98l-2.49-1c-.22-.09-.49 0-.61.22l-2 3.46c-.13.22-.07.49.12.64L4.57 11c-.04.34-.07.67-.07 1c0 .33.03.65.07.97l-2.11 1.66c-.19.15-.25.42-.12.64l2 3.46c.12.22.39.3.61.22l2.49-1.01c.52.4 1.06.74 1.69.99l.37 2.65c.04.24.25.42.5.42h4c.25 0 .46-.18.5-.42l.37-2.65c.63-.26 1.17-.59 1.69-.99l2.49 1.01c.22.08.49 0 .61-.22l2-3.46c.12-.22.07-.49-.12-.64l-2.11-1.66Z"/>' }, jD = { width: 24, height: 24, body: '<path fill="currentColor" d="M15 14c-2.67 0-8 1.33-8 4v2h16v-2c0-2.67-5.33-4-8-4m0-2a4 4 0 0 0 4-4a4 4 0 0 0-4-4a4 4 0 0 0-4 4a4 4 0 0 0 4 4M5 13.28l2.45 1.49l-.65-2.81L9 10.08l-2.89-.25L5 7.19L3.87 9.83L1 10.08l2.18 1.88l-.68 2.81L5 13.28Z"/>' }, qD = { width: 24, height: 24, body: '<path fill="currentColor" d="M7 5h14v2H7V5m0 8v-2h14v2H7M4 4.5A1.5 1.5 0 0 1 5.5 6A1.5 1.5 0 0 1 4 7.5A1.5 1.5 0 0 1 2.5 6A1.5 1.5 0 0 1 4 4.5m0 6A1.5 1.5 0 0 1 5.5 12A1.5 1.5 0 0 1 4 13.5A1.5 1.5 0 0 1 2.5 12A1.5 1.5 0 0 1 4 10.5M7 19v-2h14v2H7m-3-2.5A1.5 1.5 0 0 1 5.5 18A1.5 1.5 0 0 1 4 19.5A1.5 1.5 0 0 1 2.5 18A1.5 1.5 0 0 1 4 16.5Z"/>' }, OD = { width: 24, height: 24, body: '<path fill="currentColor" d="M19 13c.34 0 .67.04 1 .09V10a2 2 0 0 0-2-2h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6a2 2 0 0 0-2 2v10c0 1.11.89 2 2 2h7.81c-.51-.88-.81-1.9-.81-3c0-3.31 2.69-6 6-6M9 6c0-1.66 1.34-3 3-3s3 1.34 3 3v2H9V6m3 11a2 2 0 1 1 2-2c0 1.11-.89 2-2 2m10.5.25L17.75 22L15 19l1.16-1.16l1.59 1.59l3.59-3.59l1.16 1.41Z"/>' }, RD = { width: 24, height: 24, body: '<path fill="currentColor" d="M4 11v2h12l-5.5 5.5l1.42 1.42L19.84 12l-7.92-7.92L10.5 5.5L16 11H4Z"/>' }, T1 = { width: 24, height: 24, body: '<path fill="currentColor" d="M12 5.5A3.5 3.5 0 0 1 15.5 9a3.5 3.5 0 0 1-3.5 3.5A3.5 3.5 0 0 1 8.5 9A3.5 3.5 0 0 1 12 5.5M5 8c.56 0 1.08.15 1.53.42c-.15 1.43.27 2.85 1.13 3.96C7.16 13.34 6.16 14 5 14a3 3 0 0 1-3-3a3 3 0 0 1 3-3m14 0a3 3 0 0 1 3 3a3 3 0 0 1-3 3c-1.16 0-2.16-.66-2.66-1.62a5.536 5.536 0 0 0 1.13-3.96c.45-.27.97-.42 1.53-.42M5.5 18.25c0-2.07 2.91-3.75 6.5-3.75s6.5 1.68 6.5 3.75V20h-13v-1.75M0 20v-1.5c0-1.39 1.89-2.56 4.45-2.9c-.59.68-.95 1.62-.95 2.65V20H0m24 0h-3.5v-1.75c0-1.03-.36-1.97-.95-2.65c2.56.34 4.45 1.51 4.45 2.9V20Z"/>' }, ID = { width: 24, height: 24, body: '<path fill="currentColor" d="M20 2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h4v3c0 .6.4 1 1 1h.5c.2 0 .5-.1.7-.3l3.7-3.7H20c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2m-9 11H7V8.8L8.3 6h2L8.9 9H11v4m6 0h-4V8.8L14.3 6h2l-1.4 3H17v4Z"/>' }, Vf = { width: 24, height: 24, body: '<path fill="currentColor" d="M19 4h-3.5l-1-1h-5l-1 1H5v2h14M6 19a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7H6v12Z"/>' }, UD = { width: 24, height: 24, body: '<path fill="currentColor" d="M20 11v2H8l5.5 5.5l-1.42 1.42L4.16 12l7.92-7.92L13.5 5.5L8 11h12Z"/>' }, zD = { width: 24, height: 24, body: '<path fill="currentColor" d="M19 13H5v-2h14v2Z"/>' }, BD = { width: 24, height: 24, body: '<path fill="currentColor" d="M16 9c6 0 6 4 6 4v2h-6v-2s0-1.69-1.15-3.2c-.17-.23-.38-.45-.6-.66C14.77 9.06 15.34 9 16 9m-8 2c3.5 0 3.94 1.56 4 2H4c.06-.44.5-2 4-2m0-2c-6 0-6 4-6 4v2h12v-2s0-4-6-4m1 8v2h6v-2l3 3l-3 3v-2H9v2l-3-3l3-3M8 3c.55 0 1 .45 1 1s-.45 1-1 1s-1-.45-1-1s.45-1 1-1m0-2C6.34 1 5 2.34 5 4s1.34 3 3 3s3-1.34 3-3s-1.34-3-3-3m8 0c-1.66 0-3 1.34-3 3s1.34 3 3 3s3-1.34 3-3s-1.34-3-3-3Z"/>' }, D1 = { width: 24, height: 24, body: '<path fill="currentColor" d="M6 2c-1.11 0-2 .89-2 2v16a2 2 0 0 0 2 2h4v-1.91L12.09 18H6v-2h8.09l2-2H6v-2h12.09L20 10.09V8l-6-6H6m7 1.5L18.5 9H13V3.5m7.15 9.5a.55.55 0 0 0-.4.16l-1.02 1.02l2.09 2.08l1.02-1.01c.21-.22.21-.58 0-.79l-1.3-1.3a.544.544 0 0 0-.39-.16m-2.01 1.77L12 20.92V23h2.08l6.15-6.15l-2.09-2.08Z"/>' }, Jf = { width: 24, height: 24, body: '<path fill="currentColor" d="m21.82 15.42l-2.5 4.33c-.49.86-1.4 1.31-2.32 1.25h-2v2l-2.5-4.5L15 14v2h2.82l-2.22-3.85l4.33-2.5l1.8 3.12c.52.77.59 1.8.09 2.65M9.21 3.06h5c.98 0 1.83.57 2.24 1.39l1 1.74l1.73-1l-2.64 4.41l-5.15.09l1.73-1l-1.41-2.45l-2.21 3.85l-4.34-2.5l1.8-3.12c.41-.83 1.26-1.41 2.25-1.41m-4.16 16.7l-2.5-4.33c-.49-.85-.42-1.87.09-2.64l1-1.73l-1.73-1l5.14.08l2.65 4.42l-1.73-1L6.56 16H11v5H7.4a2.51 2.51 0 0 1-2.35-1.24Z"/>' }, WD = { width: 24, height: 24, body: '<path fill="currentColor" d="M19 3H5c-1.11 0-2 .89-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2m0 2v14H5V5h14Z"/>' }, $D = { width: 24, height: 24, body: '<path fill="currentColor" d="M19 19H5V5h10V3H5c-1.11 0-2 .89-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-8h-2m-11.09-.92L6.5 11.5L11 16L21 6l-1.41-1.42L11 13.17l-3.09-3.09Z"/>' }, GD = { width: 24, height: 24, body: '<path fill="currentColor" d="M12 16a2 2 0 0 1 2 2a2 2 0 0 1-2 2a2 2 0 0 1-2-2a2 2 0 0 1 2-2m0-6a2 2 0 0 1 2 2a2 2 0 0 1-2 2a2 2 0 0 1-2-2a2 2 0 0 1 2-2m0-6a2 2 0 0 1 2 2a2 2 0 0 1-2 2a2 2 0 0 1-2-2a2 2 0 0 1 2-2Z"/>' }, VD = { width: 24, height: 24, body: '<path fill="currentColor" d="m21.7 13.35l-1 1l-2.05-2.05l1-1a.55.55 0 0 1 .77 0l1.28 1.28c.21.21.21.56 0 .77M12 18.94l6.06-6.06l2.05 2.05L14.06 21H12v-2.06M12 14c-4.42 0-8 1.79-8 4v2h6v-1.89l4-4c-.66-.08-1.33-.11-2-.11m0-10a4 4 0 0 0-4 4a4 4 0 0 0 4 4a4 4 0 0 0 4-4a4 4 0 0 0-4-4Z"/>' }, JD = { width: 24, height: 24, body: '<path fill="currentColor" d="m17 7l-1.41 1.41L18.17 11H8v2h10.17l-2.58 2.58L17 17l5-5M4 5h8V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2H4V5Z"/>' }, KD = { width: 24, height: 24, body: '<path fill="currentColor" d="M12.5 8c-2.65 0-5.05 1-6.9 2.6L2 7v9h9l-3.62-3.62c1.39-1.16 3.16-1.88 5.12-1.88c3.54 0 6.55 2.31 7.6 5.5l2.37-.78C21.08 11.03 17.15 8 12.5 8Z"/>' }, ZD = { width: 24, height: 24, body: '<path fill="currentColor" d="M19.07 13.88L13 19.94V22h2.06l6.06-6.07m1.58-2.35l-1.28-1.28a.517.517 0 0 0-.38-.17c-.15.01-.29.06-.39.17l-1 1l2.05 2l1-1c.19-.2.19-.52 0-.72M11 18H4V8l8 5l8-5v2h2V6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7v-2m9-12l-8 5l-8-5h16Z"/>' }, QD = { width: 24, height: 24, body: '<path fill="currentColor" d="M3 5v14h17V5H3m4 2v2H5V7h2m-2 6v-2h2v2H5m0 2h2v2H5v-2m13 2H9v-2h9v2m0-4H9v-2h9v2m0-4H9V7h9v2Z"/>' }, XD = { width: 24, height: 24, body: '<path fill="currentColor" d="M5 4h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2m0 4v4h6V8H5m8 0v4h6V8h-6m-8 6v4h6v-4H5m8 0v4h6v-4h-6Z"/>' }, eY = { width: 24, height: 24, body: '<path fill="currentColor" d="M3 4h4v4H3V4m6 1v2h12V5H9m-6 5h4v4H3v-4m6 1v2h12v-2H9m-6 5h4v4H3v-4m6 1v2h12v-2H9"/>' }, tY = { width: 24, height: 24, body: '<path fill="currentColor" d="M7 13v-2h14v2H7m0 6v-2h14v2H7M7 7V5h14v2H7M3 8V5H2V4h2v4H3m-1 9v-1h3v4H2v-1h2v-.5H3v-1h1V17H2m2.25-7a.75.75 0 0 1 .75.75c0 .2-.08.39-.21.52L3.12 13H5v1H2v-.92L4 11H2v-1h2.25Z"/>' }, sY = { width: 24, height: 24, body: '<path fill="currentColor" d="M20 17h3l-4 4l-4-4h3V3h2v14M8 5c-3.86 0-7 3.13-7 7s3.13 7 7 7c3.86 0 7-3.13 7-7s-3.13-7-7-7m0 2.15c2.67 0 4.85 2.17 4.85 4.85c0 2.68-2.17 4.85-4.85 4.85c-2.68 0-4.85-2.17-4.85-4.85c0-2.68 2.17-4.85 4.85-4.85M7 9v3.69l3.19 1.84l.75-1.3l-2.44-1.41V9"/>' }, nY = { width: 24, height: 24, body: '<path fill="currentColor" d="M13.5 4A1.5 1.5 0 0 0 12 5.5A1.5 1.5 0 0 0 13.5 7A1.5 1.5 0 0 0 15 5.5A1.5 1.5 0 0 0 13.5 4m-.36 4.77c-1.19.1-4.44 2.69-4.44 2.69c-.2.15-.14.14.02.42c.16.27.14.29.33.16c.2-.13.53-.34 1.08-.68c2.12-1.36.34 1.78-.57 7.07c-.36 2.62 2 1.27 2.61.87c.6-.39 2.21-1.5 2.37-1.61c.22-.15.06-.27-.11-.52c-.12-.17-.24-.05-.24-.05c-.65.43-1.84 1.33-2 .76c-.19-.57 1.03-4.48 1.7-7.17c.11-.64.41-2.04-.75-1.94Z"/>' }, aY = { width: 24, height: 24, body: '<path fill="currentColor" d="M11 15H6l7-14v8h5l-7 14v-8Z"/>' }, rY = { width: 24, height: 24, body: '<path fill="currentColor" d="M13 9h5.5L13 3.5V9M6 2h8l6 6v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4c0-1.11.89-2 2-2m9 16v-2H6v2h9m3-4v-2H6v2h12Z"/>' }, iY = { width: 24, height: 24, body: '<path fill="currentColor" d="M20 3h-3.2c-.4-1.2-1.5-2-2.8-2c-1.3 0-2.4.8-2.8 2H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2m-6 0c.6 0 1 .5 1 1s-.5 1-1 1s-1-.5-1-1s.4-1 1-1m2 11H9v-2h7m3-2H9V8h10M4 21h14v2H4c-1.1 0-2-.9-2-2V7h2"/>' }, oY = { width: 24, height: 24, body: '<path fill="currentColor" d="M21 17V8H7v9h14m0-14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h1V1h2v2h8V1h2v2h1M3 21h14v2H3a2 2 0 0 1-2-2V9h2v12m16-6h-4v-4h4v4Z"/>' }, lY = { width: 24, height: 24, body: '<path fill="currentColor" d="M19 19H5V8h14m-3-7v2H8V1H6v2H5c-1.11 0-2 .89-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-1V1"/>' }, dY = { width: 24, height: 24, body: '<path fill="currentColor" d="M14.47 15.08L11 13V7h1.5v5.25l3.08 1.83c-.41.28-.79.62-1.11 1m-1.39 4.84c-.36.05-.71.08-1.08.08c-4.42 0-8-3.58-8-8s3.58-8 8-8s8 3.58 8 8c0 .37-.03.72-.08 1.08c.69.1 1.33.32 1.92.64c.1-.56.16-1.13.16-1.72c0-5.5-4.5-10-10-10S2 6.5 2 12s4.47 10 10 10c.59 0 1.16-.06 1.72-.16c-.32-.59-.54-1.23-.64-1.92M18 15v3h-3v2h3v3h2v-3h3v-2h-3v-3h-2Z"/>' }, mY = { width: 24, height: 24, body: '<path fill="currentColor" d="M3 11h2v2H3v-2m8-6h2v4h-2V5m-2 6h4v4h-2v-2H9v-2m6 0h2v2h2v-2h2v2h-2v2h2v4h-2v2h-2v-2h-4v2h-2v-4h4v-2h2v-2h-2v-2m4 8v-4h-2v4h2M15 3h6v6h-6V3m2 2v2h2V5h-2M3 3h6v6H3V3m2 2v2h2V5H5M3 15h6v6H3v-6m2 2v2h2v-2H5Z"/>' }, uY = { width: 24, height: 24, body: '<path fill="currentColor" d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4.18C9.6 1.84 10.7 1 12 1c1.3 0 2.4.84 2.82 2H19m-7 0a1 1 0 0 0-1 1a1 1 0 0 0 1 1a1 1 0 0 0 1-1a1 1 0 0 0-1-1M7 7V5H5v14h14V5h-2v2H7m0 6l5 5v-3h4v-4h-4V8l-5 5Z"/>' }, cY = { width: 24, height: 24, body: '<path fill="currentColor" d="M13 19c0-3.31 2.69-6 6-6c1.1 0 2.12.3 3 .81V6a2 2 0 0 0-2-2H4c-1.11 0-2 .89-2 2v12a2 2 0 0 0 2 2h9.09c-.05-.33-.09-.66-.09-1M4 8V6l8 5l8-5v2l-8 5l-8-5m16 14v-2h-4v-2h4v-2l3 3l-3 3Z"/>' }, gY = { width: 24, height: 24, body: '<path fill="currentColor" d="m18 8l-8 5l-8-5V6l8 5l8-5m0-2H2C.9 4 0 4.9 0 6v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2m6 3h-2v6h2V7m0 8h-2v2h2v-2Z"/>' }, hY = { width: 24, height: 24, body: '<path fill="currentColor" d="M2 6v14h18v2H2c-1.105 0-2-.89-2-2V6h2m22-2c0-1.1-.9-2-2-2H6c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4m-2 0l-8 5l-8-5h16m0 12H6V6l8 5l8-5v10Z"/>' }, fY = { width: 24, height: 24, body: '<path fill="currentColor" d="M12 3C6.5 3 2 6.58 2 11a7.218 7.218 0 0 0 2.75 5.5c0 .6-.42 2.17-2.75 4.5c2.37-.11 4.64-1 6.47-2.5c1.14.33 2.34.5 3.53.5c5.5 0 10-3.58 10-8s-4.5-8-10-8m0 14c-4.42 0-8-2.69-8-6s3.58-6 8-6s8 2.69 8 6s-3.58 6-8 6Z"/>' }, _Y = { width: 24, height: 24, body: '<path fill="currentColor" d="M17 7h5v10h-5v2a1 1 0 0 0 1 1h2v2h-2.5c-.55 0-1.5-.45-1.5-1c0 .55-.95 1-1.5 1H12v-2h2a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1h-2V2h2.5c.55 0 1.5.45 1.5 1c0-.55.95-1 1.5-1H20v2h-2a1 1 0 0 0-1 1v2M2 7h11v2H4v6h9v2H2V7m18 8V9h-3v6h3Z"/>' }, pY = { width: 24, height: 24, body: '<path fill="currentColor" d="M3 6h18v2H3V6m0 5h18v2H3v-2m0 5h18v2H3v-2Z"/>' }, E = (a, i = "#000", r = 24) => ({ name: `Icon-${a.name || "custom"}`, render() {
  return tg(iD, { icon: a, color: i, width: r, height: r });
} }), yY = { archive: E(Eo, "#607D8B"), delete: E(Vf, "#F44336"), back: E(UD, "#2196F3"), minus: E(zD, "#9E9E9E"), plus: E(Gf, "#4CAF50"), restore: E(Jf, "#009688"), transfer: E(BD, "#3F51B5"), home: E(PD, "#3F51B5"), comment: E(w1, "#2196F3"), talk: E(fY, "#00BCD4"), collectives: E(T1, "#795548"), form: E(_Y, "#9C27B0"), menu: E(pY, "#607D8B"), unpublished: E(h1, "#9E9E9E"), archived: E(Eo, "#9E9E9E"), closed: E(di, "#F44336"), creation: E($f, "#FFC107"), suggestions: E(f1, "#4CAF50"), expiration: E(ym, "#E91E63") }, vY = { share: E(v1, "#03A9F4"), qrCode: E(mY, "#673AB7"), copyLink: E(uY, "#607D8B"), sendByEmail: E(cY, "#2196F3"), emailAlert: E(gY, "#F44336"), bulkMail: E(hY, "#FF9800"), lock: E(di, "#795548"), unlock: E(p1, "#4CAF50"), delete: E(Vf, "#F44336"), restore: E(Jf, "#009688"), adminGrant: E(Ho, "#FF9800"), adminRevoke: E(Ho, "#9E9E9E") };
E(nY, "#2196F3"), E(aY, "#FF9800"), E(rY, "#607D8B"), E(iY, "#795548"), E(g1, "#3F51B5"), E(oY, "#4CAF50"), E(lY, "#2196F3"), E(dY, "#FFC107"), E(ym, "#E91E63"), E(k1, "#607D8B"), E(VD, "#2196F3"), E(ZD, "#3F51B5"), E(JD, "#F44336"), E(KD, "#FFC107"), E(QD, "#2196F3"), E(XD, "#795548"), E(eY, "#009688"), E(tY, "#4CAF50"), E(sY, "#673AB7"), E(Vf, "#F44336"), E(Jf, "#009688"), E(WD, "#2196F3"), E($D, "#4CAF50"), E(GD, "#9E9E9E");
const wY = { administration: E(Ho, "#FF9800"), settings: E(k1, "#607D8B"), relevant: E(_1, "#FFC107"), myInquiries: E(jD, "#3F51B5"), private: E(di, "#F44336"), participated: E(M1, "#009688"), open: E(L1, "#4CAF50"), all: E(qD, "#2196F3"), closed: E(OD, "#795548"), archived: E(Eo, "#9E9E9E"), goTo: E(RD, "#673AB7"), group: E(T1, "#00BCD4"), add: E(Gf, "#4CAF50") }, MY = { comments: E(w1, "#2196F3"), supports: E(y1, "#4CAF50"), participants: E(ED, "#673AB7"), participated: E(M1, "#009688"), admin: E(Ho, "#FF9800"), private: E(HD, "#F44336"), open: E(L1, "#4CAF50"), archived: E(Eo, "#607D8B"), expiration: E(ym, "#F44336"), closed: E(di, "#795548") }, Xt = { proposal: E(oD, "#FFC107"), debate: E(lD, "#2196F3"), petition: E(dD, "#E91E63"), project: E(mD, "#4CAF50"), grievance: E(uD, "#F44336"), suggestion: E(ID, "#9C27B0"), official: E(cD, "#3F51B5") }, LY = { proposal: { label: "Proposal", icon: Xt.proposal }, debate: { label: "Debate", icon: Xt.debate }, petition: { label: "Petition", icon: Xt.petition }, project: { label: "Project", icon: Xt.project }, grievance: { label: "Grievance", icon: Xt.grievance }, suggestion: { label: "Suggestion", icon: Xt.suggestion }, official: { label: "Official", icon: Xt.official } };
E(h1, "#9E9E9E"), E(Eo, "#607D8B"), E(di, "#795548"), E($f, "#FF9800"), E(ym, "#F44336");
const kY = { Updated: E(gD, "#FF9800"), Calendar: E(g1, "#3F51B5"), ClockOutline: E($f, "#2196F3"), Cancel: E(hD, "#F44336"), Offer: E(f1, "#009688"), Check: E(fD, "#4CAF50"), EyeOutline: E(_D, "#9C27B0"), Magnify: E(pD, "#3F51B5"), AlertCircleOutline: E(yD, "#FF5722"), ForumOutline: E(vD, "#673AB7"), CogOutline: E(wD, "#607D8B"), PlayOutline: E(MD, "#8BC34A"), Plus: E(Gf, "#00BCD4"), Star: E(_1, "#FFD700"), Lock: E(di, "#795548"), LockOpen: E(p1, "#4CAF50"), Pencil: E(LD, "#FF9800"), Heart: E(kD, "#E91E63"), ThumbUp: E(y1, "#4CAF50"), ThumbDown: E(TD, "#F44336"), AccountMultiple: E(DD, "#4CAF50"), AdminIcon: E(Ho, "#FBC02D"), LinkIcon: E(YD, "#2196F3"), ContactIcon: E(CD, "#4CAF50"), EmailIcon: E(bD, "#FF9800"), ShareIcon: E(v1, "#03A9F4"), ContactGroupIcon: E(SD, "#9C27B0"), CircleIcon: E(FD, "#00BCD4"), DeletedUserIcon: E(xD, "#F44336"), AnoymousIcon: E(ND, "#9E9E9E"), InquiryGroupIcon: E(AD, "#673AB7"), Draft: E(D1, "#6E3ABE"), default: E(D1, "#9E9E9E") };
async function TY(a) {
  return Promise.resolve(window.confirm(a));
}
const DY = { proposal: { label: re("agora", "Proposal"), icon: Xt.proposal }, debate: { label: "Debate", icon: Xt.debate }, petition: { label: "Petition", icon: Xt.petition }, project: { label: "Project", icon: Xt.project }, grievance: { label: "Grievance", icon: Xt.grievance }, suggestion: { label: "Suggestion", icon: Xt.suggestion }, official: { label: "Official Response", icon: Xt.official } }, YY = { PROPOSAL: "proposal", PROJECT: "project", GRIEVANCE: "grievance", DEBATE: "debate", PETITION: "petition", SUGGESTION: "suggestion", OFFICIAL: "official" }, CY = { class: "empty-content", role: "note" }, bY = { key: 0, class: "empty-content__icon", "aria-hidden": "true" }, SY = { key: 0, class: "empty-content__name" }, FY = { key: 1, class: "empty-content__description" }, xY = { key: 2, class: "empty-content__action" }, NY = Zc({ __name: "NcEmptyContent", props: { description: { default: "" }, name: { default: "" } }, setup(a) {
  return (i, r) => (qe(), dt("div", CY, [i.$slots.icon ? (qe(), dt("div", bY, [Js(i.$slots, "icon", {}, void 0, true)])) : Cs("", true), Js(i.$slots, "name", {}, () => [i.name !== "" ? (qe(), dt("span", SY, Ca(i.name), 1)) : Cs("", true)], true), i.description !== "" || i.$slots.description ? (qe(), dt("p", FY, [Js(i.$slots, "description", {}, () => [Qc(Ca(i.description), 1)], true)])) : Cs("", true), i.$slots.action ? (qe(), dt("div", xY, [Js(i.$slots, "action", {}, void 0, true)])) : Cs("", true)]));
} }), Y1 = Wd(NY, [["__scopeId", "data-v-697cfd8f"]]), AY = { name: "NcDashboardWidgetItem", components: { NcAvatar: x_, NcActions: oM, NcActionButton: iM }, props: { id: { type: [String, Number], default: void 0 }, targetUrl: { type: String, default: void 0 }, avatarUrl: { type: String, default: void 0 }, avatarUsername: { type: String, default: void 0 }, avatarIsNoUser: { type: Boolean, default: false }, overlayIconUrl: { type: String, default: void 0 }, mainText: { type: String, required: true }, subText: { type: String, default: "" }, itemMenu: { type: Object, default: () => ({}) }, forceMenu: { type: Boolean, default: true } }, data() {
...
} }, methods: { onLinkClick(a) {
  a.target.closest(".action-item") && a.preventDefault();
} } }, EY = ["src"], HY = { class: "item__details" }, PY = ["title"], jY = ["title"];
function qY(a, i, r, l, u, g) {
  const f = nr("NcAvatar"), p = nr("NcActionButton"), L = nr("NcActions");
  return qe(), dt("div", { onMouseover: i[0] || (i[0] = (w) => u.hovered = true), onMouseleave: i[1] || (i[1] = (w) => u.hovered = false) }, [(qe(), Ya(mM(r.targetUrl ? "a" : "div"), { href: r.targetUrl || void 0, target: r.targetUrl ? "_blank" : void 0, class: dM({ "item-list__entry": true, "item-list__entry--has-actions-menu": g.gotMenu }), onClick: g.onLinkClick }, { default: sr(() => [Js(a.$slots, "avatar", { avatarUrl: r.avatarUrl, avatarUsername: r.avatarUsername }, () => [$d(f, { class: "item-avatar", size: 44, url: r.avatarUrl, user: r.avatarUsername, "is-no-user": r.avatarIsNoUser, "hide-status": g.gotOverlayIcon }, null, 8, ["url", "user", "is-no-user", "hide-status"])], true), r.overlayIconUrl ? (qe(), dt("img", { key: 0, class: "item-icon", alt: "", src: r.overlayIconUrl }, null, 8, EY)) : Cs("", true), Sa("div", HY, [Sa("h3", { title: r.mainText }, Ca(r.mainText), 9, PY), r.subText !== "" ? (qe(), dt("span", { key: 0, class: "message", title: r.subText }, Ca(r.subText), 9, jY)) : Cs("", true)]), g.gotMenu ? (qe(), Ya(L, { key: 1, "force-menu": r.forceMenu }, { default: sr(() => [Js(a.$slots, "actions", {}, () => [(qe(true), dt(sg, null, ng(r.itemMenu, (w, D) => (qe(), Ya(p, { key: D, icon: w.icon, "close-after-click": true, onClick: lM((b) => a.$emit(D, g.item), ["prevent", "stop"]) }, { default: sr(() => [Qc(Ca(w.text), 1)]), _: 2 }, 1032, ["icon", "onClick"]))), 128))], true)]), _: 3 }, 8, ["force-menu"])) : Cs("", true)]), _: 3 }, 8, ["href", "target", "class", "onClick"]))], 32);
}
const OY = Wd(AY, [["render", qY], ["__scopeId", "data-v-68bcbc90"]]), RY = { name: "CheckIcon", emits: ["click"], props: { title: { type: String }, fillColor: { type: String, default: "currentColor" }, size: { type: Number, default: 24 } } }, IY = ["aria-hidden", "aria-label"], UY = ["fill", "width", "height"], zY = { d: "M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" }, BY = { key: 0 };
function WY(a, i, r, l, u, g) {
  return qe(), dt("span", N_(a.$attrs, { "aria-hidden": r.title ? null : "true", "aria-label": r.title, class: "material-design-icon check-icon", role: "img", onClick: i[0] || (i[0] = (f) => a.$emit("click", f)) }), [(qe(), dt("svg", { fill: r.fillColor, class: "material-design-icon__svg", width: r.size, height: r.size, viewBox: "0 0 24 24" }, [Sa("path", zY, [r.title ? (qe(), dt("title", BY, Ca(r.title), 1)) : Cs("", true)])], 8, UY))], 16, IY);
}
const $Y = Wd(RY, [["render", WY]]);
b_(uM);
const GY = { name: "NcDashboardWidget", components: { NcAvatar: x_, NcDashboardWidgetItem: OY, NcEmptyContent: Y1, Check: $Y }, props: { items: { type: Array, default: () => [] }, showMoreUrl: { type: String, default: "" }, showMoreLabel: { type: String, default: S_("More items …") }, loading: { type: Boolean, default: false }, itemMenu: { type: Object, default: () => ({}) }, showItemsAndEmptyContent: { type: Boolean, default: false }, emptyContentMessage: { type: String, default: "" }, halfEmptyContentMessage: { type: String, default: "" } }, computed: { handlers() {
  const a = {};
  for (const i in this.itemMenu) a[i] = (r) => {
    this.$emit(i, r);
  };
  return a;
}, displayedItems() {
  const a = this.showMoreUrl && this.items.length >= this.maxItemNumber ? this.maxItemNumber - 1 : this.maxItemNumber;
  return this.items.slice(0, a);
...
} } }, VY = { class: "dashboard-widget" }, JY = { key: 1 }, KY = ["href"];
function ZY(a, i, r, l, u, g) {
  const f = nr("Check"), p = nr("NcEmptyContent"), L = nr("NcDashboardWidgetItem"), w = nr("NcAvatar");
  return qe(), dt("div", VY, [g.showHalfEmptyContentArea ? (qe(), Ya(p, { key: 0, description: g.halfEmptyContentString, class: "half-screen" }, { icon: sr(() => [Js(a.$slots, "halfEmptyContentIcon", {}, () => [$d(f)], true)]), _: 3 }, 8, ["description"])) : Cs("", true), Sa("ul", null, [(qe(true), dt(sg, null, ng(g.displayedItems, (D) => (qe(), dt("li", { key: D.id }, [Js(a.$slots, "default", { item: D }, () => [$d(L, N_({ ref_for: true }, D, { "item-menu": r.itemMenu }, cM(g.handlers)), null, 16, ["item-menu"])], true)]))), 128))]), r.loading ? (qe(), dt("div", JY, [(qe(), dt(sg, null, ng(7, (D) => Sa("div", { key: D, class: "item-list__entry" }, [$d(w, { class: "item-avatar", size: 44 }), i[0] || (i[0] = Sa("div", { class: "item__details" }, [Sa("h3", null, " "), Sa("p", { class: "message" }, "   ")], -1))])), 64))])) : r.items.length === 0 ? Js(a.$slots, "empty-content", { key: 2 }, () => [r.emptyContentMessage ? (qe(), Ya(p, { key: 0, description: r.emptyContentMessage }, { icon: sr(() => [Js(a.$slots, "emptyContentIcon", {}, void 0, true)]), _: 3 }, 8, ["description"])) : Cs("", true)], true) : g.showMore ? (qe(), dt("a", { key: 3, href: r.showMoreUrl, target: "_blank", class: "more", tabindex: "0" }, Ca(r.showMoreLabel), 9, KY)) : Cs("", true)]);
}
const QY = Wd(GY, [["render", ZY], ["__scopeId", "data-v-2d259f64"]]);
export {
  Af as A,
  MY as B,
  bs as C,
...
//# sourceMappingURL=NcDashboardWidget-Wkx_9xKh-BuiM1L_L.chunk.mjs.map
