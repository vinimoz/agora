...
const KR = "agora", YR = "1.0.0rc1", po = globalThis || void 0 || self;
function yl(e4) {
...
const Cm = (e4) => e4 != null, e1 = Object.prototype.toString, _m = (e4) => e1.call(e4) === "[object Object]", bn = () => {
}, ku = t1();
function t1() {
  var e4, t;
...
var Dm = ["input:not([inert])", "select:not([inert])", "textarea:not([inert])", "a[href]:not([inert])", "button:not([inert])", "[tabindex]:not(slot):not([inert])", "audio[controls]:not([inert])", "video[controls]:not([inert])", '[contenteditable]:not([contenteditable="false"]):not([inert])', "details>summary:first-of-type:not([inert])", "details:not([inert])"], ga = Dm.join(","), Bm = typeof Element > "u", Hr = Bm ? function() {
  ...
  return t.tabIndex < 0 && (/^(AUDIO|VIDEO|DETAILS)$/.test(t.tagName) || I1(t)) && !Um(t) ? 0 : t.tabIndex;
}, L1 = function(t, n) {
  var r = qr(t);
  ...
  return t.forEach(function(i, s) {
    var o = !!i.scopeParent, a = o ? i.scopeParent : i, l = L1(a, o), u = o ? e3(i.candidates) : a;
    l === 0 ? o ? n.push.apply(n, u) : n.push(a) : r.push({ documentOrder: s, tabIndex: l, item: i, isScope: o, content: u });
  }), r.sort(F1).reduce(function(i, s) {
    return s.isScope ? i.push.apply(i, s.content) : i.push(s.content), i;
  }, []).concat(n);
}, K1 = function(t, n) {
  n = n || {};
  var r;
  return n.getShadowRoot ? r = $m([t], n.includeContainer, { filter: Au.bind(null, n), flatten: false, getShadowRoot: n.getShadowRoot, shadowRootFilter: G1 }) : r = zm(t, n.includeContainer, Au.bind(null, n)), Z1(r);
}, Y1 = function(t, n) {
  n = n || {};
  var r;
...
}, X1 = Dm.concat("iframe").join(","), Tu = function(t, n) {
  if (n = n || {}, !t) throw new Error("No node provided");
...
var Gm = { activateTrap: function(t, n) {
  ...
  var r = n?.document || document, i = n?.trapStack || uT, s = Wm({ returnFocusOnDeactivate: true, escapeDeactivates: true, delayInitialFocus: true, isKeyForward: lT, isKeyBackward: cT }, n), o = { containers: [], containerGroups: [], tabbableGroups: [], nodeFocusedBeforeActivation: null, mostRecentlyFocusedNode: null, active: false, paused: false, manuallyPaused: false, delayInitialFocusTimer: void 0, recentNavEvent: void 0 }, a, l = function(O, j, X) {
    ...
    if (typeof fe == "function" && (fe = fe.apply(void 0, nT(se))), fe === true && (fe = void 0), !fe) {
    ...
    if (o.containerGroups = o.containers.map(function(O) {
      var j = K1(O, s.tabbableOptions), X = Y1(O, s.tabbableOptions), re = j.length > 0 ? j[0] : void 0, G = j.length > 0 ? j[j.length - 1] : void 0, se = X.find(function(me) {
        return Ci(me);
    ...
    if (O !== false && O !== v(document)) {
      ...
      O.focus({ preventScroll: !!s.preventScroll }), o.mostRecentlyFocusedNode = O, oT(O) && O.select();
    }
  }, y = function(O) {
    ...
    aT(O) && Vs(s.escapeDeactivates, O) !== false && (O.preventDefault(), a.deactivate());
  }, Y = function(O) {
    var j = wa(O);
...
const Ou = Nm().detectLanguage().build(), fT = (...e4) => Ou.ngettext(...e4), Re = (...e4) => Ou.gettext(...e4);
function Sr(...e4) {
...
const Nt = (e4, t) => {
  ...
  return (y, k) => (oe(), at(Zl(s.value), mn({ class: ["button-vue", [`button-vue--size-${y.size}`, { [`button-vue--${a.value}`]: a.value, "button-vue--tertiary": l.value, "button-vue--wide": y.wide, [`button-vue--${u.value}`]: u.value !== "center", "button-vue--reverse": c.value }]], "aria-label": y.ariaLabel }, v.value, { onClick: m }), { default: et(() => [Ae("span", ZT, [Ae("span", KT, [Mt(y.$slots, "icon", {}, void 0, true)]), Ae("span", YT, [Mt(y.$slots, "default", {}, () => [Ko(qe(y.text), 1)], true)])])]), _: 3 }, 16, ["class", "aria-label"]));
} }), Oi = Nt(XT, [["__scopeId", "data-v-e2fd60a6"]]), JT = ["top", "right", "bottom", "left"], Ym = ["start", "end"], Xm = JT.reduce((e4, t) => e4.concat(t, t + "-" + Ym[0], t + "-" + Ym[1]), []), Pi = Math.min, Er = Math.max, QT = Math.round, eN = Math.floor, tN = (e4) => ({ x: e4, y: e4 }), nN = { left: "right", right: "left", bottom: "top", top: "bottom" }, rN = { start: "end", end: "start" };
function Pu(e4, t, n) {
  return Er(e4, Pi(t, n));
}
function sr(e4, t) {
...
const QN = ".focusable", eC = { name: "NcActions", components: { NcButton: Oi, NcPopover: qu }, provide() {
  ...
  const t = _u(), n = `trigger-${t}`, r = Gt(), { top: i, bottom: s } = jm(r), { top: o, bottom: a } = jm(Fl(() => e4.boundariesElement)), { height: l } = m1(), u = ke(() => Math.max(Math.min(i.value - 84, i.value - o.value), Math.min(l.value - s.value - 34, a.value - s.value)));
...
Sr(vT), Re("a few seconds ago"), Re("seconds ago"), Re("sec. ago"), window.OCP?.Accessibility?.disableKeyboardShortcuts?.();
...
function CR(e4) {
  const t = ke(() => ot(e4) ?? document.body), n = Gt(dl(t.value)), r = c1();
  function i() {
    n.value = dl(t.value);
  }
...
//# sourceMappingURL=NcEmptyContent-q-geAf0w-C5KNLRzH.chunk.mjs.map
