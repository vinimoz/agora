...
const uo = "agora", co = "1.0.0rc2";
import { M as ge, c as y, o as c, h as s, w as p, B as v, e as n, u as e, t as o, g as P, b as A, _ as F, a as r, y as me, O as x, q as T, P as ye, Q as ne, S as re, T as ve, U as C, I as J, d as z, V as fe, z as he, J as W, f as X, G as ie, v as de, x as be, n as O, i as M, j as _e, p as Se } from "./NcEmptyContent-q-geAf0w-DExP7TOI.chunk.mjs";
import { I as Y, N as L } from "./index-ByO90ZZ0.chunk.mjs";
import { b as E, L as k, m as ue, g as we, c as le, I as B, d as ee, S as se } from "./NcDashboardWidget-Wkx_9xKh-CDYPbWzH.chunk.mjs";
import { F as Ve } from "./FlexSettings-DYwTvHIv.chunk.mjs";
import { N as $, a as U, b as D } from "./NcRichText-G8kzsdwx-D7Euftyg.chunk.mjs";
import { _ as $e, a as Ie } from "./markdown-2oeXocZy.chunk.mjs";
const q = ge("appSettings", { state: () => ({ allAccessGroups: [], allowCombo: true, allowPublicShares: true, allowAllAccess: true, allowInquiryCreation: true, allowInquiryDownload: true, autoArchive: false, autoDelete: false, autoArchiveOffset: 30, autoDeleteOffset: 30, defaultPrivacyUrl: "", defaultImprintUrl: "", disclaimer: "", imprintUrl: "", legalTermsInEmail: false, privacyUrl: "", showMailAddresses: false, showLogin: true, unrestrictedOwner: false, updateType: "noInquirying", useActivity: false, useCollaboration: true, useSiteLegalTerms: true, navigationInquiriesInList: true, finalPrivacyUrl: "", finalImprintUrl: "", comboGroups: [], publicSharesGroups: [], inquiryCreationGroups: [], inquiryDownloadGroups: [], showMailAddressesGroups: [], unrestrictedOwnerGroups: [], categoryTab: [], locationTab: [], moderationStatusTab: [], groups: [], inquiryTypeRights: {}, moderatorRights: { modifyInquiry: true, deleteInquiry: true, archiveInquiry: true }, officialRights: { modifyInquiry: false, deleteInquiry: false, archiveInquiry: true, approveInquiries: false, changeInquiryStatus: false }, status: { loadingGroups: false } }), actions: { async load() {
  try {
    ...
    const t = (await E.getAppSettings()).data.appSettings;
  ...
  try {
    const d = await E.writeAppSettings(this.$state);
  ...
  try {
    const m = await E.addModerationStatus(i);
  ...
  try {
    await E.updateModerationStatus(t, { ...i, ...l });
  } catch (m) {
  ...
  try {
    await E.deleteModerationStatus(t);
  } catch (l) {
  ...
  try {
    await E.addCategory({ name: d, parentId: t }), this.categoryTab.push({ id: a, name: d, parentId: t });
  } catch (i) {
  ...
  try {
    await E.updateCategory(d, t, l), a && (a.name = t, a.parentId = l);
  } catch (i) {
    k.error("Error getting appSettings", { error: i });
  }
  ...
  try {
    await E.addLocation({ name: d, parentId: t }), this.locationTab.push({ id: a, name: d, parentId: t });
  } catch (i) {
    k.error("Error getting appSettings", { error: i });
  }
  ...
  try {
    await E.updateLocation(d, t, l), a && (a.name = t, a.parentId = l);
  } catch (i) {
    k.error("Error getting appSettings", { error: i });
  }
...
const Fe = F(Ne, [["render", Ge]]), Pe = { class: "user_settings" }, je = { class: "disclaimer_group" }, Ke = { class: "grow_title" }, He = ["innerHTML"], Je = { __name: "AdminEmail", setup(d) {
  ...
  return (S, b) => (c(), y("div", rt, [N.value ? (c(), y("div", ut, [r("div", ct, [r("button", { class: ie({ active: _.value === "categories" }), onClick: b[0] || (b[0] = (I) => _.value = "categories") }, n(e(o)("agora", "Categories")), 3), r("button", { class: ie({ active: _.value === "locations" }), onClick: b[1] || (b[1] = (I) => _.value = "locations") }, n(e(o)("agora", "Locations")), 3)]), _.value === "categories" ? (c(), y("div", pt, [r("div", gt, [r("h3", null, n(e(o)("agora", "Add New Category")), 1), r("div", mt, [s(e(D), { modelValue: f.value.name, "onUpdate:modelValue": b[2] || (b[2] = (I) => f.value.name = I), label: e(o)("agora", "Category Name"), placeholder: e(o)("agora", "Enter category name") }, null, 8, ["modelValue", "label", "placeholder"]), s(e(U), { modelValue: l.value, "onUpdate:modelValue": b[3] || (b[3] = (I) => l.value = I), options: R.value, clearable: false, placeholder: e(o)("agora", "Select parent category") }, null, 8, ["modelValue", "options", "placeholder"]), s(e(C), { type: "primary", disabled: !f.value.name.trim(), onClick: ae }, { default: p(() => [v(n(e(o)("agora", "Add Category")), 1)]), _: 1 }, 8, ["disabled"])])]), r("div", yt, [r("h3", null, n(e(o)("agora", "Categories Tree")), 1), r("div", vt, [(c(true), y(J, null, W(Q.value, (I) => (c(), P(ce, { key: "cat-" + I.id, item: I, items: i.value, level: 0, type: "category", onEdit: w, onDelete: h }, null, 8, ["item", "items"]))), 128))])])])) : A("", true), _.value === "locations" ? (c(), y("div", ft, [r("div", ht, [r("h3", null, n(e(o)("agora", "Add New Location")), 1), r("div", bt, [s(e(D), { modelValue: g.value.name, "onUpdate:modelValue": b[4] || (b[4] = (I) => g.value.name = I), label: e(o)("agora", "Location Name"), placeholder: e(o)("agora", "Enter location name") }, null, 8, ["modelValue", "label", "placeholder"]), s(e(U), { modelValue: a.value, "onUpdate:modelValue": b[5] || (b[5] = (I) => a.value = I), options: j.value, clearable: false, placeholder: e(o)("agora", "Select parent location") }, null, 8, ["modelValue", "options", "placeholder"]), s(e(C), { type: "primary", disabled: !g.value.name.trim(), onClick: oe }, { default: p(() => [v(n(e(o)("agora", "Add Location")), 1)]), _: 1 }, 8, ["disabled"])])]), r("div", _t, [r("h3", null, n(e(o)("agora", "Locations Tree")), 1), r("div", St, [(c(true), y(J, null, W(H.value, (I) => (c(), P(ce, { key: "loc-" + I.id, item: I, items: m.value, level: 0, type: "location", onEdit: w, onDelete: h }, null, 8, ["item", "items"]))), 128))])])])) : A("", true), u.value ? (c(), y("div", wt, [r("div", Vt, [r("h3", null, n(e(o)("agora", "Edit")) + " " + n(u.value.type === "category" ? e(o)("agora", "Category") : e(o)("agora", "Location")), 1), s(e(D), { modelValue: u.value.name, "onUpdate:modelValue": b[6] || (b[6] = (I) => u.value.name = I), label: u.value.type === "category" ? e(o)("agora", "Category Name") : e(o)("agora", "Location Name") }, null, 8, ["modelValue", "label"]), s(e(U), { modelValue: Z.value, "onUpdate:modelValue": b[7] || (b[7] = (I) => Z.value = I), options: te.value, clearable: false, placeholder: e(o)("agora", "Select parent") }, null, 8, ["modelValue", "options", "placeholder"]), r("div", $t, [s(e(C), { onClick: b[8] || (b[8] = (I) => u.value = null) }, { default: p(() => [v(n(e(o)("agora", "Cancel")), 1)]), _: 1 }), s(e(C), { type: "primary", onClick: V }, { default: p(() => [v(n(e(o)("agora", "Save")), 1)]), _: 1 })])])])) : A("", true)])) : (c(), y("div", dt, n(e(o)("agora", "Loading categories and locations...")), 1))]));
} }), qt = F(It, [["__scopeId", "data-v-df8a9cce"]]), Tt = { class: "inquiry-rights-management" }, At = { class: "description" }, Ct = { key: 0, class: "loading" }, kt = { key: 1, class: "error" }, xt = { key: 2 }, Ut = { class: "type-selection" }, Lt = { for: "inquiry-type-select" }, Et = { class: "settings-container" }, Nt = { class: "settings-list" }, Rt = { class: "setting-item" }, Ot = { class: "setting-description" }, Mt = { class: "setting-item" }, Dt = { class: "setting-description" }, Gt = { class: "setting-item" }, Ft = { class: "setting-description" }, Pt = { class: "setting-item" }, jt = { for: "editor-type-select" }, Kt = { class: "setting-description" }, Ht = { __name: "AdminInquiryRights", setup(d) {
  ...
  const R = () => {
    ...
    a.value = { id: w.id, statusKey: w.statusKey, label: w.label, description: w.description || "", isFinal: w.isFinal, icon: w.icon || "ClockOutline" };
  }, K = () => {
    a.value && (t.updateStatusForInquiryType(m.value, a.value.id, { ...a.value, icon: a.value.icon?.id || String(a.value.icon) }), a.value = null);
  }, te = (w) => {
  ...
  const t = q();
  return (l, a) => (c(), y("div", Ja, [s(e($), { modelValue: e(t).allowAllAccess, "onUpdate:modelValue": [a[0] || (a[0] = (i) => e(t).allowAllAccess = i), a[1] || (a[1] = (i) => e(t).write())], type: "switch" }, { default: p(() => [v(n(e(o)("agora", "Enable the creation of openly accessible inquiries globally")), 1)]), _: 1 }, 8, ["modelValue"]), e(t).allowAllAccess ? A("", true) : (c(), y("div", za, [s(e(U), { modelValue: e(t).allAccessGroups, "onUpdate:modelValue": [a[2] || (a[2] = (i) => e(t).allAccessGroups = i), a[3] || (a[3] = (i) => e(t).write())], "input-label": e(o)("agora", "Enable only for the following groups"), label: "displayName", options: e(t).groups, "user-select": true, multiple: true, loading: l.isLoading, placeholder: e(o)("agora", "Leave empty to disable globally"), onSearch: e(t).loadGroups }, null, 8, ["modelValue", "input-label", "options", "loading", "placeholder", "onSearch"])]))]));
} }, Za = { class: "user_settings" }, Qa = { key: 0, class: "settings_details" }, Wa = { __name: "AdminSharePublicCreate", setup(d) {
  const t = q();
  return (l, a) => (c(), y("div", Za, [s(e($), { modelValue: e(t).allowPublicShares, "onUpdate:modelValue": [a[0] || (a[0] = (i) => e(t).allowPublicShares = i), a[1] || (a[1] = (i) => e(t).write())], type: "switch" }, { default: p(() => [v(n(e(o)("agora", "Enable public shares of inquiries globally")), 1)]), _: 1 }, 8, ["modelValue"]), e(t).allowPublicShares ? A("", true) : (c(), y("div", Qa, [s(e(U), { modelValue: e(t).publicSharesGroups, "onUpdate:modelValue": [a[2] || (a[2] = (i) => e(t).publicSharesGroups = i), a[3] || (a[3] = (i) => e(t).write())], "input-label": e(o)("agora", "Enable only for the following groups"), label: "displayName", options: e(t).groups, "user-select": true, multiple: true, loading: l.isLoading, placeholder: e(o)("agora", "Leave empty to disable globally"), onSearch: e(t).loadGroups }, null, 8, ["modelValue", "input-label", "options", "loading", "placeholder", "onSearch"])]))]));
  ...
  const t = q();
  return (l, a) => (c(), y("div", eo, [s(e($), { modelValue: e(t).showMailAddresses, "onUpdate:modelValue": [a[0] || (a[0] = (i) => e(t).showMailAddresses = i), a[1] || (a[1] = (i) => e(t).write())], type: "switch" }, { default: p(() => [v(n(e(o)("agora", "Show email addresses of internal accounts")), 1)]), _: 1 }, 8, ["modelValue"]), e(t).showMailAddresses ? A("", true) : (c(), y("div", to, [s(e(U), { modelValue: e(t).showMailAddressesGroups, "onUpdate:modelValue": [a[2] || (a[2] = (i) => e(t).showMailAddressesGroups = i), a[3] || (a[3] = (i) => e(t).write())], "input-label": e(o)("agora", "Show only to members of the following groups"), label: "displayName", options: e(t).groups, "user-select": true, multiple: true, loading: l.isLoading, placeholder: e(o)("agora", "Leave empty to disable globally."), onSearch: e(t).loadGroups }, null, 8, ["modelValue", "input-label", "options", "loading", "placeholder", "onSearch"])]))]));
} }, oo = { class: "user_settings" }, io = { key: 0, class: "settings_details" }, lo = { __name: "AdminUnrescrictedOwners", setup(d) {
  const t = q();
  return (l, a) => (c(), y("div", oo, [s(e($), { modelValue: e(t).unrestrictedOwner, "onUpdate:modelValue": [a[0] || (a[0] = (i) => e(t).unrestrictedOwner = i), a[1] || (a[1] = (i) => e(t).write())], type: "switch" }, { default: p(() => [v(n(e(o)("agora", "Enable unrestricted owners globally")), 1)]), _: 1 }, 8, ["modelValue"]), e(t).unrestrictedOwner ? A("", true) : (c(), y("div", io, [s(e(U), { modelValue: e(t).unrestrictedOwnerGroups, "onUpdate:modelValue": [a[2] || (a[2] = (i) => e(t).unrestrictedOwnerGroups = i), a[3] || (a[3] = (i) => e(t).write())], "input-label": e(o)("agora", "Enable only for the following groups"), label: "displayName", options: e(t).groups, "user-select": true, multiple: true, loading: e(t).status.loadingGroups, placeholder: e(o)("agora", "Leave empty to disable globally"), onSearch: e(t).loadGroups }, null, 8, ["modelValue", "input-label", "options", "loading", "placeholder", "onSearch"])])), s(Ie, { type: "info" }, { default: p(() => [r("p", null, n(e(o)("agora", "Effects on restricted owners:")), 1), r("ul", null, [r("li", null, n(e(o)("agora", "Anonymizing a inquiry of a restricted owner means that this inquiry is anonymous for everyone, including the owner.")), 1), r("li", null, n(e(o)("agora", "Deleting and changing inquiries of participants is not possible")), 1)])]), _: 1 })]));
