OC.L10N.register(
    ...
    "Optionally choose a more meaningful title for the overview page" : "選擇性為概覽頁面選擇有意義的標題",
    "Note: Based on the name change, the URL has also changed" : "注意：根據名稱變更，URL 也已變更",
    "Name" : "名稱",
    "Extended title" : "延伸標題",
    "Description" : "描述",
    "OK" : "確定",
    "Add date option" : "新增日期選項",
    "Adding options is disabled" : "已停用新增選項",
    "Existing options" : "既有選項",
    ...
    "Contact the owner, if you think that this is wrong." : "若您認為這是錯誤的，請聯絡擁有者。",
