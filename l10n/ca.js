OC.L10N.register(
    ...
    "You have changed the registration constraints for the public share labeled {sharee}" : "Heu canviat les restriccions de registre per a la compartició pública etiquetada com a {sharee}",
    "{actor} has changed the registration constraints for the public share labeled {sharee}" : "{actor}ha canviat les restriccions de registre per a la compartició pública etiquetada com a {sharee}",
    ...
    "Register" : "Registra",
    "Send confirmation mails" : "Envieu correus electrònics de confirmació",
    ...
    "Neutral" : "Neutral",
    "Average" : "Mitjana",
    "But be aware that your name is not stored in an encrypted or obfuscated way." : "Però tingueu en compte que el vostre nom no s'emmagatzema de manera xifrada ni ofuscada.",
    "_%n voting option is available._::_%n voting options are available._" : ["%n opció de vot disponible.","%n opcions de vot disponibles."],
    ...
    "Only visible to me" : "Només visible per a mi",
    "Only visible to {displayName}" : "Només visible per a {displayName}",
    ...
    "No reminder is sent" : "No s'ha enviat cap recordatori",
    ...
    "Cancel" : "Cancel",
    "Ok" : "D'acord",
    "Collapse long descriptions" : "Replega les descripcions llargues",
    "Hide unavailable options" : "Amaga les opcions no disponibles",
    "Always show results" : "Mostra sempre els resultats",
    "Never show results" : "No mostrar mai resultats",
    "\"{inquiryTitle}\" has been added" : "\"{inquiryTitle}\" s'ha afegit",
    ...
    "Edit email address" : "Edita l'adreça de correu electrònic",
    ...
    "Remove email address" : "Elimina l'adreça electrònica",
