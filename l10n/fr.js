OC.L10N.register(
    ...
    "This email is sent to you to inform you about the result of a inquiry you participated in. At least your name or your email address was recorded in this inquiry. If you want to be removed from this inquiry, contact the site administrator or the inquiry initiator, where the mail is sent from." : "Cet email vous est envoyé pour vous informer des résultats d'une enquête à laquelle vous avez participé. Au moins votre nom ou votre adresse e-mail a été enregistrée dans cette enquête. Si vous voulez être retirés de cette enquête, contactez l'administrateur du site ou le créateur de l'enquête, de qui le mail est envoyé.",
    ...
    "The used time zone is \"%s\", based on the detected time zone at your registration time. To view the times in your current time zone, enter the inquiry by clicking the button below." : "La zone horaire utilisée est \" 1%s \", basée sur la fuseau horaire détectée à votre heure d'inscription. Pour voir les heures dans votre fuseau horaire, entrez la demande en cliquant sur le bouton ci-dessous",
    "This link gives you personal access to the inquiry named above. Press the button above or copy the following link and add it in your browser's location bar:" : "Le lien vous offre un accès personnel à l'enquête nommée ci-dessus. Appuyez sur le bouton ci-dessus ou copiez le lien suivant et ajouter le dans la barre de localisation de votre navigateur:",
    ...
    "This email is sent to you, because you subscribed to notifications of this inquiry. To opt out, visit the inquiry and remove your subscription." : "Ce courriel vous est envoyé car vous vous êtes abonné aux notifications relatives à cette demande. Pour vous désabonner, consultez la demande et supprimez votre abonnement.",
