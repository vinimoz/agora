OC.L10N.register(
    ...
    "You have changed the registration constraints for the public share labeled {sharee}" : "{sharee} etiketli herkese açık paylaşım için kayıt kısıtlamalarını değiştirdiniz",
    "{actor} has changed the registration constraints for the public share labeled {sharee}" : "{actor}, {sharee} etiketli herkese açık paylaşım için kayıt kısıtlamalarını değiştirdi",
    ...
    "You have deleted the share for circle {sharee}" : "{sharee} takımı ile paylaşımı sildiniz",
    "{actor} has deleted the share for circle {sharee}" : "{actor}, {sharee} takımı ile paylaşımı sildi",
    ...
    "You have restored the share for group {sharee}" : "{sharee} grubuyla paylaşımı geri yüklediniz",
    "{actor} has restored the share for group {sharee}" : "{actor}, {sharee} grubuyla paylaşımı geri yükledi",
    "You have restored the share for circle {sharee}" : "{sharee} takımı ile paylaşımı geri yüklediniz",
    "{actor} has restored the share for circle {sharee}" : "{actor}, {sharee} takımı ile paylaşımı geri yükledi",
    "You have restored the share for contact group {sharee}" : "{sharee} kişi grubuyla paylaşımı geri yüklediniz",
    "{actor} has restored the share for contact group {sharee}" : "{actor}, {sharee} kişi grubuyla paylaşımı geri yükledi",
    ...
    "To participate, register with your email address and a name." : "Katılmak için e-posta adresinizi ve bir ad yazarak kayıt olun.",
    "To participate, register a name and optionally with your email address." : "Katılmak için bir ad ve isteğe bağlı olarak e-posta adresinizi yazarak kayıt olun.",
    ...
    "Once enabled, the anonymous setting cannot be reverted anymore." : "Açıldıktan sonra, anonimlik ayarı artık geri döndürülemez.",
    "Cancel" : "İptal",
    "Ok" : "Tamam",
    "Use Autoreminder" : "Otomatik anımsatıcılar kullanılsın",
    "Autoreminder information" : "Otomatik anımsatıcı bilgileri",
    "Collapse long descriptions" : "Uzun açıklamaları daralt",
    ...
    "Sort by expiration date" : "Geçerlilik sonu tarihine göre sırala",
    ...
    "Otherwise participate as a guest participant." : "Ya da konuk katılımcı olarak katılın.",
    ...
    "Leave empty to disable globally." : "Genel olarak kullanılmaması için boş bırakın.",
    "Enable unrestricted owners globally" : "Kısıtlanmamış sahipler genel olarak kullanılsın",
    ...
    "Resolving of {name} is not possible. The contacts app is not enabled." : "{name} adı çözümlenemedi. Kişiler uygulaması kullanıma alınmamış.",
    "Resolving of {name} is not possible. The circles app is not enabled." : "{name} adı çözümlenemedi. Takımlar uygulaması kullanıma alınmamış.",
    ...
    "Resolve this group first!" : "Önce bu grubu ayırın!",
