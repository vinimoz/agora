OC.L10N.register(
    ...
    "The used time zone is \"%s\", based on the detected time zone at your registration time. To view the times in your current time zone, enter the inquiry by clicking the button below." : "Używana strefa czasowa to \"%s\", w oparciu o wykrytą strefę czasową w czasie rejestracji. Aby wyświetlić czasy w bieżącej strefie czasowej, wprowadź zapytanie klikając przycisk poniżej.",
    ...
    "Do not share this link with other people, because it is connected to your supports." : "Nie udostępniaj tego łącza innym osobom, ponieważ jest on połączony z Twoim wsparciem.",
