OC.L10N.register(
    ...
    "Maybe" : "Quizás",
    "Loading" : "Cargando",
    "Support status" : "Estado de soporte",
    "Click" : "Clic",
    ...
    "No more voting options are available." : "No hay opciones de voto disponibles",
    ...
    "Choose a description for the overview page" : "Escoja una descripción para la página de resumen",
    "Choose a brief title for the navigation bar and the slug" : "Escoja un título breve para la barra de navegación y el slug",
    "Enter extended title" : "Ingrese el título extendido",
    "Optionally choose a more meaningful title for the overview page" : "Escoger, de forma opcional, un título más significativo para la página de resumen",
    "Note: Based on the name change, the URL has also changed" : "Nota: Basándose en el cambio de nombre, el URL también ha cambiado",
    "Name" : "Nombre",
    ...
    "Effects on restricted owners:" : "Efectos en propietarios restringidos:",
    ...
    "Type to start searching …" : "Escriba para comenzar la búsqueda …",
    ...
    "Collecting elements…" : "Recolectando elementos…",
