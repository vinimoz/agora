...
-- Converted to PostgreSQL format - CORRECTED
-- =======================================================
...
-- Note: Table name corrected from oc_agora_inq_group_misc
-- ============================
...
(5, NULL, 'announcement', 'New Mobility Rules for E-Scooters and Bikes', 'Updated regulations for micromobility devices including parking zones and speed limits.', 0, 0, 'admin', EXTRACT(EPOCH FROM NOW())::bigint - 86400*22, 0, 0, 0, 'federal-experts', 'open', 'always', EXTRACT(EPOCH FROM NOW())::bigint - 86400*1, NULL, 'accepted', 'published', 0, 0, 'collective'),
...
(9, NULL, 'news', 'Urban Noise Pollution: Citizen Jury Findings Published', 'Findings and recommendations from the citizen jury deliberation on urban noise regulations.', 0, 0, 'admin', EXTRACT(EPOCH FROM NOW())::bigint - 86400*8, 0, 0, 0, 'geneva-residents', 'open', 'always', EXTRACT(EPOCH FROM NOW())::bigint - 86400*1, NULL, 'accepted', 'published', 1, 1, 'collective'),
...
(26, NULL, 'news', 'Federal CO2 Levy Referendum Date Set for September 2025', 'Official announcement: Federal referendum on carbon pricing increase scheduled for September 28, 2025.', 0, 0, 'admin', EXTRACT(EPOCH FROM NOW())::bigint - 86400*18, 0, 0, 0, 'swiss-voters', 'open', 'always', EXTRACT(EPOCH FROM NOW())::bigint - 86400*2, NULL, 'accepted', 'published', 1, 1, 'collective'),
...
(id, cover_id, type, title, description, location_id, category_id, owner,
 ...
 allow_comment, allow_support, family)
VALUES
...
(5001, NULL, 'proposal',
 ...
 'accepted', 'active', 1, 1, 'deliberative'),
