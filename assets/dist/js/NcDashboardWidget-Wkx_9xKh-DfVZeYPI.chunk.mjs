...
const eC = "agora", tC = "1.0.0rc4";
import { aU as C_, X as Kc, aV as Gw, aW as b_, a3 as S_, d as Zc, P as tr, e as Ya, o as qe, w as sr, B as Qc, z as Ca, r as Js, x as Cs, u as qd, ab as Vw, a4 as F_, J as Jw, U as Kw, aX as Id, K as pn, aY as Rd, aZ as Od, a_ as Xc, a$ as ba, b0 as x_, b1 as Ud, b2 as Zw, k as zd, t as re, O as Qw, aO as Bd, C as Xw, aQ as eM, aP as eg, b3 as tM, D as sM, b4 as nM, b as aM, q as rM, b5 as iM, ar as tg, aJ as oM, i as Wd, c as dt, b6 as lM, b7 as dM, N as N_, V as nr, a as Sa, f as $d, L as sg, M as ng, ae as mM, I as uM, s as cM, b8 as gM, v as A_, aa as hM } from "./NcEmptyContent-q-geAf0w-DsDiM4c8.chunk.mjs";
...
var qt = { codeRemoveIndent: /^(?: {1,4}| {0,3}\t)/gm, outputLinkReplace: /\\([\[\]])/g, indentCodeCompensation: /^(\s+)(?:```)/, beginningSpace: /^\s+/, endingHash: /#$/, startingSpaceChar: /^ /, endingSpaceChar: / $/, nonSpaceChar: /[^ ]/, newLineCharGlobal: /\n/g, tabCharGlobal: /\t/g, multipleSpaceGlobal: /\s+/g, blankLine: /^[ \t]*$/, doubleBlankLine: /\n[ \t]*\n[ \t]*$/, blockquoteStart: /^ {0,3}>/, blockquoteSetextReplace: /\n {0,3}((?:=+|-+) *)(?=\n|$)/g, blockquoteSetextReplace2: /^ {0,3}>[ \t]?/gm, listReplaceTabs: /^\t+/, listReplaceNesting: /^ {1,4}(?=( {4})*[^ ])/g, listIsTask: /^\[[ xX]\] /, listReplaceTask: /^\[[ xX]\] +/, anyLine: /\n.*\n/, hrefBrackets: /^<(.*)>$/, tableDelimiter: /[:|]/, tableAlignChars: /^\||\| *$/g, tableRowBlankLine: /\n[ \t]*$/, tableAlignRight: /^ *-+: *$/, tableAlignCenter: /^ *:-+: *$/, tableAlignLeft: /^ *:-+ *$/, startATag: /^<a /i, endATag: /^<\/a>/i, startPreScriptTag: /^<(pre|code|kbd|script)(\s|>)/i, endPreScriptTag: /^<\/(pre|code|kbd|script)(\s|>)/i, startAngleBracket: /^</, endAngleBracket: />$/, pedanticHrefTitle: /^([^'"]*[^\s])\s+(['"])(.*)\2/, unicodeAlphaNumeric: /[\p{L}\p{N}]/u, escapeTest: /[&<>"']/, escapeReplace: /[&<>"']/g, escapeTestNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/, escapeReplaceNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g, unescapeTest: /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig, caret: /(^|[^\[])\^/g, percentDecode: /%25/g, findPipe: /\|/g, splitPipe: / \|/, slashPipe: /\\\|/g, carriageReturn: /\r\n|\r/g, spaceLine: /^ +$/gm, notSpaceStart: /^\S*/, endingNewline: /\n$/, listItemRegex: (s) => new RegExp(`^( {0,3}${s})((?:[	 ][^\\n]*)?(?:\\n|$))`), nextBulletRegex: (s) => new RegExp(`^ {0,${Math.min(3, s - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`), hrRegex: (s) => new RegExp(`^ {0,${Math.min(3, s - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`), fencesBeginRegex: (s) => new RegExp(`^ {0,${Math.min(3, s - 1)}}(?:\`\`\`|~~~)`), headingBeginRegex: (s) => new RegExp(`^ {0,${Math.min(3, s - 1)}}#`), htmlBeginRegex: (s) => new RegExp(`^ {0,${Math.min(3, s - 1)}}<(?:[a-z].*>|!--)`, "i") }, _M = /^(?:[ \t]*(?:\n|$))+/, pM = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/, yM = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/, Lo = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/, vM = /^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/, rg = /(?:[*+-]|\d{1,9}[.)])/, H_ = /^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/, P_ = Se(H_).replace(/bull/g, rg).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex(), wM = Se(H_).replace(/bull/g, rg).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(), ig = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/, MM = /^[^\n]+/, og = /(?!\s*\])(?:\\.|[^\[\]\\])+/, LM = Se(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label", og).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(), kM = Se(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, rg).getRegex(), Gd = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", lg = /<!--(?:-?>|[\s\S]*?(?:-->|$))/, TM = Se("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", lg).replace("tag", Gd).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), j_ = Se(ig).replace("hr", Lo).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Gd).getRegex(), DM = Se(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph", j_).getRegex(), dg = { blockquote: DM, code: pM, def: LM, fences: yM, heading: vM, hr: Lo, html: TM, lheading: P_, list: kM, newline: _M, paragraph: j_, table: Mo, text: MM }, q_ = Se("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", Lo).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Gd).getRegex(), YM = { ...dg, lheading: wM, table: q_, paragraph: Se(ig).replace("hr", Lo).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", q_).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Gd).getRegex() }, CM = { ...dg, html: Se(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment", lg).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(), def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/, heading: /^(#{1,6})(.*)(?:\n+|$)/, fences: Mo, lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/, paragraph: Se(ig).replace("hr", Lo).replace("heading", ` *#{1,6} *[^
]`).replace("lheading", P_).replace("|table", "").replace("blockquote", " {0,3}>").replace("|fences", "").replace("|list", "").replace("|html", "").replace("|tag", "").getRegex() }, bM = /^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/, SM = /^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/, I_ = /^( {2,}|\\)\n(?!\s*$)/, FM = /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/, Vd = /[\p{P}\p{S}]/u, mg = /[\s\p{P}\p{S}]/u, R_ = /[^\s\p{P}\p{S}]/u, xM = Se(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, mg).getRegex(), O_ = /(?!~)[\p{P}\p{S}]/u, NM = /(?!~)[\s\p{P}\p{S}]/u, AM = /(?:[^\s\p{P}\p{S}]|~)/u, EM = /\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g, U_ = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/, HM = Se(U_, "u").replace(/punct/g, Vd).getRegex(), PM = Se(U_, "u").replace(/punct/g, O_).getRegex(), z_ = "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)", jM = Se(z_, "gu").replace(/notPunctSpace/g, R_).replace(/punctSpace/g, mg).replace(/punct/g, Vd).getRegex(), qM = Se(z_, "gu").replace(/notPunctSpace/g, AM).replace(/punctSpace/g, NM).replace(/punct/g, O_).getRegex(), IM = Se("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, R_).replace(/punctSpace/g, mg).replace(/punct/g, Vd).getRegex(), RM = Se(/\\(punct)/, "gu").replace(/punct/g, Vd).getRegex(), OM = Se(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(), UM = Se(lg).replace("(?:-->|$)", "-->").getRegex(), zM = Se("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", UM).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(), Jd = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, BM = Se(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label", Jd).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(), B_ = Se(/^!?\[(label)\]\[(ref)\]/).replace("label", Jd).replace("ref", og).getRegex(), W_ = Se(/^!?\[(ref)\](?:\[\])?/).replace("ref", og).getRegex(), WM = Se("reflink|nolink(?!\\()", "g").replace("reflink", B_).replace("nolink", W_).getRegex(), ug = { _backpedal: Mo, anyPunctuation: RM, autolink: OM, blockSkip: EM, br: I_, code: SM, del: Mo, emStrongLDelim: HM, emStrongRDelimAst: jM, emStrongRDelimUnd: IM, escape: bM, link: BM, nolink: W_, punctuation: xM, reflink: B_, reflinkSearch: WM, tag: zM, text: FM, url: Mo }, $M = { ...ug, link: Se(/^!?\[(label)\]\((.*?)\)/).replace("label", Jd).getRegex(), reflink: Se(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", Jd).getRegex() }, cg = { ...ug, emStrongRDelimAst: qM, emStrongLDelim: PM, url: Se(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/, "i").replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(), _backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/, del: /^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/, text: /^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/ }, GM = { ...cg, br: Se(I_).replace("{2,}", "*").getRegex(), text: Se(cg.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex() }, Kd = { normal: dg, gfm: YM, pedantic: CM }, ko = { normal: ug, gfm: cg, breaks: GM, pedantic: $M }, VM = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }, $_ = (s) => VM[s];
function yn(s, i) {
  if (i) {
...
`) };
  ...
  fences(s) {
    ...
    if (i) {
      const r = i[0], l = KM(r, i[3] || "", this.rules);
...
const QM = /[\0-\x1F!-,\.\/:-@\[-\^`\{-\xA9\xAB-\xB4\xB6-\xB9\xBB-\xBF\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u02FF\u0375\u0378\u0379\u037E\u0380-\u0385\u0387\u038B\u038D\u03A2\u03F6\u0482\u0530\u0557\u0558\u055A-\u055F\u0589-\u0590\u05BE\u05C0\u05C3\u05C6\u05C8-\u05CF\u05EB-\u05EE\u05F3-\u060F\u061B-\u061F\u066A-\u066D\u06D4\u06DD\u06DE\u06E9\u06FD\u06FE\u0700-\u070F\u074B\u074C\u07B2-\u07BF\u07F6-\u07F9\u07FB\u07FC\u07FE\u07FF\u082E-\u083F\u085C-\u085F\u086B-\u089F\u08B5\u08C8-\u08D2\u08E2\u0964\u0965\u0970\u0984\u098D\u098E\u0991\u0992\u09A9\u09B1\u09B3-\u09B5\u09BA\u09BB\u09C5\u09C6\u09C9\u09CA\u09CF-\u09D6\u09D8-\u09DB\u09DE\u09E4\u09E5\u09F2-\u09FB\u09FD\u09FF\u0A00\u0A04\u0A0B-\u0A0E\u0A11\u0A12\u0A29\u0A31\u0A34\u0A37\u0A3A\u0A3B\u0A3D\u0A43-\u0A46\u0A49\u0A4A\u0A4E-\u0A50\u0A52-\u0A58\u0A5D\u0A5F-\u0A65\u0A76-\u0A80\u0A84\u0A8E\u0A92\u0AA9\u0AB1\u0AB4\u0ABA\u0ABB\u0AC6\u0ACA\u0ACE\u0ACF\u0AD1-\u0ADF\u0AE4\u0AE5\u0AF0-\u0AF8\u0B00\u0B04\u0B0D\u0B0E\u0B11\u0B12\u0B29\u0B31\u0B34\u0B3A\u0B3B\u0B45\u0B46\u0B49\u0B4A\u0B4E-\u0B54\u0B58-\u0B5B\u0B5E\u0B64\u0B65\u0B70\u0B72-\u0B81\u0B84\u0B8B-\u0B8D\u0B91\u0B96-\u0B98\u0B9B\u0B9D\u0BA0-\u0BA2\u0BA5-\u0BA7\u0BAB-\u0BAD\u0BBA-\u0BBD\u0BC3-\u0BC5\u0BC9\u0BCE\u0BCF\u0BD1-\u0BD6\u0BD8-\u0BE5\u0BF0-\u0BFF\u0C0D\u0C11\u0C29\u0C3A-\u0C3C\u0C45\u0C49\u0C4E-\u0C54\u0C57\u0C5B-\u0C5F\u0C64\u0C65\u0C70-\u0C7F\u0C84\u0C8D\u0C91\u0CA9\u0CB4\u0CBA\u0CBB\u0CC5\u0CC9\u0CCE-\u0CD4\u0CD7-\u0CDD\u0CDF\u0CE4\u0CE5\u0CF0\u0CF3-\u0CFF\u0D0D\u0D11\u0D45\u0D49\u0D4F-\u0D53\u0D58-\u0D5E\u0D64\u0D65\u0D70-\u0D79\u0D80\u0D84\u0D97-\u0D99\u0DB2\u0DBC\u0DBE\u0DBF\u0DC7-\u0DC9\u0DCB-\u0DCE\u0DD5\u0DD7\u0DE0-\u0DE5\u0DF0\u0DF1\u0DF4-\u0E00\u0E3B-\u0E3F\u0E4F\u0E5A-\u0E80\u0E83\u0E85\u0E8B\u0EA4\u0EA6\u0EBE\u0EBF\u0EC5\u0EC7\u0ECE\u0ECF\u0EDA\u0EDB\u0EE0-\u0EFF\u0F01-\u0F17\u0F1A-\u0F1F\u0F2A-\u0F34\u0F36\u0F38\u0F3A-\u0F3D\u0F48\u0F6D-\u0F70\u0F85\u0F98\u0FBD-\u0FC5\u0FC7-\u0FFF\u104A-\u104F\u109E\u109F\u10C6\u10C8-\u10CC\u10CE\u10CF\u10FB\u1249\u124E\u124F\u1257\u1259\u125E\u125F\u1289\u128E\u128F\u12B1\u12B6\u12B7\u12BF\u12C1\u12C6\u12C7\u12D7\u1311\u1316\u1317\u135B\u135C\u1360-\u137F\u1390-\u139F\u13F6\u13F7\u13FE-\u1400\u166D\u166E\u1680\u169B-\u169F\u16EB-\u16ED\u16F9-\u16FF\u170D\u1715-\u171F\u1735-\u173F\u1754-\u175F\u176D\u1771\u1774-\u177F\u17D4-\u17D6\u17D8-\u17DB\u17DE\u17DF\u17EA-\u180A\u180E\u180F\u181A-\u181F\u1879-\u187F\u18AB-\u18AF\u18F6-\u18FF\u191F\u192C-\u192F\u193C-\u1945\u196E\u196F\u1975-\u197F\u19AC-\u19AF\u19CA-\u19CF\u19DA-\u19FF\u1A1C-\u1A1F\u1A5F\u1A7D\u1A7E\u1A8A-\u1A8F\u1A9A-\u1AA6\u1AA8-\u1AAF\u1AC1-\u1AFF\u1B4C-\u1B4F\u1B5A-\u1B6A\u1B74-\u1B7F\u1BF4-\u1BFF\u1C38-\u1C3F\u1C4A-\u1C4C\u1C7E\u1C7F\u1C89-\u1C8F\u1CBB\u1CBC\u1CC0-\u1CCF\u1CD3\u1CFB-\u1CFF\u1DFA\u1F16\u1F17\u1F1E\u1F1F\u1F46\u1F47\u1F4E\u1F4F\u1F58\u1F5A\u1F5C\u1F5E\u1F7E\u1F7F\u1FB5\u1FBD\u1FBF-\u1FC1\u1FC5\u1FCD-\u1FCF\u1FD4\u1FD5\u1FDC-\u1FDF\u1FED-\u1FF1\u1FF5\u1FFD-\u203E\u2041-\u2053\u2055-\u2070\u2072-\u207E\u2080-\u208F\u209D-\u20CF\u20F1-\u2101\u2103-\u2106\u2108\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A\u213B\u2140-\u2144\u214A-\u214D\u214F-\u215F\u2189-\u24B5\u24EA-\u2BFF\u2C2F\u2C5F\u2CE5-\u2CEA\u2CF4-\u2CFF\u2D26\u2D28-\u2D2C\u2D2E\u2D2F\u2D68-\u2D6E\u2D70-\u2D7E\u2D97-\u2D9F\u2DA7\u2DAF\u2DB7\u2DBF\u2DC7\u2DCF\u2DD7\u2DDF\u2E00-\u2E2E\u2E30-\u3004\u3008-\u3020\u3030\u3036\u3037\u303D-\u3040\u3097\u3098\u309B\u309C\u30A0\u30FB\u3100-\u3104\u3130\u318F-\u319F\u31C0-\u31EF\u3200-\u33FF\u4DC0-\u4DFF\u9FFD-\u9FFF\uA48D-\uA4CF\uA4FE\uA4FF\uA60D-\uA60F\uA62C-\uA63F\uA673\uA67E\uA6F2-\uA716\uA720\uA721\uA789\uA78A\uA7C0\uA7C1\uA7CB-\uA7F4\uA828-\uA82B\uA82D-\uA83F\uA874-\uA87F\uA8C6-\uA8CF\uA8DA-\uA8DF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA954-\uA95F\uA97D-\uA97F\uA9C1-\uA9CE\uA9DA-\uA9DF\uA9FF\uAA37-\uAA3F\uAA4E\uAA4F\uAA5A-\uAA5F\uAA77-\uAA79\uAAC3-\uAADA\uAADE\uAADF\uAAF0\uAAF1\uAAF7-\uAB00\uAB07\uAB08\uAB0F\uAB10\uAB17-\uAB1F\uAB27\uAB2F\uAB5B\uAB6A-\uAB6F\uABEB\uABEE\uABEF\uABFA-\uABFF\uD7A4-\uD7AF\uD7C7-\uD7CA\uD7FC-\uD7FF\uE000-\uF8FF\uFA6E\uFA6F\uFADA-\uFAFF\uFB07-\uFB12\uFB18-\uFB1C\uFB29\uFB37\uFB3D\uFB3F\uFB42\uFB45\uFBB2-\uFBD2\uFD3E-\uFD4F\uFD90\uFD91\uFDC8-\uFDEF\uFDFC-\uFDFF\uFE10-\uFE1F\uFE30-\uFE32\uFE35-\uFE4C\uFE50-\uFE6F\uFE75\uFEFD-\uFF0F\uFF1A-\uFF20\uFF3B-\uFF3E\uFF40\uFF5B-\uFF65\uFFBF-\uFFC1\uFFC8\uFFC9\uFFD0\uFFD1\uFFD8\uFFD9\uFFDD-\uFFFF]|\uD800[\uDC0C\uDC27\uDC3B\uDC3E\uDC4E\uDC4F\uDC5E-\uDC7F\uDCFB-\uDD3F\uDD75-\uDDFC\uDDFE-\uDE7F\uDE9D-\uDE9F\uDED1-\uDEDF\uDEE1-\uDEFF\uDF20-\uDF2C\uDF4B-\uDF4F\uDF7B-\uDF7F\uDF9E\uDF9F\uDFC4-\uDFC7\uDFD0\uDFD6-\uDFFF]|\uD801[\uDC9E\uDC9F\uDCAA-\uDCAF\uDCD4-\uDCD7\uDCFC-\uDCFF\uDD28-\uDD2F\uDD64-\uDDFF\uDF37-\uDF3F\uDF56-\uDF5F\uDF68-\uDFFF]|\uD802[\uDC06\uDC07\uDC09\uDC36\uDC39-\uDC3B\uDC3D\uDC3E\uDC56-\uDC5F\uDC77-\uDC7F\uDC9F-\uDCDF\uDCF3\uDCF6-\uDCFF\uDD16-\uDD1F\uDD3A-\uDD7F\uDDB8-\uDDBD\uDDC0-\uDDFF\uDE04\uDE07-\uDE0B\uDE14\uDE18\uDE36\uDE37\uDE3B-\uDE3E\uDE40-\uDE5F\uDE7D-\uDE7F\uDE9D-\uDEBF\uDEC8\uDEE7-\uDEFF\uDF36-\uDF3F\uDF56-\uDF5F\uDF73-\uDF7F\uDF92-\uDFFF]|\uD803[\uDC49-\uDC7F\uDCB3-\uDCBF\uDCF3-\uDCFF\uDD28-\uDD2F\uDD3A-\uDE7F\uDEAA\uDEAD-\uDEAF\uDEB2-\uDEFF\uDF1D-\uDF26\uDF28-\uDF2F\uDF51-\uDFAF\uDFC5-\uDFDF\uDFF7-\uDFFF]|\uD804[\uDC47-\uDC65\uDC70-\uDC7E\uDCBB-\uDCCF\uDCE9-\uDCEF\uDCFA-\uDCFF\uDD35\uDD40-\uDD43\uDD48-\uDD4F\uDD74\uDD75\uDD77-\uDD7F\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDFF\uDE12\uDE38-\uDE3D\uDE3F-\uDE7F\uDE87\uDE89\uDE8E\uDE9E\uDEA9-\uDEAF\uDEEB-\uDEEF\uDEFA-\uDEFF\uDF04\uDF0D\uDF0E\uDF11\uDF12\uDF29\uDF31\uDF34\uDF3A\uDF45\uDF46\uDF49\uDF4A\uDF4E\uDF4F\uDF51-\uDF56\uDF58-\uDF5C\uDF64\uDF65\uDF6D-\uDF6F\uDF75-\uDFFF]|\uD805[\uDC4B-\uDC4F\uDC5A-\uDC5D\uDC62-\uDC7F\uDCC6\uDCC8-\uDCCF\uDCDA-\uDD7F\uDDB6\uDDB7\uDDC1-\uDDD7\uDDDE-\uDDFF\uDE41-\uDE43\uDE45-\uDE4F\uDE5A-\uDE7F\uDEB9-\uDEBF\uDECA-\uDEFF\uDF1B\uDF1C\uDF2C-\uDF2F\uDF3A-\uDFFF]|\uD806[\uDC3B-\uDC9F\uDCEA-\uDCFE\uDD07\uDD08\uDD0A\uDD0B\uDD14\uDD17\uDD36\uDD39\uDD3A\uDD44-\uDD4F\uDD5A-\uDD9F\uDDA8\uDDA9\uDDD8\uDDD9\uDDE2\uDDE5-\uDDFF\uDE3F-\uDE46\uDE48-\uDE4F\uDE9A-\uDE9C\uDE9E-\uDEBF\uDEF9-\uDFFF]|\uD807[\uDC09\uDC37\uDC41-\uDC4F\uDC5A-\uDC71\uDC90\uDC91\uDCA8\uDCB7-\uDCFF\uDD07\uDD0A\uDD37-\uDD39\uDD3B\uDD3E\uDD48-\uDD4F\uDD5A-\uDD5F\uDD66\uDD69\uDD8F\uDD92\uDD99-\uDD9F\uDDAA-\uDEDF\uDEF7-\uDFAF\uDFB1-\uDFFF]|\uD808[\uDF9A-\uDFFF]|\uD809[\uDC6F-\uDC7F\uDD44-\uDFFF]|[\uD80A\uD80B\uD80E-\uD810\uD812-\uD819\uD824-\uD82B\uD82D\uD82E\uD830-\uD833\uD837\uD839\uD83D\uD83F\uD87B-\uD87D\uD87F\uD885-\uDB3F\uDB41-\uDBFF][\uDC00-\uDFFF]|\uD80D[\uDC2F-\uDFFF]|\uD811[\uDE47-\uDFFF]|\uD81A[\uDE39-\uDE3F\uDE5F\uDE6A-\uDECF\uDEEE\uDEEF\uDEF5-\uDEFF\uDF37-\uDF3F\uDF44-\uDF4F\uDF5A-\uDF62\uDF78-\uDF7C\uDF90-\uDFFF]|\uD81B[\uDC00-\uDE3F\uDE80-\uDEFF\uDF4B-\uDF4E\uDF88-\uDF8E\uDFA0-\uDFDF\uDFE2\uDFE5-\uDFEF\uDFF2-\uDFFF]|\uD821[\uDFF8-\uDFFF]|\uD823[\uDCD6-\uDCFF\uDD09-\uDFFF]|\uD82C[\uDD1F-\uDD4F\uDD53-\uDD63\uDD68-\uDD6F\uDEFC-\uDFFF]|\uD82F[\uDC6B-\uDC6F\uDC7D-\uDC7F\uDC89-\uDC8F\uDC9A-\uDC9C\uDC9F-\uDFFF]|\uD834[\uDC00-\uDD64\uDD6A-\uDD6C\uDD73-\uDD7A\uDD83\uDD84\uDD8C-\uDDA9\uDDAE-\uDE41\uDE45-\uDFFF]|\uD835[\uDC55\uDC9D\uDCA0\uDCA1\uDCA3\uDCA4\uDCA7\uDCA8\uDCAD\uDCBA\uDCBC\uDCC4\uDD06\uDD0B\uDD0C\uDD15\uDD1D\uDD3A\uDD3F\uDD45\uDD47-\uDD49\uDD51\uDEA6\uDEA7\uDEC1\uDEDB\uDEFB\uDF15\uDF35\uDF4F\uDF6F\uDF89\uDFA9\uDFC3\uDFCC\uDFCD]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85-\uDE9A\uDEA0\uDEB0-\uDFFF]|\uD838[\uDC07\uDC19\uDC1A\uDC22\uDC25\uDC2B-\uDCFF\uDD2D-\uDD2F\uDD3E\uDD3F\uDD4A-\uDD4D\uDD4F-\uDEBF\uDEFA-\uDFFF]|\uD83A[\uDCC5-\uDCCF\uDCD7-\uDCFF\uDD4C-\uDD4F\uDD5A-\uDFFF]|\uD83B[\uDC00-\uDDFF\uDE04\uDE20\uDE23\uDE25\uDE26\uDE28\uDE33\uDE38\uDE3A\uDE3C-\uDE41\uDE43-\uDE46\uDE48\uDE4A\uDE4C\uDE50\uDE53\uDE55\uDE56\uDE58\uDE5A\uDE5C\uDE5E\uDE60\uDE63\uDE65\uDE66\uDE6B\uDE73\uDE78\uDE7D\uDE7F\uDE8A\uDE9C-\uDEA0\uDEA4\uDEAA\uDEBC-\uDFFF]|\uD83C[\uDC00-\uDD2F\uDD4A-\uDD4F\uDD6A-\uDD6F\uDD8A-\uDFFF]|\uD83E[\uDC00-\uDFEF\uDFFA-\uDFFF]|\uD869[\uDEDE-\uDEFF]|\uD86D[\uDF35-\uDF3F]|\uD86E[\uDC1E\uDC1F]|\uD873[\uDEA2-\uDEAF]|\uD87A[\uDFE1-\uDFFF]|\uD87E[\uDE1E-\uDFFF]|\uD884[\uDF4B-\uDFFF]|\uDB40[\uDC00-\uDCFF\uDDF0-\uDFFF]/g, XM = Object.hasOwnProperty;
class K_ {
  constructor() {
  ...
  slug(i, r) {
    ...
    let u = eL(i, r === true);
    const g = u;
    for (; XM.call(l.occurrences, u); ) l.occurrences[g]++, u = g + "-" + l.occurrences[g];
...
function eL(s, i) {
  return typeof s != "string" ? "" : (i || (s = s.toLowerCase()), s.replace(QM, "").replace(/ /g, "-"));
}
let Z_ = new K_(), Q_ = [];
const tL = /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;
function sL(s) {
  return s.replace(tL, (i, r) => (r = r.toLowerCase(), r === "colon" ? ":" : r.charAt(0) === "#" ? r.charAt(1) === "x" ? String.fromCharCode(parseInt(r.substring(2), 16)) : String.fromCharCode(+r.substring(1)) : ""));
}
function X_({ prefix: s = "", globalSlugs: i = false } = {}) {
  return { headerIds: false, hooks: { preprocess(r) {
    ...
    const u = this.parser.parseInline(r), g = sL(u).trim().replace(/<[!\/a-z].*?>/gi, ""), f = l, p = `${s}${Z_.slug(g.toLowerCase())}`, L = { level: f, text: u, id: p, raw: g };
...
var em = { exports: {} }, aL = em.exports, tp;
function rL() {
...
const mL = Kc(dL);
S_();
const uL = Zc({ __name: "NcDialogButton", props: { callback: { type: Function, default: () => {
  ...
  return (f, p) => (qe(), Ya(qd(Kw), { "aria-label": f.label, disabled: f.disabled, type: f.type, variant: f.variant, onClick: g }, { icon: sr(() => [Js(f.$slots, "icon", {}, () => [u.value ? (qe(), Ya(qd(Vw), { key: 0, name: qd(F_)("Loading …") }, null, 8, ["name"])) : f.icon !== void 0 ? (qe(), Ya(qd(Jw), { key: 1, svg: f.icon }, null, 8, ["svg"])) : Cs("", true)])]), default: sr(() => [Qc(Ca(f.label) + " ", 1)]), _: 3 }, 8, ["aria-label", "disabled", "type", "variant"]));
...
const cL = "off", gL = "polite", hL = "assertive";
var hg = ((s) => (s[s.OFF = cL] = "OFF", s[s.POLITE = gL] = "POLITE", s[s.ASSERTIVE = hL] = "ASSERTIVE", s))(hg || {});
const fL = 7e3;
function fg(s, i) {
  if (i = { timeout: fL, isHTML: false, type: void 0, selector: void 0, onRemove: () => {
  ...
  const g = mL({ [l ? "node" : "text"]: s, duration: i.timeout, callback: i.onRemove, onClick: i.onClick, close: i.close, gravity: "top", selector: i.selector, position: "right", backgroundColor: "", className: "dialogs " + r, escapeMarkup: !i.isHTML, ariaLive: u });
...
`);
        ...
        var fv = le(function(t, a) {
          return _s(t, 1, a);
        }), _v = le(function(t, a, o) {
        ...
        var Qv = pa(Br), Xv = pa(function(t, a) {
          return t <= a;
        });
        function g_(t) {
          if (!t) return [];
        ...
        var R2 = gn(function(t, a, o) {
          return t + (o ? "-" : "") + a.toLowerCase();
        }), O2 = gn(function(t, a, o) {
          return t + (o ? " " : "") + a.toLowerCase();
        }), U2 = id("toLowerCase");
        function z2(t, a, o) {
          t = be(t), a = me(a);
...
`) + R + `return __p
        ...
        var ww = Qi(xe), Mw = Qi(Lr), Lw = Qi(Mi);
        function D_(t) {
        ...
        var Nw = gt(function(t, a) {
          return t + a;
        }, 0), Aw = to("ceil"), Ew = gt(function(t, a) {
          return t / a;
        }, 1), Hw = to("floor");
        function Pw(t) {
        ...
        var Uw = gt(function(t, a) {
          return t * a;
        }, 1), zw = to("round"), Bw = gt(function(t, a) {
          return t - a;
        }, 0);
        function Ww(t) {
        ...
        return y.after = hv, y.ary = s_, y.assign = t2, y.assignIn = __, y.assignInWith = jd, y.assignWith = s2, y.at = n2, y.before = n_, y.bind = jc, y.bindAll = lw, y.bindKey = a_, y.castArray = Yv, y.chain = Xf, y.chunk = Tc, y.compact = uo, y.concat = kd, y.cond = dw, y.conforms = mw, y.constant = Bc, y.countBy = W1, y.create = a2, y.curry = r_, y.curryRight = i_, y.debounce = o_, y.defaults = r2, y.defaultsDeep = i2, y.defer = fv, y.delay = _v, y.difference = Td, y.differenceBy = Dc, y.differenceWith = co, y.drop = Dd, y.dropRight = Yc, y.dropRightWhile = Cc, y.dropWhile = Yd, y.fill = bc, y.filter = G1, y.flatMap = K1, y.flatMapDeep = Z1, y.flatMapDepth = Q1, y.flatten = $s, y.flattenDeep = Pn, y.flattenDepth = Sc, y.flip = pv, y.flow = cw, y.flowRight = gw, y.fromPairs = fn, y.functions = g2, y.functionsIn = h2, y.groupBy = X1, y.initial = go, y.intersection = Fc, y.intersectionBy = xc, y.intersectionWith = La, y.invert = _2, y.invertBy = p2, y.invokeMap = tv, y.iteratee = Wc, y.keyBy = sv, y.keys = lt, y.keysIn = Kt, y.map = xd, y.mapKeys = v2, y.mapValues = w2, y.matches = hw, y.matchesProperty = fw, y.memoize = Ad, y.merge = M2, y.mergeWith = p_, y.method = _w, y.methodOf = pw, y.mixin = $c, y.negate = Ed, y.nthArg = vw, y.omit = L2, y.omitBy = k2, y.once = yv, y.orderBy = nv, y.over = ww, y.overArgs = vv, y.overEvery = Mw, y.overSome = Lw, y.partial = qc, y.partialRight = l_, y.partition = av, y.pick = T2, y.pickBy = y_, y.property = D_, y.propertyOf = kw, y.pull = Nc, y.pullAll = bd, y.pullAllBy = ho, y.pullAllWith = fo, y.pullAt = _o, y.range = Tw, y.rangeRight = Dw, y.rearg = wv, y.reject = ov, y.remove = Ac, y.rest = Mv, y.reverse = po, y.sampleSize = dv, y.set = Y2, y.setWith = C2, y.shuffle = mv, y.slice = ka, y.sortBy = gv, y.sortedUniq = Ta, y.sortedUniqBy = Sd, y.split = K2, y.spread = Lv, y.tail = vo, y.take = e, y.takeRight = n, y.takeRightWhile = d, y.takeWhile = m, y.tap = P1, y.throttle = kv, y.thru = Fd, y.toArray = g_, y.toPairs = v_, y.toPairsIn = w_, y.toPath = Fw, y.toPlainObject = f_, y.transform = b2, y.unary = Tv, y.union = h, y.unionBy = k, y.unionWith = S, y.uniq = W, y.uniqBy = ie, y.uniqWith = ye, y.unset = S2, y.unzip = nt, y.unzipWith = Ds, y.update = F2, y.updateWith = x2, y.values = ni, y.valuesIn = N2, y.without = _n, y.words = k_, y.wrap = Dv, y.xor = S1, y.xorBy = F1, y.xorWith = x1, y.zip = N1, y.zipObject = A1, y.zipObjectDeep = E1, y.zipWith = H1, y.entries = v_, y.entriesIn = w_, y.extend = __, y.extendWith = jd, $c(y, y), y.add = Nw, y.attempt = T_, y.camelCase = P2, y.capitalize = M_, y.ceil = Aw, y.clamp = A2, y.clone = Cv, y.cloneDeep = Sv, y.cloneDeepWith = Fv, y.cloneWith = bv, y.conformsTo = xv, y.deburr = L_, y.defaultTo = uw, y.divide = Ew, y.endsWith = j2, y.eq = Gs, y.escape = q2, y.escapeRegExp = I2, y.every = $1, y.find = V1, y.findIndex = ei, y.findKey = o2, y.findLast = J1, y.findLastIndex = Hn, y.findLastKey = l2, y.floor = Hw, y.forEach = e_, y.forEachRight = t_, y.forIn = d2, y.forInRight = m2, y.forOwn = u2, y.forOwnRight = c2, y.get = Oc, y.gt = Nv, y.gte = Av, y.has = f2, y.hasIn = Uc, y.head = ti, y.identity = Zt, y.includes = ev, y.indexOf = Cd, y.inRange = E2, y.invoke = y2, y.isArguments = er, y.isArray = de, y.isArrayBuffer = Ev, y.isArrayLike = Jt, y.isArrayLikeObject = Xe, y.isBoolean = Hv, y.isBuffer = Da, y.isDate = Pv, y.isElement = jv, y.isEmpty = qv, y.isEqual = Iv, y.isEqualWith = Rv, y.isError = Ic, y.isFinite = Ov, y.isFunction = qn, y.isInteger = d_, y.isLength = Hd, y.isMap = m_, y.isMatch = Uv, y.isMatchWith = zv, y.isNaN = Bv, y.isNative = Wv, y.isNil = Gv, y.isNull = $v, y.isNumber = u_, y.isObject = $e, y.isObjectLike = Je, y.isPlainObject = wo, y.isRegExp = Rc, y.isSafeInteger = Vv, y.isSet = c_, y.isString = Pd, y.isSymbol = ls, y.isTypedArray = si, y.isUndefined = Jv, y.isWeakMap = Kv, y.isWeakSet = Zv, y.join = Gt, y.kebabCase = R2, y.last = Ie, y.lastIndexOf = Ht, y.lowerCase = O2, y.lowerFirst = U2, y.lt = Qv, y.lte = Xv, y.max = Pw, y.maxBy = jw, y.mean = qw, y.meanBy = Iw, y.min = Rw, y.minBy = Ow, y.stubArray = Vc, y.stubFalse = Jc, y.stubObject = Yw, y.stubString = Cw, y.stubTrue = bw, y.multiply = Uw, y.nth = Pt, y.noConflict = yw, y.noop = Gc, y.now = Nd, y.pad = z2, y.padEnd = B2, y.padStart = W2, y.parseInt = $2, y.random = H2, y.reduce = rv, y.reduceRight = iv, y.repeat = G2, y.replace = V2, y.result = D2, y.round = zw, y.runInContext = Y, y.sample = lv, y.size = uv, y.snakeCase = J2, y.some = cv, y.sortedIndex = Ec, y.sortedIndexBy = yo, y.sortedIndexOf = Vt, y.sortedLastIndex = Hc, y.sortedLastIndexBy = jn, y.sortedLastIndexOf = Pc, y.startCase = Z2, y.startsWith = Q2, y.subtract = Bw, y.sum = Ww, y.sumBy = $w, y.template = X2, y.times = Sw, y.toFinite = In, y.toInteger = me, y.toLength = h_, y.toLower = ew, y.toNumber = Ys, y.toSafeInteger = e2, y.toString = be, y.toUpper = tw, y.trim = sw, y.trimEnd = nw, y.trimStart = aw, y.truncate = rw, y.unescape = iw, y.uniqueId = xw, y.upperCase = ow, y.upperFirst = zc, y.each = e_, y.eachRight = t_, y.first = ti, $c(y, (function() {
          var t = {};
        ...
        }), ca[xn(r, Q).name] = [{ name: "wrapper", func: r }], ue.prototype.clone = Fu, ue.prototype.reverse = xu, ue.prototype.value = Nu, y.prototype.at = j1, y.prototype.chain = q1, y.prototype.commit = I1, y.prototype.next = R1, y.prototype.plant = U1, y.prototype.reverse = z1, y.prototype.toJSON = y.prototype.valueOf = y.prototype.value = B1, y.prototype.first = y.prototype.head, Ra && (y.prototype[Ra] = O1), y;
      }), la = _u();
...
function LL() {
  if (yp) return Dg;
  yp = 1;
  var s = gp(), i = ML(), r = Xc(), l = pp(), u = /[\\^$.*+?()[\]{}|]/g, g = /^\[object .+?Constructor\]$/, f = Function.prototype, p = Object.prototype, L = f.toString, w = p.hasOwnProperty, D = RegExp("^" + L.call(w).replace(u, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
  function b(H) {
...
function zL() {
  if (Vp) return sh;
  Vp = 1;
  var s = UL(), i = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, r = /\\(\\)?/g, l = s(function(u) {
    var g = [];
...
function oy() {
  if (iy) return hh;
  iy = 1;
  var s = rm(), i = $L(), r = GL(), l = VL(), u = JL(), g = KL();
  function f(p) {
...
function rk() {
  if (yy) return Th;
  yy = 1;
  var s = x_(), i = sk(), r = Fp(), l = hy(), u = nk(), g = ak(), f = 1, p = 2, L = "[object Boolean]", w = "[object Date]", D = "[object Error]", b = "[object Map]", H = "[object Number]", N = "[object RegExp]", q = "[object Set]", O = "[object String]", x = "[object Symbol]", Q = "[object ArrayBuffer]", X = "[object DataView]", se = s ? s.prototype : void 0, Z = se ? se.valueOf : void 0;
...
function mk() {
  if (ky) return Sh;
  ky = 1;
  var s = lk(), i = dk(), r = Object.prototype, l = r.propertyIsEnumerable, u = Object.getOwnPropertySymbols, g = u ? function(f) {
...
function Cy() {
  if (Yy) return Nh;
  Yy = 1;
  var s = ck(), i = Ud(), r = Object.prototype, l = r.hasOwnProperty, u = r.propertyIsEnumerable, g = s(/* @__PURE__ */ (function() {
    return arguments;
  })()) ? s : function(f) {
...
function Fy() {
  return Sy || (Sy = 1, (function(s, i) {
    var r = ba(), l = gk(), u = i && !i.nodeType && i, g = u && true && s && !s.nodeType && s, f = g && g.exports === u, p = f ? r.Buffer : void 0, L = p ? p.isBuffer : void 0, w = L || l;
    s.exports = w;
...
function fk() {
  return jy || (jy = 1, (function(s, i) {
    var r = Zw(), l = i && !i.nodeType && i, u = l && true && s && !s.nodeType && s, g = u && u.exports === l, f = g && r.process, p = (function() {
      try {
...
function Iy() {
  if (qy) return Ih;
  qy = 1;
  var s = hk(), i = Py(), r = fk(), l = r && r.isTypedArray, u = l ? i(l) : s;
  return Ih = u, Ih;
}
var Rh, Ry;
function _k() {
  if (Ry) return Rh;
  Ry = 1;
  var s = uk(), i = Cy(), r = vn(), l = Fy(), u = Ny(), g = Iy(), f = Object.prototype, p = f.hasOwnProperty;
  function L(w, D) {
...
function vk() {
  if (zy) return zh;
  zy = 1;
  var s = yk(), i = s(Object.keys, Object);
  return zh = i, zh;
}
var Bh, By;
function wk() {
  if (By) return Bh;
  By = 1;
  var s = pk(), i = vk(), r = Object.prototype, l = r.hasOwnProperty;
  function u(g) {
    if (!s(g)) return i(g);
    var f = [];
...
function Lk() {
  if (Vy) return Kh;
  Vy = 1;
  var s = Mk(), i = 1, r = Object.prototype, l = r.hasOwnProperty;
...
function Ck() {
  if (Xy) return tf;
  Xy = 1;
  var s = kk(), i = Bg(), r = Tk(), l = Dk(), u = Yk(), g = Od(), f = pp(), p = "[object Map]", L = "[object Object]", w = "[object Promise]", D = "[object Set]", b = "[object WeakMap]", H = "[object DataView]", N = f(s), q = f(i), O = f(r), x = f(l), Q = f(u), X = g;
...
function bk() {
  if (e0) return sf;
  e0 = 1;
  var s = oy(), i = hy(), r = rk(), l = Lk(), u = Ck(), g = vn(), f = Fy(), p = Iy(), L = 1, w = "[object Arguments]", D = "[object Array]", b = "[object Object]", H = Object.prototype, N = H.hasOwnProperty;
...
function Pk() {
  if (h0) return hf;
  h0 = 1;
  var s = s0(), i = Nk(), r = Hk(), l = wg(), u = r0(), g = l0(), f = om(), p = 1, L = 2;
  function w(D, b) {
...
function Kk() {
  if (F0) return Sf;
  F0 = 1;
  var s = dp(), i = lh(), r = Rk(), l = $k(), u = Gk(), g = Py(), f = Jk(), p = _0(), L = vn();
  function w(D, b, H) {
...
var Qk = Zk();
const ir = Kc(Qk), ii = pn("inquiryGroups", () => {
  ...
  return ir(l, [Xk[s.sort.by]], [s.sort.reverse ? "desc" : "asc"]);
}, chunkedList() {
...
} } }), xf = pn("comments", { state: () => ({ comments: [] }), getters: { count: (s) => s.comments.length, groupedComments: (s) => fM(s.comments) }, actions: { async load() {
  const s = Ee();
  try {
...
} } }), sT = { baseURL: Xw("apps/agora/"), headers: { Accept: "application/json", "Nc-Agora-Client-Time-Zone": Intl.DateTimeFormat().resolvedOptions().timeZone } }, nT = { baseURL: eM("apps/"), headers: { Accept: "application/json" } }, aT = eg.CancelToken, I = eg.create(sT), rT = eg.create(nT);
...
const Rt = (s) => {
  ...
  return Object.getOwnPropertyNames(s).forEach((r) => {
    ...
    i[r] = { handleRequestCancellation: () => (l.cancelToken && l.cancelToken.cancel(`${r} canceled`), l.cancelToken = aT.source(), l.cancelToken) };
  }), i;
}, E0 = { getActivities(s) {
  return rT.request({ method: "GET", url: "activity/api/v2/activity/inquiries", params: { format: "json", since: 0, limit: 50, object_type: "inquiry", object_id: s }, cancelToken: iT[this.getActivities.name].handleRequestCancellation().token });
} }, iT = Rt(E0), H0 = { runAutoReminder() {
  ...
  return I.request({ method: "GET", url: "/session", params: { time: +/* @__PURE__ */ new Date() }, cancelToken: oT[this.getSession.name].handleRequestCancellation().token });
} }, oT = Rt(z0), um = { uploadAttachment(s, i) {
  ...
  return Ye.use(X_(lT)), sM.sanitize(Ye.parse(this.description).toString());
} }, actions: { reset() {
  this.$reset();
  ...
  this.$debounce(async () => {
    ...
    try {
      ...
      this.$patch(r.data.inquiry), tM(Ef.UpdateInquiry, { store: "inquiry", message: re("inquiries", "Inquiry updated") });
    } catch (r) {
      if (r?.code === "ERR_CANCELED") return;
...
function V0(s, i) {
  ...
  for (const u in l) {
    const g = l[u];
    g && (i(u, uT(s, u, g)), r.push(u));
  }
  return r;
}
const cT = { provider: "", aliases: {}, not_found: {}, ...$0 };
function If(s, i) {
...
function J0(s) {
  ...
  const i = s;
  if (typeof i.prefix != "string" || !s.icons || typeof s.icons != "object" || !If(s, cT)) return null;
  const r = i.icons;
  for (const u in r) {
    const g = r[u];
...
function _T(s, i) {
  ...
  return i ? hT(l, r.name, i) : (l.missing.add(r.name), true);
}
function pT(s, i) {
...
const X0 = Object.freeze({ width: null, height: null }), e1 = Object.freeze({ ...X0, ...hm }), yT = /(-?[0-9.]*[0-9]+[0-9.]*)/g, vT = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function t1(s, i, r) {
  if (i === 1) return s;
...
function LT(s, i, r) {
  const l = wT(s);
  return MT(l.defs, i + l.content + r);
}
const kT = (s) => s === "unset" || s === "undefined" || s === "none";
function TT(s, i) {
  ...
  [r, l].forEach((O) => {
    ...
    se % 2 === 1 && (u.left !== u.top && (Z = u.left, u.left = u.top, u.top = Z), u.width !== u.height && (Z = u.width, u.width = u.height, u.height = Z)), x.length && (g = LT(g, '<g transform="' + x.join(" ") + '">', "</g>"));
  });
...
const DT = /\sid="(\S+)"/g, YT = "IconifyId" + Date.now().toString(16) + (Math.random() * 16777216 | 0).toString(16);
let CT = 0;
function bT(s, i = YT) {
  const r = [];
  let l;
  for (; l = DT.exec(s); ) r.push(l[1]);
  if (!r.length) return s;
  const u = "suffix" + (Math.random() * 16777216 | Date.now()).toString(16);
  return r.forEach((g) => {
    const f = typeof i == "function" ? i(g) : i + (CT++).toString(), p = g.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
...
var zT = { resources: [], index: 0, timeout: 2e3, rotate: 750, random: false, dataAfterTimeout: false };
function BT(s, i, r, l) {
...
function nD(s) {
  return "data:image/svg+xml," + sD(s);
}
function aD(s) {
  return 'url("' + nD(s) + '")';
}
const l1 = { ...e1, inline: false }, rD = { xmlns: "http://www.w3.org/2000/svg", "xmlns:xlink": "http://www.w3.org/1999/xlink", "aria-hidden": true, role: "img" }, iD = { display: "inline-block" }, $f = { backgroundColor: "currentColor" }, d1 = { backgroundColor: "transparent" }, m1 = { Image: "var(--svg)", Repeat: "no-repeat", Size: "100% 100%" }, u1 = { webkitMask: $f, mask: $f, background: d1 };
for (const s in u1) {
  const i = u1[s];
...
const g1 = (s, i) => {
  const r = ZT(l1, i), l = { ...rD }, u = i.mode || "svg", g = {}, f = i.style, p = typeof f == "object" && !(f instanceof Array) ? f : {};
  for (let O in i) {
    const x = i[O];
    if (x !== void 0) switch (O) {
      ...
      case "vFlip":
        ...
        break;
      case "flip":
        typeof x == "string" && XT(r, x);
        break;
      case "color":
        g.color = x;
        break;
      case "rotate":
        typeof x == "string" ? r[O] = eD(x) : typeof x == "number" && (r[O] = x);
        break;
      case "ariaHidden":
      case "aria-hidden":
  ...
  const L = TT(s, r), w = L.attributes;
  if (r.inline && (g.verticalAlign = "-0.125em"), u === "svg") {
    l.style = { ...g, ...p }, Object.assign(l, w);
    let O = 0, x = i.id;
    return typeof x == "string" && (x = x.replace(/-/g, "_")), l.innerHTML = bT(L.body, x ? () => x + "ID" + O++ : "iconifyVue"), tg("svg", l);
  }
  const { body: D, width: b, height: H } = s, N = u === "mask" || (u === "bg" ? false : D.indexOf("currentColor") !== -1), q = tD(D, { ...w, width: b + "", height: H + "" });
  return l.style = { ...g, "--svg": aD(q), width: c1(w.width), height: c1(w.height), ...iD, ...N ? $f : d1, ...p }, tg("span", l);
};
if (Q0(true), ST("", jT), typeof document < "u" && typeof window < "u") {
  const s = window;
  if (s.IconifyPreload !== void 0) {
    ...
    typeof i == "object" && i !== null && (i instanceof Array ? i : [i]).forEach((l) => {
      try {
        (typeof l != "object" || l === null || l instanceof Array || typeof l.icons != "object" || typeof l.prefix != "string" || !pT(l)) && console.error(r);
      } catch {
        console.error(r);
      }
    });
...
const oD = { ...fm, body: "" }, lD = Zc((s, { emit: i }) => {
  const r = tr(null);
  function l() {
    r.value && (r.value.abort?.(), r.value = null);
  }
  const u = tr(!!s.ssr), g = tr(""), f = nM(null);
  function p() {
    const w = s.icon;
    ...
    if (!b) {
      const q = r.value;
      return (!q || q.name !== w) && (b === null ? r.value = { name: w } : r.value = { name: w, abort: KT([D], L) }), null;
    }
    l(), g.value !== w && (g.value = w, oM(() => {
      i("load", w);
    }));
    const H = s.customise;
    if (H) {
...
function QY(s, i, r, l, u, g) {
  ...
  return qe(), dt("div", JY, [g.showHalfEmptyContentArea ? (qe(), Ya(p, { key: 0, description: g.halfEmptyContentString, class: "half-screen" }, { icon: sr(() => [Js(s.$slots, "halfEmptyContentIcon", {}, () => [$d(f)], true)]), _: 3 }, 8, ["description"])) : Cs("", true), Sa("ul", null, [(qe(true), dt(sg, null, ng(g.displayedItems, (D) => (qe(), dt("li", { key: D.id }, [Js(s.$slots, "default", { item: D }, () => [$d(L, A_({ ref_for: true }, D, { "item-menu": r.itemMenu }, hM(g.handlers)), null, 16, ["item-menu"])], true)]))), 128))]), r.loading ? (qe(), dt("div", KY, [(qe(), dt(sg, null, ng(7, (D) => Sa("div", { key: D, class: "item-list__entry" }, [$d(w, { class: "item-avatar", size: 44 }), i[0] || (i[0] = Sa("div", { class: "item__details" }, [Sa("h3", null, " "), Sa("p", { class: "message" }, "   ")], -1))])), 64))])) : r.items.length === 0 ? Js(s.$slots, "empty-content", { key: 2 }, () => [r.emptyContentMessage ? (qe(), Ya(p, { key: 0, description: r.emptyContentMessage }, { icon: sr(() => [Js(s.$slots, "emptyContentIcon", {}, void 0, true)]), _: 3 }, 8, ["description"])) : Cs("", true)], true) : g.showMore ? (qe(), dt("a", { key: 3, href: r.showMoreUrl, target: "_blank", class: "more", tabindex: "0" }, Ca(r.showMoreLabel), 9, ZY)) : Cs("", true)]);
}
...
//# sourceMappingURL=NcDashboardWidget-Wkx_9xKh-DfVZeYPI.chunk.mjs.map
