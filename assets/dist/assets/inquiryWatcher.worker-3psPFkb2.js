;(function () {
  ...
  function mergeConfig$1(config1, config2) {
    ...
    const mergeMap = {
      ...
      headers: (a, b2, prop) =>
        mergeDeepProperties(headersToObject(a), headersToObject(b2), prop, true),
    }
  ...
  const R = (n, e) => d(n, '', e),
    d = (n, e, o) => {
      ...
      const s =
          (i2 =
            (r = (c = window == null ? void 0 : window.OC) == null ? void 0 : c.coreApps) == null
              ? void 0
              : r.includes(n)) != null
            ? i2
            : false,
      ...
      return (
        l && !s
          ? ((t += '/index.php/apps/'.concat(n)), (t += '/'.concat(o)))
          : !l && !s
            ? ((t = b(n)), t.at(-1) !== '/' && (t += '/'), (t += o))
            : ((t += '/'.concat(n)), (t += '/'.concat(o))),
        t
      )
    }
  function f() {
