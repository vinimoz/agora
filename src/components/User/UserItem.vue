    ...
    <div class="avatar-wrapper">
      <NcAvatar v-bind="avatarProps" class="user-item__avatar" @click="showMenu()">
        <template v-if="useIconSlot" #icon>
          ...
          />
          <component
            :is="StatusIcons.ContactGroupIcon"
          ...
          />
          <component
            :is="StatusIcons.CircleIcon"
            v-if="typeComputed === 'circle'"
            :size="mdIconSize"
          />
          <component
            :is="StatusIcons.DeletedUserIcon"
