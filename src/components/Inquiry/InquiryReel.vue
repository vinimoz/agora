  ...
  <div class="inquiry-reel" :class="orientation">
    ...
    <div ref="reelContainer" class="reel-container">
      ...
      >
        ...
        >
          <InquiryItem :inquiry="inquiry" :grid-view="true" class="reel-inquiry-item">
            <template #actions>
              <InquiryItemActions
...
.inquiry-reel {
  ...
  .reel-item {
    ...
    /* Fix 1: progress bar no longer shows the blue/grey line */
    .reel-progress {
      display: none;
    }
  }
  ...
  .reel-nav-btn {
    ...
    /* Fix 3: no transform on hover/active — button stays put */
    &:hover {
    ...
    /* Fix 2: aggressive white override for all icon shapes */
    :deep(svg),
