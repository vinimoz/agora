...
<template>
    <div class="family-layout-vote">
        ...
        <!-- Stacked mode: multiple active engines, each covering disjoint options -->
        ...
        <!-- Single-engine mode: header shown even without options -->
        <div v-else-if="hasActiveEngine && currentEngine" class="vote-interface">
            ...
            <!-- No options linked to this engine yet -->
            <VoteEmptyState
...
// Progress bookkeeping for stacked mode
