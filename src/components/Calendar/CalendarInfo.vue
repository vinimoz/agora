...
const showJustDays = computed(() => dayStart.value !== dayEnd.value || calendarEvent.allDay)
...
<template>
  <div class="calendar-info" :class="[conflictLevel, statusClass]" :style="calendarStyle">
