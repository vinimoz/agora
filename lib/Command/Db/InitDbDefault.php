...
class InitDbDefault extends Command
{
	...
	private array $optionTypes = [
		...
		[
			...
			'fields' => [
				...
				['key' => 'grades', 'label' => 'Grade Categories', 'type' => 'array', 'required' => false, 'default' => ['Reject', 'Insufficient', 'Passable', 'Fairly Good', 'Good', 'Very Good', 'Excellent']],
			],
			'allowed_response' => [],
			'allow_comment' => true,
		...
		[
			...
			'fields' => [
				['key' => 'assigned_to', 'label' => 'Assigned to', 'type' => 'users', 'required' => false],
		...
		// ====================================================
		// Process Family – Agenda Item
		// ====================================================
		[
			'family' => 'process',
			'option_type' => 'agenda_item',
			'icon' => 'Calendar',
			'label' => 'Agenda Item',
			'description' => 'An item on a meeting agenda.',
			'fields' => [
				['key' => 'time', 'label' => 'Time', 'type' => 'datetime', 'required' => false],
		...
		// ====================================================
		// Process Family – Booking Slot
		// ====================================================
		[
			'family' => 'process',
			'option_type' => 'booking_slot',
			'icon' => 'Clock',
			'label' => 'Booking Slot',
			'description' => 'A time slot for booking.',
			'fields' => [
		...
		[
			...
			'fields' => [
				["key" => "linked_inquiry", "label" => "Linked inquiry", "type" => "inquiry", "required" => false],
			],
			'allowed_response' => [
				'section',
				'article',
		...
		// ====================================================
		// Consensus Family – Recommendation
		// ====================================================
		[
			'family' => 'consensus',
			...
			'description' => 'A recommendation from a citizen jury.',
			'fields' => [
				['key' => 'rationale', 'label' => 'Rationale', 'type' => 'text', 'required' => false],
			],
	...
	private array $inquiryTypes = [
		...
		[
			...
			'fields' => [
				...
				["key" => "type_of_vote","label" => "Type of Vote","type" => "enum","required" => false,"default" => "binary","allowed_values" => ["binary","majority_judgment","score"],"rules" => []],
		...
		[
			...
			'allowed_response' => ['official', 'project', 'proposal'],
			'allowed_transformation' => [],
		...
		[
			...
			'allowed_response' => ['official','audit_request','performance_review'],
			'allowed_transformation' => [],
			'allowed_option_type' => [
				'position_for',
				'position_against',
		...
		[
			...
			'allowed_response' => ['official','audit_request'],
			'allowed_transformation' => [],
			'allowed_option_type' => [
				'position_for',
				'position_against',
		...
		[
			...
			'allowed_response' => ['official','performance_review'],
			'allowed_transformation' => [],
			'allowed_option_type' => [
				'process_phase',
				'milestone',
		...
		// Add to $inquiryTypes
		[
			'inquiry_type' => 'citizen',
			'family' => 'collective',
			'icon' => 'Account',
			'label' => 'Citizen Response',
			'description' => 'Response from a citizen to an inquiry.',
			'fields' => [],
			'allowed_response' => [],
			'allowed_transformation' => null,
			'allowed_option_type' => [],
		...
		[
			...
			'icon' => 'HelpCircle',
			'label' => 'Question',
			'description' => 'A question posed to the community.',
			'fields' => [],
			'allowed_response' => ['official'],
			'allowed_transformation' => null,
			'allowed_option_type' => ['poll_option', 'consultation_question'],
			'allow_comment' => true,
			'support_feature' => 'none',
			'is_root' => true,
			'created' => '',
		...
		[
			...
			'fields' => [
				["key" => "mandate","label" => "Mandate","type" => "text","required" => false,"default" => null,"rules" => []],
				["key" => "deadline","label" => "Deadline","type" => "date","required" => false,"default" => null,"rules" => []],
				["key" => "layout_zone","label" => "Position display into the layout","type" => "enum","required" => false,"default" => "footer","allowed_values" => ["sidebar","main","footer","header"],"rules" => []],
				["key" => "render_mode","label" => "Render mode of inquiries","type" => "enum","required" => false,"default" => "cards","allowed_values" => ["cards","list","full","summary","rich_html"],"rules" => []],
				["key" => "open_mode","label" => "Open Mode","type" => "enum","required" => false,"default" => "page","allowed_values" => ["page","modal","none"],"rules" => []],
				['key' => 'support_template', 'label' => 'Support Template', 'type' => 'json', 'required' => false, 
		...
		// ============================================================
		[
			'inquiry_type' => 'ethics_review',
			'family' => 'oversight',
			'icon' => 'Scale',
			'label' => 'Ethics Review',
			'description' => 'Review of an ethical issue or public-interest concern.',
			'fields' => [],
		...
		[
			...
			'allowed_response' => ['investigation_request','official'],
			'allowed_option_type' => ['official_summary'],
			'allow_comment' => false,
			'support_feature' => 'none',
			'is_root' => true,
		...
		// ============================================================
		// SOCIAL / CHILDCARE / HOUSING / SCHOLARSHIP
		// ============================================================
		[
		...
		// ============================================================
		// NEWLY ADDED INQUIRY TYPES (to fix missing references)
		// ============================================================
		[
			'inquiry_type' => 'incident_report',
			'family' => 'service',
			'icon' => 'AlertCircle',
			'label' => 'Incident Report',
			'description' => 'Report of an incident such as accidents, safety hazards, or damages.',
			'fields' => [
				['key' => 'location', 'label' => 'Location', 'type' => 'location', 'required' => true],
				['key' => 'incident_type', 'label' => 'Incident Type', 'type' => 'enum', 'required' => true, 'allowed_values' => ['accident', 'safety_hazard', 'damage', 'other']],
				['key' => 'description', 'label' => 'Description', 'type' => 'text', 'required' => true],
				['key' => 'severity', 'label' => 'Severity', 'type' => 'enum', 'required' => false, 'allowed_values' => ['low', 'medium', 'high']],
				['key' => 'attachments', 'label' => 'Attachments', 'type' => 'files', 'required' => false],
			],
			'allowed_response' => ['official'],
			'allowed_transformation' => null,
		...
		[
			'inquiry_type' => 'service_offer',
			'family' => 'service',
			'icon' => 'Offer',
			'label' => 'Service Offer',
			'description' => 'Offer of a service by a citizen or organization.',
			'fields' => [
				['key' => 'service_type', 'label' => 'Service Type', 'type' => 'string', 'required' => true],
				['key' => 'description', 'label' => 'Description', 'type' => 'text', 'required' => true],
				['key' => 'price', 'label' => 'Price', 'type' => 'integer', 'required' => false],
				['key' => 'contact', 'label' => 'Contact', 'type' => 'string', 'required' => false],
			],
		...
		[
			...
			'icon' => 'Briefcase',
			'label' => 'Job Offer',
			'description' => 'Offer of a job or position.',
			'fields' => [
		...
		[
			...
			'icon' => 'Bank',
			'label' => 'Assembly',
			'description' => 'A general assembly or meeting.',
			'fields' => [
				...
				['key' => 'quorum', 'label' => 'Quorum', 'type' => 'integer', 'required' => false],
			],
			'allowed_response' => ['proposal','consultation','deliberation'],
			'allowed_transformation' => null,
			'allowed_option_type' => ['agenda_item','message','official_summary'],
			'allow_comment' => true,
			'support_feature' => 'none',
		...
		[
			...
			'icon' => 'File',
			'label' => 'Report',
			'description' => 'A formal report on a topic.',
			'fields' => [
				['key' => 'title', 'label' => 'Title', 'type' => 'string', 'required' => true],
				['key' => 'content', 'label' => 'Content', 'type' => 'rich_text', 'required' => true],
				['key' => 'published_by', 'label' => 'Published by', 'type' => 'users', 'required' => false],
    ...
    [
        ...
        'actions' => [
            ['key' => 'create_inquiry', 'label' => 'Report Issue', 'icon' => 'Plus'],
        ],
        'sort_order' => 1,
        'created' => '',
    ],
    [
        ...
        'actions' => [
            ['key' => 'create_inquiry', 'label' => 'Publish Ad', 'icon' => 'Plus'],
        ],
        'sort_order' => 3,
        'created' => '',
    ],
    ...
    [
        ...
        'rules' => [
            'allow_child_groups' => false,
            'allow_child_inquiries' => true,
            'allow_multiple_inquiry_types' => false,
            'require_inquiry_selection' => true,
        ],
        'actions' => [
            ['key' => 'create_inquiry', 'label' => 'Add Investigation', 'icon' => 'Plus'],
        ],
        'sort_order' => 2,
        'created' => '',
    ],
    [
        ...
        'actions' => [
            ['key' => 'create_inquiry', 'label' => 'Create Review', 'icon' => 'Plus'],
        ],
        'sort_order' => 3,
        'created' => '',
    ],
    ...
    [
        ...
        'description' => 'Official public announcements and communications.',
        'fields' => [
            ["key" => "priority", "label" => "Priority", "type" => "string", "required" => false, "default" => null, "rules" => []],
        ...
        'actions' => [
            ['key' => 'create_inquiry', 'label' => 'Publish Announcement', 'icon' => 'Plus'],
        ],
        'sort_order' => 1,
        'created' => '',
    ],
    [
        ...
        'description' => 'Municipal reports and structured public documentation.',
        'fields' => [
        ...
        'actions' => [
            ['key' => 'create_inquiry', 'label' => 'Add Report', 'icon' => 'Plus'],
            ['key' => 'create_group', 'label' => 'Add Section', 'icon' => 'FolderPlus'],
        ],
        'sort_order' => 2,
        'created' => '',
    ],
    ...
    [
        ...
        'icon' => 'Users',
        'label' => 'Citizen Jury',
        'description' => 'Structured citizen deliberation and decision process.',
        'fields' => [
            // Core identification
    ...
    [
        ...
        'icon' => 'Lightbulb',
        'label' => 'Initiative Group',
        'description' => 'Collection of citizen initiatives and proposals.',
        'fields' => [
        ...
        'actions' => [
            ['key' => 'create_inquiry', 'label' => 'Create Initiative', 'icon' => 'Plus'],
            ['key' => 'create_group', 'label' => 'Create Subgroup', 'icon' => 'FolderPlus'],
        ],
        'sort_order' => 2,
        'created' => '',
    ...
    [
        ...
        'actions' => [
            ['key' => 'create_group', 'label' => 'Create Group', 'icon' => 'FolderPlus'],
            ['key' => 'create_inquiry', 'label' => 'Create Inquiry', 'icon' => 'Plus'],
        ],
        'sort_order' => 6,
        'created' => '',
    ...
    [
        ...
        'actions' => [
            ['key' => 'create_inquiry', 'label' => 'Create Poll', 'icon' => 'Plus'],
        ],
        'sort_order' => 7,
        'created' => '',
    ],
    ...
    [
        ...
        'actions' => [
            ['key' => 'open_group', 'label' => 'Open', 'icon' => 'FolderOpen'],
        ],
        'sort_order' => 1,
        'created' => '',
    ],
    ...
    [
        ...
        'actions' => [
            ['key' => 'create_inquiry', 'label' => 'Add Task', 'icon' => 'Plus'],
            ['key' => 'create_group', 'label' => 'Create Subgroup', 'icon' => 'FolderPlus'],
        ],
        'sort_order' => 1,
        'created' => '',
    ...
    [
        ...
        'actions' => [
            ['key' => 'create_inquiry', 'label' => 'Add Case', 'icon' => 'Plus'],
            ['key' => 'create_group', 'label' => 'Create Subgroup', 'icon' => 'FolderPlus'],
        ],
        'sort_order' => 2,
        'created' => '',
    ...
    [
        ...
        'actions' => [
            ['key' => 'create_inquiry', 'label' => 'Add Consultation', 'icon' => 'Plus'],
        ],
        'sort_order' => 5,
        'created' => '',
    ],
	...
	$groups = ['Agora Users','Agora Moderator', 'Agora Official','Agora Administrator','Agora Group Editor'];
