...
/**
 * @template-extends QBMapper<OptionFamily>
 */
class OptionFamilyMapper extends QBMapper
{
    public const TABLE = OptionFamily::TABLE;
    ...
    {
        parent::__construct($db, self::TABLE, OptionFamily::class);
    }
