...
/**
 * @template-extends QBMapper<InquiryGroupMisc>
 */
class InquiryGroupMiscMapper extends QBMapper
{
    public const TABLE = InquiryGroupMisc::TABLE;
    ...
    {
        parent::__construct($db, self::TABLE, InquiryGroupMisc::class);
    }

    /**
     * @throws \OCP\AppFramework\Db\DoesNotExistException if not found
     * @throws \OCP\AppFramework\Db\MultipleObjectsReturnedException if more than one result
     * @return InquiryGroupMisc
     */
    ...
    {
        try {
            $setting = $this->findByInquiryGroupIdAndKey($inquiryGroupId, $key);
            return $setting->getValue();
        } catch (\OCP\AppFramework\Db\DoesNotExistException $e) {
            return null;
        } catch (\OCP\AppFramework\Db\MultipleObjectsReturnedException $e) {
            $settings = $this->findByInquiryGroupIdAndKeyMultiple($inquiryGroupId, $key);
     ...
     */
    public function setValues(int $inquiryGroupId, array $dynamicFields): void
    {
    ...
    public function setValue(int $inquiryGroupId, string $key, $value): InquiryGroupMisc
    {
        // Create the entity object first
        $miscField = new InquiryGroupMisc();
        $miscField->setInquiryGroupId($inquiryGroupId);
