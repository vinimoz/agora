...
class ShareApiController extends BaseApiV2Controller
{
  ...
  *
    ...
    #[NoAdminRequired]
    #[NoCSRFRequired]
    #[ApiRoute(verb: 'GET', url: '/api/v1.0/inquiry/{inquiryId}/shares', requirements: ['apiVersion' => '(v2)'])]
    public function list(int $inquiryId): DataResponse
    {
        return $this->response(fn () => ['shares' => $this->shareService->list($inquiryId)]);
    }
  ...
  *
    ...
    #[NoAdminRequired]
    #[NoCSRFRequired]
    #[ApiRoute(verb: 'POST', url: '/api/v1.0/inquiry/{inquiryId}/share/{type}', requirements: ['apiVersion' => '(v2)'])]
    public function add(int $inquiryId, string $type, string $userId = '', string $displayName = '', string $emailAddress = ''): DataResponse
    {
        return $this->response(fn () => ['share' => $this->shareService->add($inquiryId, $type, $userId, $displayName, $emailAddress)], Http::STATUS_CREATED);
    }
